...
SpeciesToAdd = {...
'API'; 'O3'; 'NO'; 'NO2'; 'HONO'; 'ONIT'; 'PAN'; 'HNO3'; ...
'ACD'; 'ACE'; 'ACO3'; 'ACT'; 'ACTP'; 'ADCN'; 'ADDC'; 'ALD'; 'APIP'; ...
...
'HC8'; 'HC8P'; 'HCHO'; 'HKET';  'HOONO'; 'HO2'; 'HO2NO2'; 'ISHP'; ...
'ISO'; 'ISON'; 'ISOP'; 'KET'; 'KETP'; 'LIM'; 'LIMP'; 'MACP'; 'MACR'; 'MAHP'; ...
'MBO'; 'MBOP'; 'MBORO2'; 'MCP'; 'MCT'; 'MCTO'; 'MCTP'; 'MEK'; 'MEKP'; 'MGLY'; ...
'MO2'; 'MOH'; 'MPAN'; 'MVK'; 'MVKP'; 'N2O5'; 'NALD'; ...
'NO3';  'O3P'; 'OH'; 'OLI'; 'OLIP'; 'OLND'; 'OLNN'; 'OLT'; ...
'OLTP';  'OP1'; 'OP2'; 'ORA1'; 'ORA2'; 'ORAP'; 'O1D'; 'PAA';  ...
'PER1'; 'PER2'; 'PHEN'; 'PHO'; 'PPN'; 'RCO3'; 'ROH'; 'SO2'; 'SULF'; 'TLP1'; ...
'TOL'; 'TOLP'; 'TR2'; 'UALD'; 'UALP'; 'XO2'; 'XY2'; 'XYL1'; 'XYLP'; 'XYM'; ...
'XYO'; 'XYP'; 'XYO2'; 'XYOP'; ...
'A'; 'B'; 'C'; 'D'; 'E'; 'F'; 'G'; 'F'; 'G'; 'H'; 'I'; 'J'; 'K'; 'L'; 'M'; 'N'; 'O'; };

AddSpecies

%%Emissions
%%These pseduo-first order reactions simulate emissions for Case20 specified for Stockwell et al., 1997
i=i+1; %<Emiss_1>;
Rnames{i} = 'A=NO';
k(:,i) = 4.33E-9;
Gstr{i,1} = 'A'; 
