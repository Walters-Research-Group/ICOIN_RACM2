...
i=i+1; %<BAPI_044>
Rnames{i} = 'API + O3 = 0.16 PINAL + 0.16H2O2 + 0.8 OH + 0.33 APINO2c + 0.47 APINO2d';
...
fAPINO2c(i)=fAPINO2c(i)+0.33; fAPINO2d(i)=fAPINO2d(i)+0.47; 
...
i=i+1; %<BAPI_050>
Rnames{i} = 'APINO2a + NO = 0.115 cAPINITa + 0.115nAPINITa + 0.7PINAL + 0.7 HO2 + 0.77 NO2';
k(:,i) =  2.55E-12*exp(380/T);
Gstr{i,1} = 'APINO2a'; Gstr{i,2} = 'NO'; 
fAPINO2a(i)=fAPINO2a(i)-1; fNO(i)=fNO(i)-1; fcAPINITa(i)=fcAPINITa(i)+0.115; fnAPINITa(i)=fnAPINITa(i)+0.115; 
fPINAL(i)=fPINAL(i)+0.7; fHO2(i)=fHO2(i)+0.7;  fNO2(i)=fNO2(i)+0.77; 

i=i+1; %<BAPI_051>
Rnames{i} = 'APINO2b + NO = 0.115 cAPINITb + 0.115nAPINITb + 0.7PINAL + 0.7 HO2 + 0.77 NO2';
k(:,i) =  2.55E-12*exp(380/T);
Gstr{i,1} = 'APINO2b'; Gstr{i,2} = 'NO'; 
fAPINO2b(i)=fAPINO2b(i)-1; fNO(i)=fNO(i)-1; fcAPINITb(i)=fcAPINITb(i)+0.115; fnAPINITb(i)=fnAPINITb(i)+0.115; 
fPINAL(i)=fPINAL(i)+0.7; fHO2(i)=fHO2(i)+0.7;  fNO2(i)=fNO2(i)+0.77; 

i=i+1; %<BAPI_052>
Rnames{i} = 'APINO2c + NO = APINP + NO2';
k(:,i) =  2.55E-12*exp(380/T);
