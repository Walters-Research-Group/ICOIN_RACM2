...
i=i+1; %<BAPI_044>
Rnames{i} = 'API + O3 = 0.16 PINAL + 0.02H2O2 +0.14 HO2 + 0.85 OH + 0.33 APINO2c + 0.47 APINO2d';
k(:,i) = 0.48E-15*exp(-550/T);
Gstr{i,1} = 'API'; Gstr{i,2} = 'O3'; 
fAPI(i)=fAPI(i)-1; fO3(i)=fO3(i)-1; fPINAL(i)=fPINAL(i)+0.16; fH2O2(i)=fH2O2(i)+0.02; fOH(i)=fOH(i)+0.85; 
fAPINO2c(i)=fAPINO2c(i)+0.33; fAPINO2d(i)=fAPINO2d(i)+0.47; fHO2(i)=fHO2(i)+0.14;
...
i=i+1; %<BAPI_050>
Rnames{i} = 'APINO2a + NO = 0.035 cAPINITa + 0.035nAPINITa + 0.05PINAL + 0.93 HO2 + 0.93 NO2 + 0.11 HCHO + 0.13 APINP + 0.44 KET';
k(:,i) =  2.55E-12*exp(380/T);
Gstr{i,1} = 'APINO2a'; Gstr{i,2} = 'NO'; 
fAPINO2a(i)=fAPINO2a(i)-1; fNO(i)=fNO(i)-1; fcAPINITa(i)=fcAPINITa(i)+0.035; fnAPINITa(i)=fnAPINITa(i)+0.035; 
fPINAL(i)=fPINAL(i)+0.05; fHO2(i)=fHO2(i)+0.93;  fNO2(i)=fNO2(i)+0.93; fHCHO(i)=fHCHO(i)+0.11; fAPINP(i)=fAPINP(i)+0.13; fKET(i)=fKET(i)+0.44;

i=i+1; %<BAPI_051>
Rnames{i} = 'APINO2b + NO = 0.035 cAPINITb + 0.035nAPINITb + 0.05PINAL + 0.93 HO2 + 0.93 NO2 + 0.11 HCHO + 0.13 APINP +0.44 KET';
k(:,i) =  2.55E-12*exp(380/T);
Gstr{i,1} = 'APINO2b'; Gstr{i,2} = 'NO'; 
fAPINO2b(i)=fAPINO2b(i)-1; fNO(i)=fNO(i)-1; fcAPINITb(i)=fcAPINITb(i)+0.035; fnAPINITb(i)=fnAPINITb(i)+0.035; 
fPINAL(i)=fPINAL(i)+0.05; fHO2(i)=fHO2(i)+0.93;  fNO2(i)=fNO2(i)+0.93; fHCHO(i)=fHCHO(i)+0.11; fAPINP(i)=fAPINP(i)+0.13; fKET(i)=fKET(i)+0.44;
...
i=i+1; %<BAPI_053>
Rnames{i} = 'APINO2d + NO = APINP + 0.93NO2 + 0.035cAPINITc + 0.035nAPINITc + 0.93 HO2';
k(:,i) =  2.55E-12*exp(380/T);
Gstr{i,1} = 'APINO2d'; Gstr{i,2} = 'NO'; 
fAPINO2d(i)=fAPINO2d(i)-1; fNO(i)=fNO(i)-1; fAPINP(i)=fAPINP(i)+1; fNO2(i)=fNO2(i)+0.93;
fcAPINITc(i)=fcAPINITc(i)+0.035; fnAPINITc(i)=fnAPINITc(i)+0.035; fHO2(i)=fHO2(i)+0.93;
...
i=i+1; %<BAPI_080>
Rnames{i} = 'APINNO2a + NO3 = 0.05 cAPINITa +0.05 nAPINITa+ 0.9 PINAL + 1.8 NO2';
k(:,i) =    2.3E-12;
Gstr{i,1} = 'APINNO2a'; Gstr{i,2} = 'NO3'; 
fAPINNO2a(i)=fAPINNO2a(i)-1; fNO3(i)=fNO3(i)-1; fcAPINITa(i)=fcAPINITa(i)+0.05; fnAPINITa(i)=fnAPINITa(i)+0.05;
fPINAL(i)=fPINAL(i)+0.9; fNO2(i)=fNO2(i)+1.8;

i=i+1; %<BAPI_081>
Rnames{i} = 'APINNO2b + NO3 = 0.05 cAPINITb +0.05 nAPINITb+ 0.9 PINAL + 1.8 NO2';
k(:,i) =    2.3E-12;
Gstr{i,1} = 'APINNO2b'; Gstr{i,2} = 'NO3'; 
fAPINNO2b(i)=fAPINNO2b(i)-1; fNO3(i)=fNO3(i)-1; fcAPINITb(i)=fcAPINITb(i)+0.05; fnAPINITb(i)=fnAPINITb(i)+0.05;
fPINAL(i)=fPINAL(i)+0.9; fNO2(i)=fNO2(i)+1.8;

i=i+1; %<BAPI_082>
Rnames{i} = 'APINNO2a + APINNO2a = 0.16 DIMER + 1.68 PINAL + 1.68 NO2';
k(:,i) =   1E-14;
Gstr{i,1} = 'APINNO2a'; Gstr{i,2} = 'APINNO2a'; 
fAPINNO2a(i)=fAPINNO2a(i)-1; fAPINNO2a(i)=fAPINNO2a(i)-1; fDIMER(i)=fDIMER(i)+0.16; fPINAL(i)=fPINAL(i)+1.68;
fNO2(i)=fNO2(i)+1.68;

i=i+1; %<BAPI_083>
Rnames{i} = 'APINNO2a + APINNO2b = 0.17 cAPINITb + 0.17 nAPINITb + 0.16 DIMER + 1.34 PINAL + 1.34 NO2';
k(:,i) =   1E-14;
Gstr{i,1} = 'APINNO2a'; Gstr{i,2} = 'APINNO2b'; 
fAPINNO2a(i)=fAPINNO2a(i)-1; fAPINNO2b(i)=fAPINNO2b(i)-1;   fcAPINITb(i)=fcAPINITb(i)+0.17; 
fnAPINITb(i)=fnAPINITb(i)+0.17; fDIMER(i)=fDIMER(i)+0.16; fPINAL(i)=fPINAL(i)+1.34;
fNO2(i)=fNO2(i)+1.34;

i=i+1; %<BAPI_084>
Rnames{i} = 'APINNO2b + APINNO2b = 0.34 cAPINITb + 0.34 nAPINITb + 0.16 DIMER + PINAL + NO2';
k(:,i) =   1E-14;
Gstr{i,1} = 'APINNO2b'; Gstr{i,2} = 'APINNO2b'; 
fAPINNO2b(i)=fAPINNO2b(i)-1; fAPINNO2b(i)=fAPINNO2b(i)-1;   fcAPINITb(i)=fcAPINITb(i)+0.34; 
fnAPINITb(i)=fnAPINITb(i)+0.34; fDIMER(i)=fDIMER(i)+0.16; fPINAL(i)=fPINAL(i)+1;
fNO2(i)=fNO2(i)+1;
...
i=i+1; %<BAPI_088>
Rnames{i} = 'RCO3 + HO2 = 0.44ETHP 0.66APINP + 0.44OH + 0.15O3';
k(:,i) =  KAPHO2;
Gstr{i,1} = 'RCO3'; Gstr{i,1} = 'HO2';  
fRCO3(i)=fRCO3(i)-1; fHO2(i)=fHO2(i)-1;  fAPINP(i)=fAPINP(i)+0.66;  fETHP(i)=fETHP(i)+0.44; fOH(i)=fOH(i)+0.44; fO3(i)=fO3(i)+0.15; 
...
i=i+1; %R195
Rnames{i} = 'KETP+NO= HO2+NO2+APINP';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'KETP'; Gstr{i,2} = 'NO'; 
fKETP(i)=fKETP(i)-1; fNO(i)=fNO(i)-1; fHO2(i)=fHO2(i)+0.77; fNO2(i)=fNO2(i)+1; fAPINP(i)=fAPINP(i)+1;

i=i+1; %R344
Rnames{i} = 'KETP+NO3=APINP+HO2+NO2';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'KETP'; Gstr{i,2} = 'NO3'; 
fKETP(i)=fKETP(i)-1; fNO3(i)=fNO3(i)-1; fAPINP(i)=fAPINP(i)+1; fHO2(i)=fHO2(i)+1; fNO2(i)=fNO2(i)+1; 

i=i+1; %R017
Rnames{i} = 'KET=ETHP+APINP';
k(:,i) = J3;
Gstr{i,1} = 'KET'; 
fKET(i)=fKET(i)-1; fETHP(i)=fETHP(i)+1; fAPINP(i)=fAPINP(i)+1; 

i=i+1; %R173
Rnames{i} = 'ETHP+NO=HO2+APINP+NO2';
k(:,i) = 2.60E-12.*exp(365./T);
Gstr{i,1} = 'ETHP'; Gstr{i,2} = 'NO'; 
fETHP(i)=fETHP(i)-1; fNO(i)=fNO(i)-1; fHO2(i)=fHO2(i)+1; fAPINP(i)=fAPINP(i)+1; fNO2(i)=fNO2(i)+1;

i=i+1;  %R213
Rnames{i} = 'ETHP+HO2=APINP';
k(:,i) = 7.50E-13.*exp(700./T);
Gstr{i,1} = 'ETHP'; Gstr{i,2} = 'HO2'; 
fETHP(i)=fETHP(i)-1; fHO2(i)=fHO2(i)-1; fAPINP(i)=fAPINP(i)+1;

 
i=i+1; %R322
Rnames{i} = 'ETHP+NO3=APINP+HO2+NO2';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'ETHP'; Gstr{i,2} = 'NO3'; 
fETHP(i)=fETHP(i)-1; fNO3(i)=fNO3(i)-1; fAPINP(i)=fAPINP(i)+1; fHO2(i)=fHO2(i)+1; fNO2(i)=fNO2(i)+1; 
