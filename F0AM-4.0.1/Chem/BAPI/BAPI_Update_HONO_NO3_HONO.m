...
i=i+1; %<BAPI_050>
Rnames{i} = 'APINO2a + NO = 0.024 cAPINITa + 0.02 nAPINITa + 0.05PINAL + 0.956 HO2 + 0.956 NO2 + 0.11 HCHO + 0.57 APINP';
k(:,i) =  2.55E-12*exp(380/T)*.1;
Gstr{i,1} = 'APINO2a'; Gstr{i,2} = 'NO'; 
fAPINO2a(i)=fAPINO2a(i)-1; fNO(i)=fNO(i)-1; fcAPINITa(i)=fcAPINITa(i)+0.024; fnAPINITa(i)=fnAPINITa(i)+0.02; 
fPINAL(i)=fPINAL(i)+0.05; fHO2(i)=fHO2(i)+0.956;  fNO2(i)=fNO2(i)+0.956; fHCHO(i)=fHCHO(i)+0.11; fAPINP(i)=fAPINP(i)+0.57;

i=i+1; %<BAPI_051>
Rnames{i} = 'APINO2b + NO = 0.024 cAPINITb + 0.02 nAPINITb + 0.05PINAL + 0.956 HO2 + 0.956 NO2 + 0.11 HCHO + 0.57 APINP';
k(:,i) =  2.55E-12*exp(380/T)*.1;
Gstr{i,1} = 'APINO2b'; Gstr{i,2} = 'NO'; 
fAPINO2b(i)=fAPINO2b(i)-1; fNO(i)=fNO(i)-1; fcAPINITb(i)=fcAPINITb(i)+0.024; fnAPINITb(i)=fnAPINITb(i)+0.02; 
fPINAL(i)=fPINAL(i)+0.05; fHO2(i)=fHO2(i)+0.956;  fNO2(i)=fNO2(i)+0.956; fHCHO(i)=fHCHO(i)+0.11; fAPINP(i)=fAPINP(i)+0.57;
...
%%%%More HONO RXN?&&&&&
i=i+1; %<BAPI_New>
Rnames{i} = 'HO2 + NO2 = HONO';
k(:,i) = 5.01E-15;
Gstr{i,1} = 'HO2'; Gstr{i,2} = 'NO2'; 
fHO2(i)=fHO2(i)-1; fNO2(i)=fNO2(i)-1; fHONO(i)=fHONO(i)+1; 
