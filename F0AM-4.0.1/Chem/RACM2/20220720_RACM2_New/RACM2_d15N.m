...
k(:,i) = 2.50E-22.*H2O; %mmarvin 20151020
Gstr{i,1} = 'Z2O5'; 
fZ2O5(i)=fZ2O5(i)-1; fZNO3(i)=fHZO3(i)+1; fHZO3(i)=fHZO3(i)+1; %SR 20160406
...
k(:,i) = 1.19E-12.*exp(490./T);
Gstr{i,1} = 'API'; Gstr{i,2} = 'NO3'; 
fAPI(i)=fAPI(i)-1; fNO3(i)=fNO3(i)-1; fOLZN(i)=fOLZN(i)+0.1;  fOLZD(i)=fOLZD(i)+0.9; 
