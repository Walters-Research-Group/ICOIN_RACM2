...
% wwalters added in the d15N reactions; 15N is denotated as "Z"
...
'XYO'; 'XYP'; 'XYO2'; 'XYOP'; 'HZO3'; 'HOZO'; 'HOOZO'; 'HO2ZO2'; 'ZNO5'; 
'Z2O5'; 'ZO'; 'ZO2'; 'ZO3'; 'OLZD'; 'OLZN'; 'OZIT'; 'PAZ'; 'PPZ'; 'MPAZ';...
 };
...
i=i+1; %R122a
Rnames{i} = 'MPAZ+OH=HKET+ZO2';
k(:,i) = 3.20E-11;
Gstr{i,1} = 'MPAZ'; Gstr{i,2} = 'OH'; 
fMPAZ(i)=fMPAZ(i)-1; fOH(i)=fOH(i)-1; fHKET(i)=fHKET(i)+1; fZO2(i)=fZO2(i)+1;
...
%d15N Tracer
i=i+1; %R141a
Rnames{i} = 'ETE+ZO3=0.80 OLZN+0.20 OLZD';
k(:,i) = 4.88E-18.*T.^2.*exp(-2282./T);
Gstr{i,1} = 'ETE'; Gstr{i,2} = 'ZO3'; 
fETE(i)=fETE(i)-1; fZO3(i)=fZO3(i)-1; fOLZN(i)=fOLZN(i)+0.8; fOLZD(i)=fOLZD(i)+0.2; 
...
%d15N Tracer
i=i+1; %R142a
Rnames{i} = 'OLT+ZO3=0.43 OLZN+0.57 OLZD';
k(:,i) = 1.79E-13.*exp(-450./T);
Gstr{i,1} = 'OLT'; Gstr{i,2} = 'ZO3'; 
fOLT(i)=fOLT(i)-1; fZO3(i)=fZO3(i)-1; fOLZN(i)=fOLZN(i)+0.43; fOLZD(i)=fOLZD(i)+0.57; 
...
%d15N Tracer
i=i+1; %R143a
Rnames{i} = 'OLI+ZO3=0.11 OLZN+0.89 OLZD';
k(:,i) = 8.64E-13.*exp(450./T);
Gstr{i,1} = 'OLI'; Gstr{i,2} = 'ZO3'; 
fOLI(i)=fOLI(i)-1; fZO3(i)=fZO3(i)-1; fOLZN(i)=fOLZN(i)+0.11; fOLZD(i)=fOLZD(i)+0.89; 
...
%d15N Tracer
i=i+1; %R144
Rnames{i} = 'DIEN+ZO3=0.90 OLZN+0.10 OLZD+0.90 MACR';
k(:,i) = 1.0E-13;
Gstr{i,1} = 'DIEN'; Gstr{i,2} = 'ZO3'; 
fDIEN(i)=fDIEN(i)-1; fZO3(i)=fZO3(i)-1; fOLZN(i)=fOLZN(i)+0.9; fOLZD(i)=fOLZD(i)+0.1; 
fMACR(i)=fMACR(i)+0.9; 
...
k(:,i) = 3.76E-12.*exp(-1900./T)*0.9967;
...
%d15N Tracer
i=i+1; %R175a
Rnames{i} = 'HC5P+ZO=HO2+MO2+ETHP+XO2+ZO2+HCHO+ACD+ALD+ACT+MEK+KET+HKET+OZIT';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'HC5P'; Gstr{i,2} = 'ZO'; 
fHC5P(i)=fHC5P(i)-1; fZO(i)=fZO(i)-1; fHO2(i)=fHO2(i)+0.20; fMO2(i)=fMO2(i)+0.051; 
fETHP(i)=fETHP(i)+0.231; fXO2(i)=fXO2(i)+0.235; fZO2(i)=fZO2(i)+0.864; fHCHO(i)=fHCHO(i)+0.018; 
fACD(i)=fACD(i)+0.045; fALD(i)=fALD(i)+0.203; fACT(i)=fACT(i)+0.217; fMEK(i)=fMEK(i)+0.033; 
fKET(i)=fKET(i)+0.039; fHKET(i)=fHKET(i)+0.272; fOZIT(i)=fOZIT(i)+0.136; 
...
%d15N Tracer
i=i+1; %R176a
Rnames{i} = 'HC8P+ZO=0.606 HO2+0.133 ETHP+0.416 XO2+0.739 ZO2+0 .150 ALD+0.642 KET+0.261 OZIT ';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'HC8P'; Gstr{i,2} = 'ZO'; 
fHC8P(i)=fHC8P(i)-1; fZO(i)=fZO(i)-1; fHO2(i)=fHO2(i)+0.606; fETHP(i)=fETHP(i)+0.133; 
fXO2(i)=fXO2(i)+0.416; fZO2(i)=fZO2(i)+0.739; fALD(i)=fALD(i)+0.150; 
fKET(i)=fKET(i)+0.642; fOZIT(i)=fOZIT(i)+0.261; 
...
%d15N Tracer
i=i+1; %R177a
Rnames{i} = 'ETEP+ZO=HO2+ZO2+1.6 HCHO+0.2 ALD';
k(:,i) = 9.00E-12;
Gstr{i,1} = 'ETEP'; Gstr{i,2} = 'ZO'; 
fETEP(i)=fETEP(i)-1; fZO(i)=fZO(i)-1; fHO2(i)=fHO2(i)+1; fZO2(i)=fZO2(i)+1;
fHCHO(i)=fHCHO(i)+1.6; fHCHO(i)=fHCHO(i)+0.2;
...
%d15N Tracer
i=i+1; %R178a
Rnames{i} = 'OLTP+ZO= HO2+ZO2+HCHO+ACD+ALD+ACT+MEK+OZIT';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'OLTP'; Gstr{i,2} = 'ZO'; 
fOLTP(i)=fOLTP(i)-1; fZO(i)=fZO(i)-1; fHO2(i)=fHO2(i)+0.78; fZO2(i)=fZO2(i)+0.97; 
fHCHO(i)=fHCHO(i)+0.78; fACD(i)=fACD(i)+0.012; fALD(i)=fALD(i)+0.44; fACT(i)=fACT(i)+0.06; 
fMEK(i)=fMEK(i)+0.13; fOZIT(i)=fOZIT(i)+0.03; 
...
%d15N Tracer
i=i+1; %R179a
Rnames{i} = 'OLIP+ZO = HO2+ZO2+ACD+ALD+ACT+KET+HKET+OZIT';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'OLIP'; Gstr{i,2} = 'ZO'; 
fOLIP(i)=fOLIP(i)-1; fZO(i)=fZO(i)-1; fHO2(i)=fHO2(i)+0.83; fZO2(i)=fZO2(i)+0.95; 
fACD(i)=fACD(i)+0.81; fALD(i)=fALD(i)+0.68; fACT(i)=fACT(i)+0.20; fKET(i)=fKET(i)+0.09; 
fHKET(i)=fHKET(i)+0.02; fOZIT(i)=fOZIT(i)+0.05; %mmarvin 20151020
...
%d15N Tracer
i=i+1; %R184a
Rnames{i} = 'XYL1+ZO=ZO2+BALD';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'XYL1'; Gstr{i,2} = 'ZO'; 
fXYL1(i)=fXYL1(i)-1; fZO(i)=fZO(i)-1; fZO2(i)=fZO2(i)+1; fBALD(i)=fBALD(i)+1; 
...
%d15N Tracer
i=i+1; %R185a
Rnames{i} = 'XYLP+ZO=0.95 HO2+0.95 ZO2+0.95 DCB3+0.050 OZIT ';
k(:,i) = 2.70E-12.*exp(360./T);
Gstr{i,1} = 'XYLP'; Gstr{i,2} = 'ZO'; 
fXYLP(i)=fXYLP(i)-1; fZO(i)=fZO(i)-1; fHO2(i)=fHO2(i)+0.95; fZO2(i)=fZO2(i)+0.95; 
fDCB3(i)=fDCB3(i)+0.95; fOZIT(i)=fOZIT(i)+0.05;
...
%d15N Tracer
i=i+1; %R186a
Rnames{i} = 'PER2+ZO=0.95 HO2+0.95 ZO2+0.95 MGLY+0.95 DCB1+1.05 DCB3+0.05 OZIT ';
k(:,i) = 2.70E-12.*exp(360./T);
Gstr{i,1} = 'PER2'; Gstr{i,2} = 'ZO'; 
fPER2(i)=fPER2(i)-1; fZO(i)=fZO(i)-1; fHO2(i)=fHO2(i)+0.95; fZO2(i)=fZO2(i)+0.95;
fMGLY(i)=fMGLY(i)+0.95; fDCB1(i)=fDCB1(i)+0.95; fDCB3(i)=fDCB3(i)+1.05; 
fOZIT(i)=fOZIT(i)+0.05;
...
%d15N Tracer
i=i+1; %R187a
Rnames{i} = 'XYOP+ZO= HO2+ZO2+GLY+MGLY+DCB1+DCB2+DCB3+OZIT';
k(:,i) = 2.70E-12.*exp(360./T);
Gstr{i,1} = 'XYOP'; Gstr{i,2} = 'ZO'; 
fXYOP(i)=fXYOP(i)-1; fZO(i)=fZO(i)-1; fHO2(i)=fHO2(i)+0.95; fZO2(i)=fZO2(i)+0.95; 
fGLY(i)=fGLY(i)+0.350; fMGLY(i)=fMGLY(i)+0.60; fDCB1(i)=fDCB1(i)+0.70; fDCB2(i)=fDCB2(i)+0.073; 
fDCB3(i)=fDCB3(i)+0.117; fOZIT(i)=fOZIT(i)+0.05; 
...
%d15N Tracer
i=i+1;  %R205a
Rnames{i} = 'OLNN+ZO=ONIT+ZO2+HO2';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'OLNN'; Gstr{i,2} = 'ZO'; 
fOLNN(i)=fOLNN(i)-1; fZO(i)=fZO(i)-1; fONIT(i)=fONIT(i)+1; fZO2(i)=fZO2(i)+1; fHO2(i)=fHO2(i)+1; 

%d15N Tracer
i=i+1;  %R205b
Rnames{i} = 'OLZN+NO=OZIT+NO2+HO2';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'OLZN'; Gstr{i,2} = 'NO'; 
fOLZN(i)=fOLZN(i)-1; fNO(i)=fNO(i)-1; fOZIT(i)=fOZIT(i)+1; fNO2(i)=fNO2(i)+1; fHO2(i)=fHO2(i)+1; 

%d15N Tracer
i=i+1;  %R205c
Rnames{i} = 'OLZN+ZO=OZIT+ZO2+HO2';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'OLZN'; Gstr{i,2} = 'ZO'; 
fOLZN(i)=fOLZN(i)-1; fZO(i)=fZO(i)-1; fOZIT(i)=fOZIT(i)+1; fZO2(i)=fZO2(i)+1; fHO2(i)=fHO2(i)+1; 
...
fOLZD(i)=fOLZD(i)-1; fZO(i)=fZO(i)-1; fNO2(i)=fNO2(i)+1; fZO2(i)=fZO2(i)+1; fHCHO(i)=fHCHO(i)+0.287; fALD(i)=fALD(i)+1.24; fKET(i)=fKET(i)+0.464; 
...
%d15N Tracer
i=i+1; %R244a
Rnames{i} = 'OLZN+HO2=OZIT';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'OLZN'; Gstr{i,2} = 'HO2'; 
fOLZN(i)=fOLZN(i)-1; fHO2(i)=fHO2(i)-1; fOZIT(i)=fOZIT(i)+1; 
...
%d15N Tracer
i=i+1; %R245a
Rnames{i} = 'OLZD+HO2=OZIT';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'OLZD'; Gstr{i,2} = 'HO2'; 
fOLZD(i)=fOLZD(i)-1; fHO2(i)=fHO2(i)-1; fOZIT(i)=fOZIT(i)+1; 
...
%d15N Tracer
i=i+1; %R281a
Rnames{i} = 'OLZN+MO2=HCHO+HO2+HO2+OZIT';
k(:,i) = 1.60E-13.*exp(708./T);
Gstr{i,1} = 'OLZN'; Gstr{i,2} = 'MO2'; 
fOLZN(i)=fOLZN(i)-1; fMO2(i)=fMO2(i)-1; fHCHO(i)=fHCHO(i)+1; fHO2(i)=fHO2(i)+1; fHO2(i)=fHO2(i)+1; fOZIT(i)=fOZIT(i)+1; 
...
%d15N Tracer
i=i+1; %R317a
Rnames{i} = 'OLZN+ACO3=OZIT+MO2+HO2';
k(:,i) = 8.85E-13.*exp(765./T);
Gstr{i,1} = 'OLZN'; Gstr{i,2} = 'ACO3'; 
fOLZN(i)=fOLZN(i)-1; fACO3(i)=fACO3(i)-1; fOZIT(i)=fOZIT(i)+1; fMO2(i)=fMO2(i)+1; fHO2(i)=fHO2(i)+1; 
...
%d15N Tracer
i=i+1; %R326a
Rnames{i} = 'ETEP+ZO3=HO2+ZO2+1.6 HCHO+0.2 ALD';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'ETEP'; Gstr{i,2} = 'ZO3'; 
fETEP(i)=fETEP(i)-1; fZO3(i)=fZO3(i)-1; fHO2(i)=fHO2(i)+1; fZO2(i)=fZO2(i)+1; 
fHCHO(i)=fHCHO(i)+1.6; fALD(i)=fALD(i)+0.2; 
...
%d15N Tracer
i=i+1; %R354a
Rnames{i} = 'OLNN+ZO3=ONIT+ZO2+HO2';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'OLNN'; Gstr{i,2} = 'ZO3'; 
fOLNN(i)=fOLNN(i)-1; fZO3(i)=fZO3(i)-1; fONIT(i)=fONIT(i)+1; fZO2(i)=fZO2(i)+1; fHO2(i)=fHO2(i)+1; 

%d15N Tracer
i=i+1; %R354b
Rnames{i} = 'OLZN+ZO3=OZIT+ZO2+HO2';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'OLZN'; Gstr{i,2} = 'ZO3'; 
fOLZN(i)=fOLZN(i)-1; fZO3(i)=fZO3(i)-1; fOZIT(i)=fOZIT(i)+1; fZO2(i)=fZO2(i)+1; fHO2(i)=fHO2(i)+1; 

%d15N Tracer
i=i+1; %R354c
Rnames{i} = 'OLZN+NO3=OZIT+NO2+HO2';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'OLZN'; Gstr{i,2} = 'NO3'; 
fOLZN(i)=fOLZN(i)-1; fNO3(i)=fNO3(i)-1; fOZIT(i)=fOZIT(i)+1; fNO2(i)=fNO2(i)+1; fHO2(i)=fHO2(i)+1; 
...
%d15N Tracer
i=i+1; %R359a
Rnames{i} = 'OLZN+OLNN=OZIT+ONIT+HO2';
k(:,i) = 7.00E-14.*exp(1000./T);
Gstr{i,1} = 'OLZN'; Gstr{i,2} = 'OLNN'; 
fOLZN(i)=fOLZN(i)-1; fOLNN(i)=fOLNN(i)-1; fOZIT(i)=fOZIT(i)+1; fONIT(i)=fONIT(i)+1; fHO2(i)=fHO2(i)+1; 


%d15N Tracer
i=i+1; %R359b
Rnames{i} = 'OLZN+OLZN=OZIT+OZIT+HO2';
k(:,i) = 7.00E-14.*exp(1000./T);
Gstr{i,1} = 'OLZN'; Gstr{i,2} = 'OLZN'; 
fOLZN(i)=fOLZN(i)-1; fOLZN(i)=fOLZN(i)-1; fOZIT(i)=fOZIT(i)+1; fOZIT(i)=fOZIT(i)+1; fHO2(i)=fHO2(i)+1;
...
%d15N Tracer
i=i+1; %R360a
Rnames{i} = 'OLZN+OLND=0.50 HO2+0.50 NO2+0.202 HCHO+0.640 ALD+0.149 KET+1 OZIT + 0.5 ONIT ';
k(:,i) = 4.25E-14.*exp(1000./T);
Gstr{i,1} = 'OLZN'; Gstr{i,2} = 'OLND'; 
fOLZN(i)=fOLZN(i)-1; fOLND(i)=fOLND(i)-1; fHO2(i)=fHO2(i)+0.5; fNO2(i)=fNO2(i)+0.5;
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fOZIT(i)=fOZIT(i)+1; fONIT(i)=fONIT(i)+0.5; 


%d15N Tracer
i=i+1; %R360b
Rnames{i} = 'OLZN+OLZD=0.50 HO2+0.50 ZO2+0.202 HCHO+0.640 ALD+0.149 KET+1.5 OZIT ';
k(:,i) = 4.25E-14.*exp(1000./T);
...
%d15N Tracer
i=i+1; %R360c
Rnames{i} = 'OLNN+OLZD=0.50 HO2+0.50 ZO2+0.202 HCHO+0.640 ALD+0.149 KET+ 1 ONIT + 0.5 OZIT ';
k(:,i) = 4.25E-14.*exp(1000./T);
Gstr{i,1} = 'OLNN'; Gstr{i,2} = 'OLZD'; 
fOLNN(i)=fOLNN(i)-1; fOLZD(i)=fOLZD(i)-1; fHO2(i)=fHO2(i)+0.5; fZO2(i)=fZO2(i)+0.5;
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fOZIT(i)=fOZIT(i)+0.5; fONIT(i)=fONIT(i)+1; 
...
%d15N Tracer
i=i+1; %R361a
Rnames{i} = 'OLZD+OLND=0.5NO2 + 0.5ZO2+0.504 HCHO+1.21 ALD+0.285 KET+0.5ONIT +0.5OZIT ';
k(:,i) = 2.96E-14.*exp(1000./T);
Gstr{i,1} = 'OLZD'; Gstr{i,2} = 'OLND'; 
fOLZD(i)=fOLZD(i)-1; fOLND(i)=fOLND(i)-1; fNO2(i)=fNO2(i)+0.5; fZO2(i)=fZO2(i)+0.5; fHCHO(i)=fHCHO(i)+0.504; fALD(i)=fALD(i)+1.21; fKET(i)=fKET(i)+0.285; fONIT(i)=fONIT(i)+0.5; fOZIT(i)=fOZIT(i)+0.5;

%d15N Tracer
i=i+1; %R361b
Rnames{i} = 'OLZD+OLZD=ZO2+0.504 HCHO+1.21 ALD+0.285 KET + OZIT ';
k(:,i) = 2.96E-14.*exp(1000./T);
Gstr{i,1} = 'OLZD'; Gstr{i,2} = 'OLZD'; 
fOLZD(i)=fOLZD(i)-1; fOLZD(i)=fOLZD(i)-1; fZO2(i)=fZO2(i)+1; fHCHO(i)=fHCHO(i)+0.504; fALD(i)=fALD(i)+1.21; fKET(i)=fKET(i)+0.285; fOZIT(i)=fOZIT(i)+1;
