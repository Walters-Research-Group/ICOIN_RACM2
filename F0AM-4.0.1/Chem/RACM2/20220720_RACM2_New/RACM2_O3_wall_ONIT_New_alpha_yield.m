...
i=i+1; %R146
Rnames{i} = 'API+NO3=0.0175 OLNNT+ 0.0325OLNNS+0.3325OLNDT+0.6175OLNDS';
k(:,i) = 1.19E-12.*exp(490./T);
Gstr{i,1} = 'API'; Gstr{i,2} = 'NO3'; 
fAPI(i)=fAPI(i)-1; fNO3(i)=fNO3(i)-1; fOLNNT(i)=fOLNNT(i)+0.0175; fOLNNS(i)=fOLNNS(i)+0.0325; fOLNDT(i)=fOLNDT(i)+0.3325; fOLNDS(i)=fOLNDS(i)+0.6175; 

%O3 Tracer
i=i+1; %R146a
Rnames{i} = 'API+NO2Q=0.0175 OLNNTQ+ 0.0325OLNNSQ+0.3325OLNDTQ+0.6175OLNDSQ';
k(:,i) = 1.19E-12.*exp(490./T);
Gstr{i,1} = 'API'; Gstr{i,2} = 'NO2Q'; 
fAPI(i)=fAPI(i)-1; fNO2Q(i)=fNO2Q(i)-1; fOLNNTQ(i)=fOLNNTQ(i)+0.0175; fOLNNSQ(i)=fOLNNSQ(i)+0.0325; fOLNDTQ(i)=fOLNDTQ(i)+0.3325; fOLNDSQ(i)=fOLNDSQ(i)+0.6175;

%O3 Tracer
i=i+1; %R146b
Rnames{i} = 'API+NOQ2=0.0175 OLNNTQ2+ 0.0325OLNNSQ2+0.3325OLNDTQ2+0.6175OLNDSQ2';
k(:,i) = 1.19E-12.*exp(490./T);
Gstr{i,1} = 'API'; Gstr{i,2} = 'NOQ2'; 
fAPI(i)=fAPI(i)-1; fNOQ2(i)=fNOQ2(i)-1; fOLNNTQ2(i)=fOLNNTQ2(i)+0.0175; fOLNNSQ2(i)=fOLNNSQ2(i)+0.0325; fOLNDTQ2(i)=fOLNDTQ2(i)+0.3325; fOLNDSQ2(i)=fOLNDSQ2(i)+0.6175;

%O3 Tracer
i=i+1; %R146c
Rnames{i} = 'API+NQ3=0.0175 OLNNTQ3+ 0.0325OLNNSQ3+0.3325OLNDTQ3+0.6175OLNDSQ3';
k(:,i) = 1.19E-12.*exp(490./T);
Gstr{i,1} = 'API'; Gstr{i,2} = 'NQ3'; 
fAPI(i)=fAPI(i)-1; fNQ3(i)=fNQ3(i)-1; fOLNNTQ3(i)=fOLNNTQ3(i)+0.0175; fOLNNSQ3(i)=fOLNNSQ3(i)+0.0325; fOLNDTQ3(i)=fOLNDTQ3(i)+0.3325; fOLNDSQ3(i)=fOLNDSQ3(i)+0.6175;
...
fAPIP(i)=fAPIP(i)-1; fNO(i)=fNO(i)-1; fHO2(i)=fHO2(i)+0.91; fNO2(i)=fNO2(i)+0.91; 
fHCHO(i)=fHCHO(i)+0.23; fALD(i)=fALD(i)+0.43; fACT(i)=fACT(i)+0.11; fKET(i)=fKET(i)+0.44; 
fORA1(i)=fORA1(i)+0.07; fONITT(i)=fONITT(i)+(18/300); fONITS(i)=fONITS(i)+(9/300);
...
fAPIP(i)=fAPIP(i)-1; fNQ(i)=fNQ(i)-1; fHO2(i)=fHO2(i)+0.91; fNOQ(i)=fNOQ(i)+0.91; 
fHCHO(i)=fHCHO(i)+0.23; fALD(i)=fALD(i)+0.43; fACT(i)=fACT(i)+0.11; fKET(i)=fKET(i)+0.44; 
fORA1(i)=fORA1(i)+0.07; fONITTQ(i)=fONITTQ(i)+(18/300); fONITSQ(i)=fONITSQ(i)+(9/300); 
