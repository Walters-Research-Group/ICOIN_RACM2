...
SpeciesToAdd = {...
'ACD'; 'ACO3'; 'ACT'; 'ACTP'; 'ALD'; 'API'; 'APIO2a'; 'APIO2b'; 'APINO2a'; 'APINO2b'; 'CO'; 'CO2'; 'DCB1'; 'EOH'; 'ETHP'; ...
'GLY'; 'H2'; 'H2O2'; 'HC3P'; 'HCHO'; 'HNO3'; 'HO2'; 'HO2NO2'; 'HONO'; 'KET'; 'KETP'; 'MEK'; ...
'MEKP'; 'MGLY'; 'MO2'; 'MOH'; 'N2O5'; 'NO'; 'NO2'; 'NO3'; 'O1D'; 'O3'; 'O3P'; 'OH'; ...
'ONITa'; 'ONITb'; 'OP1'; 'OP2'; 'ORA1'; 'ORA2'; 'ORAP'; 'PAA'; 'PAN'; 'PPN'; 'RCO3'; 'ROH'; 'XO2'; ...
'A'; ...
};
...
i=i+1; %<RACM2_Update_031a>; <BAPI_025>
...
i=i+1; %<RACM2_Update_031b>; <BAPI_025>
...
i=i+1; %<RACM2_Update_123a>; <BAPI_084>
...
i=i+1; %<RACM2_Update_123b>; <BAPI_084>
...
%% Alkenes+O3
i=i+1; %<RACM2_Update_131; <BAPI_085>
...
i=i+1; %<RACM2_Update_174>; <BAPI_099>
...
Rnames{i} = 'APIO2a+NO= HO2+NO2+HCHO+ALD+ACT+KET+ORA1+ONIT';
k(:,i) = 4.00E-12;
...
i=i+1; %<RACM2_Update_243>; <BAPI_119>
...
i=i+1; %<RACM2_Update_301>; <BAPI_138>
...
i=i+1; %<RACM2_Update_318>; <BAPI_146>
