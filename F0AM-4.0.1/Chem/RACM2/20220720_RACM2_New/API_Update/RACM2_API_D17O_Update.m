...
'OP1'; 'OP2'; 'ORA1'; 'ORA2'; 'ORAP'; 'PAA'; 'PAN'; 'PPN'; 'RCO3'; 'ROH'; 'XO2'; ...
...
'PPNQ'; 'PPNQ2'; 'A'; 'APIO2a'; 'APIO2b'; 'ONITa'; 'ONITQa'; 'ONITQ2a'; 'ONITQ3a'; ...
'ONITb'; 'ONITQb'; 'ONITQ2b'; 'ONITQ3b'; 'APINO2a'; 'APINO2Qa'; 'APINO2Q2a'; 'APINO2Q3a'; ...
...
Rnames{i} = 'ONITQa=(2/3)HO2+0.2ALD+(2/3)NOQ+0.8KET+(1/3)NO2+(1/3)HOQ';
k(:,i) = JONIT;
Gstr{i,1} = 'ONITQa'; 
fONITQa(i)=fONITQa(i)-1; fHO2(i)=fHO2(i)+(2/3); fALD(i)=fALD(i)+0.2; fNOQ(i)=fNOQ(i)+(2/3); fKET(i)=fKET(i)+0.8; fNO2(i)=fNO2(i)+(1/3); fHOQ(i)=fHOQ(i)+(1/3);

%O3 Tracer
i=i+1; %<RACM2_031>; <BAPI_025b>
Rnames{i} = 'ONITQ2a=(2/3)HOQ+0.2ALD+(2/3)NOQ+0.8KET+(1/3)NQ2+(1/3)HO2';
k(:,i) = JONIT;
Gstr{i,1} = 'ONITQ2a'; 
fONITQ2a(i)=fONITQ2a(i)-1; fHO2(i)=fHO2(i)+(1/3); fALD(i)=fALD(i)+0.2; fNQ2(i)=fNQ2(i)+(1/3); fKET(i)=fKET(i)+0.8; fNOQ(i)=fNOQ(i)+(2/3); fHO2(i)=fHO2(i)+(1/3);

%O3 Tracer
i=i+1; %<RACM2_031>; <BAPI_025c>
Rnames{i} = 'ONITQ3a=HOQ+0.2ALD+NQ2+0.8KET';
k(:,i) = JONIT;
Gstr{i,1} = 'ONITQ3a'; 
fONITQ3a(i)=fONITQ3a(i)-1; fHOQ(i)=fHOQ(i)+1; fALD(i)=fALD(i)+0.2; fNQ2(i)=fNQ2(i)+1; fKET(i)=fKET(i)+0.8;


i=i+1; %<RACM2_Update_031>; <BAPI_025d>
...
Rnames{i} = 'ONITQb=(2/3)HO2+0.2ALD+(2/3)NOQ+0.8KET+(1/3)NO2+(1/3)HOQ';
k(:,i) = JONIT;
Gstr{i,1} = 'ONITQb'; 
fONITQb(i)=fONITQb(i)-1; fHO2(i)=fHO2(i)+(2/3); fALD(i)=fALD(i)+0.2; fNOQ(i)=fNOQ(i)+(2/3); fKET(i)=fKET(i)+0.8; fNO2(i)=fNO2(i)+(1/3); fHOQ(i)=fHOQ(i)+(1/3);

%O3 Tracer
i=i+1; %<RACM2_031>; <BAPI_025f>
Rnames{i} = 'ONITQ2b=(2/3)HOQ+0.2ALD+(2/3)NOQ+0.8KET+(1/3)NQ2+(1/3)HO2';
k(:,i) = JONIT;
Gstr{i,1} = 'ONITQ2b'; 
fONITQ2b(i)=fONITQ2b(i)-1; fHO2(i)=fHO2(i)+(1/3); fALD(i)=fALD(i)+0.2; fNQ2(i)=fNQ2(i)+(1/3); fKET(i)=fKET(i)+0.8; fNOQ(i)=fNOQ(i)+(2/3); fHO2(i)=fHO2(i)+(1/3);

%O3 Tracer
i=i+1; %<RACM2_031>; <BAPI_025g>
Rnames{i} = 'ONITQ3b=HOQ+0.2ALD+NQ2+0.8KET';
k(:,i) = JONIT;
Gstr{i,1} = 'ONITQ3b'; 
fONITQ3b(i)=fONITQ3b(i)-1; fHOQ(i)=fHOQ(i)+1; fALD(i)=fALD(i)+0.2; fNQ2(i)=fNQ2(i)+1; fKET(i)=fKET(i)+0.8;
...
Rnames{i} = 'ONITa+QH=HC3P+NO2+H2Q';
k(:,i) = 5.31E-12.*exp(-260./T);
Gstr{i,1} = 'ONITa'; Gstr{i,2} = 'QH'; 
fONITa(i)=fONITa(i)-1; fQH(i)=fQH(i)-1; fHC3P(i)=fHC3P(i)+1; fNO2(i)=fNO2(i)+1; 

%O3 Tracer
i=i+1; %<RACM2_123b>; <BAPI_084b>
Rnames{i} = 'ONITQa+OH=HC3P+NO2+NOQ+H2O';
k(:,i) = 5.31E-12.*exp(-260./T);
Gstr{i,1} = 'ONITQa'; Gstr{i,2} = 'OH'; 
fONITQa(i)=fONITQa(i)-1; fOH(i)=fOH(i)-1; fHC3P(i)=fHC3P(i)+1; fNO2(i)=fNO2(i)+(2/3); fNOQ(i)=fNOQ(i)+(1/3);

%O3 Tracer
i=i+1; %<RACM2_123c>; <BAPI_084c>
Rnames{i} = 'ONITQa+QH=HC3P+NOQ+NO2+H2Q';
k(:,i) = 5.31E-12.*exp(-260./T);
Gstr{i,1} = 'ONITQa'; Gstr{i,2} = 'QH'; 
fONITQa(i)=fONITQa(i)-1; fQH(i)=fQH(i)-1; fHC3P(i)=fHC3P(i)+1; fNOQ(i)=fNOQ(i)+(1/3); fNO2(i)=fNO2(i)+(2/3);

%O3 Tracer
i=i+1; %<RACM2_123d>; <BAPI_084d>
Rnames{i} = 'ONITQ2a+OH=HC3P+NOQ+NQ2+H2O';
k(:,i) = 5.31E-12.*exp(-260./T);
Gstr{i,1} = 'ONITQ2a'; Gstr{i,2} = 'OH'; 
fONITQ2a(i)=fONITQ2a(i)-1; fOH(i)=fOH(i)-1; fHC3P(i)=fHC3P(i)+1; fNQ2(i)=fNQ2(i)+(1/3); fNOQ(i)=fNOQ(i)+(2/3);

%O3 Tracer
i=i+1; %<RACM2_123e>; <BAPI_084e>
Rnames{i} = 'ONITQ2a+QH=HC3P+NOQ+NQ2+H2Q';
k(:,i) = 5.31E-12.*exp(-260./T);
Gstr{i,1} = 'ONITQ2a'; Gstr{i,2} = 'QH'; 
fONITQ2a(i)=fONITQ2a(i)-1; fQH(i)=fQH(i)-1; fHC3P(i)=fHC3P(i)+1; fNQ2(i)=fNQ2(i)+(1/3); fNOQ(i)=fNOQ(i)+(2/3);

%O3 Tracer
i=i+1; %<RACM2_123f>; <BAPI_084d>
Rnames{i} = 'ONITQ3a+OH=HC3P+NQ2+H2O';
k(:,i) = 5.31E-12.*exp(-260./T);
Gstr{i,1} = 'ONITQ3a'; Gstr{i,2} = 'OH'; 
fONITQ3a(i)=fONITQ3a(i)-1; fOH(i)=fOH(i)-1; fHC3P(i)=fHC3P(i)+1; fNQ2(i)=fNQ2(i)+1;

%O3 Tracer
i=i+1; %<RACM2_123g>; <BAPI_084e>
Rnames{i} = 'ONITQ3a+QH=HC3P+NQ2+H2Q';
k(:,i) = 5.31E-12.*exp(-260./T);
Gstr{i,1} = 'ONITQ3a'; Gstr{i,2} = 'QH'; 
fONITQ3a(i)=fONITQ3a(i)-1; fQH(i)=fQH(i)-1; fHC3P(i)=fHC3P(i)+1; fNQ2(i)=fNQ2(i)+1;





i=i+1; %<RACM2_Update_123>; <BAPI_084f>
...
%O3 Tracer
i=i+1; %<RACM2_123a>; <BAPI_084g>
Rnames{i} = 'ONITb+QH=HC3P+NO2+H2Q';
k(:,i) = 5.31E-12.*exp(-260./T);
Gstr{i,1} = 'ONITb'; Gstr{i,2} = 'QH'; 
fONITb(i)=fONITb(i)-1; fQH(i)=fQH(i)-1; fHC3P(i)=fHC3P(i)+1; fNO2(i)=fNO2(i)+1; 

%O3 Tracer
i=i+1; %<RACM2_123b>; <BAPI_084h>
Rnames{i} = 'ONITQb+OH=HC3P+NO2+NOQ+H2O';
k(:,i) = 5.31E-12.*exp(-260./T);
Gstr{i,1} = 'ONITQb'; Gstr{i,2} = 'OH'; 
fONITQb(i)=fONITQb(i)-1; fOH(i)=fOH(i)-1; fHC3P(i)=fHC3P(i)+1; fNO2(i)=fNO2(i)+(2/3); fNOQ(i)=fNOQ(i)+(1/3);

%O3 Tracer
i=i+1; %<RACM2_123c>; <BAPI_084i>
Rnames{i} = 'ONITQb+QH=HC3P+NOQ+NO2+H2Q';
k(:,i) = 5.31E-12.*exp(-260./T);
Gstr{i,1} = 'ONITQb'; Gstr{i,2} = 'QH'; 
fONITQb(i)=fONITQb(i)-1; fQH(i)=fQH(i)-1; fHC3P(i)=fHC3P(i)+1; fNOQ(i)=fNOQ(i)+(1/3); fNO2(i)=fNO2(i)+(2/3);

%O3 Tracer
i=i+1; %<RACM2_123d>; <BAPI_084j>
Rnames{i} = 'ONITQ2b+OH=HC3P+NOQ+NQ2+H2O';
k(:,i) = 5.31E-12.*exp(-260./T);
Gstr{i,1} = 'ONITQ2b'; Gstr{i,2} = 'OH'; 
fONITQ2b(i)=fONITQ2b(i)-1; fOH(i)=fOH(i)-1; fHC3P(i)=fHC3P(i)+1; fNQ2(i)=fNQ2(i)+(1/3); fNOQ(i)=fNOQ(i)+(2/3);

%O3 Tracer
i=i+1; %<RACM2_123e>; <BAPI_084k>
Rnames{i} = 'ONITQ2b+QH=HC3P+NOQ+NQ2+H2Q';
k(:,i) = 5.31E-12.*exp(-260./T);
Gstr{i,1} = 'ONITQ2b'; Gstr{i,2} = 'QH'; 
fONITQ2b(i)=fONITQ2b(i)-1; fQH(i)=fQH(i)-1; fHC3P(i)=fHC3P(i)+1; fNQ2(i)=fNQ2(i)+(1/3); fNOQ(i)=fNOQ(i)+(2/3);

%O3 Tracer
i=i+1; %<RACM2_123f>; <BAPI_084l>
Rnames{i} = 'ONITQ3b+OH=HC3P+NQ2+H2O';
k(:,i) = 5.31E-12.*exp(-260./T);
Gstr{i,1} = 'ONITQ3b'; Gstr{i,2} = 'OH'; 
fONITQ3b(i)=fONITQ3b(i)-1; fOH(i)=fOH(i)-1; fHC3P(i)=fHC3P(i)+1; fNQ2(i)=fNQ2(i)+1;

%O3 Tracer
i=i+1; %<RACM2_123g>; <BAPI_084m>
Rnames{i} = 'ONITQ3b+QH=HC3P+NQ2+H2Q';
k(:,i) = 5.31E-12.*exp(-260./T);
Gstr{i,1} = 'ONITQ3b'; Gstr{i,2} = 'QH'; 
fONITQ3b(i)=fONITQ3b(i)-1; fQH(i)=fQH(i)-1; fHC3P(i)=fHC3P(i)+1; fNQ2(i)=fNQ2(i)+1;
...
Rnames{i} = 'API+NO3=0.65 APINO2a+0.35 APINO2b';
k(:,i) = 1.19E-12.*exp(490./T);
Gstr{i,1} = 'API'; Gstr{i,2} = 'NO3'; 
fAPI(i)=fAPI(i)-1; fNO3(i)=fNO3(i)-1; fAPINO2a(i)=fAPINO2a(i)+0.65;  fAPINO2b(i)=fAPINO2b(i)+0.35; 

%O3 Tracer
i=i+1; %<RACM2_Update_146a>; <BAPI_087a>
Rnames{i} = 'API+NO2Q=0.65 APINO2Qa+0.35 APINO2Qb';
k(:,i) = 1.19E-12.*exp(490./T);
Gstr{i,1} = 'API'; Gstr{i,2} = 'NO2Q'; 
fAPI(i)=fAPI(i)-1; fNO2Q(i)=fNO2Q(i)-1; fAPINO2Qa(i)=fAPINO2Qa(i)+0.65;  fAPINO2Qb(i)=fAPINO2Qb(i)+0.35; 

%O3 Tracer
i=i+1; %<RACM2_Update_146b>; <BAPI_087b>
Rnames{i} = 'API+NOQ2=0.65 APINO2Q2a+0.35 APINO2Q2b';
k(:,i) = 1.19E-12.*exp(490./T);
Gstr{i,1} = 'API'; Gstr{i,2} = 'NOQ2'; 
fAPI(i)=fAPI(i)-1; fNOQ2(i)=fNOQ2(i)-1; fAPINO2Q2a(i)=fAPINO2Q2a(i)+0.65;  fAPINO2Q2b(i)=fAPINO2Q2b(i)+0.35; 

%O3 Tracer
i=i+1; %<RACM2_Update_146c>; <BAPI_087c>
Rnames{i} = 'API+NQ3=0.65 APINO2Q3a+0.35 APINO2Q3b';
k(:,i) = 1.19E-12.*exp(490./T);
Gstr{i,1} = 'API'; Gstr{i,2} = 'NQ3'; 
fAPI(i)=fAPI(i)-1; fNQ3(i)=fNQ3(i)-1; fAPINO2Q3a(i)=fAPINO2Q3a(i)+0.65;  fAPINO2Q3b(i)=fAPINO2Q3b(i)+0.35; 
...
%O3 Tracer
i=i+1; %<RACM2_174>; <BAPI_099>
Rnames{i} = 'HC3P+NQ=HO2+MO2+ETHP+XO2+NOQ+ACD+ALD+ACT+MEK+ONITQb';
k(:,i) = 4.00E-12;
...
fALD(i)=fALD(i)+0.132; fACT(i)=fACT(i)+0.165; fMEK(i)=fMEK(i)+0.042; fONITQb(i)=fONITQb(i)+0.065; %mmarvin 20151020


i=i+1; %<RACM2_Update_189>; <BAPI_100>
...
%O3 Tracer
i=i+1; %<RACM2_Update_189>; <BAPI_100a>
Rnames{i} = 'APIO2a+NQ= HO2+NOQ+HCHO+ALD+ACT+KET+ORA1+ONITQa';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'APIO2a'; Gstr{i,2} = 'NQ'; 
fAPIO2a(i)=fAPIO2a(i)-1; fNQ(i)=fNQ(i)-1; fHO2(i)=fHO2(i)+0.82; fNOQ(i)=fNOQ(i)+0.82; 
fHCHO(i)=fHCHO(i)+0.23; fALD(i)=fALD(i)+0.43; fACT(i)=fACT(i)+0.11; fKET(i)=fKET(i)+0.44; 
fORA1(i)=fORA1(i)+0.07; fONITQa(i)=fONITQa(i)+0.18; 

 
i=i+1; %<RACM2_Update_189>; <BAPI_100b>
Rnames{i} = 'APIO2b+NO= HO2+NO2+HCHO+ALD+ACT+KET+ORA1+ONIT';
k(:,i) =4.00E-12;
...
%O3 Tracer
i=i+1; %<RACM2_Update_189>; <BAPI_100c>
Rnames{i} = 'APIO2b+NQ= HO2+NOQ+HCHO+ALD+ACT+KET+ORA1+ONITQb';
k(:,i) =4.00E-12;
Gstr{i,1} = 'APIO2b'; Gstr{i,2} = 'NO'; 
fAPIO2b(i)=fAPIO2b(i)-1; fNQ(i)=fNQ(i)-1; fHO2(i)=fHO2(i)+0.82; fNOQ(i)=fNOQ(i)+0.82; 
fHCHO(i)=fHCHO(i)+0.23; fALD(i)=fALD(i)+0.43; fACT(i)=fACT(i)+0.11; fKET(i)=fKET(i)+0.44; 
fORA1(i)=fORA1(i)+0.07; fONITQb(i)=fONITQb(i)+0.18; 
...
Rnames{i} = 'APINO2a+NO=0.6 ONITa + 0.7 ALD + 1.4 NO2';
k(:,i) = 2.55E-12*exp(380/T);
Gstr{i,1} = 'APINO2a'; Gstr{i,2} = 'NO'; 
fAPINO2a(i)=fAPINO2a(i)-1; fNO(i)=fNO(i)-1;  fONITa(i)=fONITa(i)+0.6; fNO2(i)=fNO2(i)+1.4; fALD(i)=fALD(i)+0.7;  

%O3 Tracer
i=i+1;  %<RACM2_Update_205a>; <BAPI_108>
Rnames{i} = 'APINO2a+NQ=0.6 ONITa + 0.7 ALD + 1.4 NOQ';
k(:,i) = 2.55E-12*exp(380/T);
Gstr{i,1} = 'APINO2a'; Gstr{i,2} = 'NQ'; 
fAPINO2a(i)=fAPINO2a(i)-1; fNQ(i)=fNQ(i)-1;  fONITa(i)=fONITa(i)+0.6; fNOQ(i)=fNOQ(i)+1.4; fALD(i)=fALD(i)+0.7; 

%O3 Tracer
i=i+1;  %<RACM2_Update_205b>; <BAPI_108>
Rnames{i} = 'APINO2Qa+NO=0.6 ONITQa + 0.7 ALD + NOQ + NO2 ';
k(:,i) = 2.55E-12*exp(380/T);
Gstr{i,1} = 'APINO2Qa'; Gstr{i,2} = 'NO'; 
fAPINO2Qa(i)=fAPINO2Qa(i)-1; fNO(i)=fNO(i)-1;  fONITQa(i)=fONITQa(i)+0.6; fNOQ(i)=fNOQ(i)+(1.4/3); fNO2(i)=fNO2(i)+(2.8/3); fALD(i)=fALD(i)+0.7; 

%O3 Tracer
i=i+1;  %<RACM2_Update_205c>; <BAPI_108>
Rnames{i} = 'APINO2Qa+NQ=0.6 ONITQa + 0.7 ALD + NOQ + NQ2 ';
k(:,i) = 2.55E-12*exp(380/T);
Gstr{i,1} = 'APINO2Qa'; Gstr{i,2} = 'NQ'; 
fAPINO2Qa(i)=fAPINO2Qa(i)-1; fNQ(i)=fNQ(i)-1;  fONITQa(i)=fONITQa(i)+0.6; fNOQ(i)=fNOQ(i)+(2.8/3); fNQ2(i)=fNQ2(i)+(1.4/3); fALD(i)=fALD(i)+0.7; 

%O3 Tracer
i=i+1;  %<RACM2_Update_205d>; <BAPI_108>
Rnames{i} = 'APINO2Q2a+NO=0.6 ONITQ2a + 0.7 ALD + NOQ + NO2 ';
k(:,i) = 2.55E-12*exp(380/T);
Gstr{i,1} = 'APINO2Q2a'; Gstr{i,2} = 'NO'; 
fAPINO2Q2a(i)=fAPINO2Q2a(i)-1; fNO(i)=fNO(i)-1;  fONITQ2a(i)=fONITQ2a(i)+0.6; fNOQ(i)=fNOQ(i)+(2.8/3); fNO2(i)=fNO2(i)+(1.4/3); fALD(i)=fALD(i)+0.7; 


%O3 Tracer
i=i+1;  %<RACM2_Update_205e>; <BAPI_108>
Rnames{i} = 'APINO2Q2a+NQ=0.6 ONITQ2a + 0.7 ALD + NOQ + NQ2 ';
k(:,i) = 2.55E-12*exp(380/T);
Gstr{i,1} = 'APINO2Q2a'; Gstr{i,2} = 'NQ'; 
fAPINO2Q2a(i)=fAPINO2Q2a(i)-1; fNQ(i)=fNQ(i)-1;  fONITQ2a(i)=fONITQ2a(i)+0.6; fNQ2(i)=fNQ2(i)+(2.8/3); fNOQ(i)=fNOQ(i)+(1.4/3); fALD(i)=fALD(i)+0.7; 

%O3 Tracer
i=i+1;  %<RACM2_Update_205f>; <BAPI_108>
Rnames{i} = 'APINO2Q3a+NO=0.6 ONITQ3a + 0.7 ALD + NOQ ';
k(:,i) = 2.55E-12*exp(380/T);
Gstr{i,1} = 'APINO2Q3a'; Gstr{i,2} = 'NO'; 
fAPINO2Q3a(i)=fAPINO2Q3a(i)-1; fNO(i)=fNO(i)-1;  fONITQ3a(i)=fONITQ3a(i)+0.6; fNOQ(i)=fNOQ(i)+1.4;  fALD(i)=fALD(i)+0.7; 


%O3 Tracer
i=i+1;  %<RACM2_Update_205g>; <BAPI_108>
Rnames{i} = 'APINO2Q3a+NQ=0.6 ONITQ3a + 0.7 ALD + NQ2 ';
k(:,i) = 2.55E-12*exp(380/T);
Gstr{i,1} = 'APINO2Q3a'; Gstr{i,2} = 'NQ'; 
fAPINO2Q3a(i)=fAPINO2Q3a(i)-1; fNQ(i)=fNQ(i)-1;  fONITQ3a(i)=fONITQ3a(i)+0.6; fNQ2(i)=fNQ2(i)+1.4;  fALD(i)=fALD(i)+0.7; 


i=i+1;  %<RACM2_Update_206>; <BAPI_108>
Rnames{i} = 'APINO2b+NO=0.6 ONITb + 0.7 ALD + 1.4 NO2';
k(:,i) = 2.55E-12*exp(380/T);
Gstr{i,1} = 'APINO2b'; Gstr{i,2} = 'NO'; 
fAPINO2b(i)=fAPINO2b(i)-1; fNO(i)=fNO(i)-1;  fONITb(i)=fONITb(i)+0.6; fNO2(i)=fNO2(i)+1.4; fALD(i)=fALD(i)+0.7; 

%O3 Tracer
i=i+1;  %<RACM2_Update_206a>; <BAPI_108>
Rnames{i} = 'APINO2b+NQ=0.6 ONITb + 0.7 ALD + 1.4 NOQ';
k(:,i) = 2.55E-12*exp(380/T);
Gstr{i,1} = 'APINO2b'; Gstr{i,2} = 'NQ'; 
fAPINO2b(i)=fAPINO2b(i)-1; fNQ(i)=fNQ(i)-1;  fONITb(i)=fONITb(i)+0.6; fNOQ(i)=fNOQ(i)+1.4; fALD(i)=fALD(i)+0.7; 

%O3 Tracer
i=i+1;  %<RACM2_Update_206b>; <BAPI_108>
Rnames{i} = 'APINO2Qb+NO=0.6 ONITQb + 0.7 ALD + NOQ + NO2 ';
k(:,i) = 2.55E-12*exp(380/T);
Gstr{i,1} = 'APINO2Qb'; Gstr{i,2} = 'NO'; 
fAPINO2Qb(i)=fAPINO2Qb(i)-1; fNO(i)=fNO(i)-1;  fONITQb(i)=fONITQb(i)+0.6; fNOQ(i)=fNOQ(i)+(1.4/3); fNO2(i)=fNO2(i)+(2.8/3); fALD(i)=fALD(i)+0.7; 

%O3 Tracer
i=i+1;  %<RACM2_Update_206c>; <BAPI_108>
Rnames{i} = 'APINO2Qb+NQ=0.6 ONITQb + 0.7 ALD + NOQ + NQ2 ';
k(:,i) = 2.55E-12*exp(380/T);
Gstr{i,1} = 'APINO2Qb'; Gstr{i,2} = 'NQ'; 
fAPINO2Qb(i)=fAPINO2Qb(i)-1; fNQ(i)=fNQ(i)-1;  fONITQb(i)=fONITQb(i)+0.6; fNOQ(i)=fNOQ(i)+(2.8/3); fNQ2(i)=fNQ2(i)+(1.4/3); fALD(i)=fALD(i)+0.7; 

%O3 Tracer
i=i+1;  %<RACM2_Update_206d>; <BAPI_108>
Rnames{i} = 'APINO2Q2b+NO=0.6 ONITQ2b + 0.7 ALD + NOQ + NO2 ';
k(:,i) = 2.55E-12*exp(380/T);
Gstr{i,1} = 'APINO2Q2b'; Gstr{i,2} = 'NO'; 
fAPINO2Q2b(i)=fAPINO2Q2b(i)-1; fNO(i)=fNO(i)-1;  fONITQ2b(i)=fONITQ2b(i)+0.6; fNOQ(i)=fNOQ(i)+(2.8/3); fNO2(i)=fNO2(i)+(1.4/3); fALD(i)=fALD(i)+0.7; 


%O3 Tracer
i=i+1;  %<RACM2_Update_206e>; <BAPI_108>
Rnames{i} = 'APINO2Q2b+NQ=0.6 ONITQ2b + 0.7 ALD + NOQ + NQ2 ';
k(:,i) = 2.55E-12*exp(380/T);
Gstr{i,1} = 'APINO2Q2b'; Gstr{i,2} = 'NQ'; 
fAPINO2Q2b(i)=fAPINO2Q2b(i)-1; fNQ(i)=fNQ(i)-1;  fONITQ2b(i)=fONITQ2b(i)+0.6; fNQ2(i)=fNQ2(i)+(2.8/3); fNOQ(i)=fNOQ(i)+(1.4/3); fALD(i)=fALD(i)+0.7; 

%O3 Tracer
i=i+1;  %<RACM2_Update_206f>; <BAPI_108>
Rnames{i} = 'APINO2Q3b+NO=0.6 ONITQ3b + 0.7 ALD + NOQ ';
k(:,i) = 2.55E-12*exp(380/T);
Gstr{i,1} = 'APINO2Q3b'; Gstr{i,2} = 'NO'; 
fAPINO2Q3b(i)=fAPINO2Q3b(i)-1; fNO(i)=fNO(i)-1;  fONITQ3b(i)=fONITQ3b(i)+0.6; fNOQ(i)=fNOQ(i)+1.4;  fALD(i)=fALD(i)+0.7; 


%O3 Tracer
i=i+1;  %<RACM2_Update_206g>; <BAPI_108>
Rnames{i} = 'APINO2Q3b+NQ=0.6 ONITQ3b + 0.7 ALD + NQ2 ';
k(:,i) = 2.55E-12*exp(380/T);
Gstr{i,1} = 'APINO2Q3b'; Gstr{i,2} = 'NQ'; 
fAPINO2Q3b(i)=fAPINO2Q3b(i)-1; fNQ(i)=fNQ(i)-1;  fONITQ3b(i)=fONITQ3b(i)+0.6; fNQ2(i)=fNQ2(i)+1.4;  fALD(i)=fALD(i)+0.7; 
...
i=i+1; %<RACM2_Update_229b>; <BAPI_113c>
...
%O3 Tracer
i=i+1; %<RACM2_Update_229a>; <BAPI_113d>
...
%O3 Tracer
i=i+1; %<RACM2_Update_229b>; <BAPI_113e>
...
Rnames{i} = 'APINO2a+HO2=0.37 ONITa + 0.63 ALD + 0.63 HO2 + 0.63 OH';
k(:,i) = 2.66E-13*exp(1300./T);
Gstr{i,1} = 'APINO2a'; Gstr{i,2} = 'HO2'; 
fAPINO2a(i)=fAPINO2a(i)-1; fHO2(i)=fHO2(i)-1; fONITa(i)=fONITa(i)+0.37; fALD(i)=fALD(i)+0.63;
fHO2(i)=fHO2(i)+0.63; fOH(i)=fOH(i)+0.63;

%O3 Tracer
i=i+1; %<RACM2_Update_244a>; <BAPI_120>
Rnames{i} = 'APINO2a+HOQ=0.37 ONITa + 0.63 ALD + 0.63 HO2 + 0.63 OH';
k(:,i) = 2.66E-13*exp(1300./T);
Gstr{i,1} = 'APINO2a'; Gstr{i,2} = 'HOQ'; 
fAPINO2a(i)=fAPINO2a(i)-1; fHOQ(i)=fHOQ(i)-1; fONITa(i)=fONITa(i)+0.37; fALD(i)=fALD(i)+0.63;
fHO2(i)=fHO2(i)+0.63; fOH(i)=fOH(i)+0.63;

%O3 Tracer
i=i+1; %<RACM2_Update_244b>; <BAPI_120>
Rnames{i} = 'APINO2a+HQ2=0.37 ONITa + 0.63 ALD + 0.63 HO2 + 0.63 OH';
k(:,i) = 2.66E-13*exp(1300./T);
Gstr{i,1} = 'APINO2a'; Gstr{i,2} = 'HQ2'; 
fAPINO2a(i)=fAPINO2a(i)-1; fHQ2(i)=fHQ2(i)-1; fONITa(i)=fONITa(i)+0.37; fALD(i)=fALD(i)+0.63;
fHO2(i)=fHO2(i)+0.63; fOH(i)=fOH(i)+0.63;

%O3 Tracer
i=i+1; %<RACM2_Update_244c>; <BAPI_120>
Rnames{i} = 'APINO2Qa+HO2=0.37 ONITQa + 0.63 ALD + 0.63 HO2 + 0.63 OH';
k(:,i) = 2.66E-13*exp(1300./T);
Gstr{i,1} = 'APINO2Qa'; Gstr{i,2} = 'HO2'; 
fAPINO2Qa(i)=fAPINO2Qa(i)-1; fHO2(i)=fHO2(i)-1; fONITQa(i)=fONITQa(i)+0.37; fALD(i)=fALD(i)+0.63;
fHO2(i)=fHO2(i)+0.63; fOH(i)=fOH(i)+0.63;

%O3 Tracer
i=i+1; %<RACM2_Update_244c>; <BAPI_120>
Rnames{i} = 'APINO2Qa+HOQ=0.37 ONITQa + 0.63 ALD + 0.63 HO2 + 0.63 OH';
k(:,i) = 2.66E-13*exp(1300./T);
Gstr{i,1} = 'APINO2Qa'; Gstr{i,2} = 'HOQ'; 
fAPINO2Qa(i)=fAPINO2Qa(i)-1; fHOQ(i)=fHOQ(i)-1; fONITQa(i)=fONITQa(i)+0.37; fALD(i)=fALD(i)+0.63;
fHO2(i)=fHO2(i)+0.63; fOH(i)=fOH(i)+0.63;

%O3 Tracer
i=i+1; %<RACM2_Update_244d>; <BAPI_120>
Rnames{i} = 'APINO2Qa+HQ2=0.37 ONITQa + 0.63 ALD + 0.63 HO2 + 0.63 OH';
k(:,i) = 2.66E-13*exp(1300./T);
Gstr{i,1} = 'APINO2Qa'; Gstr{i,2} = 'HQ2'; 
fAPINO2Qa(i)=fAPINO2Qa(i)-1; fHQ2(i)=fHQ2(i)-1; fONITQa(i)=fONITQa(i)+0.37; fALD(i)=fALD(i)+0.63;
fHO2(i)=fHO2(i)+0.63; fOH(i)=fOH(i)+0.63;

%O3 Tracer
i=i+1; %<RACM2_Update_244e>; <BAPI_120>
Rnames{i} = 'APINO2Q2a+HO2=0.37 ONITQ2a + 0.63 ALD + 0.63 HO2 + 0.63 OH';
k(:,i) = 2.66E-13*exp(1300./T);
Gstr{i,1} = 'APINO2Q2a'; Gstr{i,2} = 'HO2'; 
fAPINO2Q2a(i)=fAPINO2Q2a(i)-1; fHO2(i)=fHO2(i)-1; fONITQ2a(i)=fONITQ2a(i)+0.37; fALD(i)=fALD(i)+0.63;
fHO2(i)=fHO2(i)+0.63; fOH(i)=fOH(i)+0.63;

%O3 Tracer
i=i+1; %<RACM2_Update_244f>; <BAPI_120>
Rnames{i} = 'APINO2Q2a+HOQ=0.37 ONITQ2a + 0.63 ALD + 0.63 HO2 + 0.63 OH';
k(:,i) = 2.66E-13*exp(1300./T);
Gstr{i,1} = 'APINO2Q2a'; Gstr{i,2} = 'HOQ'; 
fAPINO2Q2a(i)=fAPINO2Q2a(i)-1; fHOQ(i)=fHOQ(i)-1; fONITQ2a(i)=fONITQ2a(i)+0.37; fALD(i)=fALD(i)+0.63;
fHO2(i)=fHO2(i)+0.63; fOH(i)=fOH(i)+0.63;

%O3 Tracer
i=i+1; %<RACM2_Update_244g>; <BAPI_120>
Rnames{i} = 'APINO2Q2a+HQ2=0.37 ONITQ2a + 0.63 ALD + 0.63 HO2 + 0.63 OH';
k(:,i) = 2.66E-13*exp(1300./T);
Gstr{i,1} = 'APINO2Q2a'; Gstr{i,2} = 'HQ2'; 
fAPINO2Q2a(i)=fAPINO2Q2a(i)-1; fHQ2(i)=fHQ2(i)-1; fONITQ2a(i)=fONITQ2a(i)+0.37; fALD(i)=fALD(i)+0.63;
fHO2(i)=fHO2(i)+0.63; fOH(i)=fOH(i)+0.63;

%O3 Tracer
i=i+1; %<RACM2_Update_244h>; <BAPI_120>
Rnames{i} = 'APINO2Q3a+HO2=0.37 ONITQ3a + 0.63 ALD + 0.63 HO2 + 0.63 OH';
k(:,i) = 2.66E-13*exp(1300./T);
Gstr{i,1} = 'APINO2Q3a'; Gstr{i,2} = 'HO2'; 
fAPINO2Q3a(i)=fAPINO2Q3a(i)-1; fHO2(i)=fHO2(i)-1; fONITQ3a(i)=fONITQ3a(i)+0.37; fALD(i)=fALD(i)+0.63;
fHO2(i)=fHO2(i)+0.63; fOH(i)=fOH(i)+0.63;

%O3 Tracer
i=i+1; %<RACM2_Update_244i>; <BAPI_120>
Rnames{i} = 'APINO2Q3a+HOQ=0.37 ONITQ3a + 0.63 ALD + 0.63 HO2 + 0.63 OH';
k(:,i) = 2.66E-13*exp(1300./T);
Gstr{i,1} = 'APINO2Q3a'; Gstr{i,2} = 'HOQ'; 
fAPINO2Q3a(i)=fAPINO2Q3a(i)-1; fHOQ(i)=fHOQ(i)-1; fONITQ3a(i)=fONITQ3a(i)+0.37; fALD(i)=fALD(i)+0.63;
fHO2(i)=fHO2(i)+0.63; fOH(i)=fOH(i)+0.63;

%O3 Tracer
i=i+1; %<RACM2_Update_244j>; <BAPI_120>
Rnames{i} = 'APINO2Q3a+HQ2=0.37 ONITQ3a + 0.63 ALD + 0.63 HO2 + 0.63 OH';
k(:,i) = 2.66E-13*exp(1300./T);
Gstr{i,1} = 'APINO2Q3a'; Gstr{i,2} = 'HQ2'; 
fAPINO2Q3a(i)=fAPINO2Q3a(i)-1; fHQ2(i)=fHQ2(i)-1; fONITQ3a(i)=fONITQ3a(i)+0.37; fALD(i)=fALD(i)+0.63;
fHO2(i)=fHO2(i)+0.63; fOH(i)=fOH(i)+0.63;
...
%O3 Tracer
i=i+1; %<RACM2_Update_245a>; <BAPI_120>
Rnames{i} = 'APINO2b+HOQ=0.37 ONITb + 0.63 ALD + 0.63 HO2 + 0.63 OH';
k(:,i) = 2.66E-13*exp(1300./T);
Gstr{i,1} = 'APINO2b'; Gstr{i,2} = 'HOQ'; 
fAPINO2b(i)=fAPINO2b(i)-1; fHOQ(i)=fHOQ(i)-1; fONITb(i)=fONITb(i)+0.37; fALD(i)=fALD(i)+0.63;
fHO2(i)=fHO2(i)+0.63; fOH(i)=fOH(i)+0.63;

%O3 Tracer
i=i+1; %<RACM2_Update_245b>; <BAPI_120>
Rnames{i} = 'APINO2b+HQ2=0.37 ONITb + 0.63 ALD + 0.63 HO2 + 0.63 OH';
k(:,i) = 2.66E-13*exp(1300./T);
Gstr{i,1} = 'APINO2b'; Gstr{i,2} = 'HQ2'; 
fAPINO2b(i)=fAPINO2b(i)-1; fHQ2(i)=fHQ2(i)-1; fONITb(i)=fONITb(i)+0.37; fALD(i)=fALD(i)+0.63;
fHO2(i)=fHO2(i)+0.63; fOH(i)=fOH(i)+0.63;

%O3 Tracer
i=i+1; %<RACM2_Update_245c>; <BAPI_120>
Rnames{i} = 'APINO2Qb+HO2=0.37 ONITQb + 0.63 ALD + 0.63 HO2 + 0.63 OH';
k(:,i) = 2.66E-13*exp(1300./T);
Gstr{i,1} = 'APINO2Qb'; Gstr{i,2} = 'HO2'; 
fAPINO2Qb(i)=fAPINO2Qb(i)-1; fHO2(i)=fHO2(i)-1; fONITQb(i)=fONITQb(i)+0.37; fALD(i)=fALD(i)+0.63;
fHO2(i)=fHO2(i)+0.63; fOH(i)=fOH(i)+0.63;

%O3 Tracer
i=i+1; %<RACM2_Update_245c>; <BAPI_120>
Rnames{i} = 'APINO2Qb+HOQ=0.37 ONITQb + 0.63 ALD + 0.63 HO2 + 0.63 OH';
k(:,i) = 2.66E-13*exp(1300./T);
Gstr{i,1} = 'APINO2Qb'; Gstr{i,2} = 'HOQ'; 
fAPINO2Qb(i)=fAPINO2Qb(i)-1; fHOQ(i)=fHOQ(i)-1; fONITQb(i)=fONITQb(i)+0.37; fALD(i)=fALD(i)+0.63;
fHO2(i)=fHO2(i)+0.63; fOH(i)=fOH(i)+0.63;

%O3 Tracer
i=i+1; %<RACM2_Update_245d>; <BAPI_120>
Rnames{i} = 'APINO2Qb+HQ2=0.37 ONITQb + 0.63 ALD + 0.63 HO2 + 0.63 OH';
k(:,i) = 2.66E-13*exp(1300./T);
Gstr{i,1} = 'APINO2Qb'; Gstr{i,2} = 'HQ2'; 
fAPINO2Qb(i)=fAPINO2Qb(i)-1; fHQ2(i)=fHQ2(i)-1; fONITQb(i)=fONITQb(i)+0.37; fALD(i)=fALD(i)+0.63;
fHO2(i)=fHO2(i)+0.63; fOH(i)=fOH(i)+0.63;

%O3 Tracer
i=i+1; %<RACM2_Update_245e>; <BAPI_120>
Rnames{i} = 'APINO2Q2b+HO2=0.37 ONITQ2b + 0.63 ALD + 0.63 HO2 + 0.63 OH';
k(:,i) = 2.66E-13*exp(1300./T);
Gstr{i,1} = 'APINO2Q2b'; Gstr{i,2} = 'HO2'; 
fAPINO2Q2b(i)=fAPINO2Q2b(i)-1; fHO2(i)=fHO2(i)-1; fONITQ2b(i)=fONITQ2b(i)+0.37; fALD(i)=fALD(i)+0.63;
fHO2(i)=fHO2(i)+0.63; fOH(i)=fOH(i)+0.63;

%O3 Tracer
i=i+1; %<RACM2_Update_245f>; <BAPI_120>
Rnames{i} = 'APINO2Q2b+HOQ=0.37 ONITQ2b + 0.63 ALD + 0.63 HO2 + 0.63 OH';
k(:,i) = 2.66E-13*exp(1300./T);
Gstr{i,1} = 'APINO2Q2b'; Gstr{i,2} = 'HOQ'; 
fAPINO2Q2b(i)=fAPINO2Q2b(i)-1; fHOQ(i)=fHOQ(i)-1; fONITQ2b(i)=fONITQ2b(i)+0.37; fALD(i)=fALD(i)+0.63;
fHO2(i)=fHO2(i)+0.63; fOH(i)=fOH(i)+0.63;

%O3 Tracer
i=i+1; %<RACM2_Update_245g>; <BAPI_120>
Rnames{i} = 'APINO2Q2b+HQ2=0.37 ONITQ2b + 0.63 ALD + 0.63 HO2 + 0.63 OH';
k(:,i) = 2.66E-13*exp(1300./T);
Gstr{i,1} = 'APINO2Q2b'; Gstr{i,2} = 'HQ2'; 
fAPINO2Q2b(i)=fAPINO2Q2b(i)-1; fHQ2(i)=fHQ2(i)-1; fONITQ2b(i)=fONITQ2b(i)+0.37; fALD(i)=fALD(i)+0.63;
fHO2(i)=fHO2(i)+0.63; fOH(i)=fOH(i)+0.63;

%O3 Tracer
i=i+1; %<RACM2_Update_245h>; <BAPI_120>
Rnames{i} = 'APINO2Q3b+HO2=0.37 ONITQ3b + 0.63 ALD + 0.63 HO2 + 0.63 OH';
k(:,i) = 2.66E-13*exp(1300./T);
Gstr{i,1} = 'APINO2Q3b'; Gstr{i,2} = 'HO2'; 
fAPINO2Q3b(i)=fAPINO2Q3b(i)-1; fHO2(i)=fHO2(i)-1; fONITQ3b(i)=fONITQ3b(i)+0.37; fALD(i)=fALD(i)+0.63;
fHO2(i)=fHO2(i)+0.63; fOH(i)=fOH(i)+0.63;

%O3 Tracer
i=i+1; %<RACM2_Update_245i>; <BAPI_120>
Rnames{i} = 'APINO2Q3b+HOQ=0.37 ONITQ3b + 0.63 ALD + 0.63 HO2 + 0.63 OH';
k(:,i) = 2.66E-13*exp(1300./T);
Gstr{i,1} = 'APINO2Q3b'; Gstr{i,2} = 'HOQ'; 
fAPINO2Q3b(i)=fAPINO2Q3b(i)-1; fHOQ(i)=fHOQ(i)-1; fONITQ3b(i)=fONITQ3b(i)+0.37; fALD(i)=fALD(i)+0.63;
fHO2(i)=fHO2(i)+0.63; fOH(i)=fOH(i)+0.63;

%O3 Tracer
i=i+1; %<RACM2_Update_245j>; <BAPI_120>
Rnames{i} = 'APINO2Q3b+HQ2=0.37 ONITQ3b + 0.63 ALD + 0.63 HO2 + 0.63 OH';
k(:,i) = 2.66E-13*exp(1300./T);
Gstr{i,1} = 'APINO2Q3b'; Gstr{i,2} = 'HQ2'; 
fAPINO2Q3b(i)=fAPINO2Q3b(i)-1; fHQ2(i)=fHQ2(i)-1; fONITQ3b(i)=fONITQ3b(i)+0.37; fALD(i)=fALD(i)+0.63;
fHO2(i)=fHO2(i)+0.63; fOH(i)=fOH(i)+0.63;
...
Rnames{i} = 'APINO2b+MO2=HCHO+HO2+HO2+ONITb';
k(:,i) = 1.60E-13.*exp(708./T);
Gstr{i,1} = 'APINO2a'; Gstr{i,2} = 'MO2'; 
fAPINO2a(i)=fAPINO2a(i)-1; fMO2(i)=fMO2(i)-1; fHCHO(i)=fHCHO(i)+1; fHO2(i)=fHO2(i)+1; fHO2(i)=fHO2(i)+1; fONITb(i)=fONITb(i)+1; 

%O3 Tracer
i=i+1; %<RACM2_Update_281>; <BAPI_133a>
Rnames{i} = 'APINO2Qb+MO2=HCHO+HO2+HO2+ONITQb';
k(:,i) = 1.60E-13.*exp(708./T);
Gstr{i,1} = 'APINO2Qa'; Gstr{i,2} = 'MO2'; 
fAPINO2Qa(i)=fAPINO2Qa(i)-1; fMO2(i)=fMO2(i)-1; fHCHO(i)=fHCHO(i)+1; fHO2(i)=fHO2(i)+1; fHO2(i)=fHO2(i)+1; fONITQb(i)=fONITQb(i)+1; 

%O3 Tracer
i=i+1; %<RACM2_Update_281>; <BAPI_133b>
Rnames{i} = 'APINO2Q2b+MO2=HCHO+HO2+HO2+ONITQ2b';
k(:,i) = 1.60E-13.*exp(708./T);
Gstr{i,1} = 'APINO2Q2a'; Gstr{i,2} = 'MO2'; 
fAPINO2Q2a(i)=fAPINO2Q2a(i)-1; fMO2(i)=fMO2(i)-1; fHCHO(i)=fHCHO(i)+1; fHO2(i)=fHO2(i)+1; fHO2(i)=fHO2(i)+1; fONITQ2b(i)=fONITQ2b(i)+1; 

%O3 Tracer
i=i+1; %<RACM2_Update_281>; <BAPI_133c>
Rnames{i} = 'APINO2Q3b+MO2=HCHO+HO2+HO2+ONITQ3b';
k(:,i) = 1.60E-13.*exp(708./T);
Gstr{i,1} = 'APINO2Q3a'; Gstr{i,2} = 'MO2'; 
fAPINO2Q3a(i)=fAPINO2Q3a(i)-1; fMO2(i)=fMO2(i)-1; fHCHO(i)=fHCHO(i)+1; fHO2(i)=fHO2(i)+1; fHO2(i)=fHO2(i)+1; fONITQ3b(i)=fONITQ3b(i)+1; 

i=i+1; %<RACM2_Update_282>; <BAPI_134c>
Rnames{i} = 'APINO2a+MO2= HO2+NO2+HCHO+ALD+KET+MOH+ROH+ONITa';
k(:,i) = 9.68E-14.*exp(708./T);
Gstr{i,1} = 'APINO2a'; Gstr{i,2} = 'MO2'; 
fAPINO2a(i)=fAPINO2a(i)-1; fMO2(i)=fMO2(i)-1; fHO2(i)=fHO2(i)+0.50; fNO2(i)=fNO2(i)+0.50; 
fHCHO(i)=fHCHO(i)+0.965; fALD(i)=fALD(i)+0.93; fKET(i)=fKET(i)+0.348; fMOH(i)=fMOH(i)+0.25; 
fROH(i)=fROH(i)+0.25; fONITa(i)=fONITa(i)+0.5; 

i=i+1; %<RACM2_Update_282>; <BAPI_134e>
Rnames{i} = 'APINO2Qa+MO2= HO2+NO2+NOQ+HCHO+ALD+KET+MOH+ROH+ONITQa';
k(:,i) = 9.68E-14.*exp(708./T);
Gstr{i,1} = 'APINO2a'; Gstr{i,2} = 'MO2'; 
fAPINO2Qa(i)=fAPINO2Qa(i)-1; fMO2(i)=fMO2(i)-1; fHO2(i)=fHO2(i)+0.50; fNO2(i)=fNO2(i)+(1/6); fNOQ(i)=fNOQ(i)+(1/3); 
fHCHO(i)=fHCHO(i)+0.965; fALD(i)=fALD(i)+0.93; fKET(i)=fKET(i)+0.348; fMOH(i)=fMOH(i)+0.25; 
fROH(i)=fROH(i)+0.25; fONITQa(i)=fONITQa(i)+0.5; 

i=i+1; %<RACM2_Update_282>; <BAPI_134f>
Rnames{i} = 'APINO2Q2a+MO2= HO2+NQ2+NOQ+HCHO+ALD+KET+MOH+ROH+ONITQa';
k(:,i) = 9.68E-14.*exp(708./T);
Gstr{i,1} = 'APINO2Q2a'; Gstr{i,2} = 'MO2'; 
fAPINO2Q2a(i)=fAPINO2Q2a(i)-1; fMO2(i)=fMO2(i)-1; fHO2(i)=fHO2(i)+0.50; fNQ2(i)=fNQ2(i)+(1/6); fNOQ(i)=fNOQ(i)+(1/3); 
fHCHO(i)=fHCHO(i)+0.965; fALD(i)=fALD(i)+0.93; fKET(i)=fKET(i)+0.348; fMOH(i)=fMOH(i)+0.25; 
fROH(i)=fROH(i)+0.25; fONITQ2a(i)=fONITQ2a(i)+0.5; 

i=i+1; %<RACM2_Update_282>; <BAPI_134f>
Rnames{i} = 'APINO2Q3a+MO2= HO2+NQ2+HCHO+ALD+KET+MOH+ROH+ONITQa';
k(:,i) = 9.68E-14.*exp(708./T);
Gstr{i,1} = 'APINO2Q3a'; Gstr{i,2} = 'MO2'; 
fAPINO2Q3a(i)=fAPINO2Q3a(i)-1; fMO2(i)=fMO2(i)-1; fHO2(i)=fHO2(i)+0.50; fNQ2(i)=fNQ2(i)+(1/2); 
fHCHO(i)=fHCHO(i)+0.965; fALD(i)=fALD(i)+0.93; fKET(i)=fKET(i)+0.348; fMOH(i)=fMOH(i)+0.25; 
fROH(i)=fROH(i)+0.25; fONITQ3a(i)=fONITQ3a(i)+0.5; 
...
Rnames{i} = 'APINO2b+ACO3=ONITb+MO2+HO2';
k(:,i) = 8.85E-13.*exp(765./T);
Gstr{i,1} = 'APINO2b'; Gstr{i,2} = 'ACO3'; 
fAPINO2b(i)=fAPINO2b(i)-1; fACO3(i)=fACO3(i)-1; fONITb(i)=fONITb(i)+1; fMO2(i)=fMO2(i)+1; fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1; %<RACM2_Update_317>; <BAPI_145a>
Rnames{i} = 'APINO2Qb+ACO3=ONITQb+MO2+HO2';
k(:,i) = 8.85E-13.*exp(765./T);
Gstr{i,1} = 'APINO2Qb'; Gstr{i,2} = 'ACO3'; 
fAPINO2Qb(i)=fAPINO2Qb(i)-1; fACO3(i)=fACO3(i)-1; fONITQb(i)=fONITQb(i)+1; fMO2(i)=fMO2(i)+1; fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1; %<RACM2_Update_317>; <BAPI_145b>
Rnames{i} = 'APINO2Q2b+ACO3=ONITQ2b+MO2+HO2';
k(:,i) = 8.85E-13.*exp(765./T);
Gstr{i,1} = 'APINO2Q2b'; Gstr{i,2} = 'ACO3'; 
fAPINO2Q2b(i)=fAPINO2Q2b(i)-1; fACO3(i)=fACO3(i)-1; fONITQ2b(i)=fONITQ2b(i)+1; fMO2(i)=fMO2(i)+1; fHO2(i)=fHO2(i)+1;

%O3 Tracer
i=i+1; %<RACM2_Update_317>; <BAPI_145c>
Rnames{i} = 'APINO2Q3b+ACO3=ONITQ3b+MO2+HO2';
k(:,i) = 8.85E-13.*exp(765./T);
Gstr{i,1} = 'APINO2Q3b'; Gstr{i,2} = 'ACO3'; 
fAPINO2Q3b(i)=fAPINO2Q3b(i)-1; fACO3(i)=fACO3(i)-1; fONITQ3b(i)=fONITQ3b(i)+1; fMO2(i)=fMO2(i)+1; fHO2(i)=fHO2(i)+1;


i=i+1; %<RACM2_318>; <BAPI_146e>
Rnames{i} = 'APINO2a+ACO3= MO2+NO2+HCHO+ALD+KET+ORA2';
k(:,i) = 5.37E-13.*exp(765./T) ;
Gstr{i,1} = 'APINO2a'; Gstr{i,2} = 'ACO3'; 
fAPINO2a(i)=fAPINO2a(i)-1; fACO3(i)=fACO3(i)-1; fMO2(i)=fMO2(i)+0.50; fNO2(i)=fNO2(i)+1; 
fHCHO(i)=fHCHO(i)+0.287; fALD(i)=fALD(i)+1.24; fKET(i)=fKET(i)+0.464; fORA2(i)=fORA2(i)+0.50; 

%O3 Tracer
i=i+1; %<RACM2_318>; <BAPI_146f>
Rnames{i} = 'APINO2Qa+ACO3= MO2+NOQ+NO2+HCHO+ALD+KET+ORA2';
k(:,i) = 5.37E-13.*exp(765./T) ;
Gstr{i,1} = 'APINO2Qa'; Gstr{i,2} = 'ACO3'; 
fAPINO2Qa(i)=fAPINO2Qa(i)-1; fACO3(i)=fACO3(i)-1; fMO2(i)=fMO2(i)+0.50; fNO2(i)=fNO2(i)+(1/3); fNOQ(i)=fNOQ(i)+(2/3); fHCHO(i)=fHCHO(i)+0.287; fALD(i)=fALD(i)+1.24; fKET(i)=fKET(i)+0.464; fORA2(i)=fORA2(i)+0.50; 

%O3 Tracer
i=i+1; %<RACM2_318>; <BAPI_146g>
Rnames{i} = 'APINO2Q2a+ACO3= MO2+NOQ+NQ2+HCHO+ALD+KET+ORA2';
k(:,i) = 5.37E-13.*exp(765./T) ;
Gstr{i,1} = 'APINO2Q2a'; Gstr{i,2} = 'ACO3'; 
fAPINO2Q2a(i)=fAPINO2Q2a(i)-1; fACO3(i)=fACO3(i)-1; fMO2(i)=fMO2(i)+0.50; fNQ2(i)=fNQ2(i)+(1/3); fNOQ(i)=fNOQ(i)+(2/3); fHCHO(i)=fHCHO(i)+0.287; fALD(i)=fALD(i)+1.24; fKET(i)=fKET(i)+0.464; fORA2(i)=fORA2(i)+0.50; 


%O3 Tracer
i=i+1; %<RACM2_318>; <BAPI_146h>
Rnames{i} = 'APINO2Q3a+ACO3= MO2+NQ2+HCHO+ALD+KET+ORA2';
k(:,i) = 5.37E-13.*exp(765./T) ;
Gstr{i,1} = 'APINO2Q3a'; Gstr{i,2} = 'ACO3'; 
fAPINO2Q3a(i)=fAPINO2Q3a(i)-1; fACO3(i)=fACO3(i)-1; fMO2(i)=fMO2(i)+0.50; fNQ2(i)=fNQ2(i)+1;  
fHCHO(i)=fHCHO(i)+0.287; fALD(i)=fALD(i)+1.24; fKET(i)=fKET(i)+0.464; fORA2(i)=fORA2(i)+0.50; 
...
i=i+1; %<RACM2_Update_338d>; <BAPI_151>
...
Rnames{i} = 'APINO2a+NO3= 0.2 ONITa+1.8 NO2 + 0.9 ALD';
k(:,i) = 2.30E-12;
Gstr{i,1} = 'APINO2a'; Gstr{i,2} = 'NO3'; 
fAPINO2a(i)=fAPINO2a(i)-1; fNO3(i)=fNO3(i)-1; fONITa(i)=fONITa(i)+0.2; fNO2(i)=fNO2(i)+1.8; fALD(i)=fALD(i)+0.9; 

%O3 Tracer
i=i+1; %<RACM2_Update_354>; <BAPI_158a>
Rnames{i} = 'APINO2a+NO2Q= 0.2 ONITa+ (1.13333) NO2 + (2/3) NOQ + 0.9 ALD';
k(:,i) = 2.30E-12;
Gstr{i,1} = 'APINO2a'; Gstr{i,2} = 'NO2Q'; 
fAPINO2a(i)=fAPINO2a(i)-1; fNO2Q(i)=fNO2Q(i)-1; fONITa(i)=fONITa(i)+0.2; fNO2(i)=fNO2(i)+1.13333; fNOQ(i)=fNOQ(i)+(2/3); fALD(i)=fALD(i)+0.9; 

%O3 Tracer
i=i+1; %<RACM2_Update_354>; <BAPI_158b>
Rnames{i} = 'APINO2a+NOQ2= 0.2 ONITa+ 0.8 NO2 + (2/3) NOQ + (1/3) NQ2 + 0.9 ALD';
k(:,i) = 2.30E-12;
Gstr{i,1} = 'APINO2a'; Gstr{i,2} = 'NOQ2'; 
fAPINO2a(i)=fAPINO2a(i)-1; fNOQ2(i)=fNOQ2(i)-1; fONITa(i)=fONITa(i)+0.2; fNO2(i)=fNO2(i)+0.8; fNOQ(i)=fNOQ(i)+(2/3); fNQ2(i)=fNQ2(i)+(1/3); fALD(i)=fALD(i)+0.9; 

%O3 Tracer
i=i+1; %<RACM2_Update_354>; <BAPI_158c>
Rnames{i} = 'APINO2a+NQ3= 0.2 ONITa+ 0.8 NO2 +  NQ2 + 0.9 ALD';
k(:,i) = 2.30E-12;
Gstr{i,1} = 'APINO2a'; Gstr{i,2} = 'NQ3'; 
fAPINO2a(i)=fAPINO2a(i)-1; fNQ3(i)=fNQ3(i)-1; fONITa(i)=fONITa(i)+0.2; fNO2(i)=fNO2(i)+0.8;  fNQ2(i)=fNQ2(i)+1; fALD(i)=fALD(i)+0.9;


%O3 Tracer
i=i+1; %<RACM2_Update_354>; <BAPI_158d>
Rnames{i} = 'APINO2Qa+NO3= 0.2 ONITQa+  (1.5333)NO2 +  (0.2666)NOQ + 0.9 ALD';
k(:,i) = 2.30E-12;
Gstr{i,1} = 'APINO2Qa'; Gstr{i,2} = 'NO3'; 
fAPINO2Qa(i)=fAPINO2Qa(i)-1; fNO3(i)=fNO3(i)-1; fONITQa(i)=fONITQa(i)+0.2; fNO2(i)=fNO2(i)+1.5333;  fNOQ(i)=fNOQ(i)+0.2666; fALD(i)=fALD(i)+0.9;

%O3 Tracer
i=i+1; %<RACM2_Update_354>; <BAPI_158e>
Rnames{i} = 'APINO2Qa+NO2Q= 0.2 ONITQa+  (0.6) NO2 +  1.2 NOQ + 0.9 ALD';
k(:,i) = 2.30E-12;
Gstr{i,1} = 'APINO2Qa'; Gstr{i,2} = 'NO2Q'; 
fAPINO2Qa(i)=fAPINO2Qa(i)-1; fNO2Q(i)=fNO2Q(i)-1; fONITQa(i)=fONITQa(i)+0.2; fNO2(i)=fNO2(i)+0.6;  fNOQ(i)=fNOQ(i)+1.2; fALD(i)=fALD(i)+0.9;

%O3 Tracer
i=i+1; %<RACM2_Update_354>; <BAPI_158f>
Rnames{i} = 'APINO2Qa+NOQ2= 0.2 ONITQa + 0.2666 NO2 +  1.2 NOQ + 0.333 NQ2 + 0.9 ALD';
k(:,i) = 2.30E-12;
Gstr{i,1} = 'APINO2Qa'; Gstr{i,2} = 'NO2Q'; 
fAPINO2Qa(i)=fAPINO2Qa(i)-1; fNOQ2(i)=fNOQ2(i)-1; fONITQa(i)=fONITQa(i)+0.2; fNO2(i)=fNO2(i)+0.2666;  fNOQ(i)=fNOQ(i)+1.2; fNQ2(i)=fNQ2(i)+0.333; fALD(i)=fALD(i)+0.9;

%O3 Tracer
i=i+1; %<RACM2_Update_354>; <BAPI_158g>
Rnames{i} = 'APINO2Qa+NQ3= 0.2 ONITQa + 0.2666 NO2 +  0.5333 NOQ + 1 NQ2 + 0.9 ALD';
k(:,i) = 2.30E-12;
Gstr{i,1} = 'APINO2Qa'; Gstr{i,2} = 'NQ3'; 
fAPINO2Qa(i)=fAPINO2Qa(i)-1; fNQ3(i)=fNQ3(i)-1; fONITQa(i)=fONITQa(i)+0.2; fNO2(i)=fNO2(i)+0.2666;  fNOQ(i)=fNOQ(i)+0.5333; fNQ2(i)=fNQ2(i)+1; fALD(i)=fALD(i)+0.9;

%O3 Tracer
i=i+1; %<RACM2_Update_354>; <BAPI_158h>
Rnames{i} = 'APINO2Q2a+NO3= 0.2 ONITQ2a + 1 NO2 +  0.5333 NOQ + 0.2666 NQ2 + 0.9 ALD';
k(:,i) = 2.30E-12;
Gstr{i,1} = 'APINO2Q2a'; Gstr{i,2} = 'NO3'; 
fAPINO2Q2a(i)=fAPINO2Q2a(i)-1; fNO3(i)=fNO3(i)-1; fONITQ2a(i)=fONITQ2a(i)+0.2; fNO2(i)=fNO2(i)+0.2666;  fNOQ(i)=fNOQ(i)+0.5333; fNQ2(i)=fNQ2(i)+1; fALD(i)=fALD(i)+0.9;

%O3 Tracer
i=i+1; %<RACM2_Update_354>; <BAPI_158i>
Rnames{i} = 'APINO2Q2a+NO2Q= 0.2 ONITQ2a + 0.333 NO2 +  1.2 NOQ + 0.2666 NQ2 + 0.9 ALD';
k(:,i) = 2.30E-12;
Gstr{i,1} = 'APINO2Q2a'; Gstr{i,2} = 'NO2Q'; 
fAPINO2Q2a(i)=fAPINO2Q2a(i)-1; fNO2Q(i)=fNO2Q(i)-1; fONITQ2a(i)=fONITQ2a(i)+0.2; fNO2(i)=fNO2(i)+0.333;  fNOQ(i)=fNOQ(i)+1.2; fNQ2(i)=fNQ2(i)+0.2666; fALD(i)=fALD(i)+0.9;


%O3 Tracer
i=i+1; %<RACM2_Update_354>; <BAPI_158j>
Rnames{i} = 'APINO2Q2a+NOQ2= 0.2 ONITQ2a +  1.2 NOQ + 0.6 NQ2 + 0.9 ALD';
k(:,i) = 2.30E-12;
Gstr{i,1} = 'APINO2Q2a'; Gstr{i,2} = 'NOQ2'; 
fAPINO2Q2a(i)=fAPINO2Q2a(i)-1; fNOQ2(i)=fNOQ2(i)-1; fONITQ2a(i)=fONITQ2a(i)+0.2; fNOQ(i)=fNOQ(i)+1.2; fNQ2(i)=fNQ2(i)+0.6; fALD(i)=fALD(i)+0.9;


%O3 Tracer
i=i+1; %<RACM2_Update_354>; <BAPI_158k>
Rnames{i} = 'APINO2Q2a+NQ3= 0.2 ONITQ2a +  0.5333 NOQ + 1.2666 NQ2 + 0.9 ALD';
k(:,i) = 2.30E-12;
Gstr{i,1} = 'APINO2Q2a'; Gstr{i,2} = 'NQ3'; 
fAPINO2Q2a(i)=fAPINO2Q2a(i)-1; fNQ3(i)=fNQ3(i)-1; fONITQ2a(i)=fONITQ2a(i)+0.2; fNOQ(i)=fNOQ(i)+0.5333; fNQ2(i)=fNQ2(i)+1.2666; fALD(i)=fALD(i)+0.9;


%O3 Tracer
i=i+1; %<RACM2_Update_354>; <BAPI_158l>
Rnames{i} = 'APINO2Q3a+NO3= 0.2 ONITQ3a + 1  NO2 + 0.8 NQ2 + 0.9 ALD';
k(:,i) = 2.30E-12;
Gstr{i,1} = 'APINO2Q3a'; Gstr{i,2} = 'NO3'; 
fAPINO2Q3a(i)=fAPINO2Q3a(i)-1; fNO3(i)=fNQ3(i)-1; fONITQ3a(i)=fONITQ3a(i)+0.2; fNO2(i)=fNO2(i)+1; fNQ2(i)=fNQ2(i)+0.8; fALD(i)=fALD(i)+0.9;

%O3 Tracer
i=i+1; %<RACM2_Update_354>; <BAPI_158m>
Rnames{i} = 'APINO2Q3a+NO2Q= 0.2 ONITQ3a + 0.333 NO2 + 0.666  NOQ + 0.8 NQ2 + 0.9 ALD';
k(:,i) = 2.30E-12;
Gstr{i,1} = 'APINO2Q3a'; Gstr{i,2} = 'NO2Q'; 
fAPINO2Q3a(i)=fAPINO2Q3a(i)-1; fNO2Q(i)=fNO2Q(i)-1; fONITQ3a(i)=fONITQ3a(i)+0.2; fNO2(i)=fNO2(i)+0.333; fNOQ(i)=fNOQ(i)+0.666; fNQ2(i)=fNQ2(i)+0.8; fALD(i)=fALD(i)+0.9;

%O3 Tracer
i=i+1; %<RACM2_Update_354>; <BAPI_158o>
Rnames{i} = 'APINO2Q3a+NOQ2= 0.2 ONITQ3a + 0.666  NOQ + 1.1333 NQ2 + 0.9 ALD';
k(:,i) = 2.30E-12;
Gstr{i,1} = 'APINO2Q3a'; Gstr{i,2} = 'NOQ2'; 
fAPINO2Q3a(i)=fAPINO2Q3a(i)-1; fNOQ2(i)=fNOQ2(i)-1; fONITQ3a(i)=fONITQ3a(i)+0.2; fNOQ(i)=fNOQ(i)+0.666; fNQ2(i)=fNQ2(i)+1.1333; fALD(i)=fALD(i)+0.9;

%O3 Tracer
i=i+1; %<RACM2_Update_354>; <BAPI_158p>
Rnames{i} = 'APINO2Q3a+NQ3= 0.2 ONITQ3a +1.8 NQ2 + 0.9 ALD';
k(:,i) = 2.30E-12;
Gstr{i,1} = 'APINO2Q3a'; Gstr{i,2} = 'NQ3'; 
fAPINO2Q3a(i)=fAPINO2Q3a(i)-1; fNQ3(i)=fNQ3(i)-1; fONITQ3a(i)=fONITQ3a(i)+0.2; fNQ2(i)=fNQ2(i)+1.8; fALD(i)=fALD(i)+0.9;


i=i+1; %<RACM2_Update_355>; <BAPI_158>
Rnames{i} = 'APINO2b+NO3= 0.2 ONITb+1.8 NO2 + 0.9 ALD';
k(:,i) = 2.30E-12;
Gstr{i,1} = 'APINO2b'; Gstr{i,2} = 'NO3'; 
fAPINO2b(i)=fAPINO2b(i)-1; fNO3(i)=fNO3(i)-1; fONITb(i)=fONITb(i)+0.2; fNO2(i)=fNO2(i)+1.8; fALD(i)=fALD(i)+0.9; 

%O3 Tracer
i=i+1; %<RACM2_Update_355>; <BAPI_158a>
Rnames{i} = 'APINO2b+NO2Q= 0.2 ONITb+ (1.13333) NO2 + (2/3) NOQ + 0.9 ALD';
k(:,i) = 2.30E-12;
Gstr{i,1} = 'APINO2b'; Gstr{i,2} = 'NO2Q'; 
fAPINO2b(i)=fAPINO2b(i)-1; fNO2Q(i)=fNO2Q(i)-1; fONITb(i)=fONITb(i)+0.2; fNO2(i)=fNO2(i)+1.13333; fNOQ(i)=fNOQ(i)+(2/3); fALD(i)=fALD(i)+0.9; 

%O3 Tracer
i=i+1; %<RACM2_Update_355>; <BAPI_158b>
Rnames{i} = 'APINO2b+NOQ2= 0.2 ONITb+ 0.8 NO2 + (2/3) NOQ + (1/3) NQ2 + 0.9 ALD';
k(:,i) = 2.30E-12;
Gstr{i,1} = 'APINO2b'; Gstr{i,2} = 'NOQ2'; 
fAPINO2b(i)=fAPINO2b(i)-1; fNOQ2(i)=fNOQ2(i)-1; fONITb(i)=fONITb(i)+0.2; fNO2(i)=fNO2(i)+0.8; fNOQ(i)=fNOQ(i)+(2/3); fNQ2(i)=fNQ2(i)+(1/3); fALD(i)=fALD(i)+0.9; 

%O3 Tracer
i=i+1; %<RACM2_Update_355>; <BAPI_158c>
Rnames{i} = 'APINO2b+NQ3= 0.2 ONITb+ 0.8 NO2 +  NQ2 + 0.9 ALD';
k(:,i) = 2.30E-12;
Gstr{i,1} = 'APINO2b'; Gstr{i,2} = 'NQ3'; 
fAPINO2b(i)=fAPINO2b(i)-1; fNQ3(i)=fNQ3(i)-1; fONITb(i)=fONITb(i)+0.2; fNO2(i)=fNO2(i)+0.8;  fNQ2(i)=fNQ2(i)+1; fALD(i)=fALD(i)+0.9;


%O3 Tracer
i=i+1; %<RACM2_Update_355>; <BAPI_158d>
Rnames{i} = 'APINO2Qb+NO3= 0.2 ONITQb+  (1.5333)NO2 +  (0.2666)NOQ + 0.9 ALD';
k(:,i) = 2.30E-12;
Gstr{i,1} = 'APINO2Qb'; Gstr{i,2} = 'NO3'; 
fAPINO2Qb(i)=fAPINO2Qb(i)-1; fNO3(i)=fNO3(i)-1; fONITQb(i)=fONITQb(i)+0.2; fNO2(i)=fNO2(i)+1.5333;  fNOQ(i)=fNOQ(i)+0.2666; fALD(i)=fALD(i)+0.9;

%O3 Tracer
i=i+1; %<RACM2_Update_355>; <BAPI_158e>
Rnames{i} = 'APINO2Qb+NO2Q= 0.2 ONITQb+  (0.6) NO2 +  1.2 NOQ + 0.9 ALD';
k(:,i) = 2.30E-12;
Gstr{i,1} = 'APINO2Qb'; Gstr{i,2} = 'NO2Q'; 
fAPINO2Qb(i)=fAPINO2Qb(i)-1; fNO2Q(i)=fNO2Q(i)-1; fONITQb(i)=fONITQb(i)+0.2; fNO2(i)=fNO2(i)+0.6;  fNOQ(i)=fNOQ(i)+1.2; fALD(i)=fALD(i)+0.9;

%O3 Tracer
i=i+1; %<RACM2_Update_355>; <BAPI_158f>
Rnames{i} = 'APINO2Qb+NOQ2= 0.2 ONITQb + 0.2666 NO2 +  1.2 NOQ + 0.333 NQ2 + 0.9 ALD';
k(:,i) = 2.30E-12;
Gstr{i,1} = 'APINO2Qb'; Gstr{i,2} = 'NO2Q'; 
fAPINO2Qb(i)=fAPINO2Qb(i)-1; fNOQ2(i)=fNOQ2(i)-1; fONITQb(i)=fONITQb(i)+0.2; fNO2(i)=fNO2(i)+0.2666;  fNOQ(i)=fNOQ(i)+1.2; fNQ2(i)=fNQ2(i)+0.333; fALD(i)=fALD(i)+0.9;

%O3 Tracer
i=i+1; %<RACM2_Update_355>; <BAPI_158g>
Rnames{i} = 'APINO2Qb+NQ3= 0.2 ONITQb + 0.2666 NO2 +  0.5333 NOQ + 1 NQ2 + 0.9 ALD';
k(:,i) = 2.30E-12;
Gstr{i,1} = 'APINO2Qb'; Gstr{i,2} = 'NQ3'; 
fAPINO2Qb(i)=fAPINO2Qb(i)-1; fNQ3(i)=fNQ3(i)-1; fONITQb(i)=fONITQb(i)+0.2; fNO2(i)=fNO2(i)+0.2666;  fNOQ(i)=fNOQ(i)+0.5333; fNQ2(i)=fNQ2(i)+1; fALD(i)=fALD(i)+0.9;

%O3 Tracer
i=i+1; %<RACM2_Update_355>; <BAPI_158h>
Rnames{i} = 'APINO2Q2b+NO3= 0.2 ONITQ2b + 1 NO2 +  0.5333 NOQ + 0.2666 NQ2 + 0.9 ALD';
k(:,i) = 2.30E-12;
Gstr{i,1} = 'APINO2Q2b'; Gstr{i,2} = 'NO3'; 
fAPINO2Q2b(i)=fAPINO2Q2b(i)-1; fNO3(i)=fNO3(i)-1; fONITQ2b(i)=fONITQ2b(i)+0.2; fNO2(i)=fNO2(i)+0.2666;  fNOQ(i)=fNOQ(i)+0.5333; fNQ2(i)=fNQ2(i)+1; fALD(i)=fALD(i)+0.9;

%O3 Tracer
i=i+1; %<RACM2_Update_355>; <BAPI_158i>
Rnames{i} = 'APINO2Q2b+NO2Q= 0.2 ONITQ2b + 0.333 NO2 +  1.2 NOQ + 0.2666 NQ2 + 0.9 ALD';
k(:,i) = 2.30E-12;
Gstr{i,1} = 'APINO2Q2b'; Gstr{i,2} = 'NO2Q'; 
fAPINO2Q2b(i)=fAPINO2Q2b(i)-1; fNO2Q(i)=fNO2Q(i)-1; fONITQ2b(i)=fONITQ2b(i)+0.2; fNO2(i)=fNO2(i)+0.333;  fNOQ(i)=fNOQ(i)+1.2; fNQ2(i)=fNQ2(i)+0.2666; fALD(i)=fALD(i)+0.9;


%O3 Tracer
i=i+1; %<RACM2_Update_355>; <BAPI_158j>
Rnames{i} = 'APINO2Q2b+NOQ2= 0.2 ONITQ2b +  1.2 NOQ + 0.6 NQ2 + 0.9 ALD';
k(:,i) = 2.30E-12;
Gstr{i,1} = 'APINO2Q2b'; Gstr{i,2} = 'NOQ2'; 
fAPINO2Q2b(i)=fAPINO2Q2b(i)-1; fNOQ2(i)=fNOQ2(i)-1; fONITQ2b(i)=fONITQ2b(i)+0.2; fNOQ(i)=fNOQ(i)+1.2; fNQ2(i)=fNQ2(i)+0.6; fALD(i)=fALD(i)+0.9;


%O3 Tracer
i=i+1; %<RACM2_Update_355>; <BAPI_158k>
Rnames{i} = 'APINO2Q2b+NQ3= 0.2 ONITQ2b +  0.5333 NOQ + 1.2666 NQ2 + 0.9 ALD';
k(:,i) = 2.30E-12;
Gstr{i,1} = 'APINO2Q2b'; Gstr{i,2} = 'NQ3'; 
fAPINO2Q2b(i)=fAPINO2Q2b(i)-1; fNQ3(i)=fNQ3(i)-1; fONITQ2b(i)=fONITQ2b(i)+0.2; fNOQ(i)=fNOQ(i)+0.5333; fNQ2(i)=fNQ2(i)+1.2666; fALD(i)=fALD(i)+0.9;


%O3 Tracer
i=i+1; %<RACM2_Update_355>; <BAPI_158l>
Rnames{i} = 'APINO2Q3b+NO3= 0.2 ONITQ3b + 1  NO2 + 0.8 NQ2 + 0.9 ALD';
k(:,i) = 2.30E-12;
Gstr{i,1} = 'APINO2Q3b'; Gstr{i,2} = 'NO3'; 
fAPINO2Q3b(i)=fAPINO2Q3b(i)-1; fNO3(i)=fNQ3(i)-1; fONITQ3b(i)=fONITQ3b(i)+0.2; fNO2(i)=fNO2(i)+1; fNQ2(i)=fNQ2(i)+0.8; fALD(i)=fALD(i)+0.9;

%O3 Tracer
i=i+1; %<RACM2_Update_355>; <BAPI_158m>
Rnames{i} = 'APINO2Q3b+NO2Q= 0.2 ONITQ3b + 0.333 NO2 + 0.666  NOQ + 0.8 NQ2 + 0.9 ALD';
k(:,i) = 2.30E-12;
Gstr{i,1} = 'APINO2Q3b'; Gstr{i,2} = 'NO2Q'; 
fAPINO2Q3b(i)=fAPINO2Q3b(i)-1; fNO2Q(i)=fNO2Q(i)-1; fONITQ3b(i)=fONITQ3b(i)+0.2; fNO2(i)=fNO2(i)+0.333; fNOQ(i)=fNOQ(i)+0.666; fNQ2(i)=fNQ2(i)+0.8; fALD(i)=fALD(i)+0.9;

%O3 Tracer
i=i+1; %<RACM2_Update_355>; <BAPI_158n>
Rnames{i} = 'APINO2Q3b+NOQ2= 0.2 ONITQ3b + 0.666  NOQ + 1.1333 NQ2 + 0.9 ALD';
k(:,i) = 2.30E-12;
Gstr{i,1} = 'APINO2Q3b'; Gstr{i,2} = 'NOQ2'; 
fAPINO2Q3b(i)=fAPINO2Q3b(i)-1; fNOQ2(i)=fNOQ2(i)-1; fONITQ3b(i)=fONITQ3b(i)+0.2; fNOQ(i)=fNOQ(i)+0.666; fNQ2(i)=fNQ2(i)+1.1333; fALD(i)=fALD(i)+0.9;

%O3 Tracer
i=i+1; %<RACM2_Update_356>; <BAPI_158o>
Rnames{i} = 'APINO2Q3b+NQ3= 0.2 ONITQ3b +1.8 NQ2 + 0.9 ALD';
k(:,i) = 2.30E-12;
Gstr{i,1} = 'APINO2Q3b'; Gstr{i,2} = 'NQ3'; 
fAPINO2Q3b(i)=fAPINO2Q3b(i)-1; fNQ3(i)=fNQ3(i)-1; fONITQ3b(i)=fONITQ3b(i)+0.2; fNQ2(i)=fNQ2(i)+1.8; fALD(i)=fALD(i)+0.9;
...
Rnames{i} = 'APINO2a+APINO2a=0.32 ONITa + 1.68 ALD + 1.68 NO2';
k(:,i) = 1.00E-14;
Gstr{i,1} = 'APINO2a'; Gstr{i,2} = 'APINO2a'; 
fAPINO2a(i)=fAPINO2a(i)-1; fAPINO2a(i)=fAPINO2a(i)-1; fONITa(i)=fONITa(i)+0.32; fALD(i)=fALD(i)+1.68; fNO2(i)=fNO2(i)+1.68; 

%O3 Tracer
i=i+1; %<RACM2_Update_359>; <BAPI_162a>
Rnames{i} = 'APINO2a+APINO2Qa=0.16 ONITa + 0.16 ONITQa + 1.68 ALD + 1.12 NO2 + 0.56 NOQ';
k(:,i) = 1.00E-14;
Gstr{i,1} = 'APINO2a'; Gstr{i,2} = 'APINO2Qa'; 
fAPINO2a(i)=fAPINO2a(i)-1; fAPINO2Qa(i)=fAPINO2Qa(i)-1; fONITa(i)=fONITa(i)+0.16; fONITQa(i)=fONITQa(i)+0.16; fALD(i)=fALD(i)+1.68; fNO2(i)=fNO2(i)+1.12; fNOQ(i)=fNOQ(i)+0.56; 

%O3 Tracer
i=i+1; %<RACM2_Update_359>; <BAPI_162b>
Rnames{i} = 'APINO2a+APINO2Q2a=0.16 ONITa + 0.16 ONITQ2a + 1.68 ALD + 0.84 NO2 + 0.56 NOQ + 0.28 NQ2';
k(:,i) = 1.00E-14;
Gstr{i,1} = 'APINO2a'; Gstr{i,2} = 'APINO2Q2a'; 
fAPINO2a(i)=fAPINO2a(i)-1; fAPINO2Q2a(i)=fAPINO2Q2a(i)-1; fONITa(i)=fONITa(i)+0.16; fONITQ2a(i)=fONITQ2a(i)+0.16; fALD(i)=fALD(i)+1.68; fNO2(i)=fNO2(i)+0.84; fNOQ(i)=fNOQ(i)+0.56; fNQ2(i)=fNQ2(i)+0.28; 

%O3 Tracer
i=i+1; %<RACM2_Update_359>; <BAPI_162c>
Rnames{i} = 'APINO2a+APINO2Q3a=0.16 ONITa + 0.16 ONITQ3a + 1.68 ALD + 0.84 NO2 + 0.84 NQ2';
k(:,i) = 1.00E-14;
Gstr{i,1} = 'APINO2a'; Gstr{i,2} = 'APINO2Q3a'; 
fAPINO2a(i)=fAPINO2a(i)-1; fAPINO2Q3a(i)=fAPINO2Q3a(i)-1; fONITa(i)=fONITa(i)+0.16; fONITQ3a(i)=fONITQ3a(i)+0.16; fALD(i)=fALD(i)+1.68; fNO2(i)=fNO2(i)+0.84; fNQ2(i)=fNQ2(i)+0.84; 

%O3 Tracer
i=i+1; %<RACM2_Update_359>; <BAPI_162d>
Rnames{i} = 'APINO2Qa+APINO2Qa=0.32 ONITQa + 1.68 ALD + 0.56 NO2 + 1.12 NOQ';
k(:,i) = 1.00E-14;
Gstr{i,1} = 'APINO2Qa'; Gstr{i,2} = 'APINO2Qa'; 
fAPINO2Qa(i)=fAPINO2Qa(i)-1; fAPINO2Qa(i)=fAPINO2Qa(i)-1; fONITQa(i)=fONITQa(i)+0.32; fALD(i)=fALD(i)+1.68; fNO2(i)=fNO2(i)+0.56; fNOQ(i)=fNOQ(i)+1.12; 

%O3 Tracer
i=i+1; %<RACM2_Update_359>; <BAPI_162e>
Rnames{i} = 'APINO2Qa+APINO2Q2a=0.16 ONITQa + 0.16 ONITQ2a+ 1.68 ALD + 0.28 NO2 + 1.12 NOQ + 0.28 NQ2';
k(:,i) = 1.00E-14;
Gstr{i,1} = 'APINO2Qa'; Gstr{i,2} = 'APINO2Q2a'; 
fAPINO2Qa(i)=fAPINO2Qa(i)-1; fAPINO2Q2a(i)=fAPINO2Q2a(i)-1; fONITQa(i)=fONITQa(i)+0.16; fONITQ2a(i)=fONITQ2a(i)+0.16; fALD(i)=fALD(i)+1.68; fNO2(i)=fNO2(i)+0.28; fNOQ(i)=fNOQ(i)+1.12; fNQ2(i)=fNQ2(i)+0.28;

 
%O3 Tracer
i=i+1; %<RACM2_Update_359>; <BAPI_162f>
Rnames{i} = 'APINO2Qa+APINO2Q3a=0.16 ONITQa + 0.16 ONITQ3a+ 1.68 ALD + 0.28 NO2 + 0.56 NOQ + 0.84 NQ2';
k(:,i) = 1.00E-14;
Gstr{i,1} = 'APINO2Qa'; Gstr{i,2} = 'APINO2Q3a'; 
fAPINO2Qa(i)=fAPINO2Qa(i)-1; fAPINO2Q3a(i)=fAPINO2Q3a(i)-1; fONITQa(i)=fONITQa(i)+0.16; fONITQ3a(i)=fONITQ3a(i)+0.16; fALD(i)=fALD(i)+1.68; fNO2(i)=fNO2(i)+0.28; fNOQ(i)=fNOQ(i)+0.56; fNQ2(i)=fNQ2(i)+0.84;

 
%O3 Tracer
i=i+1; %<RACM2_Update_359>; <BAPI_162g>
Rnames{i} = 'APINO2Q2a+APINO2Q2a=0.16 ONITQ2a + 0.16 ONITQ2a+ 1.68 ALD + 1.12 NOQ + 0.56 NQ2';
k(:,i) = 1.00E-14;
Gstr{i,1} = 'APINO2Q2a'; Gstr{i,2} = 'APINO2Q2a'; 
fAPINO2Q2a(i)=fAPINO2Q2a(i)-1; fAPINO2Q2a(i)=fAPINO2Q2a(i)-1; fONITQ2a(i)=fONITQ2a(i)+0.16; fONITQ2a(i)=fONITQ2a(i)+0.16; fALD(i)=fALD(i)+1.68; fNOQ(i)=fNOQ(i)+1.12; fNQ2(i)=fNQ2(i)+0.56;

%O3 Tracer
i=i+1; %<RACM2_Update_359>; <BAPI_162h>
Rnames{i} = 'APINO2Q2a+APINO2Q3a=0.16 ONITQ2a + 0.16 ONITQ3a+ 1.68 ALD + 0.56 NOQ + 1.12 NQ2';
k(:,i) = 1.00E-14;
Gstr{i,1} = 'APINO2Q2a'; Gstr{i,2} = 'APINO2Q3a'; 
fAPINO2Q2a(i)=fAPINO2Q2a(i)-1; fAPINO2Q3a(i)=fAPINO2Q3a(i)-1; fONITQ2a(i)=fONITQ2a(i)+0.16; fONITQ3a(i)=fONITQ3a(i)+0.16; fALD(i)=fALD(i)+1.68; fNOQ(i)=fNOQ(i)+0.56; fNQ2(i)=fNQ2(i)+1.12;

%O3 Tracer
i=i+1; %<RACM2_Update_359>; <BAPI_162i>
Rnames{i} = 'APINO2Q3a+APINO2Q3a=0.16 ONITQ3a + 0.16 ONITQ3a+ 1.68 ALD + 1.68 NQ2';
k(:,i) = 1.00E-14;
Gstr{i,1} = 'APINO2Q3a'; Gstr{i,2} = 'APINO2Q3a'; 
fAPINO2Q3a(i)=fAPINO2Q3a(i)-1; fAPINO2Q3a(i)=fAPINO2Q3a(i)-1; fONITQ3a(i)=fONITQ3a(i)+0.16; fONITQ3a(i)=fONITQ3a(i)+0.16; fALD(i)=fALD(i)+1.68; fNQ2(i)=fNQ2(i)+1.68;


i=i+1; %<RACM2_Update_360>; <BAPI_163>
Rnames{i} = 'APINO2a+APINO2b=0.5 ONITb + 0.16 ONITa + 1.34 ALD + 1.34 NO2 ';
k(:,i) = 1E-14;
Gstr{i,1} = 'APINO2a'; Gstr{i,2} = 'APINO2b'; 
fAPINO2a(i)=fAPINO2a(i)-1; fAPINO2b(i)=fAPINO2b(i)-1; fONITb(i)=fONITb(i)+0.5; fONITa(i)=fONITa(i)+0.16;
fALD(i)=fALD(i)+1.34; fNO2(i)=fNO2(i)+1.340;

%O3 Tracer
i=i+1; %<RACM2_Update_360>; <BAPI_163a>
Rnames{i} = 'APINO2a+APINO2Qb= 0.16 ONITa +0.5 ONITQb + 1.34 ALD + 1.00666 NO2 + 0.333 NOQ ';
k(:,i) = 1E-14;
Gstr{i,1} = 'APINO2a'; Gstr{i,2} = 'APINO2Qb'; 
fAPINO2a(i)=fAPINO2a(i)-1; fAPINO2Qb(i)=fAPINO2Qb(i)-1; fONITa(i)=fONITa(i)+0.16; fONITQb(i)=fONITQb(i)+0.5;
fALD(i)=fALD(i)+1.34; fNO2(i)=fNO2(i)+1.00666; fNOQ(i)=fNOQ(i)+0.333;

%O3 Tracer
i=i+1; %<RACM2_Update_360>; <BAPI_163b>
Rnames{i} = 'APINO2a+APINO2Q2b= 0.16 ONITa +0.5 ONITQ2b + 1.34 ALD + 0.84 NO2 + 0.333 NOQ + 0.1666 NQ2 ';
k(:,i) = 1E-14;
Gstr{i,1} = 'APINO2a'; Gstr{i,2} = 'APINO2Q2b'; 
fAPINO2a(i)=fAPINO2a(i)-1; fAPINO2Q2b(i)=fAPINO2Q2b(i)-1; fONITa(i)=fONITa(i)+0.16; fONITQ2b(i)=fONITQ2b(i)+0.5;
fALD(i)=fALD(i)+1.34; fNO2(i)=fNO2(i)+0.84; fNOQ(i)=fNOQ(i)+0.333; fNQ2(i)=fNQ2(i)+0.1666;

%O3 Tracer
i=i+1; %<RACM2_Update_360>; <BAPI_163c>
Rnames{i} = 'APINO2a+APINO2Q3b= 0.16 ONITa +0.5 ONITQ3b + 1.34 ALD + 0.84 NO2  + 0.5 NQ2 ';
k(:,i) = 1E-14;
Gstr{i,1} = 'APINO2a'; Gstr{i,2} = 'APINO2Q3b'; 
fAPINO2a(i)=fAPINO2a(i)-1; fAPINO2Q3b(i)=fAPINO2Q3b(i)-1; fONITa(i)=fONITa(i)+0.16; fONITQ3b(i)=fONITQ3b(i)+0.5;
fALD(i)=fALD(i)+1.34; fNO2(i)=fNO2(i)+0.84; fNQ2(i)=fNQ2(i)+0.5;

%O3 Tracer
i=i+1; %<RACM2_Update_360>; <BAPI_163d>
Rnames{i} = 'APINO2Qa+APINO2b= 0.16 ONITQa +0.5 ONITb + 1.34 ALD + 0.78 NO2  + 0.56 NOQ ';
k(:,i) = 1E-14;
Gstr{i,1} = 'APINO2Qa'; Gstr{i,2} = 'APINO2b'; 
fAPINO2Qa(i)=fAPINO2Qa(i)-1; fAPINO2b(i)=fAPINO2b(i)-1; fONITQa(i)=fONITQa(i)+0.16; fONITb(i)=fONITb(i)+0.5;
fALD(i)=fALD(i)+1.34; fNO2(i)=fNO2(i)+0.78; fNOQ(i)=fNOQ(i)+0.56;

%O3 Tracer
i=i+1; %<RACM2_Update_360>; <BAPI_163e>
Rnames{i} = 'APINO2Qa+APINO2Qb= 0.16 ONITQa +0.5 ONITQb + 1.34 ALD + 0.44666 NO2  + 0.89333 NOQ ';
k(:,i) = 1E-14;
Gstr{i,1} = 'APINO2Qa'; Gstr{i,2} = 'APINO2Qb'; 
fAPINO2Qa(i)=fAPINO2Qa(i)-1; fAPINO2Qb(i)=fAPINO2Qb(i)-1; fONITQa(i)=fONITQa(i)+0.16; fONITQb(i)=fONITQb(i)+0.5;
fALD(i)=fALD(i)+1.34; fNO2(i)=fNO2(i)+0.44666; fNOQ(i)=fNOQ(i)+0.89333;

%O3 Tracer
i=i+1; %<RACM2_Update_360>; <BAPI_163f>
Rnames{i} = 'APINO2Qa+APINO2Q2b= 0.16 ONITQa +0.5 ONITQ2b + 1.34 ALD + 0.28 NO2  + 0.89333 NOQ + 0.1666 NQ2 ';
k(:,i) = 1E-14;
Gstr{i,1} = 'APINO2Qa'; Gstr{i,2} = 'APINO2Q2b'; 
fAPINO2Qa(i)=fAPINO2Qa(i)-1; fAPINO2Q2b(i)=fAPINO2Q2b(i)-1; fONITQa(i)=fONITQa(i)+0.16; fONITQ2b(i)=fONITQ2b(i)+0.5;
fALD(i)=fALD(i)+1.34; fNO2(i)=fNO2(i)+0.28; fNOQ(i)=fNOQ(i)+0.89333; fNQ2(i)=fNQ2(i)+0.16666;

%O3 Tracer
i=i+1; %<RACM2_Update_360>; <BAPI_163g>
Rnames{i} = 'APINO2Qa+APINO2Q3b= 0.16 ONITQa +0.5 ONITQ3b + 1.34 ALD + 0.28 NO2  + 0.56 NOQ + 0.50 NQ2 ';
k(:,i) = 1E-14;
Gstr{i,1} = 'APINO2Qa'; Gstr{i,2} = 'APINO2Q3b'; 
fAPINO2Qa(i)=fAPINO2Qa(i)-1; fAPINO2Q3b(i)=fAPINO2Q3b(i)-1; fONITQa(i)=fONITQa(i)+0.16; fONITQ3b(i)=fONITQ3b(i)+0.5;
fALD(i)=fALD(i)+1.34; fNO2(i)=fNO2(i)+0.28; fNOQ(i)=fNOQ(i)+0.56; fNQ2(i)=fNQ2(i)+0.5;

%O3 Tracer
i=i+1; %<RACM2_Update_360>; <BAPI_163h>
Rnames{i} = 'APINO2Q2a+APINO2b= 0.16 ONITQ2a +0.5 ONITb + 1.34 ALD + 0.5 NO2  + 0.56 NOQ + 0.28 NQ2 ';
k(:,i) = 1E-14;
Gstr{i,1} = 'APINO2Q2a'; Gstr{i,2} = 'APINO2b'; 
fAPINO2Q2a(i)=fAPINO2Q2a(i)-1; fAPINO2b(i)=fAPINO2b(i)-1; fONITQ2a(i)=fONITQ2a(i)+0.16; fONITb(i)=fONITb(i)+0.5;
fALD(i)=fALD(i)+1.34; fNO2(i)=fNO2(i)+0.5; fNOQ(i)=fNOQ(i)+0.56; fNQ2(i)=fNQ2(i)+0.28;

%O3 Tracer
i=i+1; %<RACM2_Update_360>; <BAPI_163i>
Rnames{i} = 'APINO2Q2a+APINO2Qb= 0.16 ONITQ2a +0.5 ONITQb + 1.34 ALD + 0.1666 NO2  + 0.89333 NOQ + 0.28 NQ2 ';
k(:,i) = 1E-14;
Gstr{i,1} = 'APINO2Q2a'; Gstr{i,2} = 'APINO2Qb'; 
fAPINO2Q2a(i)=fAPINO2Q2a(i)-1; fAPINO2Qb(i)=fAPINO2Qb(i)-1; fONITQ2a(i)=fONITQ2a(i)+0.16; fONITQb(i)=fONITQb(i)+0.5;
fALD(i)=fALD(i)+1.34; fNO2(i)=fNO2(i)+0.1666; fNOQ(i)=fNOQ(i)+0.89333; fNQ2(i)=fNQ2(i)+0.28;

%O3 Tracer
i=i+1; %<RACM2_Update_360>; <BAPI_163j>
Rnames{i} = 'APINO2Q2a+APINO2Q2b= 0.16 ONITQ2a +0.5 ONITQ2b + 1.34 ALD + 0.89333 NOQ + 0.44666 NQ2 ';
k(:,i) = 1E-14;
Gstr{i,1} = 'APINO2Q2a'; Gstr{i,2} = 'APINO2Q2b'; 
fAPINO2Q2a(i)=fAPINO2Q2a(i)-1; fAPINO2Q2b(i)=fAPINO2Q2b(i)-1; fONITQ2a(i)=fONITQ2a(i)+0.16; fONITQ2b(i)=fONITQ2b(i)+0.5;
fALD(i)=fALD(i)+1.34; fNOQ(i)=fNOQ(i)+0.89333; fNQ2(i)=fNQ2(i)+0.44666;

%O3 Tracer
i=i+1; %<RACM2_Update_360>; <BAPI_163k>
Rnames{i} = 'APINO2Q2a+APINO2Q3b= 0.16 ONITQ2a +0.5 ONITQ3b + 1.34 ALD + 0.56 NOQ + 0.78 NQ2 ';
k(:,i) = 1E-14;
Gstr{i,1} = 'APINO2Q2a'; Gstr{i,2} = 'APINO2Q3b'; 
fAPINO2Q2a(i)=fAPINO2Q2a(i)-1; fAPINO2Q3b(i)=fAPINO2Q3b(i)-1; fONITQ2a(i)=fONITQ2a(i)+0.16; fONITQ3b(i)=fONITQ3b(i)+0.5;
fALD(i)=fALD(i)+1.34; fNOQ(i)=fNOQ(i)+0.56; fNQ2(i)=fNQ2(i)+0.78;

%O3 Tracer
i=i+1; %<RACM2_Update_360>; <BAPI_163l>
Rnames{i} = 'APINO2Q3a+APINO2b= 0.16 ONITQ3a +0.5 ONITb + 1.34 ALD + 0.5 NO2 + 0.84 NQ2 ';
k(:,i) = 1E-14;
Gstr{i,1} = 'APINO2Q3a'; Gstr{i,2} = 'APINO2b'; 
fAPINO2Q3a(i)=fAPINO2Q3a(i)-1; fAPINO2b(i)=fAPINO2b(i)-1; fONITQ3a(i)=fONITQ3a(i)+0.16; fONITb(i)=fONITb(i)+0.5;
fALD(i)=fALD(i)+1.34; fNO2(i)=fNO2(i)+0.5; fNQ2(i)=fNQ2(i)+0.84;

%O3 Tracer
i=i+1; %<RACM2_Update_360>; <BAPI_163m>
Rnames{i} = 'APINO2Q3a+APINO2Qb= 0.16 ONITQ3a +0.5 ONITQb + 1.34 ALD + 0.1666 NO2 + 0.3333 NOQ +  0.84 NQ2 ';
k(:,i) = 1E-14;
Gstr{i,1} = 'APINO2Q3a'; Gstr{i,2} = 'APINO2Qb'; 
fAPINO2Q3a(i)=fAPINO2Q3a(i)-1; fAPINO2Qb(i)=fAPINO2Qb(i)-1; fONITQ3a(i)=fONITQ3a(i)+0.16; fONITQb(i)=fONITQb(i)+0.5;
fALD(i)=fALD(i)+1.34; fNO2(i)=fNO2(i)+0.1666; fNOQ(i)=fNOQ(i)+0.3333; fNQ2(i)=fNQ2(i)+0.84;

%O3 Tracer
i=i+1; %<RACM2_Update_360>; <BAPI_163n>
Rnames{i} = 'APINO2Q3a+APINO2Q2b= 0.16 ONITQ3a +0.5 ONITQ2b + 1.34 ALD + 0.3333 NOQ +  1.00666 NQ2 ';
k(:,i) = 1E-14;
Gstr{i,1} = 'APINO2Q3a'; Gstr{i,2} = 'APINO2Q2b'; 
fAPINO2Q3a(i)=fAPINO2Q3a(i)-1; fAPINO2Q2b(i)=fAPINO2Q2b(i)-1; fONITQ3a(i)=fONITQ3a(i)+0.16; fONITQ2b(i)=fONITQ2b(i)+0.5;
fALD(i)=fALD(i)+1.34; fNOQ(i)=fNOQ(i)+0.3333; fNQ2(i)=fNQ2(i)+1.00666;

%O3 Tracer
i=i+1; %<RACM2_Update_360>; <BAPI_163o>
Rnames{i} = 'APINO2Q3a+APINO2Q3b= 0.16 ONITQ3a +0.5 ONITQ3b + 1.34 ALD +  1.34 NQ2 ';
k(:,i) = 1E-14;
Gstr{i,1} = 'APINO2Q3a'; Gstr{i,2} = 'APINO2Q3b'; 
fAPINO2Q3a(i)=fAPINO2Q3a(i)-1; fAPINO2Q3b(i)=fAPINO2Q3b(i)-1; fONITQ3a(i)=fONITQ3a(i)+0.16; fONITQ3b(i)=fONITQ3b(i)+0.5;
fALD(i)=fALD(i)+1.34; fNQ2(i)=fNQ2(i)+1.34;


i=i+1; %<RACM2_Update_361>; <BAPI_164>
Rnames{i} ='APINO2b+APINO2b= ONITb + 1.0 ALD + 1.0 NO2 ';
k(:,i) = 1.00E-14;
Gstr{i,1} = 'APINO2b'; Gstr{i,2} = 'APINO2b'; 
fAPINO2b(i)=fAPINO2b(i)-1; fAPINO2b(i)=fAPINO2b(i)-1; fONITb(i)=fONITb(i)+1; fALD(i)=fALD(i)+1;
fNO2(i)=fNO2(i)+1;

%O3 Tracer
i=i+1; %<RACM2_Update_361>; <BAPI_164a>
Rnames{i} ='APINO2b+APINO2Qb= 0.5 ONITb + 0.5 ONITQb + 1.0 ALD + (2/3) NO2 + (1/3) NOQ ';
k(:,i) = 1.00E-14;
Gstr{i,1} = 'APINO2b'; Gstr{i,2} = 'APINO2Qb'; 
fAPINO2b(i)=fAPINO2b(i)-1; fAPINO2Qb(i)=fAPINO2Qb(i)-1; fONITb(i)=fONITb(i)+0.5; fONITQb(i)=fONITQb(i)+0.5; fALD(i)=fALD(i)+1; fNO2(i)=fNO2(i)+(2/3); fNOQ(i)=fNOQ(i)+(1/3);

%O3 Tracer
i=i+1; %<RACM2_Update_361>; <BAPI_164b>
Rnames{i} ='APINO2b+APINO2Q2b= 0.5 ONITb + 0.5 ONITQ2b + 1.0 ALD + 0.5 NO2 + (1/3) NOQ + (1/6) NQ2';
k(:,i) = 1.00E-14;
Gstr{i,1} = 'APINO2b'; Gstr{i,2} = 'APINO2Q2b'; 
fAPINO2b(i)=fAPINO2b(i)-1; fAPINO2Q2b(i)=fAPINO2Q2b(i)-1; fONITb(i)=fONITb(i)+0.5; fONITQ2b(i)=fONITQ2b(i)+0.5; fALD(i)=fALD(i)+1; fNO2(i)=fNO2(i)+(0.5); fNOQ(i)=fNOQ(i)+(1/3); fNQ2(i)=fNQ2(i)+(1/6);

%O3 Tracer
i=i+1; %<RACM2_Update_361>; <BAPI_164c>
Rnames{i} ='APINO2b+APINO2Q3b= 0.5 ONITb + 0.5 ONITQ3b + 1.0 ALD + 0.5 NO2 + 0.5 NQ2';
k(:,i) = 1.00E-14;
Gstr{i,1} = 'APINO2b'; Gstr{i,2} = 'APINO2Q3b'; 
fAPINO2b(i)=fAPINO2b(i)-1; fAPINO2Q3b(i)=fAPINO2Q3b(i)-1; fONITb(i)=fONITb(i)+0.5; fONITQ3b(i)=fONITQ3b(i)+0.5; fALD(i)=fALD(i)+1; fNO2(i)=fNO2(i)+(0.5); fNQ2(i)=fNQ2(i)+0.5;

%O3 Tracer
i=i+1; %<RACM2_Update_361>; <BAPI_164d>
Rnames{i} ='APINO2Qb+APINO2Qb= 0.5 ONITQb + 0.5 ONITQb + 1.0 ALD + (1/3) NO2 + (2/3) NOQ';
k(:,i) = 1.00E-14;
Gstr{i,1} = 'APINO2Qb'; Gstr{i,2} = 'APINO2Qb'; 
fAPINO2Qb(i)=fAPINO2Qb(i)-1; fAPINO2Qb(i)=fAPINO2Qb(i)-1; fONITQb(i)=fONITQb(i)+0.5; fONITQb(i)=fONITQb(i)+0.5; fALD(i)=fALD(i)+1; fNO2(i)=fNO2(i)+(1/3); fNOQ(i)=fNOQ(i)+(2/3);

%O3 Tracer
i=i+1; %<RACM2_Update_361>; <BAPI_164e>
Rnames{i} ='APINO2Qb+APINO2Q2b= 0.5 ONITQb + 0.5 ONITQ2b + 1.0 ALD + (1/6) NO2 + (2/3) NOQ + (1/6) NQ2';
k(:,i) = 1.00E-14;
Gstr{i,1} = 'APINO2Qb'; Gstr{i,2} = 'APINO2Q2b'; 
fAPINO2Qb(i)=fAPINO2Qb(i)-1; fAPINO2Q2b(i)=fAPINO2Q2b(i)-1; fONITQb(i)=fONITQb(i)+0.5; fONITQ2b(i)=fONITQ2b(i)+0.5; fALD(i)=fALD(i)+1; fNO2(i)=fNO2(i)+(1/6); fNOQ(i)=fNOQ(i)+(2/3); fNQ2(i)=fNQ2(i)+(1/6);

%O3 Tracer
i=i+1; %<RACM2_Update_361>; <BAPI_164f>
Rnames{i} ='APINO2Qb+APINO2Q3b= 0.5 ONITQb + 0.5 ONITQ3b + 1.0 ALD + (1/6) NO2 + (1/3) NOQ + (1/2) NQ2';
k(:,i) = 1.00E-14;
Gstr{i,1} = 'APINO2Qb'; Gstr{i,2} = 'APINO2Q3b'; 
fAPINO2Qb(i)=fAPINO2Qb(i)-1; fAPINO2Q3b(i)=fAPINO2Q3b(i)-1; fONITQb(i)=fONITQb(i)+0.5; fONITQ3b(i)=fONITQ3b(i)+0.5; fALD(i)=fALD(i)+1; fNO2(i)=fNO2(i)+(1/6); fNOQ(i)=fNOQ(i)+(1/3); fNQ2(i)=fNQ2(i)+(1/2);

%O3 Tracer
i=i+1; %<RACM2_Update_361>; <BAPI_164g>
Rnames{i} ='APINO2Q2b+APINO2Q2b= 0.5 ONITQ2b + 0.5 ONITQ2b + 1.0 ALD + (2/3) NOQ + (1/3) NQ2';
k(:,i) = 1.00E-14;
Gstr{i,1} = 'APINO2Q2b'; Gstr{i,2} = 'APINO2Q2b'; 
fAPINO2Q2b(i)=fAPINO2Q2b(i)-1; fAPINO2Q2b(i)=fAPINO2Q2b(i)-1; fONITQ2b(i)=fONITQ2b(i)+0.5; fONITQ2b(i)=fONITQ2b(i)+0.5; fALD(i)=fALD(i)+1; fNOQ(i)=fNOQ(i)+(2/3); fNQ2(i)=fNQ2(i)+(1/3);


%O3 Tracer
i=i+1; %<RACM2_Update_361>; <BAPI_164h>
Rnames{i} ='APINO2Q2b+APINO2Q3b= 0.5 ONITQ2b + 0.5 ONITQ3b + 1.0 ALD + (1/3) NOQ + (2/3) NQ2';
k(:,i) = 1.00E-14;
Gstr{i,1} = 'APINO2Q2b'; Gstr{i,2} = 'APINO2Q3b'; 
fAPINO2Q2b(i)=fAPINO2Q2b(i)-1; fAPINO2Q3b(i)=fAPINO2Q3b(i)-1; fONITQ2b(i)=fONITQ2b(i)+0.5; fONITQ3b(i)=fONITQ3b(i)+0.5; fALD(i)=fALD(i)+1; fNOQ(i)=fNOQ(i)+(1/3); fNQ2(i)=fNQ2(i)+(2/3);

%O3 Tracer
i=i+1; %<RACM2_Update_361>; <BAPI_164i>
Rnames{i} ='APINO2Q3b+APINO2Q3b= 0.5 ONITQ3b + 0.5 ONITQ3b + 1.0 ALD + 1 NQ2';
k(:,i) = 1.00E-14;
Gstr{i,1} = 'APINO2Q3b'; Gstr{i,2} = 'APINO2Q3b'; 
fAPINO2Q3b(i)=fAPINO2Q3b(i)-1; fAPINO2Q3b(i)=fAPINO2Q3b(i)-1; fONITQ3b(i)=fONITQ3b(i)+0.5; fONITQ3b(i)=fONITQ3b(i)+0.5; fALD(i)=fALD(i)+1; fNQ2(i)=fNQ2(i)+1;
...
Rnames{i} ='APINO2Qa+APIO2a= 0.32 ONITQa + 1.68 ALD + 0.28 NO2 + 0.56 NOQ + 0.84 HO2';
k(:,i) = 1E-14;
Gstr{i,1} = 'APINO2Qa'; Gstr{i,2} = 'APIO2a'; 
fAPINO2Qa(i)=fAPINO2Qa(i)-1; fAPIO2a(i)=fAPIO2a(i)-1; fONITQa(i)=fONITQa(i)+0.32; fALD(i)=fALD(i)+1.68;
fNO2(i)=fNO2(i)+0.28; fNOQ(i)=fNOQ(i)+0.56;

%O3 Tracer
i=i+1; %<RACM2_Update>; <BAPI_Xb>
Rnames{i} ='APINO2Q2a+APIO2a= 0.32 ONITQ2a + 1.68 ALD + 0.56 NOQ + 0.28 NQ2 + 0.84 HO2';
k(:,i) = 1E-14;
Gstr{i,1} = 'APINO2Q2a'; Gstr{i,2} = 'APIO2a'; 
fAPINO2Q2a(i)=fAPINO2Q2a(i)-1; fAPIO2a(i)=fAPIO2a(i)-1; fONITQ2a(i)=fONITQ2a(i)+0.32; fALD(i)=fALD(i)+1.68;
fNOQ(i)=fNOQ(i)+0.56; fNQ2(i)=fNQ2(i)+0.28;

%O3 Tracer
i=i+1; %<RACM2_Update>; <BAPI_Xc>
Rnames{i} ='APINO2Q3a+APIO2a= 0.32 ONITQ3a + 1.68 ALD + 0.84 NQ2 + 0.84 HO2';
k(:,i) = 1E-14;
Gstr{i,1} = 'APINO2Q3a'; Gstr{i,2} = 'APIO2a'; 
fAPINO2Q3a(i)=fAPINO2Q3a(i)-1; fAPIO2a(i)=fAPIO2a(i)-1; fONITQ3a(i)=fONITQ3a(i)+0.32; fALD(i)=fALD(i)+1.68;
fNQ2(i)=fNQ2(i)+0.84;
...
Rnames{i} ='APINO2Qb+APIO2a= 0.32 ONITQb + 1.68 ALD + 0.28 NO2 + 0.56 NOQ + 0.84 HO2';
k(:,i) = 1E-14;
Gstr{i,1} = 'APINO2Qb'; Gstr{i,2} = 'APIO2a'; 
fAPINO2Qb(i)=fAPINO2Qb(i)-1; fAPIO2a(i)=fAPIO2a(i)-1; fONITQb(i)=fONITQb(i)+0.32; fALD(i)=fALD(i)+1.68;
fNO2(i)=fNO2(i)+0.28; fNOQ(i)=fNOQ(i)+0.56;

%O3 Tracer
i=i+1; %<RACM2_Update>; <BAPI_Xf>
Rnames{i} ='APINO2Q2b+APIO2a= 0.32 ONITQ2b + 1.68 ALD + 0.56 NOQ + 0.28 NQ2 + 0.84 HO2';
k(:,i) = 1E-14;
Gstr{i,1} = 'APINO2Q2b'; Gstr{i,2} = 'APIO2a'; 
fAPINO2Q2b(i)=fAPINO2Q2b(i)-1; fAPIO2a(i)=fAPIO2a(i)-1; fONITQ2b(i)=fONITQ2b(i)+0.32; fALD(i)=fALD(i)+1.68;
fNOQ(i)=fNOQ(i)+0.56; fNQ2(i)=fNQ2(i)+0.28;

%O3 Tracer
i=i+1; %<RACM2_Update>; <BAPI_Xg>
Rnames{i} ='APINO2Q3b+APIO2a= 0.32 ONITQ3b + 1.68 ALD + 0.84 NQ2 + 0.84 HO2';
k(:,i) = 1E-14;
Gstr{i,1} = 'APINO2Q3b'; Gstr{i,2} = 'APIO2a'; 
fAPINO2Q3b(i)=fAPINO2Q3b(i)-1; fAPIO2a(i)=fAPIO2a(i)-1; fONITQ3b(i)=fONITQ3b(i)+0.32; fALD(i)=fALD(i)+1.68;
fNQ2(i)=fNQ2(i)+0.84;
...
%O3 Tracer
i=i+1; %<RACM2_Update>; <BAPI_Xa>
Rnames{i} ='APINO2Qa+APIO2b= 0.32 ONITQa + 1.68 ALD + 0.28 NO2 + 0.56 NOQ + 0.84 HO2';
k(:,i) = 1E-14;
Gstr{i,1} = 'APINO2Qa'; Gstr{i,2} = 'APIO2b'; 
fAPINO2Qa(i)=fAPINO2Qa(i)-1; fAPIO2b(i)=fAPIO2b(i)-1; fONITQa(i)=fONITQa(i)+0.32; fALD(i)=fALD(i)+1.68;
fNO2(i)=fNO2(i)+0.28; fNOQ(i)=fNOQ(i)+0.56;
 
%O3 Tracer
i=i+1; %<RACM2_Update>; <BAPI_Xb>
Rnames{i} ='APINO2Q2a+APIO2b= 0.32 ONITQ2a + 1.68 ALD + 0.56 NOQ + 0.28 NQ2 + 0.84 HO2';
k(:,i) = 1E-14;
Gstr{i,1} = 'APINO2Q2a'; Gstr{i,2} = 'APIO2b'; 
fAPINO2Q2a(i)=fAPINO2Q2a(i)-1; fAPIO2b(i)=fAPIO2b(i)-1; fONITQ2a(i)=fONITQ2a(i)+0.32; fALD(i)=fALD(i)+1.68;
fNOQ(i)=fNOQ(i)+0.56; fNQ2(i)=fNQ2(i)+0.28;
 
%O3 Tracer
i=i+1; %<RACM2_Update>; <BAPI_Xc>
Rnames{i} ='APINO2Q3a+APIO2b= 0.32 ONITQ3a + 1.68 ALD + 0.84 NQ2 + 0.84 HO2';
k(:,i) = 1E-14;
Gstr{i,1} = 'APINO2Q3a'; Gstr{i,2} = 'APIO2b'; 
fAPINO2Q3a(i)=fAPINO2Q3a(i)-1; fAPIO2b(i)=fAPIO2b(i)-1; fONITQ3a(i)=fONITQ3a(i)+0.32; fALD(i)=fALD(i)+1.68;
fNQ2(i)=fNQ2(i)+0.84;
...
%O3 Tracer
i=i+1; %<RACM2_Update>; <BAPI_Xe>
Rnames{i} ='APINO2Qb+APIO2b= 0.32 ONITQb + 1.68 ALD + 0.28 NO2 + 0.56 NOQ + 0.84 HO2';
k(:,i) = 1E-14;
Gstr{i,1} = 'APINO2Qb'; Gstr{i,2} = 'APIO2b'; 
fAPINO2Qb(i)=fAPINO2Qb(i)-1; fAPIO2b(i)=fAPIO2b(i)-1; fONITQb(i)=fONITQb(i)+0.32; fALD(i)=fALD(i)+1.68;
fNO2(i)=fNO2(i)+0.28; fNOQ(i)=fNOQ(i)+0.56;
 
%O3 Tracer
i=i+1; %<RACM2_Update>; <BAPI_Xf>
Rnames{i} ='APINO2Q2b+APIO2b= 0.32 ONITQ2b + 1.68 ALD + 0.56 NOQ + 0.28 NQ2 + 0.84 HO2';
k(:,i) = 1E-14;
Gstr{i,1} = 'APINO2Q2b'; Gstr{i,2} = 'APIO2b'; 
fAPINO2Q2b(i)=fAPINO2Q2b(i)-1; fAPIO2b(i)=fAPIO2b(i)-1; fONITQ2b(i)=fONITQ2b(i)+0.32; fALD(i)=fALD(i)+1.68;
fNOQ(i)=fNOQ(i)+0.56; fNQ2(i)=fNQ2(i)+0.28;
 
%O3 Tracer
i=i+1; %<RACM2_Update>; <BAPI_Xg>
Rnames{i} ='APINO2Q3b+APIO2b= 0.32 ONITQ3b + 1.68 ALD + 0.84 NQ2 + 0.84 HO2';
k(:,i) = 1E-14;
Gstr{i,1} = 'APINO2Q3b'; Gstr{i,2} = 'APIO2b'; 
fAPINO2Q3b(i)=fAPINO2Q3b(i)-1; fAPIO2b(i)=fAPIO2b(i)-1; fONITQ3b(i)=fONITQ3b(i)+0.32; fALD(i)=fALD(i)+1.68;
fNQ2(i)=fNQ2(i)+0.84;
