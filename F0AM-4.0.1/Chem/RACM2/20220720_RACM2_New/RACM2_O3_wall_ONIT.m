...
i=i+1; %R146
Rnames{i} = 'API+NO3=0.10TOLNN+0.90 TOLND';
k(:,i) = 1.19E-12.*exp(490./T);
Gstr{i,1} = 'API'; Gstr{i,2} = 'NO3'; 
fAPI(i)=fAPI(i)-1; fNO3(i)=fNO3(i)-1; fTOLNN(i)=fTOLNN(i)+0.1;  fTOLND(i)=fTOLND(i)+0.9; 
...
i=i+1; %R189
Rnames{i} = 'APIP+NO= HO2+NO2+HCHO+ALD+ACT+KET+ORA1+TONIT+0.06UTONIT';
k(:,i) = 4.00E-12;
...
fORA1(i)=fORA1(i)+0.07; fTONIT(i)=fTONIT(i)+0.12; fUTONIT(i)=fUTNIT(i)+0.06;
...
i=i+1;  %R205
Rnames{i} = 'TOLNN+NO=TONIT+NO2+HO2';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'TOLNN'; Gstr{i,2} = 'NO'; 
fOLNN(i)=fOLNN(i)-1; fNO(i)=fNO(i)-1; fTONIT(i)=fTONIT(i)+1; fNO2(i)=fNO2(i)+1; fHO2(i)=fHO2(i)+1; 
...
i=i+1; %R244
Rnames{i} = 'TOLNN+HO2=0.7TONIT+0.3UTONIT';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'TOLNN'; Gstr{i,2} = 'HO2'; 
fTOLNN(i)=fTOLNN(i)-1; fHO2(i)=fHO2(i)-1; fTONIT(i)=fTONIT(i)+0.7; fUTONIT(i)=fUTONIT(i)+0.3; 
...
i=i+1; %R281
Rnames{i} = 'TOLNN+MO2=HCHO+HO2+HO2+TONIT+UONIT';
k(:,i) = 1.60E-13.*exp(708./T);
Gstr{i,1} = 'TOLNN'; Gstr{i,2} = 'MO2'; 
fTOLNN(i)=fTOLNN(i)-1; fMO2(i)=fMO2(i)-1; fHCHO(i)=fHCHO(i)+1; fHO2(i)=fHO2(i)+1; fHO2(i)=fHO2(i)+1; fTONIT(i)=fTONIT(i)+0.7; fUTONIT(i)=fUTONIT(i)+0.3; 
...
i=i+1; %R317
Rnames{i} = 'TOLNN+ACO3=TONIT+UTONIT+MO2+HO2';
k(:,i) = 8.85E-13.*exp(765./T);
Gstr{i,1} = 'TOLNN'; Gstr{i,2} = 'ACO3'; 
fTOLNN(i)=fTOLNN(i)-1; fACO3(i)=fACO3(i)-1; fTONIT(i)=fTONIT(i)+0.7; fUTONIT(i)=fUTONIT(i)+0.3; fMO2(i)=fMO2(i)+1; fHO2(i)=fHO2(i)+1; 
...
i=i+1; %R354
Rnames{i} = 'TOLNN+NO3=TONIT+UTONIT+NO2+HO2';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'TOLNN'; Gstr{i,2} = 'NO3'; 
fTOLNN(i)=fTOLNN(i)-1; fNO3(i)=fNO3(i)-1; fTONIT(i)=fTONIT(i)+0.7; fUTONIT(i)=fUTONIT(i)+0.3; fNO2(i)=fNO2(i)+1; fHO2(i)=fHO2(i)+1; 
...
i=i+1; %R359
Rnames{i} = 'TOLNN+TOLNN=TONIT+UTONIT+HO2';
k(:,i) = 7.00E-14.*exp(1000./T);
Gstr{i,1} = 'TOLNN'; Gstr{i,2} = 'TOLNN'; 
fTOLNN(i)=fTOLNN(i)-1; fTOLNN(i)=fTOLNN(i)-1; fTONIT(i)=fTONIT(i)+1.4; fUTONIT(i)=fUTONIT(i)+0.6; fHO2(i)=fHO2(i)+1; 
...
i=i+1; %R360
Rnames{i} = 'TOLNN+TOLND=0.50 HO2+0.50 NO2+0.202 HCHO+0.640 ALD+0.149 KET+0.7 TONIT+0.3 UTONIT+0.5MONIT ';
k(:,i) = 4.25E-14.*exp(1000./T);
Gstr{i,1} = 'TOLNN'; Gstr{i,2} = 'TOLND'; 
fTOLNN(i)=fTOLNN(i)-1; fTOLND(i)=fTOLND(i)-1; fHO2(i)=fHO2(i)+0.5; fNO2(i)=fNO2(i)+0.5;
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fTONIT(i)=fTONIT(i)+0.7; fUTONIT(i)=fUTONIT(i)+0.3; fMONIT(i)=fMONIT(i)+0.5; 
...
i=i+1; %R361
Rnames{i} = 'TOLND+TOLND=NO2+0.504 HCHO+1.21 ALD+0.285 KET+ONIT ';
