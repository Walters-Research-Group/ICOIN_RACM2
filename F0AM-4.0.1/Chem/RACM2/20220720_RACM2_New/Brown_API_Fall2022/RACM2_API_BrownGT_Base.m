...
k(:,i) =4.67E-3 ;
Gstr{i,1} = 'ONIT'; 
fONIT(i)=fONIT(i)-1; fpONIT(i)=fpONIT(i)+1; 

i=i+1; %<HET_05>
Rnames{i} = 'pONIT=ROH + HNO3';
k(:,i) =2.78E-4 ;
Gstr{i,1} = 'pONIT'; 
fpONIT(i)=fpONIT(i)-1; fROH(i)=fROH(i)+1; fHNO3(i)=fHNO3(i)+1; 
...
k(:,i) =  1.0E-20*H2O;
Gstr{i,1} = N2O5'; 
fN2O5(i)=fN2O5(i)-1; fwHNO3(i)=fwHNO3
(i)+2; 
...
i=i+1; %<Wall_09>
Rnames{i} = 'pONIT=wONIT';
k(:,i) =  8.8E-6;
Gstr{i,1} = 'pONIT'; 
fpONIT(i)=fpONIT(i)-1; fwONIT(i)=fwONIT(i)+1; 
