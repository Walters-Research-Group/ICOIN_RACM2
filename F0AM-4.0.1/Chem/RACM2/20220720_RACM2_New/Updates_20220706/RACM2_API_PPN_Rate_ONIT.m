...
Rnames{i} = 'HC3P+NO=HO2+MO2+ETHP+XO2+NO2+ACD+ALD+ACT+MEK+ONIT+MONITSC';
k(:,i) = 4.00E-12;
...
Rnames{i} = 'KETP+NO= HO2+ACO3+XO2+NO2+MGLY+ALD+MONITUC';
k(:,i) = 4.00E-12;
...
Rnames{i} = 'OLNN+NO=MONITSN+NO2+HO2';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'OLNN'; Gstr{i,2} = 'NO'; 
fOLNN(i)=fOLNN(i)-1; fNO(i)=fNO(i)-1; fMONITSN(i)=fMONITSN(i)+1; fNO2(i)=fNO2(i)+1; fHO2(i)=fHO2(i)+1; 
...
Rnames{i} = 'OLNN+HO2=0.7MONITSN+0.3MONITUN';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'OLNN'; Gstr{i,2} = 'HO2'; 
fOLNN(i)=fOLNN(i)-1; fHO2(i)=fHO2(i)-1; fMONITSN(i)=fMONITSN(i)+0.7; fMONITUN(i)=fMONITUN(i)+0.3;

i=i+1; %<RACM2_245>; <BAPI_121>; wwalters ONIT Expansion
Rnames{i} = 'OLND+HO2=0.7MONITSN+0.3MONITUN';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'OLND'; Gstr{i,2} = 'HO2'; 
fOLND(i)=fOLND(i)-1; fHO2(i)=fHO2(i)-1; fMONITSN(i)=fMONITSN(i)+0.7; fMONITUN(i)=fMONITUN(i)+0.3;
...
Rnames{i} = 'OLNN+MO2=HCHO+HO2+HO2+0.7MONITSN+0.3MONITUN';
k(:,i) = 1.60E-13.*exp(708./T);
Gstr{i,1} = 'OLNN'; Gstr{i,2} = 'MO2'; 
fOLNN(i)=fOLNN(i)-1; fMO2(i)=fMO2(i)-1; fHCHO(i)=fHCHO(i)+1; fHO2(i)=fHO2(i)+1; fHO2(i)=fHO2(i)+1; fMONITSN(i)=fMONITSN(i)+0.7; fMONITUN(i)=fMONITUN(i)+0.3; 

i=i+1; %<RACM2_282>; <BAPI_134>; wwalters ONIT Expansion
Rnames{i} = 'OLND+MO2= HO2+NO2+HCHO+ALD+KET+MOH+ROH+.35MONITSN+0.15MONITUN';
...
fROH(i)=fROH(i)+0.25; fMONITSN(i)=fMONITSN(i)+0.35; fMONITUN(i)=fMONITUN(i)+0.15; 
...
Rnames{i} = 'OLNN+ACO3=0.7MONITSN+0.3MONITUN+MO2+HO2';
k(:,i) = 8.85E-13.*exp(765./T);
Gstr{i,1} = 'OLNN'; Gstr{i,2} = 'ACO3'; 
fOLNN(i)=fOLNN(i)-1; fACO3(i)=fACO3(i)-1; fMONITSN(i)=fMONITSN(i)+0.7; fMONITUN(i)=fMONITUN(i)+0.3; fMO2(i)=fMO2(i)+1; fHO2(i)=fHO2(i)+1;
...
Rnames{i} = 'OLNN+NO3=0.7MONITSN+0.3MONITUN+NO2+HO2';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'OLNN'; Gstr{i,2} = 'NO3'; 
fOLNN(i)=fOLNN(i)-1; fNO3(i)=fNO3(i)-1; fMONITSN(i)=fMONITSN(i)+0.7; fMONITUN(i)=fMONITUN(i)+0.3; fNO2(i)=fNO2(i)+1; fHO2(i)=fHO2(i)+1; 
...
Rnames{i} = 'OLNN+OLNN=1.4MONITSN+0.6MONITUN+HO2';
k(:,i) = 7.00E-14.*exp(1000./T);
Gstr{i,1} = 'OLNN'; Gstr{i,2} = 'OLNN'; 
fOLNN(i)=fOLNN(i)-1; fOLNN(i)=fOLNN(i)-1; fMONITSN(i)=fMONITSN(i)+1.4; fMONITUN(i)=fMONITUN(i)+0.6; fHO2(i)=fHO2(i)+1; 

i=i+1; %<RACM2_360>; <BAPI_163>; wwalters ONIT Expansion
Rnames{i} = 'OLNN+OLND=0.50 HO2+0.50 NO2+0.202 HCHO+0.640 ALD+0.149 KET+1.05MONITSN+0.45MONITUN ';
...
fMONITSN(i)=fMONITSN(i)+1.05; fMONITUN(i)=fMONITUN(i)+0.45; 

i=i+1; %<RACM2_361>; <BAPI_164>; wwalters ONIT Expansion
Rnames{i} = 'OLND+OLND=NO2+0.504 HCHO+1.21 ALD+0.285 KET+0.7MONITSN+0.3MONITUN ';
...
fALD(i)=fALD(i)+1.21; fKET(i)=fKET(i)+0.285; fMONITSN(i)=fMONITSN(i)+0.7; fMONITUN(i)=fMONITUN(i)+0.3;
...
i=i+1; %<BAPI_169>
Rnames{i} = 'MONITSC+OH=HONITC';
k(:,i) = 4.8E-12;
Gstr{i,1} = 'MONITSC';  Gstr{i,2} = 'OH'; 
fMONITSC(i)=fMONITSC(i)-1; fOH(i)=fOH(i)-1; fHONITC(i)=fHONITC(i)+1;

i=i+1; %<BAPI_170>
Rnames{i} = 'MONITSN+OH=HONITC';
k(:,i) = 4.8E-12;
Gstr{i,1} = 'MONITSN';  Gstr{i,2} = 'OH'; 
fMONITSN(i)=fMONITSN(i)-1; fOH(i)=fOH(i)-1; fHONITC(i)=fHONITC(i)+1;

i=i+1; %<BAPI_171>
Rnames{i} = 'MONITUC+OH=HONITC';
k(:,i) = 7.29E-11;
Gstr{i,1} = 'MONITUC';  Gstr{i,2} = 'OH'; 
fMONITUC(i)=fMONITUC(i)-1; fOH(i)=fOH(i)-1; fHONITC(i)=fHONITC(i)+1;

i=i+1; %<BAPI_172>
Rnames{i} = 'MONITUN+OH=HONITC';
k(:,i) = 7.29E-11;
Gstr{i,1} = 'MONITUN';  Gstr{i,2} = 'OH'; 
fMONITUN(i)=fMONITUN(i)-1; fOH(i)=fOH(i)-1; fHONITC(i)=fHONITC(i)+1;

i=i+1; %<BAPI_173>
Rnames{i} = 'MONITUC+O3=HONITC';
k(:,i) = 1.67E-16;
Gstr{i,1} = 'MONITUC';  Gstr{i,2} = 'O3'; 
fMONITUC(i)=fMONITUC(i)-1; fO3(i)=fO3(i)-1; fHONITC(i)=fHONITC(i)+1;

i=i+1; %<BAPI_174>
Rnames{i} = 'MONITUN+O3=HONITC';
k(:,i) = 1.67E-16;
Gstr{i,1} = 'MONITUN';  Gstr{i,2} = 'O3'; 
fMONITUN(i)=fMONITUN(i)-1; fO3(i)=fO3(i)-1; fHONITC(i)=fHONITC(i)+1;

i=i+1; %<BAPI_175>
Rnames{i} = 'MONITUC+NO3=HONITC';
k(:,i) = 3.15E-13*exp(-448/T);
Gstr{i,1} = 'MONITUC';  Gstr{i,2} = 'NO3'; 
fMONITUC(i)=fMONITUC(i)-1; fNO3(i)=fNO3(i)-1; fHONITC(i)=fHONITC(i)+1;

i=i+1; %<BAPI_176>
Rnames{i} = 'MONITUN+NO3=HONITC';
k(:,i) = 3.15E-13*exp(-448/T);
Gstr{i,1} = 'MONITUN';  Gstr{i,2} = 'NO3'; 
fMONITUN(i)=fMONITUN(i)-1; fNO3(i)=fNO3(i)-1; fHONITC(i)=fHONITC(i)+1;

i=i+1; %<BAPI_177>
Rnames{i} = 'MONITSC+NO3=HONITC';
k(:,i) = 3.15E-13*exp(-448/T);
Gstr{i,1} = 'MONITSC';  Gstr{i,2} = 'NO3'; 
fMONITSC(i)=fMONITSC(i)-1; fNO3(i)=fNO3(i)-1; fHONITC(i)=fHONITC(i)+1;

i=i+1; %<BAPI_178>; 
Rnames{i} = 'MONITSN+NO3=HONITC';
k(:,i) = 3.15E-13*exp(-448/T);
Gstr{i,1} = 'MONITSN';  Gstr{i,2} = 'NO3'; 
fMONITSN(i)=fMONITSN(i)-1; fNO3(i)=fNO3(i)-1; fHONITC(i)=fHONITC(i)+1;

i=i+1; %<BAPI_179>
Rnames{i} = 'HONITC+OH=NO3+HKET';
k(:,i) = K_OH_HNO3;
Gstr{i,1} = 'HONITC';  Gstr{i,2} = 'OH'; 
fHONITC(i)=fHONITC(i)-1; fOH(i)=fOH(i)-1; fNO3(i)=fNO3(i)+1; fHKET(i)=fHKET(i)+1;

i=i+1; %<BAPI_180>; photolysis MCM-tert-butyl nitrate x-section/3; JOH3
Rnames{i} = 'MONITSC=NO2+KET';
k(:,i) = JMONIT;
Gstr{i,1} = 'MONITSC'; 
fMONITSC(i)=fMONITSC(i)-1; fNO2(i)=fNO2(i)+1; fKET(i)=fKET(i)+1;

i=i+1; %<BAPI_181>;
Rnames{i} = 'MONITSN=NO2+KET';
k(:,i) = JMONIT;
Gstr{i,1} = 'MONITSN'; 
fMONITSN(i)=fMONITSN(i)-1; fNO2(i)=fNO2(i)+1; fKET(i)=fKET(i)+1;

i=i+1; %<BAPI_182>;
Rnames{i} = 'MONITUC=NO2+UALD';
k(:,i) = JMONIT;
Gstr{i,1} = 'MONITUC'; 
fMONITUC(i)=fMONITUC(i)-1; fNO2(i)=fNO2(i)+1; fUALD(i)=fUALD(i)+1;

i=i+1; %<BAPI_183>;
Rnames{i} = 'MONITUN=NO2+UALD';
k(:,i) = JMONIT;
Gstr{i,1} = 'MONITUN'; 
fMONITUN(i)=fMONITUN(i)-1; fNO2(i)=fNO2(i)+1; fUALD(i)=fUALD(i)+1;

i=i+1; %<BAPI_184>;
Rnames{i} = 'HONITC=NO2+HKET';
k(:,i) = JMONIT;
Gstr{i,1} = 'HONITC'; 
fHONITC(i)=fHONITC(i)-1; fNO2(i)=fNO2(i)+1; fHKET(i)=fHKET(i)+1;
