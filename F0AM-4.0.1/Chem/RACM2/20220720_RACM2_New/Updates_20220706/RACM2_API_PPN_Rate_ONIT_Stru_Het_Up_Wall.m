...
'UALD'; 'UALP'; 'MONITSCTert'; 'MONITSCNonTert'; 'MONITUCTert'; 'MONITSN'; ...
'MONITSNTert'; 'MONITSNNonTert'; 'MONITSNTert'; 'MONITSNNonTert'; 'MONITUNTert'; 'HONITCTert'; 'HONITCNonTert'; 'pNO3'; ...
'pMONITTert'; 'pMONITNonTert'; 'pHONITTert'; 'pHONITNonTert'; 'wNO'; 'wO3';...
'wHNO3'; 'wpNO3'; 'wMONITSCTert'; 'wMONITSCNonTert'; 'wMONITUCTert'; 'wMONITSNTert'; 'wMONITSNNonTert';...
'wMONITUNTert'; 'wHONITCTert'; 'wHONITCNonTert'; 'wpMONITTert'; 'wpMONITNonTert'; 'wpHONITTert'; 'wpHONITNonTert'; 'A'; ....
};
...
%%HNO3 Heterogeneous Rxns wwalters
i=i+1; %<BAPI_185>
...
i=i+1; %<BAPI_189>
Rnames{i} = 'MONITUCTert=pMONITTert';
k(:,i) = 0.018682;
Gstr{i,1} = 'MONITUCTert'; 
fMONITUCTert(i)=fMONITUCTert(i)-1; fpMONITTert(i)=fpMONITTert(i)+1;

i=i+1; %<BAPI_190>
Rnames{i} = 'MONITSCTert=pMONITTert';
k(:,i) = 0.018682;
Gstr{i,1} = 'MONITSCTert'; 
fMONITSCTert(i)=fMONITSCTert(i)-1; fpMONITTert(i)=fpMONITTert(i)+1;

i=i+1; %<BAPI_191>
Rnames{i} = 'MONITSCNonTert=pMONITNonTert';
k(:,i) = 0.018682;
Gstr{i,1} = 'MONITSCNonTert'; 
fMONITSCNonTert(i)=fMONITSCNonTert(i)-1; fpMONITNonTert(i)=fpMONITNonTert(i)+1;

i=i+1; %<BAPI_192>
Rnames{i} = 'HONITCTert=pHONITTert';
k(:,i) = 0.018682;
Gstr{i,1} = 'HONITCTert'; 
fHONITCTert(i)=fHONITCTert(i)-1; fpHONITTert(i)=fpHONITTert(i)+1;

i=i+1; %<BAPI_193>
Rnames{i} = 'HONITCNonTert=pHONITNonTert';
k(:,i) = 0.018682;
Gstr{i,1} = 'HONITCNonTert'; 
fHONITCNonTert(i)=fHONITCNonTert(i)-1; fpHONITNonTert(i)=fpHONITNonTert(i)+1;
...
k(:,i) =  2.77778E-05
Gstr{i,1} = 'pNO3'; 
fpNO3(i)=fpNO3(i)-1; fwpNO3(i)=fwpNO3(i)+1; 

i=i+1; %<BAPI_201>
Rnames{i} = 'MONITSCTert=wMONITSCTert';
k(:,i) =  8.8E-6
Gstr{i,1} = 'MONITSCTert'; 
fMONITSCTert(i)=fMONITSCTert(i)-1; fwMONITSCTert(i)=fwMONITSCTert(i)+1; 

i=i+1; %<BAPI_202>
Rnames{i} = 'MONITSCNonTert=wMONITSCNonTert';
k(:,i) =  8.8E-6
Gstr{i,1} = 'MONITSCNonTert'; 
fMONITSCNonTert(i)=fMONITSCNonTert(i)-1; fwMONITSCNonTert(i)=fwMONITSCNonTert(i)+1; 

i=i+1; %<BAPI_203>
Rnames{i} = 'MONITUCTert=wMONITUCTert';
k(:,i) =  8.8E-6
Gstr{i,1} = 'MONITUCTert'; 
fMONITUCTert(i)=fMONITUCTert(i)-1; fwMONITUCTert(i)=fwMONITUCTert(i)+1; 

i=i+1; %<BAPI_204>
Rnames{i} = 'MONITSNTert=wMONITSNTert';
k(:,i) =  8.8E-6
Gstr{i,1} = 'MONITSNTert'; 
fMONITSNTert(i)=fMONITSNTert(i)-1; fwMONITSNTert(i)=fwMONITSNTert(i)+1; 

i=i+1; %<BAPI_205>
Rnames{i} = 'MONITSNNonTert=wMONITSNNonTert';
k(:,i) =  8.8E-6
Gstr{i,1} = 'MONITSNNonTert'; 
fMONITSNNonTert(i)=fMONITSNNonTert(i)-1; fwMONITSNNonTert(i)=fwMONITSNNonTert(i)+1; 

i=i+1; %<BAPI_206>
Rnames{i} = 'MONITUNTert=wMONITUNTert';
k(:,i) =  8.8E-6
Gstr{i,1} = 'MONITUNTert'; 
fMONITUNTert(i)=fMONITUNTert(i)-1; fwMONITUNTert(i)=fwMONITUNTert(i)+1; 

i=i+1; %<BAPI_209>
Rnames{i} = 'HONITCTert=wHONITCTert';
k(:,i) =  8.8E-6
Gstr{i,1} = 'HONITCTert'; 
fHONITCTert(i)=fHONITCTert(i)-1; fwHONITCTert(i)=fwHONITCTert(i)+1; 


i=i+1; %<BAPI_210>
Rnames{i} = 'HONITCNonTert=wHONITCNonTert';
k(:,i) =  8.8E-6
Gstr{i,1} = 'HONITCNonTert'; 
fHONITCNonTert(i)=fHONITCNonTert(i)-1; fwHONITCNonTert(i)=fwHONITCNonTert(i)+1; 

i=i+1; %<BAPI_211>
Rnames{i} = 'pMONITTert=wpMONITTert';
k(:,i) =  2.77778E-05
Gstr{i,1} = 'pMONITTert'; 
fpMONITTert(i)=fpMONITTert(i)-1; fwpMONITTert(i)=fwpMONITTert(i)+1; 


i=i+1; %<BAPI_212>
Rnames{i} = 'pMONITNonTert=wpMONITNonTert';
k(:,i) =  2.77778E-05
Gstr{i,1} = 'pMONITNonTert'; 
fpMONITNonTert(i)=fpMONITNonTert(i)-1; fwpMONITNonTert(i)=fwpMONITNonTert(i)+1; 

i=i+1; %<BAPI_213>
Rnames{i} = 'pHONITTert=wpHONITTert';
k(:,i) =  2.77778E-05
Gstr{i,1} = 'pHONITTert'; 
fpHONITTert(i)=fpHONITTert(i)-1; fwpHONITTert(i)=fwpHONITTert(i)+1; 

i=i+1; %<BAPI_214>
Rnames{i} = 'pHONITNonTert=wpHONITNonTert';
k(:,i) =  2.77778E-05
Gstr{i,1} = 'pHONITNonTert'; 
fpHONITNonTert(i)=fpHONITNonTert(i)-1; fwpHONITNonTert(i)=fwpHONITNonTert(i)+1; 
