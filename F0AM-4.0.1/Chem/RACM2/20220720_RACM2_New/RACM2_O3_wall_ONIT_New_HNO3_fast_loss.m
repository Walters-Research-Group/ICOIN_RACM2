...
'wpONITT'; 'wpONITTQ'; 'wpONITTQ2'; 'wpONITTQ3'; 'wpONITS'; 'wpONITSQ'; 'wpONITSQ2'; 'wpONITSQ3'; 'A';
};
...
%Rapid HNO3 Wall Loss
i=i+1; %R382
Rnames{i} = 'HNO3+A=wHNO3';
k(:,i) = 1.E-16;
Gstr{i,1} = 'HNO3'; Gstr{i,2} = 'A';  
fHNO3(i)=fHNO3(i)-1; fA(i)=fA(i)-1; fwHNO3(i)=fwHNO3(i)+1; 

%O3 Tracer
i=i+1; %R382a
Rnames{i} = 'HNO2Q+A=wHNO2Q';
k(:,i) = 1.E-16;
Gstr{i,1} = 'HNO2Q';  Gstr{i,2} = 'A';
fHNO2Q(i)=fHNO2Q(i)-1; fA(i)=fA(i)-1; fwHNO2Q(i)=fwHNO2Q(i)+1; 

%O3 Tracer
i=i+1; %R382b
Rnames{i} = 'HNOQ2+A=wHNOQ2';
k(:,i) = 1.E-16;
Gstr{i,1} = 'HNOQ2';  Gstr{i,2} = 'A';
fHNOQ2(i)=fHNOQ2(i)-1; fA(i)=fA(i)-1; fwHNOQ2(i)=fwHNOQ2(i)+1; 
 
%O3 Tracer
i=i+1; %R382c
Rnames{i} = 'HNQ3+A=wHNQ3';
k(:,i) = 1.E-16;
Gstr{i,1} = 'HNQ3';  Gstr{i,2} = 'A';
fHNQ3(i)=fHNQ3(i)-1; fA(i)=fA(i)-1; fwHNQ3(i)=fwHNQ3(i)+1; 


i=i+1; %R382
Rnames{i} = 'wHNO3 = HNO3+A';
k(:,i) = 1E-3;
Gstr{i,1} = 'wHNO3';  
fwHNO3(i)=fwHNO3(i)-1; fHNO3(i)=fHNO3(i)-1; fA(i)=fA(i)+1; 

%O3 Tracer
i=i+1; %R382a
Rnames{i} = 'wHNO2Q=HNO2Q+A';
k(:,i) = 1.E-3;
Gstr{i,1} = 'wHNO2Q'; 
fwHNO2Q(i)=fwHNO2Q(i)-1; fA(i)=fA(i)+1; fHNO2Q(i)=fHNO2Q(i)+1; 

%O3 Tracer
i=i+1; %R382b
Rnames{i} = 'wHNOQ2=HNOQ2+A';
k(:,i) = 1.E-3;
Gstr{i,1} = 'wHNOQ2';
fwHNOQ2(i)=fwHNOQ2(i)-1; fA(i)=fA(i)+1; fHNOQ2(i)=fHNOQ2(i)+1; 
 
%O3 Tracer
i=i+1; %R382c
Rnames{i} = 'wHNQ3=HNQ3+A';
k(:,i) = 1.E-3;
Gstr{i,1} = 'wHNQ3';
fwHNQ3(i)=fwHNQ3(i)-1; fA(i)=fA(i)+1; fHNQ3(i)=fHNQ3(i)+1; 
