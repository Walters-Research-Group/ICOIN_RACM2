...
i=i+1; %R146
Rnames{i} = 'API+NO3=0.035 OLNNT+ 0.065OLNNS+0.1089OLNDT+0.7911OLNDS';
k(:,i) = 1.19E-12.*exp(490./T);
Gstr{i,1} = 'API'; Gstr{i,2} = 'NO3'; 
fAPI(i)=fAPI(i)-1; fNO3(i)=fNO3(i)-1; fOLNNT(i)=fOLNNT(i)+0.035; fOLNNS(i)=fOLNNS(i)+0.065; fOLNDT(i)=fOLNDT(i)+0.1089; fOLNDS(i)=fOLNDS(i)+0.7911; 

%O3 Tracer
i=i+1; %R146a
Rnames{i} = 'API+NO2Q=0.0121 OLNNTQ+ 0.0879OLNNSQ+0.1089OLNDTQ+0.7911OLNDSQ';
k(:,i) = 1.19E-12.*exp(490./T);
Gstr{i,1} = 'API'; Gstr{i,2} = 'NO2Q'; 
fAPI(i)=fAPI(i)-1; fNO2Q(i)=fNO2Q(i)-1; fOLNNTQ(i)=fOLNNTQ(i)+0.0121; fOLNNSQ(i)=fOLNNSQ(i)+0.0879; fOLNDTQ(i)=fOLNDTQ(i)+0.1089; fOLNDSQ(i)=fOLNDSQ(i)+0.7911;

%O3 Tracer
i=i+1; %R146b
Rnames{i} = 'API+NOQ2=0.0121 OLNNTQ2+ 0.0879OLNNSQ2+0.1089OLNDTQ2+0.7911OLNDSQ2';
k(:,i) = 1.19E-12.*exp(490./T);
Gstr{i,1} = 'API'; Gstr{i,2} = 'NOQ2'; 
fAPI(i)=fAPI(i)-1; fNOQ2(i)=fNOQ2(i)-1; fOLNNTQ2(i)=fOLNNTQ2(i)+0.0121; fOLNNSQ2(i)=fOLNNSQ2(i)+0.0879; fOLNDTQ2(i)=fOLNDTQ2(i)+0.1089; fOLNDSQ2(i)=fOLNDSQ2(i)+0.7911;

%O3 Tracer
i=i+1; %R146c
Rnames{i} = 'API+NQ3=0.0121 OLNNTQ3+ 0.0879OLNNSQ3+0.1089OLNDTQ3+0.7911OLNDSQ3';
k(:,i) = 1.19E-12.*exp(490./T);
Gstr{i,1} = 'API'; Gstr{i,2} = 'NQ3'; 
fAPI(i)=fAPI(i)-1; fNQ3(i)=fNQ3(i)-1; fOLNNTQ3(i)=fOLNNTQ3(i)+0.0121; fOLNNSQ3(i)=fOLNNSQ3(i)+0.0879; fOLNDTQ3(i)=fOLNDTQ3(i)+0.1089; fOLNDSQ3(i)=fOLNDSQ3(i)+0.7911;
...
fAPIP(i)=fAPIP(i)-1; fNO(i)=fNO(i)-1; fHO2(i)=fHO2(i)+0.95; fNO2(i)=fNO2(i)+0.95; 
fHCHO(i)=fHCHO(i)+0.23; fALD(i)=fALD(i)+0.43; fACT(i)=fACT(i)+0.11; fKET(i)=fKET(i)+0.44; 
fORA1(i)=fORA1(i)+0.07; fONITT(i)=fONITT(i)+0.0385; fONITS(i)=fONITS(i)+0.0115;
...
fAPIP(i)=fAPIP(i)-1; fNQ(i)=fNQ(i)-1; fHO2(i)=fHO2(i)+0.95; fNOQ(i)=fNOQ(i)+0.95; 
fHCHO(i)=fHCHO(i)+0.23; fALD(i)=fALD(i)+0.43; fACT(i)=fACT(i)+0.11; fKET(i)=fKET(i)+0.44; 
fORA1(i)=fORA1(i)+0.07; fONITTQ(i)=fONITTQ(i)+0.0385; fONITSQ(i)=fONITSQ(i)+0.0115; 
