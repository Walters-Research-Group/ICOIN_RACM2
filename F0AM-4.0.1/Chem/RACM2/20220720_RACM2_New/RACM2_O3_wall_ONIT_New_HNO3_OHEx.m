...
'wpONITT'; 'wpONITTQ'; 'wpONITTQ2'; 'wpONITTQ3'; 'wpONITS'; 'wpONITSQ'; 'wpONITSQ2'; 'wpONITSQ3';
};
...
%O3 Tracer
Rnames{i} = 'NO3=HNO3'; %R393
k(:,i) = 1.74E-02;
Gstr{i,1} = 'NO3'; 
fNO3(i)=fNO3(i)-1; fHNO3(i)=fHNO3(i)+1; 

%O3 Tracer
Rnames{i} = 'NO2Q=HNO2Q'; %R393a
k(:,i) = 1.74E-02;
Gstr{i,1} = 'NO2Q'; 
...
%O3 Tracer
Rnames{i} = 'NQ3=HNQ3'; %R393c
k(:,i) = 1.74E-02;
Gstr{i,1} = 'NQ3'; 
fNQ3(i)=fNQ3(i)-1; fHNQ3(i)=fHNQ3(i)+1; 


Rnames{i} = 'N2O5=HNO3+HNO3'; %R394
k(:,i) = 1.58E-04;
Gstr{i,1} = 'N2O5'; 
...
%O3 and OH Exchange?
i=i+1; %R394
Rnames{i} = 'OH+O3=QH+O3';
k(:,i) = 1.E-5;   
fOH(i)=fOH(i)-1; fO3(i)=fO3(i)-1; fQH(i)=fQH(i)+1; fO3(i)=fO3(i)+1;
