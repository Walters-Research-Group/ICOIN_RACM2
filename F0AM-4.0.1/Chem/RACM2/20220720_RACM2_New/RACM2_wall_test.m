...
'XYO'; 'XYP'; 'XYO2'; 'XYOP'; 'wO3'; 'wNO'; 'wHNO3'; 'wPAN'; 'wPPN'; 'wONIT'; 'W'};
...
i=i+1; %R370
Rnames{i} = 'HNO3+W=wHNO3';
k(:,i) = 1.E-12;
Gstr{i,1} = 'HNO3'; Gstr{i,2} = 'W';  
fHNO3(i)=fHNO3(i)-1; fW(i)=fW(i)-1; fwHNO3(i)=fwHNO3(i)+1;
...
i=i+1; %R386
Rnames{i} = 'wHNO3=OH+NO2+W';
k(:,i) = JHNO3;
Gstr{i,1} = 'wHNO3'; 
fwHNO3(i)=fwHNO3(i)-1; fOH(i)=fOH(i)+1; fNO2(i)=fNO2(i)+1; fW(i)=fW(i)+1
