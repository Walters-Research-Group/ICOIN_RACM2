...
'XYO'; 'XYP'; 'XYO2'; 'XYOP'; 'wO3'; 'wNO'; 'wNO2'; 'wHNO3'; 'wALD'; 'wKET'; 'wPAA'; 'wORA2'; 'wONIT';};
...
i=i+1; %R189
Rnames{i} = 'APIP+NO= HO2+NO2+HCHO+ALD+ACT+KET+ORA1+MONITS+MONITU';
k(:,i) = 4.00E-12;
...
fORA1(i)=fORA1(i)+0.07; fMONINTS(i)=fMONITS(i)+1; fMONINTU(i)=fMONITU(i)+1;
...
i=i+1;  %R205
Rnames{i} = 'OLNN+NO=MONITS+NO2+HO2';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'OLNN'; Gstr{i,2} = 'NO'; 
fOLNN(i)=fOLNN(i)-1; fNO(i)=fNO(i)-1; fMONITS(i)=fMONITS(i)+1; fNO2(i)=fNO2(i)+1; fHO2(i)=fHO2(i)+1; 
...
i=i+1; %R281
Rnames{i} = 'OLNN+MO2=HCHO+HO2+HO2+0.7MONITS+0.3MONITU';
k(:,i) = 1.60E-13.*exp(708./T);
Gstr{i,1} = 'OLNN'; Gstr{i,2} = 'MO2'; 
fOLNN(i)=fOLNN(i)-1; fMO2(i)=fMO2(i)-1; fHCHO(i)=fHCHO(i)+1; fHO2(i)=fHO2(i)+1; fHO2(i)=fHO2(i)+1; fMONITS(i)=fMONITS(i)+0.7; fMONITU(i)=fMONITU(i)+0.3; 

i=i+1; %R282
Rnames{i} = 'OLND+MO2= HO2+NO2+HCHO+ALD+KET+MOH+ROH+.35MONITS+0.15MONITU';
...
fROH(i)=fROH(i)+0.25; fMONITS(i)=fMONITS(i)+0.35; fMONITU(i)=fONITU(i)+0.15; 
...
i=i+1; %R317
Rnames{i} = 'OLNN+ACO3=0.7MONITS+0.3MONITU+MO2+HO2';
k(:,i) = 8.85E-13.*exp(765./T);
Gstr{i,1} = 'OLNN'; Gstr{i,2} = 'ACO3'; 
fOLNN(i)=fOLNN(i)-1; fACO3(i)=fACO3(i)-1; fMONITS(i)=fMONITS(i)+0.7; fMONITU(i)=fMONITU(i)+0.3; fMO2(i)=fMO2(i)+1; fHO2(i)=fHO2(i)+1; 
...
i=i+1; %R354
Rnames{i} = 'OLNN+NO3=0.7MONITS+0.3MONITU+NO2+HO2';
k(:,i) = 1.20E-12;
...
i=i+1; %R359
Rnames{i} = 'OLNN+OLNN=1.4MONITS+0.6MONITU+HO2';
k(:,i) = 7.00E-14.*exp(1000./T);
Gstr{i,1} = 'OLNN'; Gstr{i,2} = 'OLNN'; 
fOLNN(i)=fOLNN(i)-1; fOLNN(i)=fOLNN(i)-1; fMONITS(i)=fMONITS(i)+1.4; fMONITU(i)=fMONITU(i)+0.6; fHO2(i)=fHO2(i)+1; 

i=i+1; %R360
Rnames{i} = 'OLNN+OLND=0.50 HO2+0.50 NO2+0.202 HCHO+0.640 ALD+0.149 KET+1.05MONITS+0.45MONITU ';
...
fMONITS(i)=fMONITS(i)+1.05; fMONITU(i)=fMONITU(i)+0.45; 

i=i+1; %R361
Rnames{i} = 'OLND+OLND=NO2+0.504 HCHO+1.21 ALD+0.285 KET+0.7MONITS+0.3MONITU ';
...
fALD(i)=fALD(i)+1.21; fKET(i)=fKET(i)+0.285; fMONITS(i)=fMONITS(i)+0.7; fMONITU(i)=fMONITU(i)+0.3;
...
k(:,i) = 1E-3;
Gstr{i,1} = 'ALD';  
fALD(i)=fALD(i)-1; fwALD(i)=fwALD(i)+1; 
...
k(:,i) = 1E-3;
Gstr{i,1} = 'KET';  
fKET(i)=fKET(i)-1; fwKET(i)=fwKET(i)+1; 
...
k(:,i) = 1E-3;
Gstr{i,1} = 'PAA';  
fPAA(i)=fPAA(i)-1; fwPAA(i)=fwPAA(i)+1;
...
k(:,i) = 1E-3;
Gstr{i,1} = 'ORA2';  
fORA2(i)=fORA2(i)-1; fwORA2(i)=fwORA2(i)+1;

%%Monoterpene Expansion
i=i+1; %R364
