...
Rnames{i} = 'APINO2a+NQ=ONITa+NOQ+HO2';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'APINO2a'; Gstr{i,2} = 'NQ'; 
fAPINO2a(i)=fAPINO2a(i)-1; fNQ(i)=fNQ(i)-1; fONITa(i)=fONITa(i)+1; fNOQ(i)=fNOQ(i)+1; fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1;  %<RACM2_205b>; <BAPI_107b>
Rnames{i} = 'APINO2Qa+NO=ONITQa+NO2+HO2';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'APINO2Qa'; Gstr{i,2} = 'NO'; 
fAPINO2Qa(i)=fAPINO2Qa(i)-1; fNO(i)=fNO(i)-1; fONITQa(i)=fONITQa(i)+1; fNO2(i)=fNO2(i)+1; fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1;  %<RACM2_205c>; <BAPI_107c>
Rnames{i} = 'APINO2Qa+NQ=ONITQa+NOQ+HO2';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'APINO2Qa'; Gstr{i,2} = 'NQ'; 
fAPINO2Qa(i)=fAPINO2Qa(i)-1; fNQ(i)=fNQ(i)-1; fONITQa(i)=fONITQa(i)+1; fNOQ(i)=fNOQ(i)+1; fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1;  %<RACM2_205d>; <BAPI_107d>
Rnames{i} = 'APINO2Q2a+NO=ONITQ2a+NO2+HO2';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'APINO2Q2a'; Gstr{i,2} = 'NO'; 
fAPINO2Q2a(i)=fAPINO2Q2a(i)-1; fNO(i)=fNO(i)-1; fONITQ2a(i)=fONITQ2a(i)+1; fNO2(i)=fNO2(i)+1; fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1;  %<RACM2_205e>; <BAPI_107e>
Rnames{i} = 'APINO2Q2a+NQ=ONITQ2a+NOQ+HO2';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'APINO2Q2a'; Gstr{i,2} = 'NQ'; 
fAPINO2Q2a(i)=fAPINO2Q2a(i)-1; fNQ(i)=fNQ(i)-1; fONITQ2a(i)=fONITQ2a(i)+1; fNOQ(i)=fNOQ(i)+1; fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1;  %<RACM2_205f>; <BAPI_107f>
Rnames{i} = 'APINO2Q3a+NO=ONITQ3a+NO2+HO2';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'APINO2Q3a'; Gstr{i,2} = 'NO'; 
fAPINO2Q3a(i)=fAPINO2Q3a(i)-1; fNO(i)=fNO(i)-1; fONITQ3a(i)=fONITQ3a(i)+1; fNO2(i)=fNO2(i)+1; fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1;  %<RACM2_205g>; <BAPI_107g>
Rnames{i} = 'APINO2Q3a+NQ=ONITQ3a+NOQ+HO2';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'APINO2Q3a'; Gstr{i,2} = 'NQ'; 
fAPINO2Q3a(i)=fAPINO2Q3a(i)-1; fNQ(i)=fNQ(i)-1; fONITQ3a(i)=fONITQ3a(i)+1; fNOQ(i)=fNOQ(i)+1; fHO2(i)=fHO2(i)+1; 
