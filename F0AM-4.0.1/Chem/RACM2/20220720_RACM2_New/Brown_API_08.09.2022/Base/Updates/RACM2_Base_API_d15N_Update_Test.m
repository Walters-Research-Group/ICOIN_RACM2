...
Rnames{i} = 'OLND+NO=NO2+HCHO+ALD+KET + ONIT';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'OLND'; Gstr{i,2} = 'NO'; 
fOLND(i)=fOLND(i)-1; fNO(i)=fNO(i)-1; fNO2(i)=fNO2(i)+2*0.9; fHCHO(i)=fHCHO(i)+0.2583; fALD(i)=fALD(i)+1.116; fKET(i)=fKET(i)+0.4176; fONIT(i)=fONIT(i)+0.1;


%d15N Tracer
i=i+1;  %<RACM2_206a>; <BAPI_108>
Rnames{i} = 'OLND+ZO=NO2+ZO2+HCHO+ALD+KET + ONIT';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'OLND'; Gstr{i,2} = 'ZO'; 
fOLND(i)=fOLND(i)-1; fZO(i)=fZO(i)-1; fNO2(i)=fNO2(i)+0.9; fZO2(i)=fZO2(i)+1; fHCHO(i)=fHCHO(i)+0.2583; fALD(i)=fALD(i)+1.116; fKET(i)=fKET(i)+0.4176; fONIT(i)=fONIT(i)+0.1;

%d15N Tracer
i=i+1;  %<RACM2_206b>; <BAPI_108>
Rnames{i} = 'OLZD+NO=NO2+ZO2+HCHO+ALD+KET + OZIT';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'OLZD'; Gstr{i,2} = 'NO'; 
fOLZD(i)=fOLZD(i)-1; fNO(i)=fNO(i)-1; fZO2(i)=fZO2(i)+1; fNO2(i)=fNO2(i)+1; fHCHO(i)=fHCHO(i)+0.2583; fALD(i)=fALD(i)+1.116; fKET(i)=fKET(i)+0.4176; fOZIT(i)=fOZIT(i)+0.1;

%d15N Tracer
i=i+1;  %<RACM2_206c>; <BAPI_108>
Rnames{i} = 'OLZD+ZO=ZO2+ZO2+HCHO+ALD+KET + OZIT';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'OLZD'; Gstr{i,2} = 'ZO'; 
fOLZD(i)=fOLZD(i)-1; fZO(i)=fZO(i)-1; fZO2(i)=fZO2(i)+1; fZO2(i)=fZO2(i)+1; fHCHO(i)=fHCHO(i)+0.2583; fALD(i)=fALD(i)+1.116; fKET(i)=fKET(i)+0.4176; fOZIT(i)=fOZIT(i)+0.1;
...
Rnames{i} = 'OLND+HO2=0.5ONIT+0.5 ALD + 0.5 HO2 + 0.5 OH';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'OLND'; Gstr{i,2} = 'HO2'; 
fOLND(i)=fOLND(i)-1; fHO2(i)=fHO2(i)-1; fONIT(i)=fONIT(i)+0.5; fALD(i)=fALD(i)+0.5;
fHO2(i)=fHO2(i)+0.5;  fOH(i)=fOH(i)+0.5; fNO2(i)=fNO2(i)+0.5;

%d15N Tracer
i=i+1; %<RACM2_245a>; <BAPI_121>
Rnames{i} = 'OLZD+HO2=0.5OZIT+0.5 ALD + 0.5 HO2 + 0.5 OH';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'OLZD'; Gstr{i,2} = 'HO2'; 
fOLZD(i)=fOLZD(i)-1; fHO2(i)=fHO2(i)-1; fOZIT(i)=fOZIT(i)+0.5; fALD(i)=fALD(i)+0.5;
fHO2(i)=fHO2(i)+0.5;  fOH(i)=fOH(i)+0.5; fZO2(i)=fZO2(i)+0.5;
