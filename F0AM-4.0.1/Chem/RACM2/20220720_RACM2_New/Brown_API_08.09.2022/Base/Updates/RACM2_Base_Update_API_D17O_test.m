...
'OLNDQ2'; 'OLNDQ3'; 'OLNNQ'; 'OLNNQ2'; 'OLNNQ3';  'wHNO3'; 'A'; 'P'; ...
};
...
fAPIP(i)=fAPIP(i)-1; fNO(i)=fNO(i)-1; fHO2(i)=fHO2(i)+0.82; fNO2(i)=fNO2(i)+0.92; 
fHCHO(i)=fHCHO(i)+0.23; fALD(i)=fALD(i)+0.43; fACT(i)=fACT(i)+0.11; fKET(i)=fKET(i)+0.44; 
fORA1(i)=fORA1(i)+0.07; fONIT(i)=fONIT(i)+0.08; 
...
Rnames{i} = 'OLND+NQ=NOQ+HCHO+ALD+KET + ONIT';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'OLND'; Gstr{i,2} = 'NQ'; 
fOLND(i)=fOLND(i)-1; fNQ(i)=fNQ(i)-1; fNOQ(i)=fNOQ(i)+1*0.9; fNO2(i)=fNO2(i)+1*0.9; fHCHO(i)=fHCHO(i)+0.2583; fALD(i)=fALD(i)+1.116; fKET(i)=fKET(i)+0.4176; fONIT(i)=fONIT(i)+0.1;

%O3 Tracer
i=i+1;  %<RACM2_206b>; <BAPI_108b>
Rnames{i} = 'OLNDQ+NO=NO2+HCHO+ALD+KET + ONITQ';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'OLNDQ'; Gstr{i,2} = 'NO'; 
fOLNDQ(i)=fOLNDQ(i)-1; fNO(i)=fNO(i)-1; fNO2(i)=fNO2(i)+1*0.9; fNOQ(i)=fNOQ(i)+1*0.9; fHCHO(i)=fHCHO(i)+0.2583; fALD(i)=fALD(i)+1.116; fKET(i)=fKET(i)+0.4176; fONITQ(i)=fONITQ(i)+0.1;

%O3 Tracer
i=i+1;  %<RACM2_206c>; <BAPI_108c>
Rnames{i} = 'OLNDQ+NQ=NOQ+HCHO+ALD+KET + ONITQ';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'OLNDQ'; Gstr{i,2} = 'NQ'; 
fOLNDQ(i)=fOLNDQ(i)-1; fNQ(i)=fNQ(i)-1; fNOQ(i)=fNOQ(i)+2*0.9; fHCHO(i)=fHCHO(i)+0.2583; fALD(i)=fALD(i)+1.116; fKET(i)=fKET(i)+0.4176; fONITQ(i)=fONITQ(i)+0.1;

%O3 Tracer
i=i+1;  %<RACM2_206d>; <BAPI_108d>
Rnames{i} = 'OLNDQ2+NO=NOQ+NO2+NQ2+HCHO+ALD+KET + ONITQ2';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'OLNDQ2'; Gstr{i,2} = 'NO'; 
fOLNDQ2(i)=fOLNDQ2(i)-1; fNO(i)=fNO(i)-1; fNO2(i)=fNO2(i)+(1/3)*0.9; fNQ2(i)=fNQ2(i)+(1/3)*0.9; fNOQ(i)=fNOQ(i)+(4/3)*0.9; fHCHO(i)=fHCHO(i)+0.2583; fALD(i)=fALD(i)+1.116; fKET(i)=fKET(i)+0.4176; fONITQ2(i)=fONITQ2(i)+0.1;

%O3 Tracer
i=i+1;  %<RACM2_206e>; <BAPI_108e>
Rnames{i} = 'OLNDQ2+NQ=NOQ+NQ2+HCHO+ALD+KET +ONITQ2';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'OLNDQ2'; Gstr{i,2} = 'NQ'; 
fOLNDQ2(i)=fOLNDQ2(i)-1; fNQ(i)=fNQ(i)-1; fNOQ(i)=fNOQ(i)+1*0.9; fNQ2(i)=fNQ2(i)+1*0.9;fHCHO(i)=fHCHO(i)+0.2583; fALD(i)=fALD(i)+1.116; fKET(i)=fKET(i)+0.4176;  fONITQ2(i)=fONITQ2(i)+0.1;

%O3 Tracer
i=i+1;  %<RACM2_206f>; <BAPI_108f>
Rnames{i} = 'OLNDQ3+NO=NOQ+NQ2+HCHO+ALD+KET +ONITQ3';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'OLNDQ3'; Gstr{i,2} = 'NO'; 
fOLNDQ3(i)=fOLNDQ3(i)-1; fNO(i)=fNO(i)-1; fNOQ(i)=fNOQ(i)+1*0.9; fNQ2(i)=fNQ2(i)+1*0.9; fHCHO(i)=fHCHO(i)+0.2583; fALD(i)=fALD(i)+1.116; fKET(i)=fKET(i)+0.4176; fONITQ3(i)=fONITQ3(i)+0.1;

%O3 Tracer
i=i+1;  %<RACM2_206g>; <BAPI_108g>
Rnames{i} = 'OLNDQ3+NQ=NQ2+HCHO+ALD+KET + ONITQ3';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'OLNDQ3'; Gstr{i,2} = 'NQ'; 
fOLNDQ3(i)=fOLNDQ3(i)-1; fNQ(i)=fNQ(i)-1; fNQ2(i)=fNQ2(i)+2*0.9; fHCHO(i)=fHCHO(i)+0.2583; fALD(i)=fALD(i)+1.116; fKET(i)=fKET(i)+0.4176; fONITQ3(i)=fONITQ3(i)+0.1;
...
i=i+1; %<RACM2_245>; <BAPI_121>
Rnames{i} = 'OLND+HOQ=0.5ONIT+0.5 ALD + 0.5 HOQ + 0.25 QH + 0.25 OH';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'OLND'; Gstr{i,2} = 'HOQ'; 
fOLND(i)=fOLND(i)-1; fHOQ(i)=fHOQ(i)-1; fONIT(i)=fONIT(i)+0.5; fALD(i)=fALD(i)+0.5;
fHOQ(i)=fHOQ(i)+0.5;  fOH(i)=fOH(i)+0.25; fQH(i)=fQH(i)+0.25;
 
 
i=i+1; %<RACM2_245>; <BAPI_121>
Rnames{i} = 'OLND+HQ2=0.5ONIT+0.5 ALD + 0.5 HQ2 + 0.5 QH';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'OLND'; Gstr{i,2} = 'HQ2'; 
fOLND(i)=fOLND(i)-1; fHQ2(i)=fHQ2(i)-1; fONIT(i)=fONIT(i)+0.5; fALD(i)=fALD(i)+0.5;
fHQ2(i)=fHQ2(i)+0.5; fQH(i)=fQH(i)+0.5;
 
 
i=i+1; %<RACM2_245>; <BAPI_121>
Rnames{i} = 'OLNDQ+HO2=0.5ONITQ+0.5 ALD + 0.5 HO2 + 0.5 OH';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'OLNDQ'; Gstr{i,2} = 'HO2'; 
fOLNDQ(i)=fOLNDQ(i)-1; fHO2(i)=fHO2(i)-1; fONITQ(i)=fONITQ(i)+0.5; fALD(i)=fALD(i)+0.5;
fHO2(i)=fHO2(i)+0.5; fOH(i)=fOH(i)+0.5;
...
i=i+1; %<RACM2_245>; <BAPI_121>
Rnames{i} = 'OLNDQ+HOQ=0.5ONITQ+0.5 ALD + 0.5 HOQ + 0.25 OH + 0.25 QH';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'OLNDQ'; Gstr{i,2} = 'HOQ'; 
fOLNDQ(i)=fOLNDQ(i)-1; fHOQ(i)=fHOQ(i)-1; fONITQ(i)=fONITQ(i)+0.5; fALD(i)=fALD(i)+0.5;
fHOQ(i)=fHOQ(i)+0.5; fOH(i)=fOH(i)+0.25; fQH(i)=fQH(i)+0.25;
 
 
 
i=i+1; %<RACM2_245>; <BAPI_121>
Rnames{i} = 'OLNDQ+HQ2=0.5ONITQ+0.5 ALD + 0.5 HQ2  + 0.5 QH';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'OLNDQ'; Gstr{i,2} = 'HQ2'; 
fOLNDQ(i)=fOLNDQ(i)-1; fHQ2(i)=fHQ2(i)-1; fONITQ(i)=fONITQ(i)+0.5; fALD(i)=fALD(i)+0.5;
fHQ2(i)=fHQ2(i)+0.5; fQH(i)=fQH(i)+0.5;
...
i=i+1; %<RACM2_245>; <BAPI_121>
Rnames{i} = 'OLNDQ2+HO2=0.5ONITQ2+0.5 ALD + 0.5 HO2  + 0.5 OH';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'OLNDQ2'; Gstr{i,2} = 'HO2'; 
fOLNDQ2(i)=fOLNDQ2(i)-1; fHO2(i)=fHO2(i)-1; fONITQ2(i)=fONITQ2(i)+0.5; fALD(i)=fALD(i)+0.5;
fHO2(i)=fHO2(i)+0.5; fOH(i)=fOH(i)+0.5;
...
i=i+1; %<RACM2_245>; <BAPI_121>
Rnames{i} = 'OLNDQ2+HOQ=0.5ONITQ2+0.5 ALD + 0.5 HOQ  + 0.25 OH + 0.25 QH';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'OLNDQ2'; Gstr{i,2} = 'HOQ'; 
fOLNDQ2(i)=fOLNDQ2(i)-1; fHOQ(i)=fHOQ(i)-1; fONITQ2(i)=fONITQ2(i)+0.5; fALD(i)=fALD(i)+0.5;
fHOQ(i)=fHOQ(i)+0.5; fOH(i)=fOH(i)+0.25;  fQH(i)=fQH(i)+0.25;
 
 
 
i=i+1; %<RACM2_245>; <BAPI_121>
Rnames{i} = 'OLNDQ2+HQ2=0.5ONITQ2+0.5 ALD + 0.5 HQ2  + 0.5 QH';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'OLNDQ2'; Gstr{i,2} = 'HQ2'; 
fOLNDQ2(i)=fOLNDQ2(i)-1; fHQ2(i)=fHQ2(i)-1; fONITQ2(i)=fONITQ2(i)+0.5; fALD(i)=fALD(i)+0.5;
fHQ2(i)=fHQ2(i)+0.5; fQH(i)=fQH(i)+0.5;
...
i=i+1; %<RACM2_245>; <BAPI_121>
Rnames{i} = 'OLNDQ3+HO2=0.5ONITQ3+0.5 ALD + 0.5 HO2  + 0.5 OH';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'OLNDQ3'; Gstr{i,2} = 'HO2'; 
fOLNDQ3(i)=fOLNDQ3(i)-1; fHO2(i)=fHO2(i)-1; fONITQ3(i)=fONITQ3(i)+0.5; fALD(i)=fALD(i)+0.5;
fHO2(i)=fHO2(i)+0.5; fOH(i)=fOH(i)+0.5;
 
 
i=i+1; %<RACM2_245>; <BAPI_121>
Rnames{i} = 'OLNDQ3+HOQ=0.5ONITQ3+0.5 ALD + 0.5 HOQ  + 0.25 OH + 0.25 QH';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'OLNDQ3'; Gstr{i,2} = 'HOQ'; 
fOLNDQ3(i)=fOLNDQ3(i)-1; fHOQ(i)=fHOQ(i)-1; fONITQ3(i)=fONITQ3(i)+0.5; fALD(i)=fALD(i)+0.5;
fHOQ(i)=fHOQ(i)+0.5; fOH(i)=fOH(i)+0.25; fQH(i)=fQH(i)+0.25;
 
 
i=i+1; %<RACM2_245>; <BAPI_121>
Rnames{i} = 'OLNDQ3+HQ2=0.5ONITQ3+0.5 ALD + 0.5 HQ2  + 0.5 QH';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'OLNDQ3'; Gstr{i,2} = 'HQ2'; 
fOLNDQ3(i)=fOLNDQ3(i)-1; fHQ2(i)=fHQ2(i)-1; fONITQ3(i)=fONITQ3(i)+0.5; fALD(i)=fALD(i)+0.5;
fHQ2(i)=fHQ2(i)+0.5;  fQH(i)=fQH(i)+0.5;
