...
fOLND(i)=fOLND(i)-1; fHO2(i)=fHO2(i)-1; fONIT(i)=fONIT(i)+0.45; fONIT(i)=fONIT(i)+0.05; fALD(i)=fALD(i)+0.5;
...
Rnames{i} = 'OLNN+OLNN=ONIT+hONIT+HO2';
k(:,i) = 7.00E-14.*exp(1000./T);
Gstr{i,1} = 'OLNN'; Gstr{i,2} = 'OLNN'; 
fOLNN(i)=fOLNN(i)-1; fOLNN(i)=fOLNN(i)-1; fONIT(i)=fONIT(i)+1.8; fONIT(i)=fONIT(i)+0.2; fHO2(i)=fHO2(i)+1; 

i=i+1; %<RACM2_360>; <BAPI_163>
Rnames{i} = 'OLNN+OLND=0.50 HO2+0.50 NO2+0.202 HCHO+0.640 ALD+0.149 KET+1.35 ONIT +0.15 hONIT ';
...
Rnames{i} = 'OLND+OLND=NO2+0.504 HCHO+1.21 ALD+0.285 KET+ONIT+hONIT ';
