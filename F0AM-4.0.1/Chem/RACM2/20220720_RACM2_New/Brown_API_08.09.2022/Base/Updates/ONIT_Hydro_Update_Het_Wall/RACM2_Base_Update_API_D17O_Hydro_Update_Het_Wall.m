...
'HNO3'; 'HNO2Q'; 'HNOQ2'; 'HNQ3'; 'ONIT'; 'ONITQ'; 'ONITQ2'; 'ONITQ3'; ...
'pONIT'; 'pONITQ'; 'pONITQ2'; 'pONITQ3';
'ACD'; 'ACO3'; 'ACT'; 'ACTP'; 'ALD'; 'API'; 'APIP'; 'CO'; 'CO2'; 'DCB1'; 'EOH'; 'ETHP'; ...
'GLY'; 'H2'; 'H2O2'; 'HC3P'; 'HCHO';  'HO2'; 'HO2NO2'; 'HONO'; 'KET'; 'KETP'; 'MEK'; ...
'MEKP'; 'MGLY'; 'MO2'; 'MOH'; 'N2O5'; 'NO';  'NO3'; 'O1D'; 'O3'; 'O3P'; 'OH'; 'OLND'; ...
'OLNN';  'OP1'; 'OP2'; 'ORA1'; 'ORA2'; 'ORAP'; 'PAA';   'RCO3'; 'ROH'; 'XO2'; ...
'COQ'; 'CQ'; 'CQ2'; 'H2OQ'; 'H2Q2'; 'HCHQ'; ...
 'HO2NOQ'; 'HO2NQ2'; 'HONQ'; 'HOQ'; 'HOQNO2'; 'HOQNOQ'; 'HOQNQ2'; ...
'HQ2'; 'HQ2NO2'; 'HQ2NOQ'; 'HQ2NQ2'; 'HQNO'; 'HQNQ'; 'NO2Q';  'NOQ2'; 'NQ'; ...
 'NQ3';   'Q1D'; 'Q3P'; 'QH'; ...
'OQ'; 'Q2'; 'H2Q2'; 'N2O4Q'; 'N2O3Q2'; 'N2O2Q3'; 'N2OQ4'; 'N2Q5'; 'OLNDQ'; 
'OLNDQ2'; 'OLNDQ3'; 'OLNNQ'; 'OLNNQ2'; 'OLNNQ3';  'wHNO3';  ...
'hONIT'; 'hONITQ'; 'hONITQ2'; 'hONITQ3'; ...
'wO3'; 'wNO'; 'wNQ'; 'wHNO3'; 'wHNO2Q'; 'wHNOQ2'; 'wHNQ3'; 'wONIT'; ...
'wONITQ'; 'wONITQ2'; 'wONITQ3'; 'wHO2'; 'wHOQ'; 'wHQ2'; ...
'A'; ...
};
...
i=i+1; %<RACM2_031>; <BAPI_025>
Rnames{i} = 'hONIT=HO2+0.2ALD+NO2+0.8KET';
k(:,i) = JONIT;
Gstr{i,1} = 'hONIT'; 
fhONIT(i)=fhONIT(i)-1; fHO2(i)=fHO2(i)+1; fALD(i)=fALD(i)+0.2; fNO2(i)=fNO2(i)+1; fKET(i)=fKET(i)+0.8; 

%O3 Tracer
i=i+1; %<RACM2_031>; <BAPI_025a>
Rnames{i} = 'hONITQ=(2/3)HO2+0.2ALD+(2/3)NOQ+0.8KET+(1/3)NO2+(1/3)HOQ';
k(:,i) = JONIT;
Gstr{i,1} = 'hONITQ'; 
fhONITQ(i)=fhONITQ(i)-1; fHO2(i)=fHO2(i)+(2/3); fALD(i)=fALD(i)+0.2; fNOQ(i)=fNOQ(i)+(2/3); fKET(i)=fKET(i)+0.8; fNO2(i)=fNO2(i)+(1/3); fHOQ(i)=fHOQ(i)+(1/3);

%O3 Tracer
i=i+1; %<RACM2_031>; <BAPI_025b>
Rnames{i} = 'hONITQ2=(2/3)HOQ+0.2ALD+(2/3)NOQ+0.8KET+(1/3)NQ2+(1/3)HO2';
k(:,i) = JONIT;
Gstr{i,1} = 'hONITQ2'; 
fhONITQ2(i)=fhONITQ2(i)-1; fHO2(i)=fHO2(i)+(1/3); fALD(i)=fALD(i)+0.2; fNQ2(i)=fNQ2(i)+(1/3); fKET(i)=fKET(i)+0.8; fNOQ(i)=fNOQ(i)+(2/3); fHO2(i)=fHO2(i)+(1/3);

%O3 Tracer
i=i+1; %<RACM2_031>; <BAPI_025c>
Rnames{i} = 'hONITQ3=HOQ+0.2ALD+NQ2+0.8KET';
k(:,i) = JONIT;
Gstr{i,1} = 'hONITQ3'; 
fhONITQ3(i)=fhONITQ3(i)-1; fHOQ(i)=fHOQ(i)+1; fALD(i)=fALD(i)+0.2; fNQ2(i)=fNQ2(i)+1; fKET(i)=fKET(i)+0.8;
...
i=i+1; %<RACM2_123>; <BAPI_084>
Rnames{i} = 'hONIT+OH=HC3P+NO2+H2O';
k(:,i) = 5.31E-12.*exp(-260./T);
Gstr{i,1} = 'hONIT'; Gstr{i,2} = 'OH'; 
fhONIT(i)=fhONIT(i)-1; fOH(i)=fOH(i)-1; fHC3P(i)=fHC3P(i)+1; fNO2(i)=fNO2(i)+1; 

%O3 Tracer
i=i+1; %<RACM2_123a>; <BAPI_084a>
Rnames{i} = 'hONIT+QH=HC3P+NO2+H2Q';
k(:,i) = 5.31E-12.*exp(-260./T);
Gstr{i,1} = 'hONIT'; Gstr{i,2} = 'QH'; 
fhONIT(i)=fhONIT(i)-1; fQH(i)=fQH(i)-1; fHC3P(i)=fHC3P(i)+1; fNO2(i)=fNO2(i)+1; 

%O3 Tracer
i=i+1; %<RACM2_123b>; <BAPI_084b>
Rnames{i} = 'hONITQ+OH=HC3P+NOQ+H2O';
k(:,i) = 5.31E-12.*exp(-260./T);
Gstr{i,1} = 'hONITQ'; Gstr{i,2} = 'OH'; 
fhONITQ(i)=fhONITQ(i)-1; fOH(i)=fOH(i)-1; fHC3P(i)=fHC3P(i)+1; fNOQ(i)=fNOQ(i)+1;

%O3 Tracer
i=i+1; %<RACM2_123c>; <BAPI_084c>
Rnames{i} = 'hONITQ+QH=HC3P+NOQ+H2Q';
k(:,i) = 5.31E-12.*exp(-260./T);
Gstr{i,1} = 'hONITQ'; Gstr{i,2} = 'QH'; 
fhONITQ(i)=fhONITQ(i)-1; fQH(i)=fQH(i)-1; fHC3P(i)=fHC3P(i)+1; fNOQ(i)=fNOQ(i)+1;

%O3 Tracer
i=i+1; %<RACM2_123d>; <BAPI_084d>
Rnames{i} = 'hONITQ2+OH=HC3P+NQ2+H2O';
k(:,i) = 5.31E-12.*exp(-260./T);
Gstr{i,1} = 'hONITQ2'; Gstr{i,2} = 'OH'; 
fhONITQ2(i)=fhONITQ2(i)-1; fOH(i)=fOH(i)-1; fHC3P(i)=fHC3P(i)+1; fNQ2(i)=fNQ2(i)+1;

%O3 Tracer
i=i+1; %<RACM2_123e>; <BAPI_084e>
Rnames{i} = 'hONITQ2+QH=HC3P+NQ2+H2Q';
k(:,i) = 5.31E-12.*exp(-260./T);
Gstr{i,1} = 'hONITQ2'; Gstr{i,2} = 'QH'; 
fhONITQ2(i)=fhONITQ2(i)-1; fQH(i)=fQH(i)-1; fHC3P(i)=fHC3P(i)+1; fNQ2(i)=fNQ2(i)+1;
...
Rnames{i} = 'API+O3= QH+HQ2+ETHP+KETP+CQ+H2Q2+ALD+KET';
k(:,i) = 5.00E-16.*exp(-530./T) ;
Gstr{i,1} = 'API'; Gstr{i,2} = 'O3'; 
fAPI(i)=fAPI(i)-1; fO3(i)=fO3(i)-1; fQH(i)=fQH(i)+0.85; fHQ2(i)=fHQ2(i)+0.10; 
fETHP(i)=fETHP(i)+0.20; fKETP(i)=fKETP(i)+0.42; fCQ(i)=fCQ(i)+0.14; fH2Q2(i)=fH2Q2(i)+0.02; 
fALD(i)=fALD(i)+0.65; fKET(i)=fKET(i)+0.53; 

%O3 Tracer
i=i+1; %<RACM2_136>; <BAPI_086>
Rnames{i} = 'DCB1+O3= QH+HQ2+RCO3+XO2+CQ+HCHO+GLY+MGLY+OP2+CO2';
k(:,i) = 2.00E-16;
Gstr{i,1} = 'DCB1'; Gstr{i,2} = 'O3'; 
fDCB1(i)=fDCB1(i)-1; fO3(i)=fO3(i)-1; fQH(i)=fQH(i)+0.05; fHQ2(i)=fHQ2(i)+1.0; 
...
Rnames{i} = 'APIP+NO= HO2+NO2+HCHO+ALD+ACT+KET+ORA1+ONIT + hONIT';
k(:,i) = 4.00E-12;
...
fORA1(i)=fORA1(i)+0.07; fONIT(i)=fONIT(i)+0.1625; fhONIT(i)=fhONIT(i)+0.0875; 

%O3 Tracer
i=i+1; %<RACM2_189a>; <BAPI_100a>
Rnames{i} = 'APIP+NQ= HO2+NOQ+HCHO+ALD+ACT+KET+ORA1+ONITQ + hONITQ';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'APIP'; Gstr{i,2} = 'NQ'; 
fAPIP(i)=fAPIP(i)-1; fNQ(i)=fNQ(i)-1; fHO2(i)=fHO2(i)+0.82; fNOQ(i)=fNOQ(i)+0.82; 
fHCHO(i)=fHCHO(i)+0.23; fALD(i)=fALD(i)+0.43; fACT(i)=fACT(i)+0.11; fKET(i)=fKET(i)+0.44; 
fORA1(i)=fORA1(i)+0.07; fhONITQ(i)=fhONITQ(i)+0.1625; fhONITQ(i)=fhONITQ(i)+0.0875; 
...
Rnames{i} = 'OLNN+NO=ONIT+hONIT+NO2+HO2';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'OLNN'; Gstr{i,2} = 'NO'; 
fOLNN(i)=fOLNN(i)-1; fNO(i)=fNO(i)-1; fONIT(i)=fONIT(i)+0.9; fhONIT(i)=fhONIT(i)+0.1; fNO2(i)=fNO2(i)+1; fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1;  %<RACM2_205a>; <BAPI_107a>
Rnames{i} = 'OLNN+NQ=ONIT+hONIT+NOQ+HO2';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'OLNN'; Gstr{i,2} = 'NQ'; 
fOLNN(i)=fOLNN(i)-1; fNQ(i)=fNQ(i)-1; fONIT(i)=fONIT(i)+0.9; fhONIT(i)=fhONIT(i)+0.1; fNOQ(i)=fNOQ(i)+1; fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1;  %<RACM2_205b>; <BAPI_107b>
Rnames{i} = 'OLNNQ+NO=ONITQ+hONITQ+NO2+HO2';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'OLNNQ'; Gstr{i,2} = 'NO'; 
fOLNNQ(i)=fOLNNQ(i)-1; fNO(i)=fNO(i)-1; fONITQ(i)=fONITQ(i)+0.9; fhONITQ(i)=fhONITQ(i)+0.1; fNO2(i)=fNO2(i)+1; fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1;  %<RACM2_205c>; <BAPI_107c>
Rnames{i} = 'OLNNQ+NQ=ONITQ+hONITQ+NOQ+HO2';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'OLNNQ'; Gstr{i,2} = 'NQ'; 
fOLNNQ(i)=fOLNNQ(i)-1; fNQ(i)=fNQ(i)-1; fONITQ(i)=fONITQ(i)+0.9; fhONITQ(i)=fhONITQ(i)+0.1; fNOQ(i)=fNOQ(i)+1; fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1;  %<RACM2_205d>; <BAPI_107d>
Rnames{i} = 'OLNNQ2+NO=ONITQ2+hONITQ2+NO2+HO2';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'OLNNQ2'; Gstr{i,2} = 'NO'; 
fOLNNQ2(i)=fOLNNQ2(i)-1; fNO(i)=fNO(i)-1; fONITQ2(i)=fONITQ2(i)+0.9; fhONITQ2(i)=fhONITQ2(i)+0.1; fNO2(i)=fNO2(i)+1; fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1;  %<RACM2_205e>; <BAPI_107e>
Rnames{i} = 'OLNNQ2+NQ=ONITQ2+hONITQ2+NOQ+HO2';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'OLNNQ2'; Gstr{i,2} = 'NQ'; 
fOLNNQ2(i)=fOLNNQ2(i)-1; fNQ(i)=fNQ(i)-1; fONITQ2(i)=fONITQ2(i)+0.9; fhONITQ2(i)=fhONITQ2(i)+0.1; fNOQ(i)=fNOQ(i)+1; fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1;  %<RACM2_205f>; <BAPI_107f>
Rnames{i} = 'OLNNQ3+NO=ONITQ3+hONITQ3+NO2+HO2';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'OLNNQ3'; Gstr{i,2} = 'NO'; 
fOLNNQ3(i)=fOLNNQ3(i)-1; fNO(i)=fNO(i)-1; fONITQ3(i)=fONITQ3(i)+0.9; fhONITQ3(i)=fhONITQ3(i)+0.1; fNO2(i)=fNO2(i)+1; fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1;  %<RACM2_205g>; <BAPI_107g>
Rnames{i} = 'OLNNQ3+NQ=ONITQ3+hONITQ3+NOQ+HO2';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'OLNNQ3'; Gstr{i,2} = 'NQ'; 
fOLNNQ3(i)=fOLNNQ3(i)-1; fNQ(i)=fNQ(i)-1; fONITQ3(i)=fONITQ3(i)+0.9; fhONITQ3(i)=fhONITQ3(i)+0.1; fNOQ(i)=fNOQ(i)+1; fHO2(i)=fHO2(i)+1; 

i=i+1;  %<RACM2_206>; <BAPI_108>
Rnames{i} = 'OLND+NO=NO2+HCHO+ALD+KET + ONIT + hONIT';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'OLND'; Gstr{i,2} = 'NO'; 
fOLND(i)=fOLND(i)-1; fNO(i)=fNO(i)-1; fNO2(i)=fNO2(i)+2*0.9; fHCHO(i)=fHCHO(i)+0.2583; fALD(i)=fALD(i)+1.116; fKET(i)=fKET(i)+0.4176; fONIT(i)=fONIT(i)+0.09; fhONIT(i)=fhONIT(i)+0.01;

%O3 Tracer
i=i+1;  %<RACM2_206a>; <BAPI_108a>
Rnames{i} = 'OLND+NQ=NOQ+HCHO+ALD+KET + ONIT + hONIT';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'OLND'; Gstr{i,2} = 'NQ'; 
fOLND(i)=fOLND(i)-1; fNQ(i)=fNQ(i)-1; fNOQ(i)=fNOQ(i)+1*0.9; fNO2(i)=fNO2(i)+1*0.9; fHCHO(i)=fHCHO(i)+0.2583; fALD(i)=fALD(i)+1.116; fKET(i)=fKET(i)+0.4176; fONIT(i)=fONIT(i)+0.09; fhONIT(i)=fhONIT(i)+0.01;

%O3 Tracer
i=i+1;  %<RACM2_206b>; <BAPI_108b>
Rnames{i} = 'OLNDQ+NO=NO2+HCHO+ALD+KET + ONITQ + hONITQ';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'OLNDQ'; Gstr{i,2} = 'NO'; 
fOLNDQ(i)=fOLNDQ(i)-1; fNO(i)=fNO(i)-1; fNO2(i)=fNO2(i)+1*0.9; fNOQ(i)=fNOQ(i)+1*0.9; fHCHO(i)=fHCHO(i)+0.2583; fALD(i)=fALD(i)+1.116; fKET(i)=fKET(i)+0.4176; fONITQ(i)=fONITQ(i)+0.09; fhONITQ(i)=fhONITQ(i)+0.01;

%O3 Tracer
i=i+1;  %<RACM2_206c>; <BAPI_108c>
Rnames{i} = 'OLNDQ+NQ=NOQ+HCHO+ALD+KET + ONITQ + hONITQ';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'OLNDQ'; Gstr{i,2} = 'NQ'; 
fOLNDQ(i)=fOLNDQ(i)-1; fNQ(i)=fNQ(i)-1; fNOQ(i)=fNOQ(i)+2*0.9; fHCHO(i)=fHCHO(i)+0.2583; fALD(i)=fALD(i)+1.116; fKET(i)=fKET(i)+0.4176; fONITQ(i)=fONITQ(i)+0.09; fhONITQ(i)=fhONITQ(i)+0.01;

%O3 Tracer
i=i+1;  %<RACM2_206d>; <BAPI_108d>
Rnames{i} = 'OLNDQ2+NO=NOQ+NO2+NQ2+HCHO+ALD+KET + ONITQ2 + hONITQ2';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'OLNDQ2'; Gstr{i,2} = 'NO'; 
fOLNDQ2(i)=fOLNDQ2(i)-1; fNO(i)=fNO(i)-1; fNO2(i)=fNO2(i)+(1/3)*0.9; fNQ2(i)=fNQ2(i)+(1/3)*0.9; fNOQ(i)=fNOQ(i)+(4/3)*0.9; fHCHO(i)=fHCHO(i)+0.2583; fALD(i)=fALD(i)+1.116; fKET(i)=fKET(i)+0.4176; fONITQ2(i)=fONITQ2(i)+0.09; fhONITQ2(i)=fhONITQ2(i)+0.01;

%O3 Tracer
i=i+1;  %<RACM2_206e>; <BAPI_108e>
Rnames{i} = 'OLNDQ2+NQ=NOQ+NQ2+HCHO+ALD+KET +ONITQ2 + hONITQ2';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'OLNDQ2'; Gstr{i,2} = 'NQ'; 
fOLNDQ2(i)=fOLNDQ2(i)-1; fNQ(i)=fNQ(i)-1; fNOQ(i)=fNOQ(i)+1*0.9; fNQ2(i)=fNQ2(i)+1*0.9;fHCHO(i)=fHCHO(i)+0.2583; fALD(i)=fALD(i)+1.116; fKET(i)=fKET(i)+0.4176;  fONITQ2(i)=fONITQ2(i)+0.09; fhONITQ2(i)=fhONITQ2(i)+0.01;

%O3 Tracer
i=i+1;  %<RACM2_206f>; <BAPI_108f>
Rnames{i} = 'OLNDQ3+NO=NOQ+NQ2+HCHO+ALD+KET +ONITQ3 + hONITQ3';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'OLNDQ3'; Gstr{i,2} = 'NO'; 
fOLNDQ3(i)=fOLNDQ3(i)-1; fNO(i)=fNO(i)-1; fNOQ(i)=fNOQ(i)+1*0.9; fNQ2(i)=fNQ2(i)+1*0.9; fHCHO(i)=fHCHO(i)+0.2583; fALD(i)=fALD(i)+1.116; fKET(i)=fKET(i)+0.4176; fONITQ3(i)=fONITQ3(i)+0.09; fhONITQ3(i)=fhONITQ3(i)+0.01;

%O3 Tracer
i=i+1;  %<RACM2_206g>; <BAPI_108g>
Rnames{i} = 'OLNDQ3+NQ=NQ2+HCHO+ALD+KET + ONITQ3 + hONITQ3';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'OLNDQ3'; Gstr{i,2} = 'NQ'; 
fOLNDQ3(i)=fOLNDQ3(i)-1; fNQ(i)=fNQ(i)-1; fNQ2(i)=fNQ2(i)+2*0.9; fHCHO(i)=fHCHO(i)+0.2583; fALD(i)=fALD(i)+1.116; fKET(i)=fKET(i)+0.4176; fONITQ3(i)=fONITQ3(i)+0.09; fhONITQ3(i)=fhONITQ3(i)+0.01;
...
Rnames{i} = 'OLNN+HO2=ONIT + hONIT';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'OLNN'; Gstr{i,2} = 'HO2'; 
fOLNN(i)=fOLNN(i)-1; fHO2(i)=fHO2(i)-1; fONIT(i)=fONIT(i)+0.9; fhONIT(i)=fhONIT(i)+0.1; 

%O3 Tracer
i=i+1; %<RACM2_244a>; <BAPI_120a>
Rnames{i} = 'OLNN+HOQ=ONIT + hONIT';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'OLNN'; Gstr{i,2} = 'HOQ'; 
fOLNN(i)=fOLNN(i)-1; fHOQ(i)=fHOQ(i)-1; fONIT(i)=fONIT(i)+0.9; fhONIT(i)=fhONIT(i)+0.1; 

%O3 Tracer
i=i+1; %<RACM2_244b>; <BAPI_120b>
Rnames{i} = 'OLNN+HQ2=ONIT + hONIT';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'OLNN'; Gstr{i,2} = 'HQ2'; 
fOLNN(i)=fOLNN(i)-1; fHQ2(i)=fHQ2(i)-1; fONIT(i)=fONIT(i)+0.9; fhONIT(i)=fhONIT(i)+0.1; 

%O3 Tracer
i=i+1; %<RACM2_244c>; <BAPI_120c>
Rnames{i} = 'OLNNQ+HO2=ONITQ + hONITQ';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'OLNNQ'; Gstr{i,2} = 'HO2'; 
fOLNNQ(i)=fOLNNQ(i)-1; fHO2(i)=fHO2(i)-1; fONITQ(i)=fONITQ(i)+0.9; fhONITQ(i)=fhONITQ(i)+0.1; 

%O3 Tracer
i=i+1; %<RACM2_244d>; <BAPI_120d>
Rnames{i} = 'OLNNQ+HOQ=ONITQ + hONITQ';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'OLNNQ'; Gstr{i,2} = 'HOQ'; 
fOLNNQ(i)=fOLNNQ(i)-1; fHOQ(i)=fHOQ(i)-1; fONITQ(i)=fONITQ(i)+0.9; fhONITQ(i)=fhONITQ(i)+0.1;

%O3 Tracer
i=i+1; %<RACM2_244e>; <BAPI_120e>
Rnames{i} = 'OLNNQ+HQ2=ONITQ + hONITQ';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'OLNNQ'; Gstr{i,2} = 'HQ2'; 
fOLNNQ(i)=fOLNNQ(i)-1; fHQ2(i)=fHQ2(i)-1; fONITQ(i)=fONITQ(i)+0.9; fhONITQ(i)=fhONITQ(i)+0.1;

%O3 Tracer
i=i+1; %<RACM2_244f>; <BAPI_120f>
Rnames{i} = 'OLNNQ2+HO2=ONITQ2 + hONITQ2';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'OLNNQ2'; Gstr{i,2} = 'HO2'; 
fOLNNQ2(i)=fOLNNQ2(i)-1; fHO2(i)=fHO2(i)-1; fONITQ2(i)=fONITQ2(i)+0.9; fhONITQ2(i)=fhONITQ2(i)+0.1;

%O3 Tracer
i=i+1; %<RACM2_244g>; <BAPI_120g>
Rnames{i} = 'OLNNQ2+HOQ=ONITQ2 + hONITQ2';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'OLNNQ2'; Gstr{i,2} = 'HOQ'; 
fOLNNQ2(i)=fOLNNQ2(i)-1; fHOQ(i)=fHOQ(i)-1; fONITQ2(i)=fONITQ2(i)+0.9; fhONITQ2(i)=fhONITQ2(i)+0.1;

%O3 Tracer
i=i+1; %<RACM2_244h>; <BAPI_120h>
Rnames{i} = 'OLNNQ2+HQ2=ONITQ2 + hONITQ2';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'OLNNQ2'; Gstr{i,2} = 'HQ2'; 
fOLNNQ2(i)=fOLNNQ2(i)-1; fHQ2(i)=fHQ2(i)-1; fONITQ2(i)=fONITQ2(i)+0.9; fhONITQ2(i)=fhONITQ2(i)+0.1;

%O3 Tracer
i=i+1; %<RACM2_244i>; <BAPI_120i>
Rnames{i} = 'OLNNQ3+HO2=ONITQ3 + hONITQ3';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'OLNNQ3'; Gstr{i,2} = 'HO2'; 
fOLNNQ3(i)=fOLNNQ3(i)-1; fHO2(i)=fHO2(i)-1; fONITQ3(i)=fONITQ3(i)+0.9;  fhONITQ3(i)=fhONITQ3(i)+0.1;

%O3 Tracer
i=i+1; %<RACM2_244j>; <BAPI_120j>
Rnames{i} = 'OLNNQ3+HOQ=ONITQ3 + hONITQ3';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'OLNNQ3'; Gstr{i,2} = 'HOQ'; 
fOLNNQ3(i)=fOLNNQ3(i)-1; fHOQ(i)=fHOQ(i)-1; fONITQ3(i)=fONITQ3(i)+0.9;  fhONITQ3(i)=fhONITQ3(i)+0.1;

%O3 Tracer
i=i+1; %<RACM2_244k>; <BAPI_120k>
Rnames{i} = 'OLNNQ3+HQ2=ONITQ3 + hONITQ3';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'OLNNQ3'; Gstr{i,2} = 'HQ2'; 
fOLNNQ3(i)=fOLNNQ3(i)-1; fHQ2(i)=fHQ2(i)-1; fONITQ3(i)=fONITQ3(i)+0.9;  fhONITQ3(i)=fhONITQ3(i)+0.1;


i=i+1; %<RACM2_245>; <BAPI_121>
Rnames{i} = 'OLND+HO2=0.45ONIT+0.05hONIT+0.5 ALD + 0.5 HO2 + 0.5 OH';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'OLND'; Gstr{i,2} = 'HO2'; 
fOLND(i)=fOLND(i)-1; fHO2(i)=fHO2(i)-1; fONIT(i)=fONIT(i)+0.45; fhONIT(i)=fhONIT(i)+0.05; fALD(i)=fALD(i)+0.5;
fHO2(i)=fHO2(i)+0.5;  fOH(i)=fOH(i)+0.5;
 
 
i=i+1; %<RACM2_245>; <BAPI_121>
Rnames{i} = 'OLND+HOQ=0.45ONIT+0.05hONIT0.5 ALD + 0.5 HOQ + 0.25 QH + 0.25 OH';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'OLND'; Gstr{i,2} = 'HOQ'; 
fOLND(i)=fOLND(i)-1; fHOQ(i)=fHOQ(i)-1; fONIT(i)=fONIT(i)+0.45; fhONIT(i)=fhONIT(i)+0.05; fALD(i)=fALD(i)+0.5;
fHOQ(i)=fHOQ(i)+0.5;  fOH(i)=fOH(i)+0.25; fQH(i)=fQH(i)+0.25;
 
 
i=i+1; %<RACM2_245>; <BAPI_121>
Rnames{i} = 'OLND+HQ2=0.45ONIT+0.05hONIT+0.5 ALD + 0.5 HQ2 + 0.5 QH';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'OLND'; Gstr{i,2} = 'HQ2'; 
fOLND(i)=fOLND(i)-1; fHQ2(i)=fHQ2(i)-1; fONIT(i)=fONIT(i)+0.45; fhONIT(i)=fhONIT(i)+0.05; fALD(i)=fALD(i)+0.5;
fHQ2(i)=fHQ2(i)+0.5; fQH(i)=fQH(i)+0.5;
 
 
i=i+1; %<RACM2_245>; <BAPI_121>
Rnames{i} = 'OLNDQ+HO2=0.45ONITQ+0.05hONITQ+0.5 ALD + 0.5 HO2 + 0.5 OH';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'OLNDQ'; Gstr{i,2} = 'HO2'; 
fOLNDQ(i)=fOLNDQ(i)-1; fHO2(i)=fHO2(i)-1; fONITQ(i)=fONITQ(i)+0.45; fhONITQ(i)=fhONITQ(i)+0.05; fALD(i)=fALD(i)+0.5;
fHO2(i)=fHO2(i)+0.5; fOH(i)=fOH(i)+0.5;
...
i=i+1; %<RACM2_245>; <BAPI_121>
Rnames{i} = 'OLNDQ+HOQ=0.45ONITQ++0.05hONITQ+0.5 ALD + 0.5 HOQ + 0.25 OH + 0.25 QH';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'OLNDQ'; Gstr{i,2} = 'HOQ'; 
fOLNDQ(i)=fOLNDQ(i)-1; fHOQ(i)=fHOQ(i)-1; fONITQ(i)=fONITQ(i)+0.45; fhONITQ(i)=fhONITQ(i)+0.05; fALD(i)=fALD(i)+0.5;
fHOQ(i)=fHOQ(i)+0.5; fOH(i)=fOH(i)+0.25; fQH(i)=fQH(i)+0.25;
 
 
 
i=i+1; %<RACM2_245>; <BAPI_121>
Rnames{i} = 'OLNDQ+HQ2=0.45ONITQ+0.05hONITQ+0.5 ALD + 0.5 HQ2  + 0.5 QH';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'OLNDQ'; Gstr{i,2} = 'HQ2'; 
fOLNDQ(i)=fOLNDQ(i)-1; fHQ2(i)=fHQ2(i)-1; fONITQ(i)=fONITQ(i)+0.45; fhONITQ(i)=fhONITQ(i)+0.05; fALD(i)=fALD(i)+0.5;
fHQ2(i)=fHQ2(i)+0.5; fQH(i)=fQH(i)+0.5;
...
i=i+1; %<RACM2_245>; <BAPI_121>
Rnames{i} = 'OLNDQ2+HO2=0.45ONITQ2+0.05hONITQ2+0.5 ALD + 0.5 HO2  + 0.5 OH';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'OLNDQ2'; Gstr{i,2} = 'HO2'; 
fOLNDQ2(i)=fOLNDQ2(i)-1; fHO2(i)=fHO2(i)-1; fONITQ2(i)=fONITQ2(i)+0.45; fhONITQ2(i)=fhONITQ2(i)+0.05; fALD(i)=fALD(i)+0.5;
fHO2(i)=fHO2(i)+0.5; fOH(i)=fOH(i)+0.5;
...
i=i+1; %<RACM2_245>; <BAPI_121>
Rnames{i} = 'OLNDQ2+HOQ=0.45ONITQ2+0.05hONITQ2+0.5 ALD + 0.5 HOQ  + 0.25 OH + 0.25 QH';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'OLNDQ2'; Gstr{i,2} = 'HOQ'; 
fOLNDQ2(i)=fOLNDQ2(i)-1; fHOQ(i)=fHOQ(i)-1; fONITQ2(i)=fONITQ2(i)+0.45; fhONITQ2(i)=fhONITQ2(i)+0.05; fALD(i)=fALD(i)+0.5;
fHOQ(i)=fHOQ(i)+0.5; fOH(i)=fOH(i)+0.25;  fQH(i)=fQH(i)+0.25;
 
 
 
i=i+1; %<RACM2_245>; <BAPI_121>
Rnames{i} = 'OLNDQ2+HQ2=0.45ONITQ2+0.05hONITQ2+0.5 ALD + 0.5 HQ2  + 0.5 QH';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'OLNDQ2'; Gstr{i,2} = 'HQ2'; 
fOLNDQ2(i)=fOLNDQ2(i)-1; fHQ2(i)=fHQ2(i)-1; fONITQ2(i)=fONITQ2(i)+0.45; fhONITQ2(i)=fhONITQ2(i)+0.05; fALD(i)=fALD(i)+0.5;
fHQ2(i)=fHQ2(i)+0.5; fQH(i)=fQH(i)+0.5;
...
i=i+1; %<RACM2_245>; <BAPI_121>
Rnames{i} = 'OLNDQ3+HO2=0.45ONITQ3+0.05hONITQ3+0.5 ALD + 0.5 HO2  + 0.5 OH';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'OLNDQ3'; Gstr{i,2} = 'HO2'; 
fOLNDQ3(i)=fOLNDQ3(i)-1; fHO2(i)=fHO2(i)-1; fONITQ3(i)=fONITQ3(i)+0.45; fhONITQ3(i)=fhONITQ3(i)+0.05; fALD(i)=fALD(i)+0.5;
fHO2(i)=fHO2(i)+0.5; fOH(i)=fOH(i)+0.5;
 
 
i=i+1; %<RACM2_245>; <BAPI_121>
Rnames{i} = 'OLNDQ3+HOQ=0.45ONITQ3+0.05hONITQ3+0.5 ALD + 0.5 HOQ  + 0.25 OH + 0.25 QH';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'OLNDQ3'; Gstr{i,2} = 'HOQ'; 
fOLNDQ3(i)=fOLNDQ3(i)-1; fHOQ(i)=fHOQ(i)-1; fONITQ3(i)=fONITQ3(i)+0.45; fhONITQ3(i)=fhONITQ3(i)+0.05; fALD(i)=fALD(i)+0.5;
fHOQ(i)=fHOQ(i)+0.5; fOH(i)=fOH(i)+0.25; fQH(i)=fQH(i)+0.25;
 
 
i=i+1; %<RACM2_245>; <BAPI_121>
Rnames{i} = 'OLNDQ3+HQ2=0.45ONITQ3+0.05hONITQ3+0.5 ALD + 0.5 HQ2  + 0.5 QH';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'OLNDQ3'; Gstr{i,2} = 'HQ2'; 
fOLNDQ3(i)=fOLNDQ3(i)-1; fHQ2(i)=fHQ2(i)-1;fONITQ3(i)=fONITQ3(i)+0.45; fhONITQ3(i)=fhONITQ3(i)+0.05; fALD(i)=fALD(i)+0.5;
fHQ2(i)=fHQ2(i)+0.5;  fQH(i)=fQH(i)+0.5;
...
Rnames{i} = 'OLNN+MO2=HCHO+HO2+HO2+ONIT + hONIT';
k(:,i) = 1.60E-13.*exp(708./T);
Gstr{i,1} = 'OLNN'; Gstr{i,2} = 'MO2'; 
fOLNN(i)=fOLNN(i)-1; fMO2(i)=fMO2(i)-1; fHCHO(i)=fHCHO(i)+1; fHO2(i)=fHO2(i)+1; fHO2(i)=fHO2(i)+1; fONIT(i)=fONIT(i)+0.9; fhONIT(i)=fhONIT(i)+0.1; 

%O3 Tracer
i=i+1; %<RACM2_281a>; <BAPI_133a>
Rnames{i} = 'OLNNQ+MO2=HCHO+HO2+HO2+ONITQ + hONITQ';
k(:,i) = 1.60E-13.*exp(708./T);
Gstr{i,1} = 'OLNNQ'; Gstr{i,2} = 'MO2'; 
fOLNNQ(i)=fOLNNQ(i)-1; fMO2(i)=fMO2(i)-1; fHCHO(i)=fHCHO(i)+1; fHO2(i)=fHO2(i)+1; fHO2(i)=fHO2(i)+1; fONITQ(i)=fONITQ(i)+0.9; fhONITQ(i)=fhONITQ(i)+0.1;

%O3 Tracer
i=i+1; %<RACM2_281b>; <BAPI_133b>
Rnames{i} = 'OLNNQ2+MO2=HCHO+HO2+HO2+ONITQ2 + hONITQ2';
k(:,i) = 1.60E-13.*exp(708./T);
Gstr{i,1} = 'OLNNQ2'; Gstr{i,2} = 'MO2'; 
fOLNNQ2(i)=fOLNNQ2(i)-1; fMO2(i)=fMO2(i)-1; fHCHO(i)=fHCHO(i)+1; fHO2(i)=fHO2(i)+1; fHO2(i)=fHO2(i)+1; fONITQ2(i)=fONITQ2(i)+0.9; fhONITQ2(i)=fhONITQ2(i)+0.1;

%O3 Tracer
i=i+1; %<RACM2_281c>; <BAPI_133c>
Rnames{i} = 'OLNNQ3+MO2=HCHO+HO2+HO2+ONITQ3 + hONITQ3';
k(:,i) = 1.60E-13.*exp(708./T);
Gstr{i,1} = 'OLNNQ3'; Gstr{i,2} = 'MO2'; 
fOLNNQ3(i)=fOLNNQ3(i)-1; fMO2(i)=fMO2(i)-1; fHCHO(i)=fHCHO(i)+1; fHO2(i)=fHO2(i)+1; fHO2(i)=fHO2(i)+1; fONITQ3(i)=fONITQ3(i)+0.9; fhONITQ3(i)=fhONITQ3(i)+0.1;


i=i+1; %<RACM2_282>; <BAPI_134>
Rnames{i} = 'OLND+MO2= HO2+NO2+HCHO+ALD+KET+MOH+ROH+ONIT + hONIT';
...
fROH(i)=fROH(i)+0.25; fONIT(i)=fONIT(i)+0.45; fhONIT(i)=fhONIT(i)+0.05; 

%O3 Tracer
i=i+1; %<RACM2_282a>; <BAPI_134a>
Rnames{i} = 'OLNDQ+MO2= HO2+NOQ+NO2+HCHO+ALD+KET+MOH+ROH+ONITQ + hONITQ';
k(:,i) = 9.68E-14.*exp(708./T);
Gstr{i,1} = 'OLNDQ'; Gstr{i,2} = 'MO2'; 
fOLND(i)=fOLND(i)-1; fMO2(i)=fMO2(i)-1; fHO2(i)=fHO2(i)+0.50; fNO2(i)=fNO2(i)+(1/6); fNOQ(i)=fNOQ(i)+(1/3); 
fHCHO(i)=fHCHO(i)+0.965; fALD(i)=fALD(i)+0.93; fKET(i)=fKET(i)+0.348; fMOH(i)=fMOH(i)+0.25; 
fROH(i)=fROH(i)+0.25; fONITQ(i)=fONITQ(i)+0.45; fhONITQ(i)=fhONITQ(i)+0.05; 

%O3 Tracer
i=i+1; %<RACM2_282b>; <BAPI_134b>
Rnames{i} = 'OLNDQ2+MO2= HO2+NOQ+NQ2+HCHO+ALD+KET+MOH+ROH+ONITQ2 + hONITQ2';
k(:,i) = 9.68E-14.*exp(708./T);
Gstr{i,1} = 'OLNDQ'; Gstr{i,2} = 'MO2'; 
fOLND(i)=fOLND(i)-1; fMO2(i)=fMO2(i)-1; fHO2(i)=fHO2(i)+0.50; fNQ2(i)=fNQ2(i)+(1/6); fNOQ(i)=fNOQ(i)+(1/3); 
fHCHO(i)=fHCHO(i)+0.965; fALD(i)=fALD(i)+0.93; fKET(i)=fKET(i)+0.348; fMOH(i)=fMOH(i)+0.25; 
fROH(i)=fROH(i)+0.25; fONITQ2(i)=fONITQ2(i)+0.45; fhONITQ2(i)=fhONITQ2(i)+0.05; 

%O3 Tracer
i=i+1; %<RACM2_282c>; <BAPI_134c>
Rnames{i} = 'OLNDQ3+MO2= HO2+NQ2+HCHO+ALD+KET+MOH+ROH+ONITQ3 + hONITQ3';
k(:,i) = 9.68E-14.*exp(708./T);
Gstr{i,1} = 'OLNDQ'; Gstr{i,2} = 'MO2'; 
fOLND(i)=fOLND(i)-1; fMO2(i)=fMO2(i)-1; fHO2(i)=fHO2(i)+0.50; fNQ2(i)=fNQ2(i)+0.5; 
fHCHO(i)=fHCHO(i)+0.965; fALD(i)=fALD(i)+0.93; fKET(i)=fKET(i)+0.348; fMOH(i)=fMOH(i)+0.25; 
fROH(i)=fROH(i)+0.25; fONITQ3(i)=fONITQ3(i)+0.45; fhONITQ3(i)=fhONITQ3(i)+0.05;
...
Rnames{i} = 'OLNN+ACO3=ONIT+hONIT+MO2+HO2';
k(:,i) = 8.85E-13.*exp(765./T);
Gstr{i,1} = 'OLNN'; Gstr{i,2} = 'ACO3'; 
fOLNN(i)=fOLNN(i)-1; fACO3(i)=fACO3(i)-1; fONIT(i)=fONIT(i)+0.9; fhONIT(i)=fhONIT(i)+0.1; fMO2(i)=fMO2(i)+1; fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1; %<RACM2_317a>; <BAPI_145a>
Rnames{i} = 'OLNNQ+ACO3=ONITQ+hONITQ+MO2+HO2';
k(:,i) = 8.85E-13.*exp(765./T);
Gstr{i,1} = 'OLNNQ'; Gstr{i,2} = 'ACO3'; 
fOLNNQ(i)=fOLNNQ(i)-1; fACO3(i)=fACO3(i)-1; fONITQ(i)=fONITQ(i)+0.9; fhONITQ(i)=fhONITQ(i)+0.1; fMO2(i)=fMO2(i)+1; fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1; %<RACM2_317b>; <BAPI_145b>
Rnames{i} = 'OLNNQ2+ACO3=ONITQ2+hONITQ2+MO2+HO2';
k(:,i) = 8.85E-13.*exp(765./T);
Gstr{i,1} = 'OLNNQ2'; Gstr{i,2} = 'ACO3'; 
fOLNNQ2(i)=fOLNNQ2(i)-1; fACO3(i)=fACO3(i)-1; fONITQ2(i)=fONITQ2(i)+0.9; fhONITQ2(i)=fhONITQ2(i)+0.1; fMO2(i)=fMO2(i)+1; fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1; %<RACM2_317c>; <BAPI_145c>
Rnames{i} = 'OLNNQ3+ACO3=ONITQ3+hONITQ3+MO2+HO2';
k(:,i) = 8.85E-13.*exp(765./T);
Gstr{i,1} = 'OLNNQ3'; Gstr{i,2} = 'ACO3'; 
fOLNNQ3(i)=fOLNNQ3(i)-1; fACO3(i)=fACO3(i)-1; fONITQ3(i)=fONITQ3(i)+0.9; fhONITQ3(i)=fhONITQ3(i)+0.1; fMO2(i)=fMO2(i)+1; fHO2(i)=fHO2(i)+1; 
...
Rnames{i} = 'OLNN+NO3=ONIT+hONIT+NO2+HO2';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'OLNN'; Gstr{i,2} = 'NO3'; 
fOLNN(i)=fOLNN(i)-1; fNO3(i)=fNO3(i)-1; fONIT(i)=fONIT(i)+0.9; fhONIT(i)=fhONIT(i)+0.1; fNO2(i)=fNO2(i)+1; fHO2(i)=fHO2(i)+1; 
...
fOLNN(i)=fOLNN(i)-1; fNO2Q(i)=fNO2Q(i)-1;  fONIT(i)=fONIT(i)+0.9; fhONIT(i)=fhONIT(i)+0.1; fNO2(i)=fNO2(i)+(1/3); fNOQ(i)=fNOQ(i)+(2/3); fHO2(i)=fHO2(i)+1; 
...
fOLNN(i)=fOLNN(i)-1; fNOQ2(i)=fNOQ2(i)-1;  fONIT(i)=fONIT(i)+0.9; fhONIT(i)=fhONIT(i)+0.1; fNQ2(i)=fNQ2(i)+(1/3); fNOQ(i)=fNOQ(i)+(2/3); fHO2(i)=fHO2(i)+1; 
...
fOLNN(i)=fOLNN(i)-1; fNQ3(i)=fNQ3(i)-1;  fONIT(i)=fONIT(i)+0.9; fhONIT(i)=fhONIT(i)+0.1; fNQ2(i)=fNQ2(i)+1; fHO2(i)=fHO2(i)+1; 
...
fOLNNQ(i)=fOLNNQ(i)-1; fNO3(i)=fNO3(i)-1; fONITQ(i)=fONITQ(i)+0.9; fhONITQ(i)=fhONITQ(i)+0.1; fNO2(i)=fNO2(i)+1; fHO2(i)=fHO2(i)+1; 
...
fOLNNQ(i)=fOLNNQ(i)-1; fNO2Q(i)=fNO2Q(i)-1; fONITQ(i)=fONITQ(i)+0.9; fhONITQ(i)=fhONITQ(i)+0.1; fNO2(i)=fNO2(i)+(1/3); fNOQ(i)=fNOQ(i)+(2/3); fHO2(i)=fHO2(i)+1; 
...
fOLNNQ(i)=fOLNNQ(i)-1; fNOQ2(i)=fNOQ2(i)-1; fONITQ(i)=fONITQ(i)+0.9; fhONITQ(i)=fhONITQ(i)+0.1; fNQ2(i)=fNQ2(i)+(1/3); fNOQ(i)=fNOQ(i)+(2/3); fHO2(i)=fHO2(i)+1; 
...
fOLNNQ(i)=fOLNNQ(i)-1; fNQ3(i)=fNQ3(i)-1; fONITQ(i)=fONITQ(i)+0.9; fhONITQ(i)=fhONITQ(i)+0.1; fNQ2(i)=fNQ2(i)+1; fHO2(i)=fHO2(i)+1; 
...
fOLNNQ2(i)=fOLNNQ2(i)-1; fNO3(i)=fNO3(i)-1; fONITQ2(i)=fONITQ2(i)+0.9;  fhONITQ2(i)=fhONITQ2(i)+0.1; fNO2(i)=fNO2(i)+1; fHO2(i)=fHO2(i)+1; 
...
fOLNNQ2(i)=fOLNNQ2(i)-1; fNO2Q(i)=fNO2Q(i)-1; fONITQ2(i)=fONITQ2(i)+0.9;  fhONITQ2(i)=fhONITQ2(i)+0.1; fNO2(i)=fNO2(i)+(1/3); fNOQ(i)=fNOQ(i)+(2/3); fHO2(i)=fHO2(i)+1;
...
fOLNNQ2(i)=fOLNNQ2(i)-1; fNOQ2(i)=fNOQ2(i)-1; fONITQ2(i)=fONITQ2(i)+0.9;  fhONITQ2(i)=fhONITQ2(i)+0.1; fNQ2(i)=fNQ2(i)+(1/3); fNOQ(i)=fNOQ(i)+(2/3); fHO2(i)=fHO2(i)+1;
...
fOLNNQ2(i)=fOLNNQ2(i)-1; fNQ3(i)=fNQ3(i)-1;fONITQ2(i)=fONITQ2(i)+0.9;  fhONITQ2(i)=fhONITQ2(i)+0.1; fNQ2(i)=fNQ2(i)+1; fHO2(i)=fHO2(i)+1;
...
fOLNNQ3(i)=fOLNNQ3(i)-1; fNO3(i)=fNO3(i)-1; fONITQ3(i)=fONITQ3(i)+0.9; fhONITQ3(i)=fhONITQ3(i)+0.1; fNO2(i)=fNO2(i)+1; fHO2(i)=fHO2(i)+1;
...
fOLNNQ3(i)=fOLNNQ3(i)-1; fNO2Q(i)=fNO2Q(i)-1; fONITQ3(i)=fONITQ3(i)+0.9; fhONITQ3(i)=fhONITQ3(i)+0.1;  fNO2(i)=fNO2(i)+(1/3); fNOQ(i)=fNOQ(i)+(2/3); fHO2(i)=fHO2(i)+1;
...
fOLNNQ3(i)=fOLNNQ3(i)-1; fNOQ2(i)=fNOQ2(i)-1; fONITQ3(i)=fONITQ3(i)+0.9; fhONITQ3(i)=fhONITQ3(i)+0.1;  fNQ2(i)=fNQ2(i)+(1/3); fNOQ(i)=fNOQ(i)+(2/3); fHO2(i)=fHO2(i)+1;
...
fOLNNQ3(i)=fOLNNQ3(i)-1; fNQ3(i)=fNQ3(i)-1; fONITQ3(i)=fONITQ3(i)+0.9; fhONITQ3(i)=fhONITQ3(i)+0.1;  fNQ2(i)=fNQ2(i)+1; fHO2(i)=fHO2(i)+1;
...
fOLNN(i)=fOLNN(i)-1; fOLNN(i)=fOLNN(i)-1; fONIT(i)=fONIT(i)+1.8; fhONIT(i)=fhONIT(i)+0.2; fHO2(i)=fHO2(i)+1; 
...
fOLNN(i)=fOLNN(i)-1; fOLNNQ(i)=fOLNNQ(i)-1; fONIT(i)=fONIT(i)+0.9; fhONIT(i)=fhONIT(i)+0.1; fONITQ(i)=fONITQ(i)+0.9; fhONITQ(i)=fhONITQ(i)+0.1; fHO2(i)=fHO2(i)+1; 
...
fOLNN(i)=fOLNN(i)-1; fOLNNQ2(i)=fOLNNQ2(i)-1; fONIT(i)=fONIT(i)+0.9; fhONIT(i)=fhONIT(i)+0.1; fONITQ2(i)=fONITQ2(i)+0.9; fhONITQ2(i)=fhONITQ2(i)+0.1; fHO2(i)=fHO2(i)+1; 
...
fOLNN(i)=fOLNN(i)-1; fOLNNQ3(i)=fOLNNQ3(i)-1; fONIT(i)=fONIT(i)+0.9; fhONIT(i)=fhONIT(i)+0.1; fONITQ3(i)=fONITQ3(i)+0.9; fhONITQ3(i)=fhONITQ3(i)+0.1; fHO2(i)=fHO2(i)+1; 
...
fOLNNQ(i)=fOLNNQ(i)-1; fOLNNQ(i)=fOLNNQ(i)-1; fONITQ(i)=fONITQ(i)+0.9; fhONITQ(i)=fhONITQ(i)+0.1; fONITQ(i)=fONITQ(i)+0.9; fhONITQ(i)=fhONITQ(i)+0.1; fHO2(i)=fHO2(i)+1; 
...
fOLNNQ(i)=fOLNNQ(i)-1; fOLNNQ2(i)=fOLNNQ2(i)-1; fONITQ(i)=fONITQ(i)+0.9; fhONITQ(i)=fhONITQ(i)+0.1; fONITQ2(i)=fONITQ2(i)+0.9; fhONITQ2(i)=fhONITQ2(i)+0.1; fHO2(i)=fHO2(i)+1; 
...
fOLNNQ(i)=fOLNNQ(i)-1; fOLNNQ3(i)=fOLNNQ3(i)-1; fONITQ(i)=fONITQ(i)+0.9; fhONITQ(i)=fhONITQ(i)+0.1; fONITQ3(i)=fONITQ3(i)+0.9; fhONITQ3(i)=fhONITQ3(i)+0.1; fHO2(i)=fHO2(i)+1; 
...
fOLNNQ2(i)=fOLNNQ2(i)-1; fOLNNQ2(i)=fOLNNQ2(i)-1; fONITQ2(i)=fONITQ2(i)+0.9; fhONITQ2(i)=fhONITQ2(i)+0.1; fONITQ2(i)=fONITQ2(i)+0.9; fhONITQ2(i)=fhONITQ2(i)+0.1; fHO2(i)=fHO2(i)+1; 
...
fOLNNQ2(i)=fOLNNQ2(i)-1; fOLNNQ3(i)=fOLNNQ3(i)-1; fONITQ2(i)=fONITQ2(i)+0.9; fhONITQ2(i)=fhONITQ2(i)+0.1; fONITQ3(i)=fONITQ3(i)+0.9; fhONITQ3(i)=fhONITQ3(i)+0.1; fHO2(i)=fHO2(i)+1; 
...
fOLNNQ3(i)=fOLNNQ3(i)-1; fOLNNQ3(i)=fOLNNQ3(i)-1; fONITQ3(i)=fONITQ3(i)+1.8; fhONITQ3(i)=fhONITQ3(i)+0.2; fHO2(i)=fHO2(i)+1; 
...
fONIT(i)=fONIT(i)+1.35; fhONIT(i)=fhONIT(i)+0.15; 
...
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fONIT(i)=fONIT(i)+0.9; fhONIT(i)=fhONIT(i)+0.1; fONITQ(i)=fONITQ(i)+0.45; fhONITQ(i)=fhONITQ(i)+0.05; 
...
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fONIT(i)=fONIT(i)+0.9; fONITQ2(i)=fONITQ2(i)+0.45; fhONIT(i)=fhONIT(i)+0.1; fhONITQ2(i)=fhONITQ2(i)+0.05; 
...
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fONIT(i)=fONIT(i)+0.9; fhONIT(i)=fhONIT(i)+0.1; fONITQ3(i)=fONITQ3(i)+0.45; fhONITQ3(i)=fhONITQ3(i)+0.05; 
...
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fONITQ(i)=fONITQ(i)+0.9; fhONITQ(i)=fhONITQ(i)+0.1; fONIT(i)=fONIT(i)+0.45; fhONIT(i)=fhONIT(i)+0.05; 
...
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fONITQ(i)=fONITQ(i)+1.35; fhONITQ(i)=fhONITQ(i)+0.15; 
...
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fONITQ(i)=fONITQ(i)+0.9; fhONITQ(i)=fhONITQ(i)+0.1; fONITQ2(i)=fONITQ2(i)+0.45; fhONITQ2(i)=fhONITQ2(i)+0.05; 
...
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fONITQ(i)=fONITQ(i)+0.9; fhONITQ(i)=fhONITQ(i)+0.1; fONITQ3(i)=fONITQ3(i)+0.45; fhONITQ3(i)=fhONITQ3(i)+0.05; 
...
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fONITQ2(i)=fONITQ2(i)+0.9; fhONITQ2(i)=fhONITQ2(i)+0.1; fONIT(i)=fONIT(i)+0.45; fhONIT(i)=fhONIT(i)+0.05; 
...
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fONITQ2(i)=fONITQ2(i)+0.9; fhONITQ2(i)=fhONITQ2(i)+0.1; fONITQ(i)=fONITQ(i)+0.45; fONITQ(i)=fONITQ(i)+0.05; 
...
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fONITQ2(i)=fONITQ2(i)+1.35; fhONITQ2(i)=fhONITQ2(i)+0.15; 
...
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fONITQ2(i)=fONITQ2(i)+0.9; fhONITQ2(i)=fhONITQ2(i)+0.1; fONITQ3(i)=fONITQ3(i)+0.45; fhONITQ3(i)=fhONITQ3(i)+0.05; 
...
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fONITQ3(i)=fONITQ3(i)+0.9; fhONITQ3(i)=fhONITQ3(i)+0.1; fONIT(i)=fONIT(i)+0.45;  fhONIT(i)=fhONIT(i)+0.05; 
...
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fONITQ3(i)=fONITQ3(i)+0.9; fhONITQ3(i)=fhONITQ3(i)+0.1; fONITQ(i)=fONITQ(i)+0.45; fhONITQ(i)=fhONITQ(i)+0.05; 
...
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fONITQ3(i)=fONITQ3(i)+0.9; fhONITQ3(i)=fhONITQ3(i)+0.1; fONITQ2(i)=fONITQ2(i)+0.45; fhONITQ2(i)=fhONITQ2(i)+0.05; 
...
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fONITQ3(i)=fONITQ3(i)+1.35; fhONITQ3(i)=fhONITQ3(i)+0.15; 
...
fALD(i)=fALD(i)+1.21; fKET(i)=fKET(i)+0.285; fONIT(i)=fONIT(i)+0.9; fhONIT(i)=fhONIT(i)+0.1;
...
fALD(i)=fALD(i)+1.21; fKET(i)=fKET(i)+0.285; fONIT(i)=fONIT(i)+0.45; fhONIT(i)=fhONIT(i)+0.05; fONITQ(i)=fONITQ(i)+0.45; fhONITQ(i)=fhONITQ(i)+0.05;
...
fALD(i)=fALD(i)+1.21; fKET(i)=fKET(i)+0.285; fONIT(i)=fONIT(i)+0.45; fhONIT(i)=fhONIT(i)+0.05; fONITQ2(i)=fONITQ2(i)+0.45; fhONITQ2(i)=fhONITQ2(i)+0.05;
...
fALD(i)=fALD(i)+1.21; fKET(i)=fKET(i)+0.285; fONIT(i)=fONIT(i)+0.45; fhONIT(i)=fhONIT(i)+0.05; fONITQ3(i)=fONITQ3(i)+0.45; fhONITQ3(i)=fhONITQ3(i)+0.05;
...
fALD(i)=fALD(i)+1.21; fKET(i)=fKET(i)+0.285; fONITQ(i)=fONITQ(i)+0.9; fhONITQ(i)=fhONITQ(i)+0.1;
...
fALD(i)=fALD(i)+1.21; fKET(i)=fKET(i)+0.285; fONITQ(i)=fONITQ(i)+0.45; fhONITQ(i)=fhONITQ(i)+0.05; fONITQ2(i)=fONITQ2(i)+0.45; fhONITQ2(i)=fhONITQ2(i)+0.05;
...
fALD(i)=fALD(i)+1.21; fKET(i)=fKET(i)+0.285; fONITQ(i)=fONITQ(i)+0.45; fhONITQ(i)=fhONITQ(i)+0.05; fONITQ3(i)=fONITQ3(i)+0.45; fhONITQ3(i)=fhONITQ3(i)+0.05;
...
fALD(i)=fALD(i)+1.21; fKET(i)=fKET(i)+0.285; fONITQ2(i)=fONITQ2(i)+0.9; fhONITQ2(i)=fhONITQ2(i)+0.1; 
...
fALD(i)=fALD(i)+1.21; fKET(i)=fKET(i)+0.285; fONITQ2(i)=fONITQ2(i)+0.45; fhONITQ2(i)=fhONITQ2(i)+0.05; fONITQ3(i)=fONITQ3(i)+0.45; fhONITQ3(i)=fhONITQ3(i)+0.05; 
...
fALD(i)=fALD(i)+1.21; fKET(i)=fKET(i)+0.285; fONITQ3(i)=fONITQ3(i)+0.9; fhONITQ3(i)=fhONITQ3(i)+0.1; 
...
k(:,i) = 5.56E-4;
Gstr{i,1} = 'hONIT';  
fhONIT(i)=fhONIT(i)-1; fHNO3(i)=fHNO3(i)+1; 

i=i+1; %
Rnames{i} = 'hONITQ=HNO2Q';
k(:,i) = 5.56E-4;
Gstr{i,1} = 'hONITQ';  
fhONITQ(i)=fhONITQ(i)-1; fHNO2Q(i)=fHNO2Q(i)+1; 

i=i+1; %
Rnames{i} = 'hONITQ2=HNOQ2';
k(:,i) = 5.56E-4;
Gstr{i,1} = 'hONITQ2';  
fhONITQ2(i)=fhONITQ2(i)-1; fHNOQ2(i)=fHNOQ2(i)+1;

i=i+1; %
Rnames{i} = 'hONITQ3=HNQ3';
k(:,i) = 5.56E-4;
Gstr{i,1} = 'hONITQ3';  
fhONITQ3(i)=fhONITQ3(i)-1; fHNQ3(i)=fHNQ3(i)+1; 
...
k(:,i) = 2.19E-6;
Gstr{i,1} = 'HOQ'; 
fHOQ(i)=fHOQ(i)-1; fwHOQ(i)=fwHOQ(i)+1; 
...
k(:,i) = 2.19E-6;
Gstr{i,1} = 'HQ2'; 
fHQ2(i)=fHQ2(i)-1; fwHQ2(i)=fwHQ2(i)+1; 
