...
'OLNDQ2'; 'OLNDQ3'; 'OLNNQ'; 'OLNNQ2'; 'OLNNQ3';  'A'; ...
};
...
Rnames{i} = 'N2O3Q2+H2O=0.4HNO3 + 1.2 HNO2Q + 0.4HNOQ2';
k(:,i) = 2.50E-22.*H2O; %mmarvin 20151020
Gstr{i,1} = 'N2O3Q2'; 
% fN2O5(i)=fN2O5(i)-1; fHNO3(i)=2; 
fN2O3Q2(i)=fN2O3Q2(i)-1; fHNO3(i)=fHNO3(i)+0.4; fHNO2Q(i)=fHNO2Q(i)+1.2; fHNOQ2(i)=fHNOQ2(i)+0.4; %SR 20160406

%O3 Tracer
i=i+1; %<RACM2_065d>; <BAPI_059d>
Rnames{i} = 'N2O2Q3+H2O=0.1HNO3 + 0.9HNO2Q + 0.9HNOQ2 + 0.1HNQ3';
k(:,i) = 2.50E-22.*H2O; %mmarvin 20151020
Gstr{i,1} = 'N2O2Q3'; 
% fN2O5(i)=fN2O5(i)-1; fHNO3(i)=2; 
fN2O2Q3(i)=fN2O2Q3(i)-1; fHNO3(i)=fHNO3(i)+0.1;  fHNO2Q(i)=fHNO2Q(i)+0.9; fHNOQ2(i)=fHNOQ2(i)+0.9; fHNQ3(i)=fHNQ3(i)+0.1; %SR 20160406
