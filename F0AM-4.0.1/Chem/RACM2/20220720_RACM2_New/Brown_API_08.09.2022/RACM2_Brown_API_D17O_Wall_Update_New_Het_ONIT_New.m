...
SpeciesToAdd = {...
'NO2'; 'NOQ'; 'NQ2'; 'PAN'; 'PANQ'; 'PANQ2'; 'PPN'; 'PPNQ'; 'PPNQ2'; ...
'HNO3'; 'HNO2Q'; 'HNOQ2'; 'HNQ3'; 'MONITSa'; 'MONITSQa'; 'MONITSQ2a'; 'MONITSQ3a'; 'MONITUa'; 'MONITUQa'; 'MONITUQ2a'; 'MONITUQ3a'; ...
'MONITSb'; 'MONITSQb'; 'MONITSQ2b'; 'MONITSQ3b'; 'HONITa'; 'HONITQa'; 'HONITQ2a'; 'HONITQ3a';
'HONITb'; 'HONITQb'; 'HONITQ2b'; 'HONITQ3b'; ...
'ACD'; 'ACO3'; 'ACT'; 'ACTP'; 'ALD'; 'API'; 'CO'; 'CO2'; 'DCB1'; 'EOH'; 'ETHP'; ...
'GLY'; 'H2'; 'H2O2'; 'HC3P'; 'HCHO';  'HO2'; 'HO2NO2'; 'HONO'; 'KET'; 'KETP'; 'MEK'; ...
'MEKP'; 'MGLY'; 'MO2'; 'MOH'; 'N2O5'; 'NO';  'NO3'; 'O1D'; 'O3'; 'O3P'; 'OH'; ...
'OP1'; 'OP2'; 'ORA1'; 'ORA2'; 'ORAP'; 'PAA';   'RCO3'; 'ROH'; 'XO2'; ...
'COQ'; 'CQ'; 'CQ2'; 'H2OQ'; 'H2Q2'; 'HCHQ';  ...
 'HO2NOQ'; 'HO2NQ2'; 'HONQ'; 'HOQ'; 'HOQNO2'; 'HOQNOQ'; 'HOQNQ2'; ...
'HQ2'; 'HQ2NO2'; 'HQ2NOQ'; 'HQ2NQ2'; 'HQNO'; 'HQNQ'; 'NO2Q';  'NOQ2'; 'NQ';  'NQ3'; ...
'Q1D'; 'Q3P'; 'QH'; 'APIO2a'; 'APIO2b'; 'APINO2a'; 'APINO2Qa'; 'APINO2Q2a'; 'APINO2Q3a'; ...
'APINO2b'; 'APINO2Qb'; 'APINO2Q2b'; 'APINO2Q3b'; ...
'OQ'; 'Q2'; 'H2Q2'; 'N2O4Q'; 'N2O3Q2'; 'N2O2Q3'; 'N2OQ4'; 'N2Q5'; 
 'wO3'; 'wNO'; 'wNQ'; 'wNO2'; 'wNOQ'; 'wNQ2'; 'wHNO3'; 'wHNO2Q'; 'wHNOQ2'; 'wHNQ3'; ...
'wMONITS'; 'wMONITSQ'; 'wMONITSQ2'; 'wMONITSQ3'; 'wMONITU'; 'wMONITUQ'; 'wMONITUQ2'; 'wMONITUQ3'; ...
'wHONIT'; 'wHONITQ'; 'wHONITQ2'; 'wHONITQ3'; 'A'; ...
};
...
Rnames{i} = 'MONITSa=HO2+0.2ALD+NO2+0.8KET';
k(:,i) = JONIT;
Gstr{i,1} = 'MONITSa'; 
fMONITSa(i)=fMONITSa(i)-1; fHO2(i)=fHO2(i)+1; fALD(i)=fALD(i)+0.2; fNO2(i)=fNO2(i)+1; fKET(i)=fKET(i)+0.8; 

%O3 Tracer
i=i+1; %<RACM2_031>; <BAPI_025a>
Rnames{i} = 'MONITSQa=(2/3)HO2+0.2ALD+(2/3)NOQ+0.8KET+(1/3)NO2+(1/3)HOQ';
k(:,i) = JONIT;
Gstr{i,1} = 'MONITSQa'; 
fMONITSQa(i)=fMONITSQa(i)-1; fHO2(i)=fHO2(i)+(2/3); fALD(i)=fALD(i)+0.2; fNOQ(i)=fNOQ(i)+(2/3); fKET(i)=fKET(i)+0.8; fNO2(i)=fNO2(i)+(1/3); fHOQ(i)=fHOQ(i)+(1/3);

%O3 Tracer
i=i+1; %<RACM2_031>; <BAPI_025b>
Rnames{i} = 'MONITSQ2a=(2/3)HOQ+0.2ALD+(2/3)NOQ+0.8KET+(1/3)NQ2+(1/3)HO2';
k(:,i) = JONIT;
Gstr{i,1} = 'MONITSQ2a'; 
fMONITSQ2a(i)=fMONITSQ2a(i)-1; fHO2(i)=fHO2(i)+(1/3); fALD(i)=fALD(i)+0.2; fNQ2(i)=fNQ2(i)+(1/3); fKET(i)=fKET(i)+0.8; fNOQ(i)=fNOQ(i)+(2/3); fHO2(i)=fHO2(i)+(1/3);

%O3 Tracer
i=i+1; %<RACM2_031>; <BAPI_025c>
Rnames{i} = 'MONITSQ3a=HOQ+0.2ALD+NQ2+0.8KET';
k(:,i) = JONIT;
Gstr{i,1} = 'MONITSQ3a'; 
fMONITSQ3a(i)=fMONITSQ3a(i)-1; fHOQ(i)=fHOQ(i)+1; fALD(i)=fALD(i)+0.2; fNQ2(i)=fNQ2(i)+1; fKET(i)=fKET(i)+0.8;




i=i+1; %<RACM2_Update_031>; <BAPI_025>
Rnames{i} = 'MONITSb=HO2+0.2ALD+NO2+0.8KET';
k(:,i) = JONIT;
Gstr{i,1} = 'MONITSb'; 
fMONITSb(i)=fMONITSb(i)-1; fHO2(i)=fHO2(i)+1; fALD(i)=fALD(i)+0.2; fNO2(i)=fNO2(i)+1; fKET(i)=fKET(i)+0.8; 

%O3 Tracer
i=i+1; %<RACM2_031>; <BAPI_025e>
Rnames{i} = 'MONITSQb=(2/3)HO2+0.2ALD+(2/3)NOQ+0.8KET+(1/3)NO2+(1/3)HOQ';
k(:,i) = JONIT;
Gstr{i,1} = 'MONITSQb'; 
fMONITSQb(i)=fMONITSQb(i)-1; fHO2(i)=fHO2(i)+(2/3); fALD(i)=fALD(i)+0.2; fNOQ(i)=fNOQ(i)+(2/3); fKET(i)=fKET(i)+0.8; fNO2(i)=fNO2(i)+(1/3); fHOQ(i)=fHOQ(i)+(1/3);

%O3 Tracer
i=i+1; %<RACM2_031>; <BAPI_025f>
Rnames{i} = 'MONITSQ2b=(2/3)HOQ+0.2ALD+(2/3)NOQ+0.8KET+(1/3)NQ2+(1/3)HO2';
k(:,i) = JONIT;
Gstr{i,1} = 'MONITSQ2b'; 
fMONITSQ2b(i)=fMONITSQ2b(i)-1; fHO2(i)=fHO2(i)+(1/3); fALD(i)=fALD(i)+0.2; fNQ2(i)=fNQ2(i)+(1/3); fKET(i)=fKET(i)+0.8; fNOQ(i)=fNOQ(i)+(2/3); fHO2(i)=fHO2(i)+(1/3);

%O3 Tracer
i=i+1; %<RACM2_031>; <BAPI_025g>
Rnames{i} = 'MONITSQ3b=HOQ+0.2ALD+NQ2+0.8KET';
k(:,i) = JONIT;
Gstr{i,1} = 'MONITSQ3b'; 
fMONITSQ3b(i)=fMONITSQ3b(i)-1; fHOQ(i)=fHOQ(i)+1; fALD(i)=fALD(i)+0.2; fNQ2(i)=fNQ2(i)+1; fKET(i)=fKET(i)+0.8;

i=i+1; %<RACM2_Update_031>; <BAPI_025>
Rnames{i} = 'MONITUa=HO2+0.2ALD+NO2+0.8KET';
k(:,i) = JONIT;
Gstr{i,1} = 'MONITUa'; 
fMONITUa(i)=fMONITUa(i)-1; fHO2(i)=fHO2(i)+1; fALD(i)=fALD(i)+0.2; fNO2(i)=fNO2(i)+1; fKET(i)=fKET(i)+0.8; 

%O3 Tracer
i=i+1; %<RACM2_031>; <BAPI_025a>
Rnames{i} = 'MONITUQa=(2/3)HO2+0.2ALD+(2/3)NOQ+0.8KET+(1/3)NO2+(1/3)HOQ';
k(:,i) = JONIT;
Gstr{i,1} = 'MONITUQa'; 
fMONITUQa(i)=fMONITUQa(i)-1; fHO2(i)=fHO2(i)+(2/3); fALD(i)=fALD(i)+0.2; fNOQ(i)=fNOQ(i)+(2/3); fKET(i)=fKET(i)+0.8; fNO2(i)=fNO2(i)+(1/3); fHOQ(i)=fHOQ(i)+(1/3);

%O3 Tracer
i=i+1; %<RACM2_031>; <BAPI_025b>
Rnames{i} = 'MONITUQ2a=(2/3)HOQ+0.2ALD+(2/3)NOQ+0.8KET+(1/3)NQ2+(1/3)HO2';
k(:,i) = JONIT;
Gstr{i,1} = 'MONITUQ2a'; 
fMONITUQ2a(i)=fMONITUQ2a(i)-1; fHO2(i)=fHO2(i)+(1/3); fALD(i)=fALD(i)+0.2; fNQ2(i)=fNQ2(i)+(1/3); fKET(i)=fKET(i)+0.8; fNOQ(i)=fNOQ(i)+(2/3); fHO2(i)=fHO2(i)+(1/3);

%O3 Tracer
i=i+1; %<RACM2_031>; <BAPI_025c>
Rnames{i} = 'MONITUQ3a=HOQ+0.2ALD+NQ2+0.8KET';
k(:,i) = JONIT;
Gstr{i,1} = 'MONITUQ3a'; 
fMONITUQ3a(i)=fMONITUQ3a(i)-1; fHOQ(i)=fHOQ(i)+1; fALD(i)=fALD(i)+0.2; fNQ2(i)=fNQ2(i)+1; fKET(i)=fKET(i)+0.8;
...
%O3 Tracer
i=i+1; %<RACM2_Update_087a>; <BAPI_064>
Rnames{i} = 'API+QH=0.65 APIO2a + 0.35 APIO2b';
k(:,i) = 1.21E-11.*exp(440./T);
Gstr{i,1} = 'API'; Gstr{i,2} = 'QH'; 
fAPI(i)=fAPI(i)-1; fQH(i)=fQH(i)-1; fAPIO2a(i)=fAPIO2a(i)+0.65; fAPIO2b(i)=fAPIO2b(i)+0.35;
...
Rnames{i} = 'MONITSa+OH=HONITa';
k(:,i) =4.80E-12;
Gstr{i,1} = 'MONITSa'; Gstr{i,2} = 'OH'; 
fMONITSa(i)=fMONITSa(i)-1; fOH(i)=fOH(i)-1; fHONITa(i)=fHONITa(i)+1; 

%O3 Tracer
i=i+1; %<RACM2_Update_123>; <BAPI_084>
Rnames{i} = 'MONITSQa+OH=HONITQa';
k(:,i) =4.80E-12;
Gstr{i,1} = 'MONITSQa'; Gstr{i,2} = 'OH'; 
fMONITSQa(i)=fMONITSQa(i)-1; fOH(i)=fOH(i)-1; fHONITQa(i)=fHONITQa(i)+1; 

%O3 Tracer
i=i+1; %<RACM2_Update_123>; <BAPI_084>
Rnames{i} = 'MONITSQ2a+OH=HONITQ2a';
k(:,i) =4.80E-12;
Gstr{i,1} = 'MONITSQ2a'; Gstr{i,2} = 'OH'; 
fMONITSQ2a(i)=fMONITSQ2a(i)-1; fOH(i)=fOH(i)-1; fHONITQ2a(i)=fHONITQ2a(i)+1; 

%O3 Tracer
i=i+1; %<RACM2_Update_123>; <BAPI_084>
Rnames{i} = 'MONITSQ3a+OH=HONITQ3a';
k(:,i) =4.80E-12;
Gstr{i,1} = 'MONITSQ3a'; Gstr{i,2} = 'OH'; 
fMONITSQ3a(i)=fMONITSQ3a(i)-1; fOH(i)=fOH(i)-1; fHONITQ3a(i)=fHONITQ3a(i)+1; 


i=i+1; %<RACM2_Update_123>; <BAPI_084>
Rnames{i} = 'MONITSb+OH=HONITb';
k(:,i) =4.80E-12;
Gstr{i,1} = 'MONITSb'; Gstr{i,2} = 'OH'; 
fMONITSb(i)=fMONITSb(i)-1; fOH(i)=fOH(i)-1; fHONITb(i)=fHONITb(i)+1; 

%O3 Tracer
i=i+1; %<RACM2_Update_123>; <BAPI_084>
Rnames{i} = 'MONITSQb+OH=HONITQb';
k(:,i) =4.80E-12;
Gstr{i,1} = 'MONITSQb'; Gstr{i,2} = 'OH'; 
fMONITSQb(i)=fMONITSQb(i)-1; fOH(i)=fOH(i)-1; fHONITQb(i)=fHONITQb(i)+1; 

%O3 Tracer
i=i+1; %<RACM2_Update_123>; <BAPI_084>
Rnames{i} = 'MONITSQ2b+OH=HONITQ2b';
k(:,i) =4.80E-12;
Gstr{i,1} = 'MONITSQ2b'; Gstr{i,2} = 'OH'; 
fMONITSQ2b(i)=fMONITSQ2b(i)-1; fOH(i)=fOH(i)-1; fHONITQ2b(i)=fHONITQ2b(i)+1; 

%O3 Tracer
i=i+1; %<RACM2_Update_123>; <BAPI_084>
Rnames{i} = 'MONITSQ3b+OH=HONITQ3b';
k(:,i) =4.80E-12;
Gstr{i,1} = 'MONITSQ3b'; Gstr{i,2} = 'OH'; 
fMONITSQ3b(i)=fMONITSQ3b(i)-1; fOH(i)=fOH(i)-1; fHONITQ3b(i)=fHONITQ3b(i)+1; 



i=i+1; %<RACM2_Update_123>; <BAPI_084>
Rnames{i} = 'MONITUa+OH=HONITa';
k(:,i) =7.29E-11;
Gstr{i,1} = 'MONITUa'; Gstr{i,2} = 'OH'; 
fMONITUa(i)=fMONITUa(i)-1; fOH(i)=fOH(i)-1; fHONITa(i)=fHONITa(i)+1; 

%O3 Tracer
i=i+1; %<RACM2_Update_123>; <BAPI_084>
Rnames{i} = 'MONITUQa+OH=HONITQa';
k(:,i) =7.29E-11;
Gstr{i,1} = 'MONITUQa'; Gstr{i,2} = 'OH'; 
fMONITUQa(i)=fMONITUQa(i)-1; fOH(i)=fOH(i)-1; fHONITQa(i)=fHONITQa(i)+1; 

%O3 Tracer
i=i+1; %<RACM2_Update_123>; <BAPI_084>
Rnames{i} = 'MONITUQ2a+OH=HONITQ2a';
k(:,i) =7.29E-11;
Gstr{i,1} = 'MONITUQ2a'; Gstr{i,2} = 'OH'; 
fMONITUQ2a(i)=fMONITUQ2a(i)-1; fOH(i)=fOH(i)-1; fHONITQ2a(i)=fHONITQ2a(i)+1; 

%O3 Tracer
i=i+1; %<RACM2_Update_123>; <BAPI_084>
Rnames{i} = 'MONITUQ3a+OH=HONITQ3a';
k(:,i) =7.29E-11;
Gstr{i,1} = 'MONITUQ3a'; Gstr{i,2} = 'OH'; 
fMONITUQ3a(i)=fMONITUQ3a(i)-1; fOH(i)=fOH(i)-1; fHONITQ3a(i)=fHONITQ3a(i)+1; 
...
Rnames{i} = 'API+NO3=0.25 APINO2a+ 0.75 APINO2b';
k(:,i) = 1.19E-12.*exp(490./T);
Gstr{i,1} = 'API'; Gstr{i,2} = 'NO3'; 
fAPI(i)=fAPI(i)-1; fNO3(i)=fNO3(i)-1; fAPINO2a(i)=fAPINO2a(i)+0.25;  fAPINO2b(i)=fAPINO2b(i)+0.75; 

%O3 Tracer
i=i+1; %<RACM2_146a>; <BAPI_087a>
Rnames{i} = 'API+NO2Q=0.25 APINO2Qa+0.75 APINO2Qb';
k(:,i) = 1.19E-12.*exp(490./T);
Gstr{i,1} = 'API'; Gstr{i,2} = 'NO2Q'; 
fAPI(i)=fAPI(i)-1; fNO2Q(i)=fNO2Q(i)-1; fAPINO2Qa(i)=fAPINO2Qa(i)+0.25;  fAPINO2Qb(i)=fAPINO2Qb(i)+0.75; 

%O3 Tracer
i=i+1; %<RACM2_146b>; <BAPI_087b>
Rnames{i} = 'API+NOQ2=0.25 APINO2Q2a+0.75 APINO2Q2b';
k(:,i) = 1.19E-12.*exp(490./T);
Gstr{i,1} = 'API'; Gstr{i,2} = 'NOQ2'; 
fAPI(i)=fAPI(i)-1; fNOQ2(i)=fNOQ2(i)-1; fAPINO2Q2a(i)=fAPINO2Q2a(i)+0.25;  fAPINO2Q2b(i)=fAPINO2Q2b(i)+0.75;

%O3 Tracer
i=i+1; %<RACM2_146c>; <BAPI_087c>
Rnames{i} = 'API+NQ3=0.25 APINO2Q2a+0.75 APINO2Q3b';
k(:,i) = 1.19E-12.*exp(490./T);
Gstr{i,1} = 'API'; Gstr{i,2} = 'NQ3'; 
fAPI(i)=fAPI(i)-1; fNQ3(i)=fNQ3(i)-1; fAPINO2Q3a(i)=fAPINO2Q3a(i)+0.25;  fAPINO2Q3b(i)=fAPINO2Q3b(i)+0.75;
...
Rnames{i} = 'HC3P+NO=HO2+MO2+ETHP+XO2+NO2+ACD+ALD+ACT+MEK+MONITSb';
k(:,i) = 4.00E-12;
...
fALD(i)=fALD(i)+0.132; fACT(i)=fACT(i)+0.165; fMEK(i)=fMEK(i)+0.042; fMONITSb(i)=fMONITSb(i)+0.065; %mmarvin 20151020

%O3 Tracer
i=i+1; %<RACM2_174a>; <BAPI_099>
Rnames{i} = 'HC3P+NQ=HO2+MO2+ETHP+XO2+NOQ+ACD+ALD+ACT+MEK+MONITSQb';
k(:,i) = 4.00E-12;
...
fALD(i)=fALD(i)+0.132; fACT(i)=fACT(i)+0.165; fMEK(i)=fMEK(i)+0.042; fMONITSQb(i)=fMONITSQb(i)+0.065; %mmarvin 20151020

i=i+1; %<RACM2_Update_189a>; <BAPI_100>
Rnames{i} = 'APIO2a+NO= HO2+NO2+HCHO+ALD+ACT+KET+ORA1+MONITSa + MONITUa';
k(:,i) = 4.00E-12;
...
fORA1(i)=fORA1(i)+0.07; fMONITSa(i)=fMONITSa(i)+0.09; fMONITUa(i)=fMONITUa(i)+0.09; 


%O3 Tracer
i=i+1; %<RACM2_Update_189a>; <BAPI_100>
Rnames{i} = 'APIO2a+NQ= HO2+NOQ+HCHO+ALD+ACT+KET+ORA1+MONITSQa + MONITUQa';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'APIO2a'; Gstr{i,2} = 'NQ'; 
fAPIO2a(i)=fAPIO2a(i)-1; fNQ(i)=fNQ(i)-1; fHO2(i)=fHO2(i)+0.82; fNOQ(i)=fNOQ(i)+0.82; 
fHCHO(i)=fHCHO(i)+0.23; fALD(i)=fALD(i)+0.43; fACT(i)=fACT(i)+0.11; fKET(i)=fKET(i)+0.44; 
fORA1(i)=fORA1(i)+0.07; fMONITSQa(i)=fMONITSQa(i)+0.09; fMONITUQa(i)=fMONITUQa(i)+0.09; 

i=i+1; %<RACM2_Update_189b>; <BAPI_100>
Rnames{i} = 'APIO2b+NO= HO2+NO2+HCHO+ALD+ACT+KET+ORA1+MONITSb';
k(:,i) =4.00E-12;
Gstr{i,1} = 'APIO2b'; Gstr{i,2} = 'NO'; 
fAPIO2b(i)=fAPIO2b(i)-1; fNO(i)=fNO(i)-1; fHO2(i)=fHO2(i)+0.82; fNO2(i)=fNO2(i)+0.82; 
fHCHO(i)=fHCHO(i)+0.23; fALD(i)=fALD(i)+0.43; fACT(i)=fACT(i)+0.11; fKET(i)=fKET(i)+0.44; 
fORA1(i)=fORA1(i)+0.07; fMONITSb(i)=fMONITSb(i)+0.18; 

%O3 Tracer
i=i+1; %<RACM2_Update_189b>; <BAPI_100>
Rnames{i} = 'APIO2b+NQ= HO2+NOQ+HCHO+ALD+ACT+KET+ORA1+MONITSQb';
k(:,i) =4.00E-12;
Gstr{i,1} = 'APIO2b'; Gstr{i,2} = 'NQ'; 
fAPIO2b(i)=fAPIO2b(i)-1; fNQ(i)=fNQ(i)-1; fHO2(i)=fHO2(i)+0.82; fNOQ(i)=fNOQ(i)+0.82; 
fHCHO(i)=fHCHO(i)+0.23; fALD(i)=fALD(i)+0.43; fACT(i)=fACT(i)+0.11; fKET(i)=fKET(i)+0.44; 
fORA1(i)=fORA1(i)+0.07; fMONITSQb(i)=fMONITSQb(i)+0.18; 
...
Rnames{i} = 'APINO2a+NO=MONITSa+NO2+HO2 + HCHO + ALD + KET';
k(:,i) =  4.00E-12;
Gstr{i,1} = 'APINO2a'; Gstr{i,2} = 'NO'; 
fAPINO2a(i)=fAPINO2a(i)-1; fNO(i)=fNO(i)-1;  fNO2(i)=fNO2(i)+1.5; 
 fHO2(i)=fHO2(i)+0.5; 
fHCHO(i)=fHCHO(i)+0.1435; fALD(i)=fALD(i)+0.62; fKET(i)=fKET(i)+0.232; fMONITSa(i)=fMONITSa(i)+0.5;
 

%O3 Tracer
i=i+1;  %<RACM2_205a>; <BAPI_108a>
Rnames{i} = 'APINO2a+NQ=MONITSa + NOQ+ NO2 + HO2 + HCHO + ALD + KET';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'APINO2a'; Gstr{i,2} = 'NQ'; 
fAPINO2a(i)=fAPINO2a(i)-1; fNQ(i)=fNQ(i)-1; fNOQ(i)=fNOQ(i)+1; fNO2(i)=fNO2(i)+0.5;
 fHO2(i)=fHO2(i)+0.5; 
fHCHO(i)=fHCHO(i)+0.1435; fALD(i)=fALD(i)+0.62; fKET(i)=fKET(i)+0.232;  fMONITSa(i)=fMONITSa(i)+0.5;

%O3 Tracer
i=i+1;  %<RACM2_205b>; <BAPI_108b>
Rnames{i} = 'APINO2Qa+NO=MONITSQa + NO2+NOQ + HO2 + HCHO + ALD + KET';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'APINO2Qa'; Gstr{i,2} = 'NO'; 
fAPINO2Qa(i)=fAPINO2Qa(i)-1; fNO(i)=fNO(i)-1; fNO2(i)=fNO2(i)+0.75; fNOQ(i)=fNOQ(i)+0.75;
 fHO2(i)=fHO2(i)+0.5; 
fHCHO(i)=fHCHO(i)+0.1435; fALD(i)=fALD(i)+0.62; fKET(i)=fKET(i)+0.232;  fMONITSQa(i)=fMONITSQa(i)+0.5;

%O3 Tracer
i=i+1;  %<RACM2_205c>; <BAPI_108c>
Rnames{i} = 'APINO2Qa+NQ=MONITSQa+ NO2+NOQ+NQ2+HO2 + HCHO + ALD + KET';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'APINO2Qa'; Gstr{i,2} = 'NQ'; 
fAPINO2Qa(i)=fAPINO2Qa(i)-1; fNQ(i)=fNQ(i)-1; fNO2(i)=fNO2(i)+0.25; fNOQ(i)=fNOQ(i)+1; fNQ2(i)=fNQ2(i)+0.25; 
 fHO2(i)=fHO2(i)+0.5; 
fHCHO(i)=fHCHO(i)+0.1435; fALD(i)=fALD(i)+0.62; fKET(i)=fKET(i)+0.232; fMONITSQa(i)=fMONITSQa(i)+0.5;

%O3 Tracer
i=i+1;  %<RACM2_205d>; <BAPI_108d>
Rnames{i} = 'APINO2Q2a+NO=MONITSQ2a + NQ2+ NOQ+NO2+HO2 + HCHO + ALD + KET';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'APINO2Q2a'; Gstr{i,2} = 'NO'; 
fAPINO2Q2a(i)=fAPINO2Q2a(i)-1; fNO(i)=fNO(i)-1; fNO2(i)=fNO2(i)+0.25; fNQ2(i)=fNQ2(i)+0.25; fNOQ(i)=fNOQ(i)+1; 
 fHO2(i)=fHO2(i)+0.5; 
fHCHO(i)=fHCHO(i)+0.1435; fALD(i)=fALD(i)+0.62; fKET(i)=fKET(i)+0.232; fMONITSQ2a(i)=fMONITSQ2a(i)+0.5;

%O3 Tracer
i=i+1;  %<RACM2_205e>; <BAPI_108e>
Rnames{i} = 'APINO2Q2a+NQ=MONITSQ2a +NOQ+NQ2+HO2 + HCHO + ALD + KET';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'APINO2Q2a'; Gstr{i,2} = 'NQ'; 
fAPINO2Q2a(i)=fAPINO2Q2a(i)-1; fNQ(i)=fNQ(i)-1; fNOQ(i)=fNOQ(i)+0.75; fNQ2(i)=fNQ2(i)+0.75;
 fHO2(i)=fHO2(i)+0.5; 
fHCHO(i)=fHCHO(i)+0.1435; fALD(i)=fALD(i)+0.62; fKET(i)=fKET(i)+0.232; fMONITSQ2a(i)=fMONITSQ2a(i)+0.5;
 

%O3 Tracer
i=i+1;  %<RACM2_205f>; <BAPI_108f>
Rnames{i} = 'APINO2Q3a+NO=MONITSQ3a +NOQ+NQ2+HO2 + HCHO + ALD + KET';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'APINO2Q3a'; Gstr{i,2} = 'NO'; 
fAPINO2Q3a(i)=fAPINO2Q3a(i)-1; fNO(i)=fNO(i)-1; fNOQ(i)=fNOQ(i)+0.75; fNQ2(i)=fNQ2(i)+0.75;
 fHO2(i)=fHO2(i)+0.5; 
fHCHO(i)=fHCHO(i)+0.1435; fALD(i)=fALD(i)+0.62; fKET(i)=fKET(i)+0.232; fMONITSQ3a(i)=fMONITSQ3a(i)+0.5;
 

%O3 Tracer
i=i+1;  %<RACM2_205g>; <BAPI_108g>
Rnames{i} = 'APINO2Q3a+NQ=MONITSQ3a +NQ2+HO2 + HCHO + ALD + KET';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'APINO2Q3a'; Gstr{i,2} = 'NQ'; 
fAPINO2Q3a(i)=fAPINO2Q3a(i)-1; fNQ(i)=fNQ(i)-1; fNQ2(i)=fNQ2(i)+1.5;
 fHO2(i)=fHO2(i)+0.5; 
fHCHO(i)=fHCHO(i)+0.1435; fALD(i)=fALD(i)+0.62; fKET(i)=fKET(i)+0.232; fMONITSQ3a(i)=fMONITSQ3a(i)+0.5;
...
Rnames{i} = 'APINO2b+NQ=NOQ+HCHO+ALD+KET';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'APINO2b'; Gstr{i,2} = 'NQ'; 
fAPINO2b(i)=fAPINO2b(i)-1; fNQ(i)=fNQ(i)-1; fNOQ(i)=fNOQ(i)+1; fNO2(i)=fNO2(i)+1; fHCHO(i)=fHCHO(i)+0.287; fALD(i)=fALD(i)+1.24; fKET(i)=fKET(i)+0.464; 

%O3 Tracer
i=i+1;  %<RACM2_206b>; <BAPI_108b>
Rnames{i} = 'APINO2Qb+NO=NO2+HCHO+ALD+KET';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'APINO2Qb'; Gstr{i,2} = 'NO'; 
fAPINO2Qb(i)=fAPINO2Qb(i)-1; fNO(i)=fNO(i)-1; fNO2(i)=fNO2(i)+1; fNOQ(i)=fNOQ(i)+1; fHCHO(i)=fHCHO(i)+0.287; fALD(i)=fALD(i)+1.24; fKET(i)=fKET(i)+0.464; 

%O3 Tracer
i=i+1;  %<RACM2_206c>; <BAPI_108c>
Rnames{i} = 'APINO2Qb+NQ=NOQ+HCHO+ALD+KET';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'APINO2Qb'; Gstr{i,2} = 'NQ'; 
fAPINO2Qb(i)=fAPINO2Qb(i)-1; fNQ(i)=fNQ(i)-1; fNOQ(i)=fNOQ(i)+2; fHCHO(i)=fHCHO(i)+0.287; fALD(i)=fALD(i)+1.24; fKET(i)=fKET(i)+0.464; 

%O3 Tracer
i=i+1;  %<RACM2_206d>; <BAPI_108d>
Rnames{i} = 'APINO2Q2b+NO=NOQ+NO2+NQ2+HCHO+ALD+KET';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'APINO2Q2b'; Gstr{i,2} = 'NO'; 
fAPINO2Q2b(i)=fAPINO2Q2b(i)-1; fNO(i)=fNO(i)-1; fNO2(i)=fNO2(i)+(1/3); fNQ2(i)=fNQ2(i)+(1/3); fNOQ(i)=fNOQ(i)+(4/3); fHCHO(i)=fHCHO(i)+0.287; fALD(i)=fALD(i)+1.24; fKET(i)=fKET(i)+0.464; 

%O3 Tracer
i=i+1;  %<RACM2_206e>; <BAPI_108e>
Rnames{i} = 'APINO2Q2b+NQ=NOQ+NQ2+HCHO+ALD+KET';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'APINO2Q2b'; Gstr{i,2} = 'NQ'; 
fAPINO2Q2b(i)=fAPINO2Q2b(i)-1; fNQ(i)=fNQ(i)-1; fNOQ(i)=fNOQ(i)+1; fNQ2(i)=fNQ2(i)+1; fHCHO(i)=fHCHO(i)+0.287; fALD(i)=fALD(i)+1.24; fKET(i)=fKET(i)+0.464; 

%O3 Tracer
i=i+1;  %<RACM2_206f>; <BAPI_108f>
Rnames{i} = 'APINO2Q3b+NO=NOQ+NQ2+HCHO+ALD+KET';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'APINO2Q3b'; Gstr{i,2} = 'NO'; 
fAPINO2Q3b(i)=fAPINO2Q3b(i)-1; fNO(i)=fNO(i)-1; fNOQ(i)=fNOQ(i)+1; fNQ2(i)=fNQ2(i)+1; fHCHO(i)=fHCHO(i)+0.287; fALD(i)=fALD(i)+1.24; fKET(i)=fKET(i)+0.464; 

%O3 Tracer
i=i+1;  %<RACM2_206g>; <BAPI_108g>
Rnames{i} = 'APINO2Q3b+NQ=NQ2+HCHO+ALD+KET';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'APINO2Q3b'; Gstr{i,2} = 'NQ'; 
fAPINO2Q3b(i)=fAPINO2Q3b(i)-1; fNQ(i)=fNQ(i)-1; fNQ2(i)=fNQ2(i)+2; fHCHO(i)=fHCHO(i)+0.287; fALD(i)=fALD(i)+1.24; fKET(i)=fKET(i)+0.464; 
...
Rnames{i} = 'APIO2a+HOQ=OP2';
k(:,i) =  1.50E-11;
Gstr{i,1} = 'APIO2a'; Gstr{i,2} = 'HOQ'; 
fAPIO2a(i)=fAPIO2a(i)-1; fHOQ(i)=fHOQ(i)-1; fOP2(i)=fOP2(i)+1; 

%O3 Tracer
i=i+1; %<RACM2_Update_229c>; <BAPI_113>
Rnames{i} = 'APIO2a+HQ2=OP2';
k(:,i) =  1.50E-11;
Gstr{i,1} = 'APIO2a'; Gstr{i,2} = 'HQ2'; 
fAPIO2a(i)=fAPIO2a(i)-1; fHQ2(i)=fHQ2(i)-1; fOP2(i)=fOP2(i)+1; 

i=i+1; %<RACM2_Update_229d>; <BAPI_113>
...
%O3 Tracer
i=i+1; %<RACM2_Update_229e>; <BAPI_113d>
Rnames{i} = 'APIO2b+HOQ=OP2';
k(:,i) =  1.50E-11;
Gstr{i,1} = 'APIO2b'; Gstr{i,2} = 'HOQ'; 
fAPIO2b(i)=fAPIO2b(i)-1; fHOQ(i)=fHOQ(i)-1; fOP2(i)=fOP2(i)+1; 

%O3 Tracer
i=i+1; %<RACM2_Update_229f>; <BAPI_113e>
Rnames{i} = 'APIO2b+HQ2=OP2';
k(:,i) =  1.50E-11;
Gstr{i,1} = 'APIO2b'; Gstr{i,2} = 'HQ2'; 
fAPIO2b(i)=fAPIO2b(i)-1; fHQ2(i)=fHQ2(i)-1; fOP2(i)=fOP2(i)+1; 
...
%O3 Tracer
i=i+1; %<RACM2_243>; <BAPI_119a>
Rnames{i} = 'ORAP+HOQ=OP2'; %mmarvin 20151020
k(:,i) = 1.15E-13.*exp(1300./T);
...
%O3 Tracer
i=i+1; %<RACM2_243>; <BAPI_119a>
Rnames{i} = 'ORAP+HQ2=OP2'; %mmarvin 20151020
k(:,i) = 1.15E-13.*exp(1300./T);
...
Rnames{i} = 'APINO2a+HO2= MONITSa';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'APINO2a'; Gstr{i,2} = 'HO2'; 
fAPINO2a(i)=fAPINO2a(i)-1; fHO2(i)=fHO2(i)-1; fMONITSa(i)=fMONITSa(i)+1;

%O3 Tracer
i=i+1; %<RACM2_244a>; <BAPI_120a>
Rnames{i} = 'APINO2a+HOQ=MONITSa';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'APINO2a'; Gstr{i,2} = 'HOQ'; 
fAPINO2a(i)=fAPINO2a(i)-1; fHOQ(i)=fHOQ(i)-1; fMONITSa(i)=fMONITSa(i)+1; 

%O3 Tracer
i=i+1; %<RACM2_244b>; <BAPI_120b>
Rnames{i} = 'APINO2a+HQ2=MONITSa';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'APINO2a'; Gstr{i,2} = 'HQ2'; 
fAPINO2a(i)=fAPINO2a(i)-1; fHQ2(i)=fHQ2(i)-1; fMONITSa(i)=fMONITSa(i)+1; 

%O3 Tracer
i=i+1; %<RACM2_244c>; <BAPI_120c>
Rnames{i} = 'APINO2Qa+HO2=MONITSQa';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'APINO2Qa'; Gstr{i,2} = 'HO2'; 
fAPINO2Qa(i)=fAPINO2Qa(i)-1; fHO2(i)=fHO2(i)-1; fMONITSQa(i)=fMONITSQa(i)+1; 

%O3 Tracer
i=i+1; %<RACM2_244d>; <BAPI_120d>
Rnames{i} = 'APINO2Qa+HOQ=MONITSQa';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'APINO2Qa'; Gstr{i,2} = 'HOQ'; 
fAPINO2Qa(i)=fAPINO2Qa(i)-1; fHOQ(i)=fHOQ(i)-1; fMONITSQa(i)=fMONITSQa(i)+1; 

%O3 Tracer
i=i+1; %<RACM2_244e>; <BAPI_120e>
Rnames{i} = 'APINO2Qa+HQ2=MONITSQa';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'APINO2Qa'; Gstr{i,2} = 'HQ2'; 
fAPINO2Qa(i)=fAPINO2Qa(i)-1; fHQ2(i)=fHQ2(i)-1; fMONITSQa(i)=fMONITSQa(i)+1;

%O3 Tracer
i=i+1; %<RACM2_244f>; <BAPI_120f>
Rnames{i} = 'APINO2Q2a+HO2=MONITSQ2a';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'APINO2Q2a'; Gstr{i,2} = 'HO2'; 
fAPINO2Q2a(i)=fAPINO2Q2a(i)-1; fHO2(i)=fHO2(i)-1; fMONITSQ2a(i)=fMONITSQ2a(i)+1;

%O3 Tracer
i=i+1; %<RACM2_244g>; <BAPI_120g>
Rnames{i} = 'APINO2Q2a+HOQ=MONITSQ2a';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'APINO2Q2a'; Gstr{i,2} = 'HOQ'; 
fAPINO2Q2a(i)=fAPINO2Q2a(i)-1; fHOQ(i)=fHOQ(i)-1; fMONITSQ2a(i)=fMONITSQ2a(i)+1;

%O3 Tracer
i=i+1; %<RACM2_244h>; <BAPI_120h>
Rnames{i} = 'APINO2Q2a+HQ2=MONITSQ2a';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'APINO2Q2a'; Gstr{i,2} = 'HQ2'; 
fAPINO2Q2a(i)=fAPINO2Q2a(i)-1; fHQ2(i)=fHQ2(i)-1; fMONITSQ2a(i)=fMONITSQ2a(i)+1;

%O3 Tracer
i=i+1; %<RACM2_244i>; <BAPI_120i>
Rnames{i} = 'APINO2Q3a+HO2=MONITSQ3a';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'APINO2Q3a'; Gstr{i,2} = 'HO2'; 
fAPINO2Q3a(i)=fAPINO2Q3a(i)-1; fHO2(i)=fHO2(i)-1; fMONITSQ3a(i)=fMONITSQ3a(i)+1;

%O3 Tracer
i=i+1; %<RACM2_244j>; <BAPI_120j>
Rnames{i} = 'APINO2Q3a+HOQ=MONITSQ3a';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'APINO2Q3a'; Gstr{i,2} = 'HOQ'; 
fAPINO2Q3a(i)=fAPINO2Q3a(i)-1; fHOQ(i)=fHOQ(i)-1; fMONITSQ3a(i)=fMONITSQ3a(i)+1;

%O3 Tracer
i=i+1; %<RACM2_244k>; <BAPI_120k>
Rnames{i} = 'APINO2Q3a+HQ2=MONITSQ3a';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'APINO2Q3a'; Gstr{i,2} = 'HQ2'; 
fAPINO2Q3a(i)=fAPINO2Q3a(i)-1; fHQ2(i)=fHQ2(i)-1; fMONITSQ3a(i)=fMONITSQ3a(i)+1;

i=i+1; %<RACM2_Update_245>; <BAPI_120>
Rnames{i} = 'APINO2b+HO2=MONITSb';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'APINO2b'; Gstr{i,2} = 'HO2'; 
fAPINO2b(i)=fAPINO2b(i)-1; fHO2(i)=fHO2(i)-1; fMONITSb(i)=fMONITSb(i)+1;

%O3 Tracer
i=i+1; %<RACM2_245a>; <BAPI_121a>
Rnames{i} = 'APINO2b+HOQ=MONITSb';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'APINO2b'; Gstr{i,2} = 'HOQ'; 
fAPINO2b(i)=fAPINO2b(i)-1; fHOQ(i)=fHOQ(i)-1; fMONITSb(i)=fMONITSb(i)+1; 

%O3 Tracer
i=i+1; %<RACM2_245b>; <BAPI_121b>
Rnames{i} = 'APINO2b+HQ2=MONITSb';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'APINO2b'; Gstr{i,2} = 'HQ2'; 
fAPINO2b(i)=fAPINO2b(i)-1; fHQ2(i)=fHQ2(i)-1; fMONITSb(i)=fMONITSb(i)+1; 

%O3 Tracer
i=i+1; %<RACM2_245c>; <BAPI_121c>
Rnames{i} = 'APINO2Qb+HO2=MONITSQb';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'APINO2Qb'; Gstr{i,2} = 'HO2'; 
fAPINO2Qb(i)=fAPINO2Qb(i)-1; fHO2(i)=fHO2(i)-1; fMONITSQb(i)=fMONITSQb(i)+1; 

%O3 Tracer
i=i+1; %<RACM2_245d>; <BAPI_121d>
Rnames{i} = 'APINO2Qb+HOQ=MONITSQb';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'APINO2Qb'; Gstr{i,2} = 'HOQ'; 
fAPINO2Qb(i)=fAPINO2Qb(i)-1; fHOQ(i)=fHOQ(i)-1; fMONITSQb(i)=fMONITSQb(i)+1;

%O3 Tracer
i=i+1; %<RACM2_245e>; <BAPI_121e>
Rnames{i} = 'APINO2Qb+HQ2=MONITSQb';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'APINO2Qb'; Gstr{i,2} = 'HQ2'; 
fAPINO2Qb(i)=fAPINO2Qb(i)-1; fHQ2(i)=fHQ2(i)-1; fMONITSQb(i)=fMONITSQb(i)+1;

%O3 Tracer
i=i+1; %<RACM2_245f>; <BAPI_121f>
Rnames{i} = 'APINO2Q2b+HO2=MONITSQ2b';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'APINO2Q2b'; Gstr{i,2} = 'HO2'; 
fAPINO2Q2b(i)=fAPINO2Q2b(i)-1; fHO2(i)=fHO2(i)-1; fMONITSQ2b(i)=fMONITSQ2b(i)+1;

%O3 Tracer
i=i+1; %<RACM2_245g>; <BAPI_121g>
Rnames{i} = 'APINO2Q2b+HOQ=MONITSQ2b';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'APINO2Q2b'; Gstr{i,2} = 'HOQ'; 
fAPINO2Q2b(i)=fAPINO2Q2b(i)-1; fHOQ(i)=fHOQ(i)-1; fMONITSQ2b(i)=fMONITSQ2b(i)+1;

%O3 Tracer
i=i+1; %<RACM2_245h>; <BAPI_121h>
Rnames{i} = 'APINO2Q2b+HQ2=MONITSQ2b';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'APINO2Q2b'; Gstr{i,2} = 'HQ2'; 
fAPINO2Q2b(i)=fAPINO2Q2b(i)-1; fHQ2(i)=fHQ2(i)-1; fMONITSQ2b(i)=fMONITSQ2b(i)+1;

%O3 Tracer
i=i+1; %<RACM2_245i>; <BAPI_121i>
Rnames{i} = 'APINO2Q3b+HO2=MONITSQ3b';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'APINO2Q3b'; Gstr{i,2} = 'HO2'; 
fAPINO2Q3b(i)=fAPINO2Q3b(i)-1; fHO2(i)=fHO2(i)-1; fMONITSQ3b(i)=fMONITSQ3b(i)+1;

%O3 Tracer
i=i+1; %<RACM2_245j>; <BAPI_121j>
Rnames{i} = 'APINO2Q3b+HOQ=MONITSQ3b';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'APINO2Q3b'; Gstr{i,2} = 'HOQ'; 
fAPINO2Q3b(i)=fAPINO2Q3b(i)-1; fHOQ(i)=fHOQ(i)-1; fMONITSQ3b(i)=fMONITSQ3b(i)+1;

%O3 Tracer
i=i+1; %<RACM2_245k>; <BAPI_121k>
Rnames{i} = 'APINO2Q3b+HQ2=MONITSQ3b';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'APINO2Q3b'; Gstr{i,2} = 'HQ2'; 
fAPINO2Q3b(i)=fAPINO2Q3b(i)-1; fHQ2(i)=fHQ2(i)-1; fMONITSQ3b(i)=fMONITSQ3b(i)+1;
...
Rnames{i} = 'APINO2a+MO2=HCHO+HO2+HO2+MONITSa';
k(:,i) = 1.60E-13.*exp(708./T);
Gstr{i,1} = 'APINO2a'; Gstr{i,2} = 'MO2'; 
fAPINO2a(i)=fAPINO2a(i)-1; fMO2(i)=fMO2(i)-1; fHCHO(i)=fHCHO(i)+1; fHO2(i)=fHO2(i)+1; fHO2(i)=fHO2(i)+1; fMONITSa(i)=fMONITSa(i)+1; 

%O3 Tracer
i=i+1; %<RACM2_281a>; <BAPI_133a>
Rnames{i} = 'APINO2Qa+MO2=HCHO+HO2+HO2+MONITSQa';
k(:,i) = 1.60E-13.*exp(708./T);
Gstr{i,1} = 'APINO2Qa'; Gstr{i,2} = 'MO2'; 
fAPINO2Qa(i)=fAPINO2Qa(i)-1; fMO2(i)=fMO2(i)-1; fHCHO(i)=fHCHO(i)+1; fHO2(i)=fHO2(i)+1; fHO2(i)=fHO2(i)+1; fMONITSQa(i)=fMONITSQa(i)+1;

%O3 Tracer
i=i+1; %<RACM2_281b>; <BAPI_133b>
Rnames{i} = 'APINO2Q2a+MO2=HCHO+HO2+HO2+MONITSQ2a';
k(:,i) = 1.60E-13.*exp(708./T);
Gstr{i,1} = 'APINO2Q2a'; Gstr{i,2} = 'MO2'; 
fAPINO2Q2a(i)=fAPINO2Q2a(i)-1; fMO2(i)=fMO2(i)-1; fHCHO(i)=fHCHO(i)+1; fHO2(i)=fHO2(i)+1; fHO2(i)=fHO2(i)+1; fMONITSQ2a(i)=fMONITSQ2a(i)+1;

%O3 Tracer
i=i+1; %<RACM2_281c>; <BAPI_133c>
Rnames{i} = 'APINO2Q3a+MO2=HCHO+HO2+HO2+MONITSQ3a';
k(:,i) = 1.60E-13.*exp(708./T);
Gstr{i,1} = 'APINO2Q3a'; Gstr{i,2} = 'MO2'; 
fAPINO2Q3a(i)=fAPINO2Q3a(i)-1; fMO2(i)=fMO2(i)-1; fHCHO(i)=fHCHO(i)+1; fHO2(i)=fHO2(i)+1; fHO2(i)=fHO2(i)+1; fMONITSQ3a(i)=fMONITSQ3a(i)+1;

i=i+1; %<RACM2_Update_282>; <BAPI_134>
Rnames{i} = 'APINO2b+MO2= HO2+NO2+HCHO+ALD+KET+MOH+ROH+MONITSb';
...
fROH(i)=fROH(i)+0.25; fMONITSb(i)=fMONITSb(i)+0.5; 

%O3 Tracer
i=i+1; %<RACM2_282a>; <BAPI_134a>
Rnames{i} = 'APINO2Qb+MO2= HO2+NOQ+NO2+HCHO+ALD+KET+MOH+ROH+MONITSQb';
k(:,i) = 9.68E-14.*exp(708./T);
Gstr{i,1} = 'APINO2Qb'; Gstr{i,2} = 'MO2'; 
fAPINO2b(i)=fAPINO2b(i)-1; fMO2(i)=fMO2(i)-1; fHO2(i)=fHO2(i)+0.50; fNO2(i)=fNO2(i)+(1/6); fNOQ(i)=fNOQ(i)+(1/3); 
fHCHO(i)=fHCHO(i)+0.965; fALD(i)=fALD(i)+0.93; fKET(i)=fKET(i)+0.348; fMOH(i)=fMOH(i)+0.25; 
fROH(i)=fROH(i)+0.25; fMONITSQb(i)=fMONITSQb(i)+0.5; 

%O3 Tracer
i=i+1; %<RACM2_282b>; <BAPI_134b>
Rnames{i} = 'APINO2Q2b+MO2= HO2+NOQ+NQ2+HCHO+ALD+KET+MOH+ROH+MONITSQ2b';
k(:,i) = 9.68E-14.*exp(708./T);
Gstr{i,1} = 'APINO2Qb'; Gstr{i,2} = 'MO2'; 
fAPINO2b(i)=fAPINO2b(i)-1; fMO2(i)=fMO2(i)-1; fHO2(i)=fHO2(i)+0.50; fNQ2(i)=fNQ2(i)+(1/6); fNOQ(i)=fNOQ(i)+(1/3); 
fHCHO(i)=fHCHO(i)+0.965; fALD(i)=fALD(i)+0.93; fKET(i)=fKET(i)+0.348; fMOH(i)=fMOH(i)+0.25; 
fROH(i)=fROH(i)+0.25; fMONITSQ2b(i)=fMONITSQ2b(i)+0.5; 

%O3 Tracer
i=i+1; %<RACM2_282c>; <BAPI_134c>
Rnames{i} = 'APINO2Q3b+MO2= HO2+NQ2+HCHO+ALD+KET+MOH+ROH+MONITSQ3b';
k(:,i) = 9.68E-14.*exp(708./T);
Gstr{i,1} = 'APINO2Qb'; Gstr{i,2} = 'MO2'; 
fAPINO2b(i)=fAPINO2b(i)-1; fMO2(i)=fMO2(i)-1; fHO2(i)=fHO2(i)+0.50; fNQ2(i)=fNQ2(i)+0.5; 
fHCHO(i)=fHCHO(i)+0.965; fALD(i)=fALD(i)+0.93; fKET(i)=fKET(i)+0.348; fMOH(i)=fMOH(i)+0.25; 
fROH(i)=fROH(i)+0.25; fMONITSQ3b(i)=fMONITSQ3b(i)+0.5;
...
Rnames{i} = 'APINO2a+ACO3=MONITSa+MO2+HO2';
k(:,i) = 8.85E-13.*exp(765./T);
Gstr{i,1} = 'APINO2a'; Gstr{i,2} = 'ACO3'; 
fAPINO2a(i)=fAPINO2a(i)-1; fACO3(i)=fACO3(i)-1; fMONITSa(i)=fMONITSa(i)+1; fMO2(i)=fMO2(i)+1; fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1; %<RACM2_317a>; <BAPI_145a>
Rnames{i} = 'APINO2Qa+ACO3=MONITSQa+MO2+HO2';
k(:,i) = 8.85E-13.*exp(765./T);
Gstr{i,1} = 'APINO2Qa'; Gstr{i,2} = 'ACO3'; 
fAPINO2Qa(i)=fAPINO2Qa(i)-1; fACO3(i)=fACO3(i)-1; fMONITSQa(i)=fMONITSQa(i)+1; fMO2(i)=fMO2(i)+1; fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1; %<RACM2_317b>; <BAPI_145b>
Rnames{i} = 'APINO2Q2a+ACO3=MONITSQ2a+MO2+HO2';
k(:,i) = 8.85E-13.*exp(765./T);
Gstr{i,1} = 'APINO2Q2a'; Gstr{i,2} = 'ACO3'; 
fAPINO2Q2a(i)=fAPINO2Q2a(i)-1; fACO3(i)=fACO3(i)-1; fMONITSQ2a(i)=fMONITSQ2a(i)+1; fMO2(i)=fMO2(i)+1; fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1; %<RACM2_317c>; <BAPI_145c>
Rnames{i} = 'APINO2Q3a+ACO3=MONITSQ3a+MO2+HO2';
k(:,i) = 8.85E-13.*exp(765./T);
Gstr{i,1} = 'APINO2Q3a'; Gstr{i,2} = 'ACO3'; 
fAPINO2Q3a(i)=fAPINO2Q3a(i)-1; fACO3(i)=fACO3(i)-1; fMONITSQ3a(i)=fMONITSQ3a(i)+1; fMO2(i)=fMO2(i)+1; fHO2(i)=fHO2(i)+1; 
...
Rnames{i} = 'APINO2Qb+ACO3= MO2+NO2+NOQ+HCHO+ALD+KET+ORA2';
k(:,i) = 5.37E-13.*exp(765./T) ;
Gstr{i,1} = 'APINO2Qb'; Gstr{i,2} = 'ACO3'; 
fAPINO2Qb(i)=fAPINO2Qb(i)-1; fACO3(i)=fACO3(i)-1; fMO2(i)=fMO2(i)+0.50; fNO2(i)=fNO2(i)+(1/3); fNOQ(i)=fNOQ(i)+(2/3); 
fHCHO(i)=fHCHO(i)+0.287; fALD(i)=fALD(i)+1.24; fKET(i)=fKET(i)+0.464; fORA2(i)=fORA2(i)+0.50; 

%O3 Tracer
i=i+1; %<RACM2_318b>; <BAPI_146b>
Rnames{i} = 'APINO2Q2b+ACO3= MO2+NQ2+NOQ+HCHO+ALD+KET+ORA2';
k(:,i) = 5.37E-13.*exp(765./T) ;
Gstr{i,1} = 'APINO2Q2b'; Gstr{i,2} = 'ACO3'; 
fAPINO2Q2b(i)=fAPINO2Q2b(i)-1; fACO3(i)=fACO3(i)-1; fMO2(i)=fMO2(i)+0.50; fNQ2(i)=fNQ2(i)+(1/3); fNOQ(i)=fNOQ(i)+(2/3); 
fHCHO(i)=fHCHO(i)+0.287; fALD(i)=fALD(i)+1.24; fKET(i)=fKET(i)+0.464; fORA2(i)=fORA2(i)+0.50; 

%O3 Tracer
i=i+1; %<RACM2_318c>; <BAPI_146c>
Rnames{i} = 'APINO2Q3b+ACO3= MO2+NQ2+HCHO+ALD+KET+ORA2';
k(:,i) = 5.37E-13.*exp(765./T) ;
Gstr{i,1} = 'APINO2Q3b'; Gstr{i,2} = 'ACO3'; 
fAPINO2Q3b(i)=fAPINO2Q3b(i)-1; fACO3(i)=fACO3(i)-1; fMO2(i)=fMO2(i)+0.50; fNQ2(i)=fNQ2(i)+1;  
fHCHO(i)=fHCHO(i)+0.287; fALD(i)=fALD(i)+1.24; fKET(i)=fKET(i)+0.464; fORA2(i)=fORA2(i)+0.50; 
...
%O3 Tracer
i=i+1; %<RACM2_Update_338a>; <BAPI_151>
Rnames{i} = 'APIO2a+NO2Q=HO2+HOQ+ALD+NO2+NOQ+KET';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'APIO2a'; Gstr{i,2} = 'NO2Q'; 
fAPIO2a(i)=fAPIO2a(i)-1; fNO2Q(i)=fNO2Q(i)-1; fHO2(i)=fHO2(i)+(2/3); fHOQ(i)=fHOQ(i)+(1/3); fALD(i)=fALD(i)+1; fNO2(i)=fNO2(i)+(1/3); fNOQ(i)=fNOQ(i)+(2/3); fKET(i)=fKET(i)+1; 

%O3 Tracer
i=i+1; %<RACM2_Update_338b>; <BAPI_151>
Rnames{i} = 'APIO2a+NOQ2=HO2+HOQ+ALD+NQ2+NOQ+KET';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'APIO2a'; Gstr{i,2} = 'NOQ2'; 
fAPIO2a(i)=fAPIO2a(i)-1; fNOQ2(i)=fNOQ2(i)-1; fHO2(i)=fHO2(i)+(1/3); fHOQ(i)=fHOQ(i)+(2/3); fALD(i)=fALD(i)+1; fNQ2(i)=fNQ2(i)+(1/3); fNOQ(i)=fNOQ(i)+(2/3); fKET(i)=fKET(i)+1; 

%O3 Tracer
i=i+1; %<RACM2_Update_338c>; <BAPI_151>
Rnames{i} = 'APIO2a+NQ3=HOQ+ALD+NQ2+KET';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'APIO2a'; Gstr{i,2} = 'NQ3'; 
fAPIO2a(i)=fAPIO2a(i)-1; fNQ3(i)=fNQ3(i)-1;  fHOQ(i)=fHOQ(i)+1; fALD(i)=fALD(i)+1; fNQ2(i)=fNQ2(i)+1; fKET(i)=fKET(i)+1; 
...
%O3 Tracer
i=i+1; %<RACM2_Update_338e>; <BAPI_151>
Rnames{i} = 'APIO2b+NO2Q=HO2+HOQ+ALD+NO2+NOQ+KET';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'APIO2b'; Gstr{i,2} = 'NO2Q'; 
fAPIO2b(i)=fAPIO2b(i)-1; fNO2Q(i)=fNO2Q(i)-1; fHO2(i)=fHO2(i)+(2/3); fHOQ(i)=fHOQ(i)+(1/3); fALD(i)=fALD(i)+1; fNO2(i)=fNO2(i)+(1/3); fNOQ(i)=fNOQ(i)+(2/3); fKET(i)=fKET(i)+1; 

%O3 Tracer
i=i+1; %<RACM2_Update_338f>; <BAPI_151>
Rnames{i} = 'APIO2b+NOQ2=HO2+HOQ+ALD+NQ2+NOQ+KET';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'APIO2b'; Gstr{i,2} = 'NOQ2'; 
fAPIO2b(i)=fAPIO2b(i)-1; fNOQ2(i)=fNOQ2(i)-1; fHO2(i)=fHO2(i)+(1/3); fHOQ(i)=fHOQ(i)+(2/3); fALD(i)=fALD(i)+1; fNQ2(i)=fNQ2(i)+(1/3); fNOQ(i)=fNOQ(i)+(2/3); fKET(i)=fKET(i)+1; 

%O3 Tracer
i=i+1; %<RACM2_Update_338g>; <BAPI_151>
Rnames{i} = 'APIO2b+NQ3=HOQ+ALD+NQ2+KET';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'APIO2b'; Gstr{i,2} = 'NQ3'; 
fAPIO2b(i)=fAPIO2b(i)-1; fNQ3(i)=fNQ3(i)-1;  fHOQ(i)=fHOQ(i)+1; fALD(i)=fALD(i)+1; fNQ2(i)=fNQ2(i)+1; fKET(i)=fKET(i)+1;
...
Rnames{i} = 'APINO2a+NO3= MONITSa + NO2 + HO2';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'APINO2a'; Gstr{i,2} = 'NO3'; 
fAPINO2a(i)=fAPINO2a(i)-1; fNO3(i)=fNO3(i)-1; fMONITSa(i)=fMONITSa(i)+1; fNO2(i)=fNO2(i)+1; fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1; %<RACM2_354a>; <BAPI_158a>
Rnames{i} = 'APINO2a+NO2Q=MONITSa+NO2+NOQ+HO2';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'APINO2a'; Gstr{i,2} = 'NO2Q'; 
fAPINO2a(i)=fAPINO2a(i)-1; fNO2Q(i)=fNO2Q(i)-1; fMONITSa(i)=fMONITSa(i)+1; fNO2(i)=fNO2(i)+(1/3); fNOQ(i)=fNOQ(i)+(2/3); fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1; %<RACM2_354b>; <BAPI_158b>
Rnames{i} = 'APINO2a+NOQ2=MONITSa+NQ2+NOQ+HO2';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'APINO2a'; Gstr{i,2} = 'NOQ2'; 
fAPINO2a(i)=fAPINO2a(i)-1; fNOQ2(i)=fNOQ2(i)-1; fMONITSa(i)=fMONITSa(i)+1; fNQ2(i)=fNQ2(i)+(1/3); fNOQ(i)=fNOQ(i)+(2/3); fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1; %<RACM2_354c>; <BAPI_158c>
Rnames{i} = 'APINO2a+NQ3=MONITSa+NQ2+HO2';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'APINO2a'; Gstr{i,2} = 'NQ3'; 
fAPINO2a(i)=fAPINO2a(i)-1; fNQ3(i)=fNQ3(i)-1; fMONITSa(i)=fMONITSa(i)+1; fNQ2(i)=fNQ2(i)+1; fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1; %<RACM2_354d>; <BAPI_158d>
Rnames{i} = 'APINO2Qa+NO3=MONITSQa+NO2+HO2';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'APINO2Qa'; Gstr{i,2} = 'NO3'; 
fAPINO2Qa(i)=fAPINO2Qa(i)-1; fNO3(i)=fNO3(i)-1; fMONITSQa(i)=fMONITSQa(i)+1; fNO2(i)=fNO2(i)+1; fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1; %<RACM2_354e>; <BAPI_158e>
Rnames{i} = 'APINO2Qa+NO2Q=MONITSQa+NO2+NOQ+HO2';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'APINO2Qa'; Gstr{i,2} = 'NO2Q'; 
fAPINO2Qa(i)=fAPINO2Qa(i)-1; fNO2Q(i)=fNO2Q(i)-1; fMONITSQa(i)=fMONITSQa(i)+1; fNO2(i)=fNO2(i)+(1/3); fNOQ(i)=fNOQ(i)+(2/3); fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1; %<RACM2_354f>; <BAPI_158f>
Rnames{i} = 'APINO2Qa+NOQ2=MONITSQa+NQ2+NOQ+HO2';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'APINO2Qa'; Gstr{i,2} = 'NOQ2'; 
fAPINO2Qa(i)=fAPINO2Qa(i)-1; fNOQ2(i)=fNOQ2(i)-1; fMONITSQa(i)=fMONITSQa(i)+1; fNQ2(i)=fNQ2(i)+(1/3); fNOQ(i)=fNOQ(i)+(2/3); fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1; %<RACM2_354g>; <BAPI_158g>
Rnames{i} = 'APINO2Qa+NQ3=MONITSQa+NQ2+HO2';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'APINO2Qa'; Gstr{i,2} = 'NQ3'; 
fAPINO2Qa(i)=fAPINO2Qa(i)-1; fNQ3(i)=fNQ3(i)-1; fMONITSQa(i)=fMONITSQa(i)+1; fNQ2(i)=fNQ2(i)+1; fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1; %<RACM2_354h>; <BAPI_158h>
Rnames{i} = 'APINO2Q2a+NO3=MONITSQ2a+NO2+HO2';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'APINO2Q2a'; Gstr{i,2} = 'NO3'; 
fAPINO2Q2a(i)=fAPINO2Q2a(i)-1; fNO3(i)=fNO3(i)-1; fMONITSQ2a(i)=fMONITSQ2a(i)+1; fNO2(i)=fNO2(i)+1; fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1; %<RACM2_354i>; <BAPI_158i>
Rnames{i} = 'APINO2Q2a+NO2Q=MONITSQ2a+NO2+NOQ+HO2';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'APINO2Q2a'; Gstr{i,2} = 'NO2Q'; 
fAPINO2Q2a(i)=fAPINO2Q2a(i)-1; fNO2Q(i)=fNO2Q(i)-1; fMONITSQ2a(i)=fMONITSQ2a(i)+1; fNO2(i)=fNO2(i)+(1/3); fNOQ(i)=fNOQ(i)+(2/3); fHO2(i)=fHO2(i)+1;

%O3 Tracer
i=i+1; %%<RACM2_354j>; <BAPI_158j>
Rnames{i} = 'APINO2Q2a+NOQ2=MONITSQ2a+NQ2+NOQ+HO2';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'APINO2Q2a'; Gstr{i,2} = 'NOQ2'; 
fAPINO2Q2a(i)=fAPINO2Q2a(i)-1; fNOQ2(i)=fNOQ2(i)-1; fMONITSQ2a(i)=fMONITSQ2a(i)+1; fNQ2(i)=fNQ2(i)+(1/3); fNOQ(i)=fNOQ(i)+(2/3); fHO2(i)=fHO2(i)+1;

%O3 Tracer
i=i+1; %<RACM2_354k>; <BAPI_158k>
Rnames{i} = 'APINO2Q2a+NQ3=MONITSQ2a+NQ2+HO2';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'APINO2Q2a'; Gstr{i,2} = 'NQ3'; 
fAPINO2Q2a(i)=fAPINO2Q2a(i)-1; fNQ3(i)=fNQ3(i)-1; fMONITSQ2a(i)=fMONITSQ2a(i)+1; fNQ2(i)=fNQ2(i)+1; fHO2(i)=fHO2(i)+1;

%O3 Tracer
i=i+1; %<RACM2_354l>; <BAPI_158l>
Rnames{i} = 'APINO2Q3a+NO3=MONITSQ3a+NO2+HO2';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'APINO2Q3a'; Gstr{i,2} = 'NO3'; 
fAPINO2Q3a(i)=fAPINO2Q3a(i)-1; fNO3(i)=fNO3(i)-1; fMONITSQ3a(i)=fMONITSQ3a(i)+1; fNO2(i)=fNO2(i)+1; fHO2(i)=fHO2(i)+1;

%O3 Tracer
i=i+1; %<RACM2_354m>; <BAPI_158m>
Rnames{i} = 'APINO2Q3a+NO2Q=MONITSQ3a+NO2+NOQ+HO2';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'APINO2Q3a'; Gstr{i,2} = 'NO2Q'; 
fAPINO2Q3a(i)=fAPINO2Q3a(i)-1; fNO2Q(i)=fNO2Q(i)-1; fMONITSQ3a(i)=fMONITSQ3a(i)+1; fNO2(i)=fNO2(i)+(1/3); fNOQ(i)=fNOQ(i)+(2/3); fHO2(i)=fHO2(i)+1;

%O3 Tracer
i=i+1; %<RACM2_354n>; <BAPI_158n>
Rnames{i} = 'APINO2Q3a+NOQ2=MONITSQ3a+NQ2+NOQ+HO2';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'APINO2Q3a'; Gstr{i,2} = 'NOQ2'; 
fAPINO2Q3a(i)=fAPINO2Q3a(i)-1; fNOQ2(i)=fNOQ2(i)-1; fMONITSQ3a(i)=fMONITSQ3a(i)+1; fNQ2(i)=fNQ2(i)+(1/3); fNOQ(i)=fNOQ(i)+(2/3); fHO2(i)=fHO2(i)+1;

%O3 Tracer
i=i+1; %<RACM2_354o>; <BAPI_158o>
Rnames{i} = 'APINO2Q3a+NQ3=MONITSQ3a+NQ2+HO2';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'APINO2Q3a'; Gstr{i,2} = 'NQ3'; 
fAPINO2Q3a(i)=fAPINO2Q3a(i)-1; fNQ3(i)=fNQ3(i)-1; fMONITSQ3a(i)=fMONITSQ3a(i)+1; fNQ2(i)=fNQ2(i)+1; fHO2(i)=fHO2(i)+1;
...
Rnames{i} = 'APINO2b+NO2Q=2 NO2+NOQ+0.287 HCHO+1.24 ALD+0.464 KET';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'APINO2b'; Gstr{i,2} = 'NO2Q'; 
fAPINO2b(i)=fAPINO2b(i)-1; fNO2Q(i)=fNO2Q(i)-1; fNO2(i)=fNO2(i)+(4/3); fNOQ(i)=fNOQ(i)+(2/3); fHCHO(i)=fHCHO(i)+0.287; fALD(i)=fALD(i)+1.24; fKET(i)=fKET(i)+0.464;

%O3 Tracer
i=i+1; %<RACM2_355b>; <BAPI_159b>
Rnames{i} = 'APINO2b+NOQ2=NO2+NOQ+NQ2+0.287 HCHO+1.24 ALD+0.464 KET';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'APINO2b'; Gstr{i,2} = 'NOQ2'; 
fAPINO2b(i)=fAPINO2b(i)-1; fNOQ2(i)=fNOQ2(i)-1; fNO2(i)=fNO2(i)+(1); fNQ2(i)=fNQ2(i)+(1/3); fNOQ(i)=fNOQ(i)+(2/3); fHCHO(i)=fHCHO(i)+0.287; fALD(i)=fALD(i)+1.24; fKET(i)=fKET(i)+0.464;

%O3 Tracer
i=i+1; %<RACM2_355c>; <BAPI_159c>
Rnames{i} = 'APINO2b+NQ3=NO2+NQ2+0.287 HCHO+1.24 ALD+0.464 KET';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'APINO2b'; Gstr{i,2} = 'NQ3'; 
fAPINO2b(i)=fAPINO2b(i)-1; fNQ3(i)=fNQ3(i)-1; fNO2(i)=fNO2(i)+(1); fNQ2(i)=fNQ2(i)+1; fHCHO(i)=fHCHO(i)+0.287;
fALD(i)=fALD(i)+1.24; fKET(i)=fKET(i)+0.464;

%O3 Tracer
i=i+1; %<RACM2_355d>; <BAPI_159d>
Rnames{i} = 'APINO2Qb+NO3=NO2+NOQ+0.287 HCHO+1.24 ALD+0.464 KET';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'APINO2Qb'; Gstr{i,2} = 'NO3'; 
fAPINO2Qb(i)=fAPINO2Qb(i)-1; fNO3(i)=fNO3(i)-1; fNO2(i)=fNO2(i)+(4/3); fNOQ(i)=fNOQ(i)+(2/3); fHCHO(i)=fHCHO(i)+0.287; fALD(i)=fALD(i)+1.24; fKET(i)=fKET(i)+0.464;

%O3 Tracer
i=i+1; %<RACM2_355e>; <BAPI_159e>
Rnames{i} = 'APINO2Qb+NO2Q=NO2+NOQ+0.287 HCHO+1.24 ALD+0.464 KET';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'APINO2Qb'; Gstr{i,2} = 'NO2Q'; 
fAPINO2Qb(i)=fAPINO2Qb(i)-1; fNO2Q(i)=fNO2Q(i)-1; fNO2(i)=fNO2(i)+(2/3); fNOQ(i)=fNOQ(i)+(4/3); fHCHO(i)=fHCHO(i)+0.287; fALD(i)=fALD(i)+1.24; fKET(i)=fKET(i)+0.464;

%O3 Tracer
i=i+1; %<RACM2_355f>; <BAPI_159f>
Rnames{i} = 'APINO2Qb+NOQ2=NO2+NOQ+NQ2+0.287 HCHO+1.24 ALD+0.464 KET';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'APINO2Qb'; Gstr{i,2} = 'NOQ2'; 
fAPINO2Qb(i)=fAPINO2Qb(i)-1; fNOQ2(i)=fNOQ2(i)-1; fNO2(i)=fNO2(i)+(1/3); fNOQ(i)=fNOQ(i)+(4/3); fNQ2(i)=fNQ2(i)+(1/3); fHCHO(i)=fHCHO(i)+0.287; fALD(i)=fALD(i)+1.24; fKET(i)=fKET(i)+0.464;

%O3 Tracer
i=i+1; %<RACM2_355g>; <BAPI_159g>
Rnames{i} = 'APINO2Qb+NQ3=NO2+NOQ+NQ2+0.287 HCHO+1.24 ALD+0.464 KET';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'APINO2Qb'; Gstr{i,2} = 'NQ3'; 
fAPINO2Qb(i)=fAPINO2Qb(i)-1; fNQ3(i)=fNQ3(i)-1; fNO2(i)=fNO2(i)+(1/3); fNOQ(i)=fNOQ(i)+(2/3); fNQ2(i)=fNQ2(i)+1; fHCHO(i)=fHCHO(i)+0.287; fALD(i)=fALD(i)+1.24; fKET(i)=fKET(i)+0.464;

%O3 Tracer
i=i+1; %<RACM2_355h>; <BAPI_159h>
Rnames{i} = 'APINO2Q2b+NO3=NO2+NOQ+NQ2+0.287 HCHO+1.24 ALD+0.464 KET';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'APINO2Q2b'; Gstr{i,2} = 'NO3'; 
fAPINO2Q2b(i)=fAPINO2Q2b(i)-1; fNO3(i)=fNO3(i)-1; fNO2(i)=fNO2(i)+1; fNOQ(i)=fNOQ(i)+(2/3); fNQ2(i)=fNQ2(i)+(1/3); fHCHO(i)=fHCHO(i)+0.287; fALD(i)=fALD(i)+1.24; fKET(i)=fKET(i)+0.464;

%O3 Tracer
i=i+1; %<RACM2_355i>; <BAPI_159i>
Rnames{i} = 'APINO2Q2b+NO2Q=NO2+NOQ+NQ2+0.287 HCHO+1.24 ALD+0.464 KET';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'APINO2Q2b'; Gstr{i,2} = 'NO2Q'; 
fAPINO2Q2b(i)=fAPINO2Q2b(i)-1; fNO2Q(i)=fNO2Q(i)-1; fNO2(i)=fNO2(i)+(1/3); fNOQ(i)=fNOQ(i)+(4/3); fNQ2(i)=fNQ2(i)+(1/3); fHCHO(i)=fHCHO(i)+0.287; fALD(i)=fALD(i)+1.24; fKET(i)=fKET(i)+0.464;

%O3 Tracer
i=i+1; %<RACM2_355j>; <BAPI_159j>
Rnames{i} = 'APINO2Q2b+NOQ2=NOQ+NQ2+0.287 HCHO+1.24 ALD+0.464 KET';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'APINO2Q2b'; Gstr{i,2} = 'NOQ2'; 
fAPINO2Q2b(i)=fAPINO2Q2b(i)-1; fNOQ2(i)=fNOQ2(i)-1; fNOQ(i)=fNOQ(i)+(4/3); fNQ2(i)=fNQ2(i)+(2/3); fHCHO(i)=fHCHO(i)+0.287; fALD(i)=fALD(i)+1.24; fKET(i)=fKET(i)+0.464;

%O3 Tracer
i=i+1; %<RACM2_355k>; <BAPI_159k>
Rnames{i} = 'APINO2Q2b+NQ3=NOQ+NQ2+0.287 HCHO+1.24 ALD+0.464 KET';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'APINO2Q2b'; Gstr{i,2} = 'NQ3'; 
fAPINO2Q2b(i)=fAPINO2Q2b(i)-1; fNQ3(i)=fNQ3(i)-1; fNOQ(i)=fNOQ(i)+(2/3); fNQ2(i)=fNQ2(i)+(4/3); fHCHO(i)=fHCHO(i)+0.287; fALD(i)=fALD(i)+1.24; fKET(i)=fKET(i)+0.464;

%O3 Tracer
i=i+1; %<RACM2_355l>; <BAPI_159l>
Rnames{i} = 'APINO2Q3b+NO3=NO2+NQ2+0.287 HCHO+1.24 ALD+0.464 KET';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'APINO2Q3b'; Gstr{i,2} = 'NO3'; 
fAPINO2Q3b(i)=fAPINO2Q3b(i)-1; fNO3(i)=fNO3(i)-1; fNO2(i)=fNO2(i)+1; fNQ2(i)=fNQ2(i)+1; fHCHO(i)=fHCHO(i)+0.287;
fALD(i)=fALD(i)+1.24; fKET(i)=fKET(i)+0.464;

%O3 Tracer
i=i+1; %<RACM2_355m>; <BAPI_159m>
Rnames{i} = 'APINO2Q3b+NO2Q=NO2+NOQ+NQ2+0.287 HCHO+1.24 ALD+0.464 KET';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'APINO2Q3b'; Gstr{i,2} = 'NO2Q'; 
fAPINO2Q3b(i)=fAPINO2Q3b(i)-1; fNO2Q(i)=fNO2Q(i)-1; fNO2(i)=fNO2(i)+(1/3); fNOQ(i)=fNOQ(i)+(2/3); fNQ2(i)=fNQ2(i)+1; fHCHO(i)=fHCHO(i)+0.287; fALD(i)=fALD(i)+1.24; fKET(i)=fKET(i)+0.464;

%O3 Tracer
i=i+1; %<RACM2_355n>; <BAPI_159n>
Rnames{i} = 'APINO2Q3b+NOQ2=NOQ+NQ2+0.287 HCHO+1.24 ALD+0.464 KET';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'APINO2Q3b'; Gstr{i,2} = 'NOQ2'; 
fAPINO2Q3b(i)=fAPINO2Q3b(i)-1; fNOQ2(i)=fNOQ2(i)-1; fNOQ(i)=fNOQ(i)+(2/3); fNQ2(i)=fNQ2(i)+(4/3); fHCHO(i)=fHCHO(i)+0.287; fALD(i)=fALD(i)+1.24; fKET(i)=fKET(i)+0.464;

%O3 Tracer
i=i+1; %<RACM2_355o>; <BAPI_159o>
Rnames{i} = 'APINO2Q3b+NQ3=NQ2+0.287 HCHO+1.24 ALD+0.464 KET';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'APINO2Q3b'; Gstr{i,2} = 'NQ3'; 
fAPINO2Q3b(i)=fAPINO2Q3b(i)-1; fNQ3(i)=fNQ3(i)-1; fNQ2(i)=fNQ2(i)+2; fHCHO(i)=fHCHO(i)+0.287;
fALD(i)=fALD(i)+1.24; fKET(i)=fKET(i)+0.464;
...
Rnames{i} = 'APINO2a+APINO2a=MONITSa+MONITSa+HO2';
k(:,i) = 7.00E-14.*exp(1000./T);
Gstr{i,1} = 'APINO2a'; Gstr{i,2} = 'APINO2a'; 
fAPINO2a(i)=fAPINO2a(i)-1; fAPINO2a(i)=fAPINO2a(i)-1; fMONITSa(i)=fMONITSa(i)+1; fMONITSa(i)=fMONITSa(i)+1; fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1; %<RACM2_359a>; <BAPI_162a>
Rnames{i} = 'APINO2a+APINO2Qa=MONITSa+MONITSQa+HO2';
k(:,i) = 7.00E-14.*exp(1000./T);
Gstr{i,1} = 'APINO2a'; Gstr{i,2} = 'APINO2Qa'; 
fAPINO2a(i)=fAPINO2a(i)-1; fAPINO2Qa(i)=fAPINO2Qa(i)-1; fMONITSa(i)=fMONITSa(i)+1; fMONITSQa(i)=fMONITSQa(i)+1; fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1; %<RACM2_359b>; <BAPI_162b>
Rnames{i} = 'APINO2a+APINO2Q2a=MONITSa+MONITSQ2a+HO2';
k(:,i) = 7.00E-14.*exp(1000./T);
Gstr{i,1} = 'APINO2a'; Gstr{i,2} = 'APINO2Q2a'; 
fAPINO2a(i)=fAPINO2a(i)-1; fAPINO2Q2a(i)=fAPINO2Q2a(i)-1; fMONITSa(i)=fMONITSa(i)+1; fMONITSQ2a(i)=fMONITSQ2a(i)+1; fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1; %<RACM2_359c>; <BAPI_162c>
Rnames{i} = 'APINO2a+APINO2Q3a=MONITSa+MONITSQ3a+HO2';
k(:,i) = 7.00E-14.*exp(1000./T);
Gstr{i,1} = 'APINO2a'; Gstr{i,2} = 'APINO2Q3a'; 
fAPINO2a(i)=fAPINO2a(i)-1; fAPINO2Q3a(i)=fAPINO2Q3a(i)-1; fMONITSa(i)=fMONITSa(i)+1; fMONITSQ3a(i)=fMONITSQ3a(i)+1; fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1; %<RACM2_359d>; <BAPI_162d>
Rnames{i} = 'APINO2Qa+APINO2Qa=MONITSQa+MONITSQa+HO2';
k(:,i) = 7.00E-14.*exp(1000./T);
Gstr{i,1} = 'APINO2Qa'; Gstr{i,2} = 'APINO2Qa'; 
fAPINO2Qa(i)=fAPINO2Qa(i)-1; fAPINO2Qa(i)=fAPINO2Qa(i)-1; fMONITSQa(i)=fMONITSQa(i)+1; fMONITSQa(i)=fMONITSQa(i)+1; fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1; %<RACM2_359e>; <BAPI_162e>
Rnames{i} = 'APINO2Qa+APINO2Q2a=MONITSQa+MONITSQ2a+HO2';
k(:,i) = 7.00E-14.*exp(1000./T);
Gstr{i,1} = 'APINO2Qa'; Gstr{i,2} = 'APINO2Q2a'; 
fAPINO2Qa(i)=fAPINO2Qa(i)-1; fAPINO2Q2a(i)=fAPINO2Q2a(i)-1; fMONITSQa(i)=fMONITSQa(i)+1; fMONITSQ2a(i)=fMONITSQ2a(i)+1; fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1; %<RACM2_359f>; <BAPI_162f>
Rnames{i} = 'APINO2Qa+APINO2Q3a=MONITSQa+MONITSQ3a+HO2';
k(:,i) = 7.00E-14.*exp(1000./T);
Gstr{i,1} = 'APINO2Qa'; Gstr{i,2} = 'APINO2Q3a'; 
fAPINO2Qa(i)=fAPINO2Qa(i)-1; fAPINO2Q3a(i)=fAPINO2Q3a(i)-1; fMONITSQa(i)=fMONITSQa(i)+1; fMONITSQ3a(i)=fMONITSQ3a(i)+1; fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1; %<RACM2_359g>; <BAPI_162g>
Rnames{i} = 'APINO2Q2a+APINO2Q2a=MONITSQ2a+MONITSQ2a+HO2';
k(:,i) = 7.00E-14.*exp(1000./T);
Gstr{i,1} = 'APINO2Q2a'; Gstr{i,2} = 'APINO2Q2a'; 
fAPINO2Q2a(i)=fAPINO2Q2a(i)-1; fAPINO2Q2a(i)=fAPINO2Q2a(i)-1; fMONITSQ2a(i)=fMONITSQ2a(i)+1; fMONITSQ2a(i)=fMONITSQ2a(i)+1; fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1; %<RACM2_359h>; <BAPI_162h>
Rnames{i} = 'APINO2Q2a+APINO2Q3a=MONITSQ2a+MONITSQ3a+HO2';
k(:,i) = 7.00E-14.*exp(1000./T);
Gstr{i,1} = 'APINO2Q2a'; Gstr{i,2} = 'APINO2Q3a'; 
fAPINO2Q2a(i)=fAPINO2Q2a(i)-1; fAPINO2Q3a(i)=fAPINO2Q3a(i)-1; fMONITSQ2a(i)=fMONITSQ2a(i)+1; fMONITSQ3a(i)=fMONITSQ3a(i)+1; fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1; %<RACM2_359i>; <BAPI_162i>
Rnames{i} = 'APINO2Q3a+APINO2Q3a=MONITSQ3a+MONITSQ3a+HO2';
k(:,i) = 7.00E-14.*exp(1000./T);
Gstr{i,1} = 'APINO2Q3a'; Gstr{i,2} = 'APINO2Q3a'; 
fAPINO2Q3a(i)=fAPINO2Q3a(i)-1; fAPINO2Q3a(i)=fAPINO2Q3a(i)-1; fMONITSQ3a(i)=fMONITSQ3a(i)+1; fMONITSQ3a(i)=fMONITSQ3a(i)+1; fHO2(i)=fHO2(i)+1; 

i=i+1; %<RACM2_Update_360>; <BAPI_163>
Rnames{i} = 'APINO2a+APINO2b=0.50 HO2+0.50 NO2+0.202 HCHO+0.640 ALD+0.149 KET + MONITSa +0.5 MONITSb ';
...
fMONITSa(i)=fMONITSa(i)+1; fMONITSb(i)=fMONITSb(i)+0.5; 

%O3 Tracer
i=i+1; %<RACM2_360a>; <BAPI_163a>
Rnames{i} = 'APINO2a+APINO2Qb=HO2+HOQ+NO2+NOQ+0.202 HCHO+0.640 ALD+0.149 KET+ MONITSa +MONITSQb ';
k(:,i) = 4.25E-14.*exp(1000./T);
Gstr{i,1} = 'APINO2a'; Gstr{i,2} = 'APINO2Qb'; 
fAPINO2a(i)=fAPINO2a(i)-1; fAPINO2Qb(i)=fAPINO2Qb(i)-1; fHO2(i)=fHO2(i)+(5/6); fHOQ(i)=fHOQ(i)+(1/6); fNO2(i)=fNO2(i)+(1/6); fNOQ(i)=fNOQ(i)+(2/6);
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fMONITSa(i)=fMONITSa(i)+1; fMONITSQb(i)=fMONITSQb(i)+0.5; 

%O3 Tracer
i=i+1; %<RACM2_360b>; <BAPI_163b>
Rnames{i} = 'APINO2a+APINO2Q2b=HO2+HOQ+NQ2+NOQ+0.202 HCHO+0.640 ALD+0.149 KET+ MONITSa +MONITSQ2b';
k(:,i) = 4.25E-14.*exp(1000./T);
Gstr{i,1} = 'APINO2a'; Gstr{i,2} = 'APINO2Q2b'; 
fAPINO2a(i)=fAPINO2a(i)-1; fAPINO2Q2b(i)=fAPINO2Q2b(i)-1; fHO2(i)=fHO2(i)+(2/3); fHOQ(i)=fHOQ(i)+(1/3); fNQ2(i)=fNQ2(i)+(1/6); fNOQ(i)=fNOQ(i)+(2/6);
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fMONITSa(i)=fMONITSa(i)+1; fMONITSQ2b(i)=fMONITSQ2b(i)+0.5; 

%O3 Tracer
i=i+1; %<RACM2_360c>; <BAPI_163c>
Rnames{i} = 'APINO2a+APINO2Q3b=HO2+HOQ+NQ2+0.202 HCHO+0.640 ALD+0.149 KET+ MONITSa +MONITSQ3b';
k(:,i) = 4.25E-14.*exp(1000./T);
Gstr{i,1} = 'APINO2a'; Gstr{i,2} = 'APINO2Q3b'; 
fAPINO2a(i)=fAPINO2a(i)-1; fAPINO2Q3b(i)=fAPINO2Q3b(i)-1; fHO2(i)=fHO2(i)+0.25; fHOQ(i)=fHOQ(i)+0.25; fNQ2(i)=fNQ2(i)+(1/2); 
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fMONITSa(i)=fMONITSa(i)+1; fMONITSQ3b(i)=fMONITSQ3b(i)+0.5; 

%O3 Tracer
i=i+1; %<RACM2_360d>; <BAPI_163d>
Rnames{i} = 'APINO2Qa+APINO2b=0.50 HO2+NO2+0.202 HCHO+0.640 ALD+0.149 KET+ MONITSQa +MONITSb';
k(:,i) = 4.25E-14.*exp(1000./T);
Gstr{i,1} = 'APINO2Qa'; Gstr{i,2} = 'APINO2Qb'; 
fAPINO2Qa(i)=fAPINO2Qa(i)-1; fAPINO2b(i)=fAPINO2b(i)-1; fHO2(i)=fHO2(i)+0.5; fNO2(i)=fNO2(i)+(1/2); 
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fMONITSQa(i)=fMONITSQa(i)+1; fMONITSb(i)=fMONITSb(i)+0.5; 

%O3 Tracer
i=i+1; %<RACM2_360e>; <BAPI_163e>
Rnames{i} = 'APINO2Qa+APINO2Qb=HO2+HOQ+NO2+NOQ+0.202 HCHO+0.640 ALD+0.149 KET+ MONITSQa + MONITSQb';
k(:,i) = 4.25E-14.*exp(1000./T);
Gstr{i,1} = 'APINO2Qa'; Gstr{i,2} = 'APINO2Qb'; 
fAPINO2Qa(i)=fAPINO2Qa(i)-1; fAPINO2Qb(i)=fAPINO2Qb(i)-1; fHO2(i)=fHO2(i)+(5/6); fHOQ(i)=fHOQ(i)+(1/6); fNO2(i)=fNO2(i)+(1/6); fNOQ(i)=fNOQ(i)+(2/6); 
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fMONITSQa(i)=fMONITSQa(i)+1;  fMONITSQb(i)=fMONITSQb(i)+0.5; 

%O3 Tracer
i=i+1; %<RACM2_360f>; <BAPI_163f>
Rnames{i} = 'APINO2Qa+APINO2Q2b=HO2+HOQ+NQ2+NOQ+0.202 HCHO+0.640 ALD+0.149 KET+ MONITSQa+MONITSQ2b';
k(:,i) = 4.25E-14.*exp(1000./T);
Gstr{i,1} = 'APINO2Qa'; Gstr{i,2} = 'APINO2Q2b'; 
fAPINO2Qa(i)=fAPINO2Qa(i)-1; fAPINO2Q2b(i)=fAPINO2Q2b(i)-1; fHO2(i)=fHO2(i)+(2/3); fHO2(i)=fHO2(i)+(1/3); fNQ2(i)=fNQ2(i)+(1/6); fNOQ(i)=fNOQ(i)+(2/6); 
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fMONITSQa(i)=fMONITSQa(i)+1; fMONITSQ2b(i)=fMONITSQ2b(i)+0.5; 

%O3 Tracer
i=i+1; %<RACM2_360g>; <BAPI_163g>
Rnames{i} = 'APINO2Qa+APINO2Q3b=HO2+HOQ+NQ2+0.202 HCHO+0.640 ALD+0.149 KET+ MONITSQa+MONITSQ3b';
k(:,i) = 4.25E-14.*exp(1000./T);
Gstr{i,1} = 'APINO2Qa'; Gstr{i,2} = 'APINO2Q3b'; 
fAPINO2Qa(i)=fAPINO2Qa(i)-1; fAPINO2Q3b(i)=fAPINO2Q3b(i)-1; fHO2(i)=fHO2(i)+0.25; fHOQ(i)=fHOQ(i)+0.25; fNQ2(i)=fNQ2(i)+(1/2);  
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fMONITSQa(i)=fMONITSQa(i)+1; fMONITSQ3b(i)=fMONITSQ3b(i)+0.5; 

%O3 Tracer
i=i+1; %<RACM2_360h>; <BAPI_163h>
Rnames{i} = 'APINO2Q2a+APINO2b=0.50 HO2+NO2+0.202 HCHO+0.640 ALD+0.149 KET+ MONITSQ2a+MONITSb';
k(:,i) = 4.25E-14.*exp(1000./T);
Gstr{i,1} = 'APINO2Q2a'; Gstr{i,2} = 'APINO2b'; 
fAPINO2Q2a(i)=fAPINO2Q2a(i)-1; fAPINO2b(i)=fAPINO2b(i)-1; fHO2(i)=fHO2(i)+0.5; fNO2(i)=fNO2(i)+(1/2);  
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fMONITSQ2a(i)=fMONITSQ2a(i)+1; fMONITSb(i)=fMONITSb(i)+0.5; 

%O3 Tracer
i=i+1; %<RACM2_360i>; <BAPI_163i>
Rnames{i} = 'APINO2Q2a+APINO2Qb=HO2+HOQ+NO2+NOQ+0.202 HCHO+0.640 ALD+0.149 KET+ MONITSQ2a+MONITSQb';
k(:,i) = 4.25E-14.*exp(1000./T);
Gstr{i,1} = 'APINO2Q2a'; Gstr{i,2} = 'APINO2Qb'; 
fAPINO2Q2a(i)=fAPINO2Q2a(i)-1; fAPINO2Qb(i)=fAPINO2Qb(i)-1; fHO2(i)=fHO2(i)+(5/6); fHOQ(i)=fHOQ(i)+(1/6); fNO2(i)=fNO2(i)+(1/6); fNOQ(i)=fNOQ(i)+(2/6);  
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fMONITSQ2a(i)=fMONITSQ2a(i)+1; fMONITSQb(i)=fMONITSQb(i)+0.5; 

%O3 Tracer
i=i+1; %<RACM2_360j>; <BAPI_163j>
Rnames{i} = 'APINO2Q2a+APINO2Q2b=HO2+HOQ+NQ2+NOQ+0.202 HCHO+0.640 ALD+0.149 KET+ MONITSQ2a+MONITSQ2b';
k(:,i) = 4.25E-14.*exp(1000./T);
Gstr{i,1} = 'APINO2Q2a'; Gstr{i,2} = 'APINO2Q2b'; 
fAPINO2Q2a(i)=fAPINO2Q2a(i)-1; fAPINO2Q2b(i)=fAPINO2Q2b(i)-1; fHO2(i)=fHO2(i)+(2/3); fHOQ(i)=fHOQ(i)+(1/3); fNQ2(i)=fNQ2(i)+(1/6); fNOQ(i)=fNOQ(i)+(2/6);  
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fMONITSQ2a(i)=fMONITSQ2a(i)+1; fMONITSQ2b(i)=fMONITSQ2b(i)+0.5; 

%O3 Tracer
i=i+1; %<RACM2_360k>; <BAPI_163k>
Rnames{i} = 'APINO2Q2a+APINO2Q3b=HO2+HOQ+NQ2+0.202 HCHO+0.640 ALD+0.149 KET+ MONITSQ2a+MONITSQ3b';
k(:,i) = 4.25E-14.*exp(1000./T);
Gstr{i,1} = 'APINO2Q2a'; Gstr{i,2} = 'APINO2Q3b'; 
fAPINO2Q2a(i)=fAPINO2Q2a(i)-1; fAPINO2Q3b(i)=fAPINO2Q3b(i)-1; fHO2(i)=fHO2(i)+0.25; fHOQ(i)=fHOQ(i)+0.25; fNQ2(i)=fNQ2(i)+(1/2);   
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fMONITSQ2a(i)=fMONITSQ2a(i)+1; fMONITSQ3b(i)=fMONITSQ3b(i)+0.5; 

%O3 Tracer
i=i+1; %<RACM2_360l>; <BAPI_163l>
Rnames{i} = 'APINO2Q3a+APINO2b=0.50 HO2+NO2+0.202 HCHO+0.640 ALD+0.149 KET+ MONITSQ3a+MONITSb';
k(:,i) = 4.25E-14.*exp(1000./T);
Gstr{i,1} = 'APINO2Q3a'; Gstr{i,2} = 'APINO2b'; 
fAPINO2Q3a(i)=fAPINO2Q3a(i)-1; fAPINO2b(i)=fAPINO2b(i)-1; fHO2(i)=fHO2(i)+0.5; fNO2(i)=fNO2(i)+(1/2);   
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fMONITSQ3a(i)=fMONITSQ3a(i)+1; fMONITSb(i)=fMONITSb(i)+0.5; 

%O3 Tracer
i=i+1; %<RACM2_360m>; <BAPI_163m>
Rnames{i} = 'APINO2Q3a+APINO2Qb=HO2+HOQ+NO2+NOQ+0.202 HCHO+0.640 ALD+0.149 KET+ MONITSQ3a+MONITSQb';
k(:,i) = 4.25E-14.*exp(1000./T);
Gstr{i,1} = 'APINO2Q3a'; Gstr{i,2} = 'APINO2Qb'; 
fAPINO2Q3a(i)=fAPINO2Q3a(i)-1; fAPINO2Qb(i)=fAPINO2Qb(i)-1; fHO2(i)=fHO2(i)+(5/6); fHOQ(i)=fHOQ(i)+(1/6); fNO2(i)=fNO2(i)+(1/6); fNOQ(i)=fNOQ(i)+(2/6);   
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fMONITSQ3a(i)=fMONITSQ3a(i)+1; fMONITSQb(i)=fMONITSQb(i)+0.5; 

%O3 Tracer
i=i+1; %<RACM2_360n>; <BAPI_163n>
Rnames{i} = 'APINO2Q3a+APINO2Q2b=HO2+HOQ+NQ2+NOQ+0.202 HCHO+0.640 ALD+0.149 KET+ MONITSQ3a+MONITSQ2b';
k(:,i) = 4.25E-14.*exp(1000./T);
Gstr{i,1} = 'APINO2Q3a'; Gstr{i,2} = 'APINO2Q2b'; 
fAPINO2Q3a(i)=fAPINO2Q3a(i)-1; fAPINO2Q2b(i)=fAPINO2Q2b(i)-1; fHO2(i)=fHO2(i)+(2/3); fHOQ(i)=fHOQ(i)+(1/3); fNQ2(i)=fNQ2(i)+(1/6); fNOQ(i)=fNOQ(i)+(2/6);   
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fMONITSQ3a(i)=fMONITSQ3a(i)+1; fMONITSQ2b(i)=fMONITSQ2b(i)+0.5; 

%O3 Tracer
i=i+1; %<RACM2_360o>; <BAPI_163o>
Rnames{i} = 'APINO2Q3a+APINO2Q3b=HO2+HOQ+NQ2+0.202 HCHO+0.640 ALD+0.149 KET+ MONITSQ3a + MONITSQ3b';
k(:,i) = 4.25E-14.*exp(1000./T);
Gstr{i,1} = 'APINO2Q3a'; Gstr{i,2} = 'APINO2Q3b'; 
fAPINO2Q3a(i)=fAPINO2Q3a(i)-1; fAPINO2Q3b(i)=fAPINO2Q3b(i)-1; fHO2(i)=fHO2(i)+0.25; fHOQ(i)=fHOQ(i)+0.25; fNQ2(i)=fNQ2(i)+(1/2);    
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fMONITSQ3a(i)=fMONITSQ3a(i)+1; fMONITSQ3b(i)=fMONITSQ3b(i)+1; 


i=i+1; %<RACM2_Update_361>; <BAPI_164>
Rnames{i} ='APINO2b+APINO2b= NO2+0.504 HCHO+1.21 ALD+0.285 KET+MONITSb ';
k(:,i) = 1.00E-14;
Gstr{i,1} = 'APINO2b'; Gstr{i,2} = 'APINO2b'; 
fAPINO2b(i)=fAPINO2b(i)-1; fAPINO2b(i)=fAPINO2b(i)-1; fNO2(i)=fNO2(i)+1; fHCHO(i)=fHCHO(i)+0.504;
fALD(i)=fALD(i)+1.21; fKET(i)=fKET(i)+0.285; fMONITSb(i)=fMONITSb(i)+1;

%O3 Tracer
i=i+1; %<RACM2_361a>; <BAPI_164a>
Rnames{i} = 'APINO2b+APINO2Qb=NO2+NOQ+0.504 HCHO+1.21 ALD+0.285 KET+MONITSb+MONITSQb ';
k(:,i) = 2.96E-14.*exp(1000./T);
Gstr{i,1} = 'APINO2b'; Gstr{i,2} = 'APINO2Qb'; 
fAPINO2b(i)=fAPINO2b(i)-1; fAPINO2Qb(i)=fAPINO2Qb(i)-1; fNO2(i)=fNO2(i)+(4/6); fNOQ(i)=fNOQ(i)+(1/3); fHCHO(i)=fHCHO(i)+0.504;
fALD(i)=fALD(i)+1.21; fKET(i)=fKET(i)+0.285; fMONITSb(i)=fMONITSb(i)+0.5; fMONITSQb(i)=fMONITSQb(i)+0.5;

%O3 Tracer
i=i+1; %<RACM2_361b>; <BAPI_164b>
Rnames{i} = 'APINO2b+APINO2Q2b=NO2+NOQ+NQ2+0.504 HCHO+1.21 ALD+0.285 KET+MONITSb+MONITSQ2b';
k(:,i) = 2.96E-14.*exp(1000./T);
Gstr{i,1} = 'APINO2b'; Gstr{i,2} = 'APINO2Q2b'; 
fAPINO2b(i)=fAPINO2b(i)-1; fAPINO2Q2b(i)=fAPINO2Q2b(i)-1; fNO2(i)=fNO2(i)+(1/2); fNQ2(i)=fNQ2(i)+(1/6); fNOQ(i)=fNOQ(i)+(2/6); fHCHO(i)=fHCHO(i)+0.504;
fALD(i)=fALD(i)+1.21; fKET(i)=fKET(i)+0.285; fMONITSb(i)=fMONITSb(i)+0.5; fMONITSQ2b(i)=fMONITSQ2b(i)+0.5;

%O3 Tracer
i=i+1; %<RACM2_361c>; <BAPI_164c>
Rnames{i} = 'APINO2b+APINO2Q3b=NO2+NQ2+0.504 HCHO+1.21 ALD+0.285 KET+MONITSb+MONITSQ3b';
k(:,i) = 2.96E-14.*exp(1000./T);
Gstr{i,1} = 'APINO2b'; Gstr{i,2} = 'APINO2Q3b'; 
fAPINO2b(i)=fAPINO2b(i)-1; fAPINO2Q3b(i)=fAPINO2Q3b(i)-1; fNO2(i)=fNO2(i)+(1/2); fNQ2(i)=fNQ2(i)+(1/2); fHCHO(i)=fHCHO(i)+0.504;
fALD(i)=fALD(i)+1.21; fKET(i)=fKET(i)+0.285; fMONITSb(i)=fMONITSb(i)+0.5; fMONITSQ3b(i)=fMONITSQ3b(i)+0.5;

%O3 Tracer
i=i+1; %<RACM2_361d>; <BAPI_164d>
Rnames{i} = 'APINO2Qb+APINO2Qb=NO2+NQ2+0.504 HCHO+1.21 ALD+0.285 KET+MONITSQb';
k(:,i) = 2.96E-14.*exp(1000./T);
Gstr{i,1} = 'APINO2Qb'; Gstr{i,2} = 'APINO2Qb'; 
fAPINO2Qb(i)=fAPINO2Qb(i)-1; fAPINO2Qb(i)=fAPINO2Qb(i)-1; fNO2(i)=fNO2(i)+(1/3); fNOQ(i)=fNOQ(i)+(2/3); fHCHO(i)=fHCHO(i)+0.504;
fALD(i)=fALD(i)+1.21; fKET(i)=fKET(i)+0.285; fMONITSQb(i)=fMONITSQb(i)+1;

%O3 Tracer
i=i+1; %<RACM2_361e>; <BAPI_164e>
Rnames{i} = 'APINO2Qb+APINO2Q2b=NO2+NQ2+NQ2+0.504 HCHO+1.21 ALD+0.285 KET+MONITSQb+MONITSQ2b';
k(:,i) = 2.96E-14.*exp(1000./T);
Gstr{i,1} = 'APINO2Qb'; Gstr{i,2} = 'APINO2Q2b'; 
fAPINO2Qb(i)=fAPINO2Qb(i)-1; fAPINO2Q2b(i)=fAPINO2Q2b(i)-1; fNO2(i)=fNO2(i)+(1/6); fNOQ(i)=fNOQ(i)+(4/6); fNQ2(i)=fNQ2(i)+(1/6); fHCHO(i)=fHCHO(i)+0.504;
fALD(i)=fALD(i)+1.21; fKET(i)=fKET(i)+0.285; fMONITSQb(i)=fMONITSQb(i)+0.5; fMONITSQ2b(i)=fMONITSQ2b(i)+0.5;

%O3 Tracer
i=i+1; %<RACM2_361f>; <BAPI_164f>
Rnames{i} = 'APINO2Qb+APINO2Q3b=NO2+NQ2+NQ2+0.504 HCHO+1.21 ALD+0.285 KET+MONITSQb+MONITSQ3b';
k(:,i) = 2.96E-14.*exp(1000./T);
Gstr{i,1} = 'APINO2Qb'; Gstr{i,2} = 'APINO2Q3b'; 
fAPINO2Qb(i)=fAPINO2Qb(i)-1; fAPINO2Q3b(i)=fAPINO2Q3b(i)-1; fNO2(i)=fNO2(i)+(1/6); fNOQ(i)=fNOQ(i)+(2/6); fNQ2(i)=fNQ2(i)+(1/2); fHCHO(i)=fHCHO(i)+0.504;
fALD(i)=fALD(i)+1.21; fKET(i)=fKET(i)+0.285; fMONITSQb(i)=fMONITSQb(i)+0.5; fMONITSQ3b(i)=fMONITSQ3b(i)+0.5;

%O3 Tracer
i=i+1; %<RACM2_361g>; <BAPI_164g>
Rnames{i} = 'APINO2Q2b+APINO2Q2b=NQ2+NQ2+0.504 HCHO+1.21 ALD+0.285 KET+MONITSQ2b';
k(:,i) = 2.96E-14.*exp(1000./T);
Gstr{i,1} = 'APINO2Q2b'; Gstr{i,2} = 'APINO2Q2b'; 
fAPINO2Q2b(i)=fAPINO2Q2b(i)-1; fAPINO2Q2b(i)=fAPINO2Q2b(i)-1; fNOQ(i)=fNOQ(i)+(2/3); fNQ2(i)=fNQ2(i)+(1/3); fHCHO(i)=fHCHO(i)+0.504;
fALD(i)=fALD(i)+1.21; fKET(i)=fKET(i)+0.285; fMONITSQ2b(i)=fMONITSQ2b(i)+1; 

%O3 Tracer
i=i+1; %<RACM2_361h>; <BAPI_164h>
Rnames{i} = 'APINO2Q2b+APINO2Q3b=NQ2+NQ2+0.504 HCHO+1.21 ALD+0.285 KET+MONITSQ2b+MONITSQ3b';
k(:,i) = 2.96E-14.*exp(1000./T);
Gstr{i,1} = 'APINO2Q2b'; Gstr{i,2} = 'APINO2Q3b'; 
fAPINO2Q2b(i)=fAPINO2Q2b(i)-1; fAPINO2Q3b(i)=fAPINO2Q3b(i)-1; fNOQ(i)=fNOQ(i)+(2/6); fNQ2(i)=fNQ2(i)+(4/6); fHCHO(i)=fHCHO(i)+0.504;
fALD(i)=fALD(i)+1.21; fKET(i)=fKET(i)+0.285; fMONITSQ2b(i)=fMONITSQ2b(i)+0.5; fMONITSQ3b(i)=fMONITSQ3b(i)+0.5; 

%O3 Tracer
i=i+1; %<RACM2_361i>; <BAPI_164i>
Rnames{i} = 'APINO2Q3b+APINO2Q3b=NQ2+0.504 HCHO+1.21 ALD+0.285 KET+MONITSQ3b';
k(:,i) = 2.96E-14.*exp(1000./T);
Gstr{i,1} = 'APINO2Q3b'; Gstr{i,2} = 'APINO2Q3b'; 
fAPINO2Q3b(i)=fAPINO2Q3b(i)-1; fAPINO2Q3b(i)=fAPINO2Q3b(i)-1; fNQ2(i)=fNQ2(i)+1; fHCHO(i)=fHCHO(i)+0.504;
fALD(i)=fALD(i)+1.21; fKET(i)=fKET(i)+0.285; fMONITSQ3b(i)=fMONITSQ3b(i)+1; 
...
%%%New RO2 Radical Reactions%%%
i=i+1; %<RACM2_Update>; <BAPI_X>
Rnames{i} ='APINO2a+APIO2a= 0.32 MONITSa + 1.68 ALD + 0.84 NO2 + 0.84 HO2';
k(:,i) = 1E-14;
Gstr{i,1} = 'APINO2a'; Gstr{i,2} = 'APIO2a'; 
fAPINO2a(i)=fAPINO2a(i)-1; fAPIO2a(i)=fAPIO2a(i)-1; fMONITSa(i)=fMONITSa(i)+0.32; fALD(i)=fALD(i)+1.68;
fNO2(i)=fNO2(i)+0.84;


%O3 Tracer
i=i+1; %<RACM2_Update>; <BAPI_Xa>
Rnames{i} ='APINO2Qa+APIO2a= 0.32 MONITSQa + 1.68 ALD + 0.28 NO2 + 0.56 NOQ + 0.84 HO2';
k(:,i) = 1E-14;
Gstr{i,1} = 'APINO2Qa'; Gstr{i,2} = 'APIO2a'; 
fAPINO2Qa(i)=fAPINO2Qa(i)-1; fAPIO2a(i)=fAPIO2a(i)-1; fMONITSQa(i)=fMONITSQa(i)+0.32; fALD(i)=fALD(i)+1.68;
fNO2(i)=fNO2(i)+0.28; fNOQ(i)=fNOQ(i)+0.56;

%O3 Tracer
i=i+1; %<RACM2_Update>; <BAPI_Xb>
Rnames{i} ='APINO2Q2a+APIO2a= 0.32 MONITSQ2a + 1.68 ALD + 0.56 NOQ + 0.28 NQ2 + 0.84 HO2';
k(:,i) = 1E-14;
Gstr{i,1} = 'APINO2Q2a'; Gstr{i,2} = 'APIO2a'; 
fAPINO2Q2a(i)=fAPINO2Q2a(i)-1; fAPIO2a(i)=fAPIO2a(i)-1; fMONITSQ2a(i)=fMONITSQ2a(i)+0.32; fALD(i)=fALD(i)+1.68;
fNOQ(i)=fNOQ(i)+0.56; fNQ2(i)=fNQ2(i)+0.28;

%O3 Tracer
i=i+1; %<RACM2_Update>; <BAPI_Xc>
Rnames{i} ='APINO2Q3a+APIO2a= 0.32 MONITSQ3a + 1.68 ALD + 0.84 NQ2 + 0.84 HO2';
k(:,i) = 1E-14;
Gstr{i,1} = 'APINO2Q3a'; Gstr{i,2} = 'APIO2a'; 
fAPINO2Q3a(i)=fAPINO2Q3a(i)-1; fAPIO2a(i)=fAPIO2a(i)-1; fMONITSQ3a(i)=fMONITSQ3a(i)+0.32; fALD(i)=fALD(i)+1.68;
fNQ2(i)=fNQ2(i)+0.84;



i=i+1; %<RACM2_Update>; <BAPI_Xd>
Rnames{i} ='APINO2b+APIO2a= 0.32 MONITSb + 1.68 ALD + 0.84 NO2 + 0.84 HO2';
k(:,i) = 1E-14;
Gstr{i,1} = 'APINO2b'; Gstr{i,2} = 'APIO2a'; 
fAPINO2b(i)=fAPINO2b(i)-1; fAPIO2a(i)=fAPIO2a(i)-1; fMONITSb(i)=fMONITSb(i)+0.32; fALD(i)=fALD(i)+1.68;
fNO2(i)=fNO2(i)+0.84;

%O3 Tracer
i=i+1; %<RACM2_Update>; <BAPI_Xe>
Rnames{i} ='APINO2Qb+APIO2a= 0.32 MONITSQb + 1.68 ALD + 0.28 NO2 + 0.56 NOQ + 0.84 HO2';
k(:,i) = 1E-14;
Gstr{i,1} = 'APINO2Qb'; Gstr{i,2} = 'APIO2a'; 
fAPINO2Qb(i)=fAPINO2Qb(i)-1; fAPIO2a(i)=fAPIO2a(i)-1; fMONITSQb(i)=fMONITSQb(i)+0.32; fALD(i)=fALD(i)+1.68;
fNO2(i)=fNO2(i)+0.28; fNOQ(i)=fNOQ(i)+0.56;

%O3 Tracer
i=i+1; %<RACM2_Update>; <BAPI_Xf>
Rnames{i} ='APINO2Q2b+APIO2a= 0.32 MONITSQ2b + 1.68 ALD + 0.56 NOQ + 0.28 NQ2 + 0.84 HO2';
k(:,i) = 1E-14;
Gstr{i,1} = 'APINO2Q2b'; Gstr{i,2} = 'APIO2a'; 
fAPINO2Q2b(i)=fAPINO2Q2b(i)-1; fAPIO2a(i)=fAPIO2a(i)-1; fMONITSQ2b(i)=fMONITSQ2b(i)+0.32; fALD(i)=fALD(i)+1.68;
fNOQ(i)=fNOQ(i)+0.56; fNQ2(i)=fNQ2(i)+0.28;

%O3 Tracer
i=i+1; %<RACM2_Update>; <BAPI_Xg>
Rnames{i} ='APINO2Q3b+APIO2a= 0.32 MONITSQ3b + 1.68 ALD + 0.84 NQ2 + 0.84 HO2';
k(:,i) = 1E-14;
Gstr{i,1} = 'APINO2Q3b'; Gstr{i,2} = 'APIO2a'; 
fAPINO2Q3b(i)=fAPINO2Q3b(i)-1; fAPIO2a(i)=fAPIO2a(i)-1; fMONITSQ3b(i)=fMONITSQ3b(i)+0.32; fALD(i)=fALD(i)+1.68;
fNQ2(i)=fNQ2(i)+0.84;


i=i+1; %<RACM2_Update>; <BAPI_X>
Rnames{i} ='APINO2a+APIO2b= 0.32 MONITSa + 1.68 ALD + 0.84 NO2 + 0.84 HO2';
k(:,i) = 1E-14;
Gstr{i,1} = 'APINO2a'; Gstr{i,2} = 'APIO2b'; 
fAPINO2a(i)=fAPINO2a(i)-1; fAPIO2b(i)=fAPIO2b(i)-1; fMONITSa(i)=fMONITSa(i)+0.32; fALD(i)=fALD(i)+1.68;
fNO2(i)=fNO2(i)+0.84;
 
 
%O3 Tracer
i=i+1; %<RACM2_Update>; <BAPI_Xa>
Rnames{i} ='APINO2Qa+APIO2b= 0.32 MONITSQa + 1.68 ALD + 0.28 NO2 + 0.56 NOQ + 0.84 HO2';
k(:,i) = 1E-14;
Gstr{i,1} = 'APINO2Qa'; Gstr{i,2} = 'APIO2b'; 
fAPINO2Qa(i)=fAPINO2Qa(i)-1; fAPIO2b(i)=fAPIO2b(i)-1; fMONITSQa(i)=fMONITSQa(i)+0.32; fALD(i)=fALD(i)+1.68;
fNO2(i)=fNO2(i)+0.28; fNOQ(i)=fNOQ(i)+0.56;
 
%O3 Tracer
i=i+1; %<RACM2_Update>; <BAPI_Xb>
Rnames{i} ='APINO2Q2a+APIO2b= 0.32 MONITSQ2a + 1.68 ALD + 0.56 NOQ + 0.28 NQ2 + 0.84 HO2';
k(:,i) = 1E-14;
Gstr{i,1} = 'APINO2Q2a'; Gstr{i,2} = 'APIO2b'; 
fAPINO2Q2a(i)=fAPINO2Q2a(i)-1; fAPIO2b(i)=fAPIO2b(i)-1; fMONITSQ2a(i)=fMONITSQ2a(i)+0.32; fALD(i)=fALD(i)+1.68;
fNOQ(i)=fNOQ(i)+0.56; fNQ2(i)=fNQ2(i)+0.28;
 
%O3 Tracer
i=i+1; %<RACM2_Update>; <BAPI_Xc>
Rnames{i} ='APINO2Q3a+APIO2b= 0.32 MONITSQ3a + 1.68 ALD + 0.84 NQ2 + 0.84 HO2';
k(:,i) = 1E-14;
Gstr{i,1} = 'APINO2Q3a'; Gstr{i,2} = 'APIO2b'; 
fAPINO2Q3a(i)=fAPINO2Q3a(i)-1; fAPIO2b(i)=fAPIO2b(i)-1; fMONITSQ3a(i)=fMONITSQ3a(i)+0.32; fALD(i)=fALD(i)+1.68;
fNQ2(i)=fNQ2(i)+0.84;
...
i=i+1; %<RACM2_Update>; <BAPI_Xd>
Rnames{i} ='APINO2b+APIO2b= 0.32 MONITSb + 1.68 ALD + 0.84 NO2 + 0.84 HO2';
k(:,i) = 1E-14;
Gstr{i,1} = 'APINO2b'; Gstr{i,2} = 'APIO2b'; 
fAPINO2b(i)=fAPINO2b(i)-1; fAPIO2b(i)=fAPIO2b(i)-1; fMONITSb(i)=fMONITSb(i)+0.32; fALD(i)=fALD(i)+1.68;
fNO2(i)=fNO2(i)+0.84;
 
%O3 Tracer
i=i+1; %<RACM2_Update>; <BAPI_Xe>
Rnames{i} ='APINO2Qb+APIO2b= 0.32 MONITSQb + 1.68 ALD + 0.28 NO2 + 0.56 NOQ + 0.84 HO2';
k(:,i) = 1E-14;
Gstr{i,1} = 'APINO2Qb'; Gstr{i,2} = 'APIO2b'; 
fAPINO2Qb(i)=fAPINO2Qb(i)-1; fAPIO2b(i)=fAPIO2b(i)-1; fMONITSQb(i)=fMONITSQb(i)+0.32; fALD(i)=fALD(i)+1.68;
fNO2(i)=fNO2(i)+0.28; fNOQ(i)=fNOQ(i)+0.56;
 
%O3 Tracer
i=i+1; %<RACM2_Update>; <BAPI_Xf>
Rnames{i} ='APINO2Q2b+APIO2b= 0.32 MONITSQ2b + 1.68 ALD + 0.56 NOQ + 0.28 NQ2 + 0.84 HO2';
k(:,i) = 1E-14;
Gstr{i,1} = 'APINO2Q2b'; Gstr{i,2} = 'APIO2b'; 
fAPINO2Q2b(i)=fAPINO2Q2b(i)-1; fAPIO2b(i)=fAPIO2b(i)-1; fMONITSQ2b(i)=fMONITSQ2b(i)+0.32; fALD(i)=fALD(i)+1.68;
fNOQ(i)=fNOQ(i)+0.56; fNQ2(i)=fNQ2(i)+0.28;
 
%O3 Tracer
i=i+1; %<RACM2_Update>; <BAPI_Xg>
Rnames{i} ='APINO2Q3b+APIO2b= 0.32 MONITSQ3b + 1.68 ALD + 0.84 NQ2 + 0.84 HO2';
k(:,i) = 1E-14;
Gstr{i,1} = 'APINO2Q3b'; Gstr{i,2} = 'APIO2b'; 
fAPINO2Q3b(i)=fAPINO2Q3b(i)-1; fAPIO2b(i)=fAPIO2b(i)-1; fMONITSQ3b(i)=fMONITSQ3b(i)+0.32; fALD(i)=fALD(i)+1.68;
fNQ2(i)=fNQ2(i)+0.84;
...
k(:,i) = 2.31E-6;
Gstr{i,1} = 'NOQ'; 
fNOQ(i)=fNOQ(i)-1; fwNOQ(i)=fwNOQ(i)+1; 
...
k(:,i) = 2.31E-6;
Gstr{i,1} = 'NQ2'; 
fNQ2(i)=fNQ2(i)-1; fwNQ2(i)=fwNQ2(i)+1; 
...
%O3 Tracer
i=i+1; %<BAPI_198>
Rnames{i} = 'wNOQ=O3P+NO + Q3P + NQ';
k(:,i) = JNO2;
Gstr{i,1} = 'wNO2'; 
fwNO2(i)=fwNO2(i)-1; fO3P(i)=fO3P(i)+0.5; fNO(i)=fNO(i)+0.5; fQ3P(i)=fQ3P(i)+0.5; fNQ(i)=fNQ(i)+0.5;

%O3 Tracer
i=i+1; %<BAPI_198>
Rnames{i} = 'wNQ2=Q3P + NQ';
k(:,i) = JNO2;
Gstr{i,1} = 'wNO2'; 
fwNO2(i)=fwNO2(i)-1; fQ3P(i)=fQ3P(i)+1; fNQ(i)=fNQ(i)+1;
...
k(:,i) = 1.0E-6; 
Gstr{i,1} = 'N2O4Q'; 
fN2O4Q(i)=fN2O4Q(i)-1; fwHNO2Q(i)=fwHNO2Q(i)+1; fwHNO3(i)=fwHNO3(i)+1; 
...
k(:,i) = 1.0E-6; 
Gstr{i,1} = 'N2O3Q2'; 
fN2O3Q2(i)=fN2O3Q2(i)-1; fwHNO3(i)=fwHNO3(i)+(2/5); fwHNO2Q(i)=fwHNO2Q(i)+(6/5);  fwHNOQ2(i)=fwHNOQ2(i)+(2/5); 

%O3 Tracer
i=i+1; %R383c
Rnames{i} = 'N2O2Q3=wHNO3 + wHNO2Q + wHNOQ2 + wHNQ3';
k(:,i) = 1.0E-6; 
Gstr{i,1} = 'N2O2Q3'; 
fN2O2Q3(i)=fN2O2Q3(i)-1; fwHNO3(i)=fwHNO3(i)+(2/10); fwHNO2Q(i)=fwHNO2Q(i)+(4/5);  fwHNOQ2(i)=fwHNOQ2(i)+(4/5); fwHNQ3(i)=fwHNQ3(i)+(2/10);  
...
k(:,i) = 1.0E-6; 
Gstr{i,1} = 'N2OQ4'; 
fN2OQ4(i)=fN2OQ4(i)-1; fwHNO2Q(i)=fwHNO2Q(i)+(2/5);  fwHNOQ2(i)=fwHNOQ2(i)+(6/5); fwHNQ3(i)=fwHNQ3(i)+(2/5);  


%O3 Tracer
i=i+1; %R383e
Rnames{i} = 'N2Q5=wHNQ3+wHNOQ2';
k(:,i) = 1.0E-6; %mmarvin 20151020
Gstr{i,1} = 'N2Q5';  
...
i=i+1; %<BAPI_201>
Rnames{i} = 'MONITSa=wMONITS';
k(:,i) =  8.8E-6;
Gstr{i,1} = 'MONITSa'; 
fMONITSa(i)=fMONITSa(i)-1; fwMONITS(i)=fwMONITS(i)+1; 

%O3 Tracer
i=i+1; %<BAPI_201a>
Rnames{i} = 'MONITSQa=wMONITSQ';
k(:,i) =  8.8E-6;
Gstr{i,1} = 'MONITSQa'; 
fMONITSQa(i)=fMONITSQa(i)-1; fwMONITSQ(i)=fwMONITSQ(i)+1; 

%O3 Tracer
i=i+1; %<BAPI_201b>
Rnames{i} = 'MONITSQ2a=wMONITSQ2';
k(:,i) =  8.8E-6;
Gstr{i,1} = 'MONITSQ2a'; 
fMONITSQ2a(i)=fMONITSQ2a(i)-1; fwMONITSQ2(i)=fwMONITSQ2(i)+1; 


%O3 Tracer
i=i+1; %<BAPI_201b>
Rnames{i} = 'MONITSQ3a=wMONITSQ3';
k(:,i) =  8.8E-6;
Gstr{i,1} = 'MONITSQ3a'; 
fMONITSQ3a(i)=fMONITSQ3a(i)-1; fwMONITSQ3(i)=fwMONITSQ3(i)+1; 


i=i+1; %<BAPI_201>
Rnames{i} = 'MONITUa=wMONITU';
k(:,i) =  8.8E-6;
Gstr{i,1} = 'MONITUa'; 
fMONITUa(i)=fMONITUa(i)-1; fwMONITU(i)=fwMONITU(i)+1; 

%O3 Tracer
i=i+1; %<BAPI_201a>
Rnames{i} = 'MONITUQa=wMONITUQ';
k(:,i) =  8.8E-6;
Gstr{i,1} = 'MONITUQa'; 
fMONITUQa(i)=fMONITUQa(i)-1; fwMONITUQ(i)=fwMONITUQ(i)+1; 

%O3 Tracer
i=i+1; %<BAPI_201a>
Rnames{i} = 'MONITUQ2a=wMONITUQ2';
k(:,i) =  8.8E-6;
Gstr{i,1} = 'MONITUQ2a'; 
fMONITUQ2a(i)=fMONITUQ2a(i)-1; fwMONITUQ2(i)=fwMONITUQ2(i)+1; 

%O3 Tracer
i=i+1; %<BAPI_201a>
Rnames{i} = 'MONITUQ3a=wMONITUQ3';
k(:,i) =  8.8E-6;
Gstr{i,1} = 'MONITUQ3a'; 
fMONITUQ3a(i)=fMONITUQ3a(i)-1; fwMONITUQ3(i)=fwMONITUQ3(i)+1; 


i=i+1; %<BAPI_201>
Rnames{i} = 'MONITSb=wMONITS';
k(:,i) =  8.8E-6;
Gstr{i,1} = 'MONITSb'; 
fMONITSb(i)=fMONITSb(i)-1; fwMONITS(i)=fwMONITS(i)+1; 

%O3 Tracer
i=i+1; %<BAPI_201a>
Rnames{i} = 'MONITSQb=wMONITSQ';
k(:,i) =  8.8E-6;
Gstr{i,1} = 'MONITSQb'; 
fMONITSQb(i)=fMONITSQb(i)-1; fwMONITSQ(i)=fwMONITSQ(i)+1; 

%O3 Tracer
i=i+1; %<BAPI_201b>
Rnames{i} = 'MONITSQ2b=wMONITSQ2';
k(:,i) =  8.8E-6;
Gstr{i,1} = 'MONITSQ2b'; 
fMONITSQ2b(i)=fMONITSQ2b(i)-1; fwMONITSQ2(i)=fwMONITSQ2(i)+1; 

%O3 Tracer
i=i+1; %<BAPI_201b>
Rnames{i} = 'MONITSQ3b=wMONITSQ3';
k(:,i) =  8.8E-6;
Gstr{i,1} = 'MONITSQ3b'; 
fMONITSQ3b(i)=fMONITSQ3b(i)-1; fwMONITSQ3(i)=fwMONITSQ3(i)+1; 


i=i+1; %<BAPI_201>
Rnames{i} = 'HONITa=wHONIT';
k(:,i) =  8.8E-6;
Gstr{i,1} = 'HONITa'; 
fHONITa(i)=fHONITa(i)-1; fwHONIT(i)=fwHONIT(i)+1; 

%O3 Tracer
i=i+1; %<BAPI_201>
Rnames{i} = 'HONITQa=wHONITQ';
k(:,i) =  8.8E-6;
Gstr{i,1} = 'HONITQa'; 
fHONITQa(i)=fHONITQa(i)-1; fwHONITQ(i)=fwHONITQ(i)+1; 


%O3 Tracer
i=i+1; %<BAPI_201>
Rnames{i} = 'HONITQ2a=wHONITQ2';
k(:,i) =  8.8E-6;
Gstr{i,1} = 'HONITQ2a'; 
fHONITQ2a(i)=fHONITQ2a(i)-1; fwHONITQ2(i)=fwHONITQ2(i)+1; 

%O3 Tracer
i=i+1; %<BAPI_201>
Rnames{i} = 'HONITQ3a=wHONITQ3';
k(:,i) =  8.8E-6;
Gstr{i,1} = 'HONITQ3a'; 
fHONITQ3a(i)=fHONITQ3a(i)-1; fwHONITQ3(i)=fwHONITQ3(i)+1; 

i=i+1; %<BAPI_201>
Rnames{i} = 'HONITb=wHONIT';
k(:,i) =  8.8E-6;
Gstr{i,1} = 'HONITb'; 
fHONITb(i)=fHONITb(i)-1; fwHONIT(i)=fwHONIT(i)+1; 

%O3 Tracer
i=i+1; %<BAPI_201>
Rnames{i} = 'HONITQb=wHONITQ';
k(:,i) =  8.8E-6;
Gstr{i,1} = 'HONITQb'; 
fHONITQb(i)=fHONITQb(i)-1; fwHONITQ(i)=fwHONITQ(i)+1; 


%O3 Tracer
i=i+1; %<BAPI_201>
Rnames{i} = 'HONITQ2b=wHONITQ2';
k(:,i) =  8.8E-6;
Gstr{i,1} = 'HONITQ2b'; 
fHONITQ2b(i)=fHONITQ2b(i)-1; fwHONITQ2(i)=fwHONITQ2(i)+1; 

%O3 Tracer
i=i+1; %<BAPI_201>
Rnames{i} = 'HONITQ3b=wHONITQ3';
k(:,i) =  8.8E-6;
Gstr{i,1} = 'HONITQ3b'; 
fHONITQ3b(i)=fHONITQ3b(i)-1; fwHONITQ3(i)=fwHONITQ3(i)+1; 
...
k(:,i) = 3.96E-4; %mmarvin 20151020
Gstr{i,1} = 'N2Q5';  
fN2Q5(i)=fN2Q5(i)-1; fHNQ3(i)=fHNQ3(i)+1; fHNOQ2(i)=fHNOQ2(i)+1;

%%ONIT Expansion%%%
i=i+1; %<RACM2_Update_XX>; <BAPI_XX>
Rnames{i} = 'MONITUa+O3=HONITa';
k(:,i) =1.67E-16;
Gstr{i,1} = 'MONITUa'; Gstr{i,2} = 'O3'; 
fMONITUa(i)=fMONITUa(i)-1; fO3(i)=fO3(i)-1; fHONITa(i)=fHONITa(i)+1; 


%O3 Tracer
i=i+1; %<RACM2_Update_XX>; <BAPI_XX>
Rnames{i} = 'MONITUQa+O3=HONITQa';
k(:,i) =1.67E-16;
Gstr{i,1} = 'MONITUQa'; Gstr{i,2} = 'O3'; 
fMONITUQa(i)=fMONITUQa(i)-1; fO3(i)=fO3(i)-1; fHONITQa(i)=fHONITQa(i)+1; 

%O3 Tracer
i=i+1; %<RACM2_Update_XX>; <BAPI_XX>
Rnames{i} = 'MONITUQ2a+O3=HONITQ2a';
k(:,i) =1.67E-16;
Gstr{i,1} = 'MONITUQ2a'; Gstr{i,2} = 'O3'; 
fMONITUQ2a(i)=fMONITUQ2a(i)-1; fO3(i)=fO3(i)-1; fHONITQ2a(i)=fHONITQ2a(i)+1; 

%O3 Tracer
i=i+1; %<RACM2_Update_XX>; <BAPI_XX>
Rnames{i} = 'MONITUQ3a+O3=HONITQ3a';
k(:,i) =1.67E-16;
Gstr{i,1} = 'MONITUQ3a'; Gstr{i,2} = 'O3'; 
fMONITUQ3a(i)=fMONITUQ3a(i)-1; fO3(i)=fO3(i)-1; fHONITQ3a(i)=fHONITQ3a(i)+1; 


i=i+1; %<RACM2_Update_XX>; <BAPI_XX>
Rnames{i} = 'MONITSa+NO3=HONITa';
k(:,i) =3.15E-13*exp(-448/T);
Gstr{i,1} = 'MONITSa'; Gstr{i,2} = 'NO3'; 
fMONITSa(i)=fMONITSa(i)-1; fNO3(i)=fNO3(i)-1; fHONITa(i)=fHONITa(i)+1; 

%O3 Tracer
i=i+1; %<RACM2_Update_XX>; <BAPI_XX>
Rnames{i} = 'MONITSQa+NO3=HONITQa';
k(:,i) =3.15E-13*exp(-448/T);
Gstr{i,1} = 'MONITSQa'; Gstr{i,2} = 'NO3'; 
fMONITSQa(i)=fMONITSQa(i)-1; fNO3(i)=fNO3(i)-1; fHONITQa(i)=fHONITQa(i)+1; 

%O3 Tracer
i=i+1; %<RACM2_Update_XX>; <BAPI_XX>
Rnames{i} = 'MONITSQ2a+NO3=HONITQ2a';
k(:,i) =3.15E-13*exp(-448/T);
Gstr{i,1} = 'MONITSQ2a'; Gstr{i,2} = 'NO3'; 
fMONITSQ2a(i)=fMONITSQ2a(i)-1; fNO3(i)=fNO3(i)-1; fHONITQ2a(i)=fHONITQ2a(i)+1; 

%O3 Tracer
i=i+1; %<RACM2_Update_XX>; <BAPI_XX>
Rnames{i} = 'MONITSQ3a+NO3=HONITQ3a';
k(:,i) =3.15E-13*exp(-448/T);
Gstr{i,1} = 'MONITSQ3a'; Gstr{i,2} = 'NO3'; 
fMONITSQ3a(i)=fMONITSQ3a(i)-1; fNO3(i)=fNO3(i)-1; fHONITQ3a(i)=fHONITQ3a(i)+1; 



i=i+1; %<RACM2_Update_XX>; <BAPI_XX>
Rnames{i} = 'MONITSb+NO3=HONITb';
k(:,i) =3.15E-13*exp(-448/T);
Gstr{i,1} = 'MONITSb'; Gstr{i,2} = 'NO3'; 
fMONITSb(i)=fMONITSb(i)-1; fNO3(i)=fNO3(i)-1; fHONITb(i)=fHONITb(i)+1; 

%O3 Tracer
i=i+1; %<RACM2_Update_XX>; <BAPI_XX>
Rnames{i} = 'MONITSQb+NO3=HONITQb';
k(:,i) =3.15E-13*exp(-448/T);
Gstr{i,1} = 'MONITSQb'; Gstr{i,2} = 'NO3'; 
fMONITSQb(i)=fMONITSQb(i)-1; fNO3(i)=fNO3(i)-1; fHONITQb(i)=fHONITQb(i)+1; 

%O3 Tracer
i=i+1; %<RACM2_Update_XX>; <BAPI_XX>
Rnames{i} = 'MONITSQ2b+NO3=HONITQ2b';
k(:,i) =3.15E-13*exp(-448/T);
Gstr{i,1} = 'MONITSQ2b'; Gstr{i,2} = 'NO3'; 
fMONITSQ2b(i)=fMONITSQ2b(i)-1; fNO3(i)=fNO3(i)-1; fHONITQ2b(i)=fHONITQ2b(i)+1; 

%O3 Tracer
i=i+1; %<RACM2_Update_XX>; <BAPI_XX>
Rnames{i} = 'MONITSQ3b+NO3=HONITQ3b';
k(:,i) =3.15E-13*exp(-448/T);
Gstr{i,1} = 'MONITSQ3b'; Gstr{i,2} = 'NO3'; 
fMONITSQ3b(i)=fMONITSQ3b(i)-1; fNO3(i)=fNO3(i)-1; fHONITQ3b(i)=fHONITQ3b(i)+1; 


i=i+1; %<RACM2_Update_XX>; <BAPI_XX>
Rnames{i} = 'MONITUa+NO3=HONITa';
k(:,i) =3.15E-13*exp(-448/T);
Gstr{i,1} = 'MONITUa'; Gstr{i,2} = 'NO3'; 
fMONITUa(i)=fMONITUa(i)-1; fNO3(i)=fNO3(i)-1; fHONITa(i)=fHONITa(i)+1; 

%O3 Tracer
i=i+1; %<RACM2_Update_XX>; <BAPI_XX>
Rnames{i} = 'MONITUQa+NO3=HONITQa';
k(:,i) =3.15E-13*exp(-448/T);
Gstr{i,1} = 'MONITUQa'; Gstr{i,2} = 'NO3'; 
fMONITUQa(i)=fMONITUQa(i)-1; fNO3(i)=fNO3(i)-1; fHONITQa(i)=fHONITQa(i)+1; 

%O3 Tracer
i=i+1; %<RACM2_Update_XX>; <BAPI_XX>
Rnames{i} = 'MONITUQ2a+NO3=HONITQ2a';
k(:,i) =3.15E-13*exp(-448/T);
Gstr{i,1} = 'MONITUQ2a'; Gstr{i,2} = 'NO3'; 
fMONITUQ2a(i)=fMONITUQ2a(i)-1; fNO3(i)=fNO3(i)-1; fHONITQ2a(i)=fHONITQ2a(i)+1; 

%O3 Tracer
i=i+1; %<RACM2_Update_XX>; <BAPI_XX>
Rnames{i} = 'MONITUQ3a+NO3=HONITQ3a';
k(:,i) =3.15E-13*exp(-448/T);
Gstr{i,1} = 'MONITUQ3a'; Gstr{i,2} = 'NO3'; 
fMONITUQ3a(i)=fMONITUQ3a(i)-1; fNO3(i)=fNO3(i)-1; fHONITQ3a(i)=fHONITQ3a(i)+1; 
...
i=i+1; %<RACM2_Update_XX>; <BAPI_XX>
Rnames{i} = 'HONITa+OH=HC3P+NO3';
k(:,i) = 5.31E-12.*exp(-260./T);
Gstr{i,1} = 'HONITa'; Gstr{i,2} = 'OH'; 
fHONITa(i)=fHONITa(i)-1; fOH(i)=fOH(i)-1; fHC3P(i)=fHC3P(i)+1; fNO3(i)=fNO3(i)+1;

%O3 Tracer
i=i+1; %<RACM2_Update_XX>; <BAPI_XX>
Rnames{i} = 'HONITQa+OH=HC3P+NO2Q';
k(:,i) = 5.31E-12.*exp(-260./T);
Gstr{i,1} = 'HONITQa'; Gstr{i,2} = 'OH'; 
fHONITQa(i)=fHONITQa(i)-1; fOH(i)=fOH(i)-1; fHC3P(i)=fHC3P(i)+1; fNO2Q(i)=fNO2Q(i)+1;

%O3 Tracer
i=i+1; %<RACM2_Update_XX>; <BAPI_XX>
Rnames{i} = 'HONITQ2a+OH=HC3P+NOQ2';
k(:,i) = 5.31E-12.*exp(-260./T);
Gstr{i,1} = 'HONITQ2a'; Gstr{i,2} = 'OH'; 
fHONITQ2a(i)=fHONITQ2a(i)-1; fOH(i)=fOH(i)-1; fHC3P(i)=fHC3P(i)+1; fNOQ2(i)=fNOQ2(i)+1;

%O3 Tracer
i=i+1; %<RACM2_Update_XX>; <BAPI_XX>
Rnames{i} = 'HONITQ3a+OH=HC3P+NQ3';
k(:,i) = 5.31E-12.*exp(-260./T);
Gstr{i,1} = 'HONITQ3a'; Gstr{i,2} = 'OH'; 
fHONITQ3a(i)=fHONITQ3a(i)-1; fOH(i)=fOH(i)-1; fHC3P(i)=fHC3P(i)+1; fNQ3(i)=fNQ3(i)+1;

%O3 Tracer
i=i+1; %<RACM2_Update_XX>; <BAPI_XX>
Rnames{i} = 'HONITa+QH=HC3P+NO3';
k(:,i) = 5.31E-12.*exp(-260./T);
Gstr{i,1} = 'HONITa'; Gstr{i,2} = 'QH'; 
fHONITa(i)=fHONITa(i)-1; fQH(i)=fQH(i)-1; fHC3P(i)=fHC3P(i)+1; fNO3(i)=fNO3(i)+1;

%O3 Tracer
i=i+1; %<RACM2_Update_XX>; <BAPI_XX>
Rnames{i} = 'HONITQa+QH=HC3P+NO2Q';
k(:,i) = 5.31E-12.*exp(-260./T);
Gstr{i,1} = 'HONITQa'; Gstr{i,2} = 'QH'; 
fHONITQa(i)=fHONITQa(i)-1; fQH(i)=fQH(i)-1; fHC3P(i)=fHC3P(i)+1; fNO2Q(i)=fNO2Q(i)+1;

%O3 Tracer
i=i+1; %<RACM2_Update_XX>; <BAPI_XX>
Rnames{i} = 'HONITQ2a+QH=HC3P+NOQ2';
k(:,i) = 5.31E-12.*exp(-260./T);
Gstr{i,1} = 'HONITQ2a'; Gstr{i,2} = 'QH'; 
fHONITQ2a(i)=fHONITQ2a(i)-1; fQH(i)=fQH(i)-1; fHC3P(i)=fHC3P(i)+1; fNOQ2(i)=fNOQ2(i)+1;

%O3 Tracer
i=i+1; %<RACM2_Update_XX>; <BAPI_XX>
Rnames{i} = 'HONITQ3a+QH=HC3P+NQ3';
k(:,i) = 5.31E-12.*exp(-260./T);
Gstr{i,1} = 'HONITQ3a'; Gstr{i,2} = 'QH'; 
fHONITQ3a(i)=fHONITQ3a(i)-1; fQH(i)=fQH(i)-1; fHC3P(i)=fHC3P(i)+1; fNQ3(i)=fNQ3(i)+1;




i=i+1; %<RACM2_Update_XX>; <BAPI_XX>
Rnames{i} = 'HONITb+OH=HC3P+NO3';
k(:,i) = 5.31E-12.*exp(-260./T);
Gstr{i,1} = 'HONITb'; Gstr{i,2} = 'OH'; 
fHONITb(i)=fHONITb(i)-1; fOH(i)=fOH(i)-1; fHC3P(i)=fHC3P(i)+1; fNO3(i)=fNO3(i)+1;

%O3 Tracer
i=i+1; %<RACM2_Update_XX>; <BAPI_XX>
Rnames{i} = 'HONITQb+OH=HC3P+NO2Q';
k(:,i) = 5.31E-12.*exp(-260./T);
Gstr{i,1} = 'HONITQb'; Gstr{i,2} = 'OH'; 
fHONITQb(i)=fHONITQb(i)-1; fOH(i)=fOH(i)-1; fHC3P(i)=fHC3P(i)+1; fNO2Q(i)=fNO2Q(i)+1;

%O3 Tracer
i=i+1; %<RACM2_Update_XX>; <BAPI_XX>
Rnames{i} = 'HONITQ2b+OH=HC3P+NOQ2';
k(:,i) = 5.31E-12.*exp(-260./T);
Gstr{i,1} = 'HONITQ2b'; Gstr{i,2} = 'OH'; 
fHONITQ2b(i)=fHONITQ2b(i)-1; fOH(i)=fOH(i)-1; fHC3P(i)=fHC3P(i)+1; fNOQ2(i)=fNOQ2(i)+1;

%O3 Tracer
i=i+1; %<RACM2_Update_XX>; <BAPI_XX>
Rnames{i} = 'HONITQ3b+OH=HC3P+NQ3';
k(:,i) = 5.31E-12.*exp(-260./T);
Gstr{i,1} = 'HONITQ3b'; Gstr{i,2} = 'OH'; 
fHONITQ3b(i)=fHONITQ3b(i)-1; fOH(i)=fOH(i)-1; fHC3P(i)=fHC3P(i)+1; fNQ3(i)=fNQ3(i)+1;

%O3 Tracer
i=i+1; %<RACM2_Update_XX>; <BAPI_XX>
Rnames{i} = 'HONITb+QH=HC3P+NO3';
k(:,i) = 5.31E-12.*exp(-260./T);
Gstr{i,1} = 'HONITb'; Gstr{i,2} = 'QH'; 
fHONITb(i)=fHONITb(i)-1; fQH(i)=fQH(i)-1; fHC3P(i)=fHC3P(i)+1; fNO3(i)=fNO3(i)+1;

%O3 Tracer
i=i+1; %<RACM2_Update_XX>; <BAPI_XX>
Rnames{i} = 'HONITQb+QH=HC3P+NO2Q';
k(:,i) = 5.31E-12.*exp(-260./T);
Gstr{i,1} = 'HONITQb'; Gstr{i,2} = 'QH'; 
fHONITQb(i)=fHONITQb(i)-1; fQH(i)=fQH(i)-1; fHC3P(i)=fHC3P(i)+1; fNO2Q(i)=fNO2Q(i)+1;

%O3 Tracer
i=i+1; %<RACM2_Update_XX>; <BAPI_XX>
Rnames{i} = 'HONITQ2b+QH=HC3P+NOQ2';
k(:,i) = 5.31E-12.*exp(-260./T);
Gstr{i,1} = 'HONITQ2b'; Gstr{i,2} = 'QH'; 
fHONITQ2b(i)=fHONITQ2b(i)-1; fQH(i)=fQH(i)-1; fHC3P(i)=fHC3P(i)+1; fNOQ2(i)=fNOQ2(i)+1;

%O3 Tracer
i=i+1; %<RACM2_Update_XX>; <BAPI_XX>
Rnames{i} = 'HONITQ3b+QH=HC3P+NQ3';
k(:,i) = 5.31E-12.*exp(-260./T);
Gstr{i,1} = 'HONITQ3b'; Gstr{i,2} = 'QH'; 
fHONITQ3b(i)=fHONITQ3b(i)-1; fQH(i)=fQH(i)-1; fHC3P(i)=fHC3P(i)+1; fNQ3(i)=fNQ3(i)+1;
...
%%%ONIT Hydrolysis%%%%
i=i+1; %<RACM2_Update_XX>; <BAPI_XX>
Rnames{i} = 'HONITa=HNO3';
k(:,i) =5.556E-4;
Gstr{i,1} = 'HONITa';  
fHONITa(i)=fHONITa(i)-1; fHNO3(i)=fHNO3(i)+1; 

%O3 Tracer
i=i+1; %<RACM2_Update_XX>; <BAPI_XX>
Rnames{i} = 'HONITQa=HNO2Q';
k(:,i) =5.556E-4;
Gstr{i,1} = 'HONITQa';  
fHONITQa(i)=fHONITQa(i)-1; fHNO2Q(i)=fHNO2Q(i)+1; 

%O3 Tracer
i=i+1; %<RACM2_Update_XX>; <BAPI_XX>
Rnames{i} = 'HONITQ2a=HNOQ2';
k(:,i) =5.556E-4;
Gstr{i,1} = 'HONITQ2a';  
fHONITQ2a(i)=fHONITQ2a(i)-1; fHNOQ2(i)=fHNOQ2(i)+1; 


%O3 Tracer
i=i+1; %<RACM2_Update_XX>; <BAPI_XX>
Rnames{i} = 'HONITQ3a=HNQ3';
k(:,i) =5.556E-4;
Gstr{i,1} = 'HONITQ3a';  
fHONITQ3a(i)=fHONITQ3a(i)-1; fHNQ3(i)=fHNQ3(i)+1; 
