...
'OQ'; 'Q2'; 'H2Q2'; 'N2O4Q'; 'N2O3Q2'; 'N2O2Q3'; 'N2OQ4'; 'N2Q5'; 'HKET'; ...
 'A'; ...
};
...
%O3 Tracer
i=i+1; %<RACM2_095a>; <BAPI_070a>
Rnames{i} = 'HKET+QH=HOQ+MGLY+H2O';
k(:,i) = 3.00E-12;
Gstr{i,1} = 'HKET'; Gstr{i,2} = 'QH'; 
fHKET(i)=fHKET(i)-1; fQH(i)=fQH(i)-1; fHOQ(i)=fHOQ(i)+1; fMGLY(i)=fMGLY(i)+1; 
...
i=i+1; %<RACM2_Update_XX>; <BAPI_XX>
Rnames{i} = 'HONITa+OH=HKET+NO3';
k(:,i) = 5.31E-12.*exp(-260./T);
Gstr{i,1} = 'HONITa'; Gstr{i,2} = 'OH'; 
fHONITa(i)=fHONITa(i)-1; fOH(i)=fOH(i)-1; fHKET(i)=fHKET(i)+1; fNO3(i)=fNO3(i)+1;

%O3 Tracer
i=i+1; %<RACM2_Update_XX>; <BAPI_XX>
Rnames{i} = 'HONITQa+OH=HKET+NO2Q';
k(:,i) = 5.31E-12.*exp(-260./T);
Gstr{i,1} = 'HONITQa'; Gstr{i,2} = 'OH'; 
fHONITQa(i)=fHONITQa(i)-1; fOH(i)=fOH(i)-1; fHKET(i)=fHKET(i)+1; fNO2Q(i)=fNO2Q(i)+1;

%O3 Tracer
i=i+1; %<RACM2_Update_XX>; <BAPI_XX>
Rnames{i} = 'HONITQ2a+OH=HKET+NOQ2';
k(:,i) = 5.31E-12.*exp(-260./T);
Gstr{i,1} = 'HONITQ2a'; Gstr{i,2} = 'OH'; 
fHONITQ2a(i)=fHONITQ2a(i)-1; fOH(i)=fOH(i)-1; fHKET(i)=fHKET(i)+1; fNOQ2(i)=fNOQ2(i)+1;

%O3 Tracer
i=i+1; %<RACM2_Update_XX>; <BAPI_XX>
Rnames{i} = 'HONITQ3a+OH=HKET+NQ3';
k(:,i) = 5.31E-12.*exp(-260./T);
Gstr{i,1} = 'HONITQ3a'; Gstr{i,2} = 'OH'; 
fHONITQ3a(i)=fHONITQ3a(i)-1; fOH(i)=fOH(i)-1; fHKET(i)=fHKET(i)+1; fNQ3(i)=fNQ3(i)+1;

%O3 Tracer
i=i+1; %<RACM2_Update_XX>; <BAPI_XX>
Rnames{i} = 'HONITa+QH=HKET+NO3';
k(:,i) = 5.31E-12.*exp(-260./T);
Gstr{i,1} = 'HONITa'; Gstr{i,2} = 'QH'; 
fHONITa(i)=fHONITa(i)-1; fQH(i)=fQH(i)-1; fHKET(i)=fHKET(i)+1; fNO3(i)=fNO3(i)+1;

%O3 Tracer
i=i+1; %<RACM2_Update_XX>; <BAPI_XX>
Rnames{i} = 'HONITQa+QH=HKET+NO2Q';
k(:,i) = 5.31E-12.*exp(-260./T);
Gstr{i,1} = 'HONITQa'; Gstr{i,2} = 'QH'; 
fHONITQa(i)=fHONITQa(i)-1; fQH(i)=fQH(i)-1; fHKET(i)=fHKET(i)+1; fNO2Q(i)=fNO2Q(i)+1;

%O3 Tracer
i=i+1; %<RACM2_Update_XX>; <BAPI_XX>
Rnames{i} = 'HONITQ2a+QH=HKET+NOQ2';
k(:,i) = 5.31E-12.*exp(-260./T);
Gstr{i,1} = 'HONITQ2a'; Gstr{i,2} = 'QH'; 
fHONITQ2a(i)=fHONITQ2a(i)-1; fQH(i)=fQH(i)-1; fHKET(i)=fHKET(i)+1; fNOQ2(i)=fNOQ2(i)+1;

%O3 Tracer
i=i+1; %<RACM2_Update_XX>; <BAPI_XX>
Rnames{i} = 'HONITQ3a+QH=HKET+NQ3';
k(:,i) = 5.31E-12.*exp(-260./T);
Gstr{i,1} = 'HONITQ3a'; Gstr{i,2} = 'QH'; 
fHONITQ3a(i)=fHONITQ3a(i)-1; fQH(i)=fQH(i)-1; fHKET(i)=fHKET(i)+1; fNQ3(i)=fNQ3(i)+1;




i=i+1; %<RACM2_Update_XX>; <BAPI_XX>
Rnames{i} = 'HONITb+OH=HKET+NO3';
k(:,i) = 5.31E-12.*exp(-260./T);
Gstr{i,1} = 'HONITb'; Gstr{i,2} = 'OH'; 
fHONITb(i)=fHONITb(i)-1; fOH(i)=fOH(i)-1; fHKET(i)=fHKET(i)+1; fNO3(i)=fNO3(i)+1;

%O3 Tracer
i=i+1; %<RACM2_Update_XX>; <BAPI_XX>
Rnames{i} = 'HONITQb+OH=HKET+NO2Q';
k(:,i) = 5.31E-12.*exp(-260./T);
Gstr{i,1} = 'HONITQb'; Gstr{i,2} = 'OH'; 
fHONITQb(i)=fHONITQb(i)-1; fOH(i)=fOH(i)-1; fHKET(i)=fHKET(i)+1; fNO2Q(i)=fNO2Q(i)+1;

%O3 Tracer
i=i+1; %<RACM2_Update_XX>; <BAPI_XX>
Rnames{i} = 'HONITQ2b+OH=HKET+NOQ2';
k(:,i) = 5.31E-12.*exp(-260./T);
Gstr{i,1} = 'HONITQ2b'; Gstr{i,2} = 'OH'; 
fHONITQ2b(i)=fHONITQ2b(i)-1; fOH(i)=fOH(i)-1; fHKET(i)=fHKET(i)+1; fNOQ2(i)=fNOQ2(i)+1;

%O3 Tracer
i=i+1; %<RACM2_Update_XX>; <BAPI_XX>
Rnames{i} = 'HONITQ3b+OH=HKET+NQ3';
k(:,i) = 5.31E-12.*exp(-260./T);
Gstr{i,1} = 'HONITQ3b'; Gstr{i,2} = 'OH'; 
fHONITQ3b(i)=fHONITQ3b(i)-1; fOH(i)=fOH(i)-1; fHKET(i)=fHKET(i)+1; fNQ3(i)=fNQ3(i)+1;

%O3 Tracer
i=i+1; %<RACM2_Update_XX>; <BAPI_XX>
Rnames{i} = 'HONITb+QH=HKET+NO3';
k(:,i) = 5.31E-12.*exp(-260./T);
Gstr{i,1} = 'HONITb'; Gstr{i,2} = 'QH'; 
fHONITb(i)=fHONITb(i)-1; fQH(i)=fQH(i)-1; fHKET(i)=fHKET(i)+1; fNO3(i)=fNO3(i)+1;

%O3 Tracer
i=i+1; %<RACM2_Update_XX>; <BAPI_XX>
Rnames{i} = 'HONITQb+QH=HKET+NO2Q';
k(:,i) = 5.31E-12.*exp(-260./T);
Gstr{i,1} = 'HONITQb'; Gstr{i,2} = 'QH'; 
fHONITQb(i)=fHONITQb(i)-1; fQH(i)=fQH(i)-1; fHKET(i)=fHKET(i)+1; fNO2Q(i)=fNO2Q(i)+1;

%O3 Tracer
i=i+1; %<RACM2_Update_XX>; <BAPI_XX>
Rnames{i} = 'HONITQ2b+QH=HKET+NOQ2';
k(:,i) = 5.31E-12.*exp(-260./T);
Gstr{i,1} = 'HONITQ2b'; Gstr{i,2} = 'QH'; 
fHONITQ2b(i)=fHONITQ2b(i)-1; fQH(i)=fQH(i)-1; fHKET(i)=fHKET(i)+1; fNOQ2(i)=fNOQ2(i)+1;

%O3 Tracer
i=i+1; %<RACM2_Update_XX>; <BAPI_XX>
Rnames{i} = 'HONITQ3b+QH=HKET+NQ3';
k(:,i) = 5.31E-12.*exp(-260./T);
Gstr{i,1} = 'HONITQ3b'; Gstr{i,2} = 'QH'; 
fHONITQ3b(i)=fHONITQ3b(i)-1; fQH(i)=fQH(i)-1; fHKET(i)=fHKET(i)+1; fNQ3(i)=fNQ3(i)+1;



i=i+1; %<RACM2_Update_XX>; <BAPI_XX>
Rnames{i} = 'HONITa=HKET+NO2';
k(:,i) = JONIT;
Gstr{i,1} = 'HONITa';  
fHONITa(i)=fHONITa(i)-1; fHKET(i)=fHKET(i)+1; fNO2(i)=fNO2(i)+1;

%O3 Tracer
i=i+1; %<RACM2_Update_XX>; <BAPI_XX>
Rnames{i} = 'HONITQa=HKET+NO2+NOQ';
k(:,i) = JONIT;
Gstr{i,1} = 'HONITQa';  
fHONITQa(i)=fHONITQa(i)-1; fHKET(i)=fHKET(i)+1; fNO2(i)=fNO2(i)+(1/3); fNOQ(i)=fNOQ(i)+(2/3);

%O3 Tracer
i=i+1; %<RACM2_Update_XX>; <BAPI_XX>
Rnames{i} = 'HONITQ2a=HKET+NQ2+NOQ';
k(:,i) = JONIT;
Gstr{i,1} = 'HONITQ2a';  
fHONITQ2a(i)=fHONITQ2a(i)-1; fHKET(i)=fHKET(i)+1; fNQ2(i)=fNQ2(i)+(1/3); fNOQ(i)=fNOQ(i)+(2/3);

%O3 Tracer
i=i+1; %<RACM2_Update_XX>; <BAPI_XX>
Rnames{i} = 'HONITQ3a=HKET+NQ2+NOQ';
k(:,i) = JONIT;
Gstr{i,1} = 'HONITQ3a';  
fHONITQ3a(i)=fHONITQ3a(i)-1; fHKET(i)=fHKET(i)+1; fNQ2(i)=fNQ2(i)+1; 

i=i+1; %<RACM2_Update_XX>; <BAPI_XX>
Rnames{i} = 'HONITb=HKET+NO2';
k(:,i) = JONIT;
Gstr{i,1} = 'HONITb';  
fHONITb(i)=fHONITb(i)-1; fHKET(i)=fHKET(i)+1; fNO2(i)=fNO2(i)+1;

%O3 Tracer
i=i+1; %<RACM2_Update_XX>; <BAPI_XX>
Rnames{i} = 'HONITQb=HKET+NO2+NOQ';
k(:,i) = JONIT;
Gstr{i,1} = 'HONITQb';  
fHONITQb(i)=fHONITQb(i)-1; fHKET(i)=fHKET(i)+1; fNO2(i)=fNO2(i)+(1/3); fNOQ(i)=fNOQ(i)+(2/3);

%O3 Tracer
i=i+1; %<RACM2_Update_XX>; <BAPI_XX>
Rnames{i} = 'HONITQ2b=HKET+NQ2+NOQ';
k(:,i) = JONIT;
Gstr{i,1} = 'HONITQ2b';  
fHONITQ2b(i)=fHONITQ2b(i)-1; fHKET(i)=fHKET(i)+1; fNQ2(i)=fNQ2(i)+(1/3); fNOQ(i)=fNOQ(i)+(2/3);

%O3 Tracer
i=i+1; %<RACM2_Update_XX>; <BAPI_XX>
Rnames{i} = 'HONITQ3b=HKET+NQ2+NOQ';
k(:,i) = JONIT;
Gstr{i,1} = 'HONITQ3b';  
fHONITQ3b(i)=fHONITQ3b(i)-1; fHKET(i)=fHKET(i)+1; fNQ2(i)=fNQ2(i)+1; 
