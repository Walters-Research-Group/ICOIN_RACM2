...
Rnames{i} = 'API+NO3=0.1 APINO2a+ 0.9 APINO2b';
k(:,i) = 1.19E-12.*exp(490./T);
Gstr{i,1} = 'API'; Gstr{i,2} = 'NO3'; 
fAPI(i)=fAPI(i)-1; fNO3(i)=fNO3(i)-1; fAPINO2a(i)=fAPINO2a(i)+0.1;  fAPINO2b(i)=fAPINO2b(i)+0.9; 

%O3 Tracer
i=i+1; %<RACM2_146a>; <BAPI_087a>
Rnames{i} = 'API+NO2Q=0.1 APINO2Qa+0.9 APINO2Qb';
k(:,i) = 1.19E-12.*exp(490./T);
Gstr{i,1} = 'API'; Gstr{i,2} = 'NO2Q'; 
fAPI(i)=fAPI(i)-1; fNO2Q(i)=fNO2Q(i)-1; fAPINO2Qa(i)=fAPINO2Qa(i)+0.1;  fAPINO2Qb(i)=fAPINO2Qb(i)+0.9; 

%O3 Tracer
i=i+1; %<RACM2_146b>; <BAPI_087b>
Rnames{i} = 'API+NOQ2=0.1 APINO2Q2a+0.9 APINO2Q2b';
k(:,i) = 1.19E-12.*exp(490./T);
Gstr{i,1} = 'API'; Gstr{i,2} = 'NOQ2'; 
fAPI(i)=fAPI(i)-1; fNOQ2(i)=fNOQ2(i)-1; fAPINO2Q2a(i)=fAPINO2Q2a(i)+0.1;  fAPINO2Q2b(i)=fAPINO2Q2b(i)+0.9;

%O3 Tracer
i=i+1; %<RACM2_146c>; <BAPI_087c>
Rnames{i} = 'API+NQ3=0.1 APINO2Q2a+0.9 APINO2Q3b';
k(:,i) = 1.19E-12.*exp(490./T);
Gstr{i,1} = 'API'; Gstr{i,2} = 'NQ3'; 
fAPI(i)=fAPI(i)-1; fNQ3(i)=fNQ3(i)-1; fAPINO2Q3a(i)=fAPINO2Q3a(i)+0.1;  fAPINO2Q3b(i)=fAPINO2Q3b(i)+0.9;
