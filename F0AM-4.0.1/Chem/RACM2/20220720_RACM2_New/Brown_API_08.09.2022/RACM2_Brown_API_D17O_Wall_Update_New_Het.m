...
'NQ2'; 'NQ3'; 'ONITa'; 'ONITQa'; 'ONITQ2a'; 'ONITQ3a'; 'ONITb'; 'ONITQb'; 'ONITQ2b'; 'ONITQ3b'; ...
'PANQ'; 'PANQ2'; 'Q1D'; 'Q3P'; 'QH'; 'APIO2a'; 'APIO2b'; 'APINO2a'; 'APINO2Qa'; 'APINO2Q2a'; 'APINO2Q3a'; ...
'APINO2b'; 'APINO2Qb'; 'APINO2Q2b'; 'APINO2Q3b'; ...
'OQ'; 'Q2'; 'H2Q2'; 'N2O4Q'; 'N2O3Q2'; 'N2O2Q3'; 'N2OQ4'; 'N2Q5'; 
'PPNQ'; 'PPNQ2'; 'wO3'; 'wNO'; 'wNQ'; 'wNO2'; 'wNOQ'; 'wNQ2'; 'wHNO3'; 'wHNO2Q'; 'wHNOQ2'; 'wHNQ3'; ...
'wONIT'; 'wONITQ'; 'wONITQ2'; 'wONITQ3'; 'A'; ...
};
...
fORA1(i)=fORA1(i)+0.07; fONITQa(i)=fONITQa(i)+0.18; 
 ...
 i=i+1; %<RACM2_Update_189b>; <BAPI_100b>
...
%O3 Tracer
i=i+1; %<RACM2_Update_189a>; <BAPI_100c>
...
Rnames{i} = 'APINO2a+NO=ONITa+NO2+HO2 + HCHO + ALD + KET';
k(:,i) =  4.00E-12;
Gstr{i,1} = 'APINO2a'; Gstr{i,2} = 'NO'; 
fAPINO2a(i)=fAPINO2a(i)-1; fNO(i)=fNO(i)-1;  fNO2(i)=fNO2(i)+1.5; 
 fHO2(i)=fHO2(i)+0.5; 
fHCHO(i)=fHCHO(i)+0.1435; fALD(i)=fALD(i)+0.62; fKET(i)=fKET(i)+0.232; fONITa(i)=fONITa(i)+0.5;
 

%O3 Tracer
i=i+1;  %<RACM2_205a>; <BAPI_108a>
Rnames{i} = 'APINO2a+NQ=ONITa + NOQ+ NO2 + HO2 + HCHO + ALD + KET';
k(:,i) = 4.00E-12;
...
Rnames{i} = 'APINO2Qa+NO=ONITQa + NO2+NOQ + HO2 + HCHO + ALD + KET';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'APINO2Qa'; Gstr{i,2} = 'NO'; 
fAPINO2Qa(i)=fAPINO2Qa(i)-1; fNO(i)=fNO(i)-1; fNO2(i)=fNO2(i)+0.75; fNOQ(i)=fNOQ(i)+0.75;
 fHO2(i)=fHO2(i)+0.5; 
fHCHO(i)=fHCHO(i)+0.1435; fALD(i)=fALD(i)+0.62; fKET(i)=fKET(i)+0.232;  fONITQa(i)=fONITQa(i)+0.5;

%O3 Tracer
i=i+1;  %<RACM2_205c>; <BAPI_108c>
Rnames{i} = 'APINO2Qa+NQ=ONITQa+ NO2+NOQ+NQ2+HO2 + HCHO + ALD + KET';
k(:,i) = 4.00E-12;
...
Rnames{i} = 'APINO2Q2a+NO=ONITQ2a + NQ2+ NOQ+NO2+HO2 + HCHO + ALD + KET';
k(:,i) = 4.00E-12;
...
fAPINO2Q2a(i)=fAPINO2Q2a(i)-1; fNO(i)=fNO(i)-1; fNO2(i)=fNO2(i)+0.25; fNQ2(i)=fNQ2(i)+0.25; fNOQ(i)=fNOQ(i)+1; 
 fHO2(i)=fHO2(i)+0.5; 
fHCHO(i)=fHCHO(i)+0.1435; fALD(i)=fALD(i)+0.62; fKET(i)=fKET(i)+0.232; fONITQ2a(i)=fONITQ2a(i)+0.5;

%O3 Tracer
i=i+1;  %<RACM2_205e>; <BAPI_108e>
Rnames{i} = 'APINO2Q2a+NQ=ONITQ2a +NOQ+NQ2+HO2 + HCHO + ALD + KET';
k(:,i) = 4.00E-12;
...
Rnames{i} = 'APINO2Q3a+NO=ONITQ3a +NOQ+NQ2+HO2 + HCHO + ALD + KET';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'APINO2Q3a'; Gstr{i,2} = 'NO'; 
fAPINO2Q3a(i)=fAPINO2Q3a(i)-1; fNO(i)=fNO(i)-1; fNOQ(i)=fNOQ(i)+0.75; fNQ2(i)=fNQ2(i)+0.75;
 fHO2(i)=fHO2(i)+0.5; 
fHCHO(i)=fHCHO(i)+0.1435; fALD(i)=fALD(i)+0.62; fKET(i)=fKET(i)+0.232; fONITQ3a(i)=fONITQ3a(i)+0.5;
 

%O3 Tracer
i=i+1;  %<RACM2_205g>; <BAPI_108g>
Rnames{i} = 'APINO2Q3a+NQ=ONITQ3a +NQ2+HO2 + HCHO + ALD + KET';
k(:,i) = 4.00E-12;
...
Rnames{i} = 'APINO2a+HOQ=ONITa';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'APINO2a'; Gstr{i,2} = 'HOQ'; 
fAPINO2a(i)=fAPINO2a(i)-1; fHOQ(i)=fHOQ(i)-1; fONITa(i)=fONITa(i)+1; 

%O3 Tracer
i=i+1; %<RACM2_244b>; <BAPI_120b>
Rnames{i} = 'APINO2a+HQ2=ONITa';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'APINO2a'; Gstr{i,2} = 'HQ2'; 
fAPINO2a(i)=fAPINO2a(i)-1; fHQ2(i)=fHQ2(i)-1; fONITa(i)=fONITa(i)+1; 

%O3 Tracer
i=i+1; %<RACM2_244c>; <BAPI_120c>
Rnames{i} = 'APINO2Qa+HO2=ONITQa';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'APINO2Qa'; Gstr{i,2} = 'HO2'; 
fAPINO2Qa(i)=fAPINO2Qa(i)-1; fHO2(i)=fHO2(i)-1; fONITQa(i)=fONITQa(i)+1; 

%O3 Tracer
i=i+1; %<RACM2_244d>; <BAPI_120d>
Rnames{i} = 'APINO2Qa+HOQ=ONITQa';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'APINO2Qa'; Gstr{i,2} = 'HOQ'; 
fAPINO2Qa(i)=fAPINO2Qa(i)-1; fHOQ(i)=fHOQ(i)-1; fONITQa(i)=fONITQa(i)+1; 

%O3 Tracer
i=i+1; %<RACM2_244e>; <BAPI_120e>
Rnames{i} = 'APINO2Qa+HQ2=ONITQa';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'APINO2Qa'; Gstr{i,2} = 'HQ2'; 
fAPINO2Qa(i)=fAPINO2Qa(i)-1; fHQ2(i)=fHQ2(i)-1; fONITQa(i)=fONITQa(i)+1;

%O3 Tracer
i=i+1; %<RACM2_244f>; <BAPI_120f>
Rnames{i} = 'APINO2Q2a+HO2=ONITQ2a';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'APINO2Q2a'; Gstr{i,2} = 'HO2'; 
fAPINO2Q2a(i)=fAPINO2Q2a(i)-1; fHO2(i)=fHO2(i)-1; fONITQ2a(i)=fONITQ2a(i)+1;

%O3 Tracer
i=i+1; %<RACM2_244g>; <BAPI_120g>
Rnames{i} = 'APINO2Q2a+HOQ=ONITQ2a';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'APINO2Q2a'; Gstr{i,2} = 'HOQ'; 
fAPINO2Q2a(i)=fAPINO2Q2a(i)-1; fHOQ(i)=fHOQ(i)-1; fONITQ2a(i)=fONITQ2a(i)+1;

%O3 Tracer
i=i+1; %<RACM2_244h>; <BAPI_120h>
Rnames{i} = 'APINO2Q2a+HQ2=ONITQ2a';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'APINO2Q2a'; Gstr{i,2} = 'HQ2'; 
fAPINO2Q2a(i)=fAPINO2Q2a(i)-1; fHQ2(i)=fHQ2(i)-1; fONITQ2a(i)=fONITQ2a(i)+1;

%O3 Tracer
i=i+1; %<RACM2_244i>; <BAPI_120i>
Rnames{i} = 'APINO2Q3a+HO2=ONITQ3a';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'APINO2Q3a'; Gstr{i,2} = 'HO2'; 
fAPINO2Q3a(i)=fAPINO2Q3a(i)-1; fHO2(i)=fHO2(i)-1; fONITQ3a(i)=fONITQ3a(i)+1;

%O3 Tracer
i=i+1; %<RACM2_244j>; <BAPI_120j>
Rnames{i} = 'APINO2Q3a+HOQ=ONITQ3a';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'APINO2Q3a'; Gstr{i,2} = 'HOQ'; 
fAPINO2Q3a(i)=fAPINO2Q3a(i)-1; fHOQ(i)=fHOQ(i)-1; fONITQ3a(i)=fONITQ3a(i)+1;

%O3 Tracer
i=i+1; %<RACM2_244k>; <BAPI_120k>
Rnames{i} = 'APINO2Q3a+HQ2=ONITQ3a';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'APINO2Q3a'; Gstr{i,2} = 'HQ2'; 
fAPINO2Q3a(i)=fAPINO2Q3a(i)-1; fHQ2(i)=fHQ2(i)-1; fONITQ3a(i)=fONITQ3a(i)+1;
...
Rnames{i} = 'APINO2b+HOQ=ONITb';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'APINO2b'; Gstr{i,2} = 'HOQ'; 
fAPINO2b(i)=fAPINO2b(i)-1; fHOQ(i)=fHOQ(i)-1; fONITb(i)=fONITb(i)+1; 

%O3 Tracer
i=i+1; %<RACM2_245b>; <BAPI_121b>
Rnames{i} = 'APINO2b+HQ2=ONITb';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'APINO2b'; Gstr{i,2} = 'HQ2'; 
fAPINO2b(i)=fAPINO2b(i)-1; fHQ2(i)=fHQ2(i)-1; fONITb(i)=fONITb(i)+1; 

%O3 Tracer
i=i+1; %<RACM2_245c>; <BAPI_121c>
Rnames{i} = 'APINO2Qb+HO2=ONITQb';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'APINO2Qb'; Gstr{i,2} = 'HO2'; 
fAPINO2Qb(i)=fAPINO2Qb(i)-1; fHO2(i)=fHO2(i)-1; fONITQb(i)=fONITQb(i)+1; 

%O3 Tracer
i=i+1; %<RACM2_245d>; <BAPI_121d>
Rnames{i} = 'APINO2Qb+HOQ=ONITQb';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'APINO2Qb'; Gstr{i,2} = 'HOQ'; 
fAPINO2Qb(i)=fAPINO2Qb(i)-1; fHOQ(i)=fHOQ(i)-1; fONITQb(i)=fONITQb(i)+1;

%O3 Tracer
i=i+1; %<RACM2_245e>; <BAPI_121e>
Rnames{i} = 'APINO2Qb+HQ2=ONITQb';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'APINO2Qb'; Gstr{i,2} = 'HQ2'; 
fAPINO2Qb(i)=fAPINO2Qb(i)-1; fHQ2(i)=fHQ2(i)-1; fONITQb(i)=fONITQb(i)+1;

%O3 Tracer
i=i+1; %<RACM2_245f>; <BAPI_121f>
Rnames{i} = 'APINO2Q2b+HO2=ONITQ2b';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'APINO2Q2b'; Gstr{i,2} = 'HO2'; 
fAPINO2Q2b(i)=fAPINO2Q2b(i)-1; fHO2(i)=fHO2(i)-1; fONITQ2b(i)=fONITQ2b(i)+1;

%O3 Tracer
i=i+1; %<RACM2_245g>; <BAPI_121g>
Rnames{i} = 'APINO2Q2b+HOQ=ONITQ2b';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'APINO2Q2b'; Gstr{i,2} = 'HOQ'; 
fAPINO2Q2b(i)=fAPINO2Q2b(i)-1; fHOQ(i)=fHOQ(i)-1; fONITQ2b(i)=fONITQ2b(i)+1;

%O3 Tracer
i=i+1; %<RACM2_245h>; <BAPI_121h>
Rnames{i} = 'APINO2Q2b+HQ2=ONITQ2b';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'APINO2Q2b'; Gstr{i,2} = 'HQ2'; 
fAPINO2Q2b(i)=fAPINO2Q2b(i)-1; fHQ2(i)=fHQ2(i)-1; fONITQ2b(i)=fONITQ2b(i)+1;

%O3 Tracer
i=i+1; %<RACM2_245i>; <BAPI_121i>
Rnames{i} = 'APINO2Q3b+HO2=ONITQ3b';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'APINO2Q3b'; Gstr{i,2} = 'HO2'; 
fAPINO2Q3b(i)=fAPINO2Q3b(i)-1; fHO2(i)=fHO2(i)-1; fONITQ3b(i)=fONITQ3b(i)+1;

%O3 Tracer
i=i+1; %<RACM2_245j>; <BAPI_121j>
Rnames{i} = 'APINO2Q3b+HOQ=ONITQ3b';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'APINO2Q3b'; Gstr{i,2} = 'HOQ'; 
fAPINO2Q3b(i)=fAPINO2Q3b(i)-1; fHOQ(i)=fHOQ(i)-1; fONITQ3b(i)=fONITQ3b(i)+1;

%O3 Tracer
i=i+1; %<RACM2_245k>; <BAPI_121k>
Rnames{i} = 'APINO2Q3b+HQ2=ONITQ3b';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'APINO2Q3b'; Gstr{i,2} = 'HQ2'; 
fAPINO2Q3b(i)=fAPINO2Q3b(i)-1; fHQ2(i)=fHQ2(i)-1; fONITQ3b(i)=fONITQ3b(i)+1;
...
Rnames{i} = 'APINO2Qa+MO2=HCHO+HO2+HO2+ONITQa';
k(:,i) = 1.60E-13.*exp(708./T);
Gstr{i,1} = 'APINO2Qa'; Gstr{i,2} = 'MO2'; 
fAPINO2Qa(i)=fAPINO2Qa(i)-1; fMO2(i)=fMO2(i)-1; fHCHO(i)=fHCHO(i)+1; fHO2(i)=fHO2(i)+1; fHO2(i)=fHO2(i)+1; fONITQa(i)=fONITQa(i)+1;

%O3 Tracer
i=i+1; %<RACM2_281b>; <BAPI_133b>
Rnames{i} = 'APINO2Q2a+MO2=HCHO+HO2+HO2+ONITQ2a';
k(:,i) = 1.60E-13.*exp(708./T);
Gstr{i,1} = 'APINO2Q2a'; Gstr{i,2} = 'MO2'; 
fAPINO2Q2a(i)=fAPINO2Q2a(i)-1; fMO2(i)=fMO2(i)-1; fHCHO(i)=fHCHO(i)+1; fHO2(i)=fHO2(i)+1; fHO2(i)=fHO2(i)+1; fONITQ2a(i)=fONITQ2a(i)+1;

%O3 Tracer
i=i+1; %<RACM2_281c>; <BAPI_133c>
Rnames{i} = 'APINO2Q3a+MO2=HCHO+HO2+HO2+ONITQ3a';
k(:,i) = 1.60E-13.*exp(708./T);
Gstr{i,1} = 'APINO2Q3a'; Gstr{i,2} = 'MO2'; 
fAPINO2Q3a(i)=fAPINO2Q3a(i)-1; fMO2(i)=fMO2(i)-1; fHCHO(i)=fHCHO(i)+1; fHO2(i)=fHO2(i)+1; fHO2(i)=fHO2(i)+1; fONITQ3a(i)=fONITQ3a(i)+1;
...
Rnames{i} = 'APINO2Qb+MO2= HO2+NOQ+NO2+HCHO+ALD+KET+MOH+ROH+ONITQb';
k(:,i) = 9.68E-14.*exp(708./T);
...
fHCHO(i)=fHCHO(i)+0.965; fALD(i)=fALD(i)+0.93; fKET(i)=fKET(i)+0.348; fMOH(i)=fMOH(i)+0.25; 
fROH(i)=fROH(i)+0.25; fONITQb(i)=fONITQb(i)+0.5; 

%O3 Tracer
i=i+1; %<RACM2_282b>; <BAPI_134b>
Rnames{i} = 'APINO2Q2b+MO2= HO2+NOQ+NQ2+HCHO+ALD+KET+MOH+ROH+ONITQ2b';
k(:,i) = 9.68E-14.*exp(708./T);
Gstr{i,1} = 'APINO2Qb'; Gstr{i,2} = 'MO2'; 
fAPINO2b(i)=fAPINO2b(i)-1; fMO2(i)=fMO2(i)-1; fHO2(i)=fHO2(i)+0.50; fNQ2(i)=fNQ2(i)+(1/6); fNOQ(i)=fNOQ(i)+(1/3); 
fHCHO(i)=fHCHO(i)+0.965; fALD(i)=fALD(i)+0.93; fKET(i)=fKET(i)+0.348; fMOH(i)=fMOH(i)+0.25; 
fROH(i)=fROH(i)+0.25; fONITQ2b(i)=fONITQ2b(i)+0.5; 

%O3 Tracer
i=i+1; %<RACM2_282c>; <BAPI_134c>
Rnames{i} = 'APINO2Q3b+MO2= HO2+NQ2+HCHO+ALD+KET+MOH+ROH+ONITQ3b';
k(:,i) = 9.68E-14.*exp(708./T);
Gstr{i,1} = 'APINO2Qb'; Gstr{i,2} = 'MO2'; 
fAPINO2b(i)=fAPINO2b(i)-1; fMO2(i)=fMO2(i)-1; fHO2(i)=fHO2(i)+0.50; fNQ2(i)=fNQ2(i)+0.5; 
fHCHO(i)=fHCHO(i)+0.965; fALD(i)=fALD(i)+0.93; fKET(i)=fKET(i)+0.348; fMOH(i)=fMOH(i)+0.25; 
fROH(i)=fROH(i)+0.25; fONITQ3b(i)=fONITQ3b(i)+0.5;
...
Rnames{i} = 'APINO2Qa+ACO3=ONITQa+MO2+HO2';
k(:,i) = 8.85E-13.*exp(765./T);
Gstr{i,1} = 'APINO2Qa'; Gstr{i,2} = 'ACO3'; 
fAPINO2Qa(i)=fAPINO2Qa(i)-1; fACO3(i)=fACO3(i)-1; fONITQa(i)=fONITQa(i)+1; fMO2(i)=fMO2(i)+1; fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1; %<RACM2_317b>; <BAPI_145b>
Rnames{i} = 'APINO2Q2a+ACO3=ONITQ2a+MO2+HO2';
k(:,i) = 8.85E-13.*exp(765./T);
Gstr{i,1} = 'APINO2Q2a'; Gstr{i,2} = 'ACO3'; 
fAPINO2Q2a(i)=fAPINO2Q2a(i)-1; fACO3(i)=fACO3(i)-1; fONITQ2a(i)=fONITQ2a(i)+1; fMO2(i)=fMO2(i)+1; fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1; %<RACM2_317c>; <BAPI_145c>
Rnames{i} = 'APINO2Q3a+ACO3=ONITQ3a+MO2+HO2';
k(:,i) = 8.85E-13.*exp(765./T);
Gstr{i,1} = 'APINO2Q3a'; Gstr{i,2} = 'ACO3'; 
fAPINO2Q3a(i)=fAPINO2Q3a(i)-1; fACO3(i)=fACO3(i)-1; fONITQ3a(i)=fONITQ3a(i)+1; fMO2(i)=fMO2(i)+1; fHO2(i)=fHO2(i)+1; 
...
Rnames{i} = 'APINO2a+NO2Q=ONITa+NO2+NOQ+HO2';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'APINO2a'; Gstr{i,2} = 'NO2Q'; 
fAPINO2a(i)=fAPINO2a(i)-1; fNO2Q(i)=fNO2Q(i)-1; fONITa(i)=fONITa(i)+1; fNO2(i)=fNO2(i)+(1/3); fNOQ(i)=fNOQ(i)+(2/3); fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1; %<RACM2_354b>; <BAPI_158b>
Rnames{i} = 'APINO2a+NOQ2=ONITa+NQ2+NOQ+HO2';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'APINO2a'; Gstr{i,2} = 'NOQ2'; 
fAPINO2a(i)=fAPINO2a(i)-1; fNOQ2(i)=fNOQ2(i)-1; fONITa(i)=fONITa(i)+1; fNQ2(i)=fNQ2(i)+(1/3); fNOQ(i)=fNOQ(i)+(2/3); fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1; %<RACM2_354c>; <BAPI_158c>
Rnames{i} = 'APINO2a+NQ3=ONITa+NQ2+HO2';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'APINO2a'; Gstr{i,2} = 'NQ3'; 
fAPINO2a(i)=fAPINO2a(i)-1; fNQ3(i)=fNQ3(i)-1; fONITa(i)=fONITa(i)+1; fNQ2(i)=fNQ2(i)+1; fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1; %<RACM2_354d>; <BAPI_158d>
Rnames{i} = 'APINO2Qa+NO3=ONITQa+NO2+HO2';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'APINO2Qa'; Gstr{i,2} = 'NO3'; 
fAPINO2Qa(i)=fAPINO2Qa(i)-1; fNO3(i)=fNO3(i)-1; fONITQa(i)=fONITQa(i)+1; fNO2(i)=fNO2(i)+1; fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1; %<RACM2_354e>; <BAPI_158e>
Rnames{i} = 'APINO2Qa+NO2Q=ONITQa+NO2+NOQ+HO2';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'APINO2Qa'; Gstr{i,2} = 'NO2Q'; 
fAPINO2Qa(i)=fAPINO2Qa(i)-1; fNO2Q(i)=fNO2Q(i)-1; fONITQa(i)=fONITQa(i)+1; fNO2(i)=fNO2(i)+(1/3); fNOQ(i)=fNOQ(i)+(2/3); fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1; %<RACM2_354f>; <BAPI_158f>
Rnames{i} = 'APINO2Qa+NOQ2=ONITQa+NQ2+NOQ+HO2';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'APINO2Qa'; Gstr{i,2} = 'NOQ2'; 
fAPINO2Qa(i)=fAPINO2Qa(i)-1; fNOQ2(i)=fNOQ2(i)-1; fONITQa(i)=fONITQa(i)+1; fNQ2(i)=fNQ2(i)+(1/3); fNOQ(i)=fNOQ(i)+(2/3); fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1; %<RACM2_354g>; <BAPI_158g>
Rnames{i} = 'APINO2Qa+NQ3=ONITQa+NQ2+HO2';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'APINO2Qa'; Gstr{i,2} = 'NQ3'; 
fAPINO2Qa(i)=fAPINO2Qa(i)-1; fNQ3(i)=fNQ3(i)-1; fONITQa(i)=fONITQa(i)+1; fNQ2(i)=fNQ2(i)+1; fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1; %<RACM2_354h>; <BAPI_158h>
Rnames{i} = 'APINO2Q2a+NO3=ONITQ2a+NO2+HO2';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'APINO2Q2a'; Gstr{i,2} = 'NO3'; 
fAPINO2Q2a(i)=fAPINO2Q2a(i)-1; fNO3(i)=fNO3(i)-1; fONITQ2a(i)=fONITQ2a(i)+1; fNO2(i)=fNO2(i)+1; fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1; %<RACM2_354i>; <BAPI_158i>
Rnames{i} = 'APINO2Q2a+NO2Q=ONITQ2a+NO2+NOQ+HO2';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'APINO2Q2a'; Gstr{i,2} = 'NO2Q'; 
fAPINO2Q2a(i)=fAPINO2Q2a(i)-1; fNO2Q(i)=fNO2Q(i)-1; fONITQ2a(i)=fONITQ2a(i)+1; fNO2(i)=fNO2(i)+(1/3); fNOQ(i)=fNOQ(i)+(2/3); fHO2(i)=fHO2(i)+1;

%O3 Tracer
i=i+1; %%<RACM2_354j>; <BAPI_158j>
Rnames{i} = 'APINO2Q2a+NOQ2=ONITQ2a+NQ2+NOQ+HO2';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'APINO2Q2a'; Gstr{i,2} = 'NOQ2'; 
fAPINO2Q2a(i)=fAPINO2Q2a(i)-1; fNOQ2(i)=fNOQ2(i)-1; fONITQ2a(i)=fONITQ2a(i)+1; fNQ2(i)=fNQ2(i)+(1/3); fNOQ(i)=fNOQ(i)+(2/3); fHO2(i)=fHO2(i)+1;

%O3 Tracer
i=i+1; %<RACM2_354k>; <BAPI_158k>
Rnames{i} = 'APINO2Q2a+NQ3=ONITQ2a+NQ2+HO2';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'APINO2Q2a'; Gstr{i,2} = 'NQ3'; 
fAPINO2Q2a(i)=fAPINO2Q2a(i)-1; fNQ3(i)=fNQ3(i)-1; fONITQ2a(i)=fONITQ2a(i)+1; fNQ2(i)=fNQ2(i)+1; fHO2(i)=fHO2(i)+1;

%O3 Tracer
i=i+1; %<RACM2_354l>; <BAPI_158l>
Rnames{i} = 'APINO2Q3a+NO3=ONITQ3a+NO2+HO2';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'APINO2Q3a'; Gstr{i,2} = 'NO3'; 
fAPINO2Q3a(i)=fAPINO2Q3a(i)-1; fNO3(i)=fNO3(i)-1; fONITQ3a(i)=fONITQ3a(i)+1; fNO2(i)=fNO2(i)+1; fHO2(i)=fHO2(i)+1;

%O3 Tracer
i=i+1; %<RACM2_354m>; <BAPI_158m>
Rnames{i} = 'APINO2Q3a+NO2Q=ONITQ3a+NO2+NOQ+HO2';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'APINO2Q3a'; Gstr{i,2} = 'NO2Q'; 
fAPINO2Q3a(i)=fAPINO2Q3a(i)-1; fNO2Q(i)=fNO2Q(i)-1; fONITQ3a(i)=fONITQ3a(i)+1; fNO2(i)=fNO2(i)+(1/3); fNOQ(i)=fNOQ(i)+(2/3); fHO2(i)=fHO2(i)+1;

%O3 Tracer
i=i+1; %<RACM2_354n>; <BAPI_158n>
Rnames{i} = 'APINO2Q3a+NOQ2=ONITQ3a+NQ2+NOQ+HO2';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'APINO2Q3a'; Gstr{i,2} = 'NOQ2'; 
fAPINO2Q3a(i)=fAPINO2Q3a(i)-1; fNOQ2(i)=fNOQ2(i)-1; fONITQ3a(i)=fONITQ3a(i)+1; fNQ2(i)=fNQ2(i)+(1/3); fNOQ(i)=fNOQ(i)+(2/3); fHO2(i)=fHO2(i)+1;

%O3 Tracer
i=i+1; %<RACM2_354o>; <BAPI_158o>
Rnames{i} = 'APINO2Q3a+NQ3=ONITQ3a+NQ2+HO2';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'APINO2Q3a'; Gstr{i,2} = 'NQ3'; 
fAPINO2Q3a(i)=fAPINO2Q3a(i)-1; fNQ3(i)=fNQ3(i)-1; fONITQ3a(i)=fONITQ3a(i)+1; fNQ2(i)=fNQ2(i)+1; fHO2(i)=fHO2(i)+1;
...
Rnames{i} = 'APINO2a+APINO2Qa=ONITa+ONITQa+HO2';
k(:,i) = 7.00E-14.*exp(1000./T);
Gstr{i,1} = 'APINO2a'; Gstr{i,2} = 'APINO2Qa'; 
fAPINO2a(i)=fAPINO2a(i)-1; fAPINO2Qa(i)=fAPINO2Qa(i)-1; fONITa(i)=fONITa(i)+1; fONITQa(i)=fONITQa(i)+1; fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1; %<RACM2_359b>; <BAPI_162b>
Rnames{i} = 'APINO2a+APINO2Q2a=ONITa+ONITQ2a+HO2';
k(:,i) = 7.00E-14.*exp(1000./T);
Gstr{i,1} = 'APINO2a'; Gstr{i,2} = 'APINO2Q2a'; 
fAPINO2a(i)=fAPINO2a(i)-1; fAPINO2Q2a(i)=fAPINO2Q2a(i)-1; fONITa(i)=fONITa(i)+1; fONITQ2a(i)=fONITQ2a(i)+1; fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1; %<RACM2_359c>; <BAPI_162c>
Rnames{i} = 'APINO2a+APINO2Q3a=ONITa+ONITQ3a+HO2';
k(:,i) = 7.00E-14.*exp(1000./T);
Gstr{i,1} = 'APINO2a'; Gstr{i,2} = 'APINO2Q3a'; 
fAPINO2a(i)=fAPINO2a(i)-1; fAPINO2Q3a(i)=fAPINO2Q3a(i)-1; fONITa(i)=fONITa(i)+1; fONITQ3a(i)=fONITQ3a(i)+1; fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1; %<RACM2_359d>; <BAPI_162d>
Rnames{i} = 'APINO2Qa+APINO2Qa=ONITQa+ONITQa+HO2';
k(:,i) = 7.00E-14.*exp(1000./T);
Gstr{i,1} = 'APINO2Qa'; Gstr{i,2} = 'APINO2Qa'; 
fAPINO2Qa(i)=fAPINO2Qa(i)-1; fAPINO2Qa(i)=fAPINO2Qa(i)-1; fONITQa(i)=fONITQa(i)+1; fONITQa(i)=fONITQa(i)+1; fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1; %<RACM2_359e>; <BAPI_162e>
Rnames{i} = 'APINO2Qa+APINO2Q2a=ONITQa+ONITQ2a+HO2';
k(:,i) = 7.00E-14.*exp(1000./T);
Gstr{i,1} = 'APINO2Qa'; Gstr{i,2} = 'APINO2Q2a'; 
fAPINO2Qa(i)=fAPINO2Qa(i)-1; fAPINO2Q2a(i)=fAPINO2Q2a(i)-1; fONITQa(i)=fONITQa(i)+1; fONITQ2a(i)=fONITQ2a(i)+1; fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1; %<RACM2_359f>; <BAPI_162f>
Rnames{i} = 'APINO2Qa+APINO2Q3a=ONITQa+ONITQ3a+HO2';
k(:,i) = 7.00E-14.*exp(1000./T);
Gstr{i,1} = 'APINO2Qa'; Gstr{i,2} = 'APINO2Q3a'; 
fAPINO2Qa(i)=fAPINO2Qa(i)-1; fAPINO2Q3a(i)=fAPINO2Q3a(i)-1; fONITQa(i)=fONITQa(i)+1; fONITQ3a(i)=fONITQ3a(i)+1; fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1; %<RACM2_359g>; <BAPI_162g>
Rnames{i} = 'APINO2Q2a+APINO2Q2a=ONITQ2a+ONITQ2a+HO2';
k(:,i) = 7.00E-14.*exp(1000./T);
Gstr{i,1} = 'APINO2Q2a'; Gstr{i,2} = 'APINO2Q2a'; 
fAPINO2Q2a(i)=fAPINO2Q2a(i)-1; fAPINO2Q2a(i)=fAPINO2Q2a(i)-1; fONITQ2a(i)=fONITQ2a(i)+1; fONITQ2a(i)=fONITQ2a(i)+1; fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1; %<RACM2_359h>; <BAPI_162h>
Rnames{i} = 'APINO2Q2a+APINO2Q3a=ONITQ2a+ONITQ3a+HO2';
k(:,i) = 7.00E-14.*exp(1000./T);
Gstr{i,1} = 'APINO2Q2a'; Gstr{i,2} = 'APINO2Q3a'; 
fAPINO2Q2a(i)=fAPINO2Q2a(i)-1; fAPINO2Q3a(i)=fAPINO2Q3a(i)-1; fONITQ2a(i)=fONITQ2a(i)+1; fONITQ3a(i)=fONITQ3a(i)+1; fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1; %<RACM2_359i>; <BAPI_162i>
Rnames{i} = 'APINO2Q3a+APINO2Q3a=ONITQ3a+ONITQ3a+HO2';
k(:,i) = 7.00E-14.*exp(1000./T);
Gstr{i,1} = 'APINO2Q3a'; Gstr{i,2} = 'APINO2Q3a'; 
fAPINO2Q3a(i)=fAPINO2Q3a(i)-1; fAPINO2Q3a(i)=fAPINO2Q3a(i)-1; fONITQ3a(i)=fONITQ3a(i)+1; fONITQ3a(i)=fONITQ3a(i)+1; fHO2(i)=fHO2(i)+1; 
...
Rnames{i} = 'APINO2a+APINO2Qb=HO2+HOQ+NO2+NOQ+0.202 HCHO+0.640 ALD+0.149 KET+ ONITa +ONITQb ';
k(:,i) = 4.25E-14.*exp(1000./T);
...
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fONITa(i)=fONITa(i)+1; fONITQb(i)=fONITQb(i)+0.5; 

%O3 Tracer
i=i+1; %<RACM2_360b>; <BAPI_163b>
Rnames{i} = 'APINO2a+APINO2Q2b=HO2+HOQ+NQ2+NOQ+0.202 HCHO+0.640 ALD+0.149 KET+ ONITa +ONITQ2b';
k(:,i) = 4.25E-14.*exp(1000./T);
...
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fONITa(i)=fONITa(i)+1; fONITQ2b(i)=fONITQ2b(i)+0.5; 

%O3 Tracer
i=i+1; %<RACM2_360c>; <BAPI_163c>
Rnames{i} = 'APINO2a+APINO2Q3b=HO2+HOQ+NQ2+0.202 HCHO+0.640 ALD+0.149 KET+ ONITa +ONITQ3b';
k(:,i) = 4.25E-14.*exp(1000./T);
...
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fONITa(i)=fONITa(i)+1; fONITQ3b(i)=fONITQ3b(i)+0.5; 

%O3 Tracer
i=i+1; %<RACM2_360d>; <BAPI_163d>
Rnames{i} = 'APINO2Qa+APINO2b=0.50 HO2+NO2+0.202 HCHO+0.640 ALD+0.149 KET+ ONITQa +ONITb';
k(:,i) = 4.25E-14.*exp(1000./T);
Gstr{i,1} = 'APINO2Qa'; Gstr{i,2} = 'APINO2Qb'; 
fAPINO2Qa(i)=fAPINO2Qa(i)-1; fAPINO2b(i)=fAPINO2b(i)-1; fHO2(i)=fHO2(i)+0.5; fNO2(i)=fNO2(i)+(1/2); 
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fONITQa(i)=fONITQa(i)+1; fONITb(i)=fONITb(i)+0.5; 

%O3 Tracer
i=i+1; %<RACM2_360e>; <BAPI_163e>
Rnames{i} = 'APINO2Qa+APINO2Qb=HO2+HOQ+NO2+NOQ+0.202 HCHO+0.640 ALD+0.149 KET+ ONITQa + ONITQb';
k(:,i) = 4.25E-14.*exp(1000./T);
Gstr{i,1} = 'APINO2Qa'; Gstr{i,2} = 'APINO2Qb'; 
...
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fONITQa(i)=fONITQa(i)+1;  fONITQb(i)=fONITQb(i)+0.5; 

%O3 Tracer
i=i+1; %<RACM2_360f>; <BAPI_163f>
Rnames{i} = 'APINO2Qa+APINO2Q2b=HO2+HOQ+NQ2+NOQ+0.202 HCHO+0.640 ALD+0.149 KET+ ONITQa+ONITQ2b';
k(:,i) = 4.25E-14.*exp(1000./T);
...
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fONITQa(i)=fONITQa(i)+1; fONITQ2b(i)=fONITQ2b(i)+0.5; 

%O3 Tracer
i=i+1; %<RACM2_360g>; <BAPI_163g>
Rnames{i} = 'APINO2Qa+APINO2Q3b=HO2+HOQ+NQ2+0.202 HCHO+0.640 ALD+0.149 KET+ ONITQa+ONITQ3b';
k(:,i) = 4.25E-14.*exp(1000./T);
...
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fONITQa(i)=fONITQa(i)+1; fONITQ3b(i)=fONITQ3b(i)+0.5; 

%O3 Tracer
i=i+1; %<RACM2_360h>; <BAPI_163h>
Rnames{i} = 'APINO2Q2a+APINO2b=0.50 HO2+NO2+0.202 HCHO+0.640 ALD+0.149 KET+ ONITQ2a+ONITb';
k(:,i) = 4.25E-14.*exp(1000./T);
...
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fONITQ2a(i)=fONITQ2a(i)+1; fONITb(i)=fONITb(i)+0.5; 

%O3 Tracer
i=i+1; %<RACM2_360i>; <BAPI_163i>
Rnames{i} = 'APINO2Q2a+APINO2Qb=HO2+HOQ+NO2+NOQ+0.202 HCHO+0.640 ALD+0.149 KET+ ONITQ2a+ONITQb';
k(:,i) = 4.25E-14.*exp(1000./T);
...
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fONITQ2a(i)=fONITQ2a(i)+1; fONITQb(i)=fONITQb(i)+0.5; 

%O3 Tracer
i=i+1; %<RACM2_360j>; <BAPI_163j>
Rnames{i} = 'APINO2Q2a+APINO2Q2b=HO2+HOQ+NQ2+NOQ+0.202 HCHO+0.640 ALD+0.149 KET+ ONITQ2a+ONITQ2b';
k(:,i) = 4.25E-14.*exp(1000./T);
...
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fONITQ2a(i)=fONITQ2a(i)+1; fONITQ2b(i)=fONITQ2b(i)+0.5; 

%O3 Tracer
i=i+1; %<RACM2_360k>; <BAPI_163k>
Rnames{i} = 'APINO2Q2a+APINO2Q3b=HO2+HOQ+NQ2+0.202 HCHO+0.640 ALD+0.149 KET+ ONITQ2a+ONITQ3b';
k(:,i) = 4.25E-14.*exp(1000./T);
...
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fONITQ2a(i)=fONITQ2a(i)+1; fONITQ3b(i)=fONITQ3b(i)+0.5; 

%O3 Tracer
i=i+1; %<RACM2_360l>; <BAPI_163l>
Rnames{i} = 'APINO2Q3a+APINO2b=0.50 HO2+NO2+0.202 HCHO+0.640 ALD+0.149 KET+ ONITQ3a+ONITb';
k(:,i) = 4.25E-14.*exp(1000./T);
...
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fONITQ3a(i)=fONITQ3a(i)+1; fONITb(i)=fONITb(i)+0.5; 

%O3 Tracer
i=i+1; %<RACM2_360m>; <BAPI_163m>
Rnames{i} = 'APINO2Q3a+APINO2Qb=HO2+HOQ+NO2+NOQ+0.202 HCHO+0.640 ALD+0.149 KET+ ONITQ3a+ONITQb';
k(:,i) = 4.25E-14.*exp(1000./T);
...
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fONITQ3a(i)=fONITQ3a(i)+1; fONITQb(i)=fONITQb(i)+0.5; 

%O3 Tracer
i=i+1; %<RACM2_360n>; <BAPI_163n>
Rnames{i} = 'APINO2Q3a+APINO2Q2b=HO2+HOQ+NQ2+NOQ+0.202 HCHO+0.640 ALD+0.149 KET+ ONITQ3a+ONITQ2b';
k(:,i) = 4.25E-14.*exp(1000./T);
...
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fONITQ3a(i)=fONITQ3a(i)+1; fONITQ2b(i)=fONITQ2b(i)+0.5; 

%O3 Tracer
i=i+1; %<RACM2_360o>; <BAPI_163o>
Rnames{i} = 'APINO2Q3a+APINO2Q3b=HO2+HOQ+NQ2+0.202 HCHO+0.640 ALD+0.149 KET+ ONITQ3a + ONITQ3b';
k(:,i) = 4.25E-14.*exp(1000./T);
...
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fONITQ3a(i)=fONITQ3a(i)+1; fONITQ3b(i)=fONITQ3b(i)+1; 
...
Rnames{i} = 'APINO2b+APINO2Qb=NO2+NOQ+0.504 HCHO+1.21 ALD+0.285 KET+ONITb+ONITQb ';
...
fALD(i)=fALD(i)+1.21; fKET(i)=fKET(i)+0.285; fONITb(i)=fONITb(i)+0.5; fONITQb(i)=fONITQb(i)+0.5;

%O3 Tracer
i=i+1; %<RACM2_361b>; <BAPI_164b>
Rnames{i} = 'APINO2b+APINO2Q2b=NO2+NOQ+NQ2+0.504 HCHO+1.21 ALD+0.285 KET+ONITb+ONITQ2b';
k(:,i) = 2.96E-14.*exp(1000./T);
...
fALD(i)=fALD(i)+1.21; fKET(i)=fKET(i)+0.285; fONITb(i)=fONITb(i)+0.5; fONITQ2b(i)=fONITQ2b(i)+0.5;

%O3 Tracer
i=i+1; %<RACM2_361c>; <BAPI_164c>
Rnames{i} = 'APINO2b+APINO2Q3b=NO2+NQ2+0.504 HCHO+1.21 ALD+0.285 KET+ONITb+ONITQ3b';
k(:,i) = 2.96E-14.*exp(1000./T);
...
fALD(i)=fALD(i)+1.21; fKET(i)=fKET(i)+0.285; fONITb(i)=fONITb(i)+0.5; fONITQ3b(i)=fONITQ3b(i)+0.5;

%O3 Tracer
i=i+1; %<RACM2_361d>; <BAPI_164d>
Rnames{i} = 'APINO2Qb+APINO2Qb=NO2+NQ2+0.504 HCHO+1.21 ALD+0.285 KET+ONITQb';
k(:,i) = 2.96E-14.*exp(1000./T);
...
fALD(i)=fALD(i)+1.21; fKET(i)=fKET(i)+0.285; fONITQb(i)=fONITQb(i)+1;

%O3 Tracer
i=i+1; %<RACM2_361e>; <BAPI_164e>
Rnames{i} = 'APINO2Qb+APINO2Q2b=NO2+NQ2+NQ2+0.504 HCHO+1.21 ALD+0.285 KET+ONITQb+ONITQ2b';
k(:,i) = 2.96E-14.*exp(1000./T);
...
fALD(i)=fALD(i)+1.21; fKET(i)=fKET(i)+0.285; fONITQb(i)=fONITQb(i)+0.5; fONITQ2b(i)=fONITQ2b(i)+0.5;

%O3 Tracer
i=i+1; %<RACM2_361f>; <BAPI_164f>
Rnames{i} = 'APINO2Qb+APINO2Q3b=NO2+NQ2+NQ2+0.504 HCHO+1.21 ALD+0.285 KET+ONITQb+ONITQ3b';
k(:,i) = 2.96E-14.*exp(1000./T);
...
fALD(i)=fALD(i)+1.21; fKET(i)=fKET(i)+0.285; fONITQb(i)=fONITQb(i)+0.5; fONITQ3b(i)=fONITQ3b(i)+0.5;

%O3 Tracer
i=i+1; %<RACM2_361g>; <BAPI_164g>
Rnames{i} = 'APINO2Q2b+APINO2Q2b=NQ2+NQ2+0.504 HCHO+1.21 ALD+0.285 KET+ONITQ2b';
k(:,i) = 2.96E-14.*exp(1000./T);
...
fALD(i)=fALD(i)+1.21; fKET(i)=fKET(i)+0.285; fONITQ2b(i)=fONITQ2b(i)+1; 

%O3 Tracer
i=i+1; %<RACM2_361h>; <BAPI_164h>
Rnames{i} = 'APINO2Q2b+APINO2Q3b=NQ2+NQ2+0.504 HCHO+1.21 ALD+0.285 KET+ONITQ2b+ONITQ3b';
k(:,i) = 2.96E-14.*exp(1000./T);
...
fALD(i)=fALD(i)+1.21; fKET(i)=fKET(i)+0.285; fONITQ2b(i)=fONITQ2b(i)+0.5; fONITQ3b(i)=fONITQ3b(i)+0.5; 

%O3 Tracer
i=i+1; %<RACM2_361i>; <BAPI_164i>
Rnames{i} = 'APINO2Q3b+APINO2Q3b=NQ2+0.504 HCHO+1.21 ALD+0.285 KET+ONITQ3b';
k(:,i) = 2.96E-14.*exp(1000./T);
...
fALD(i)=fALD(i)+1.21; fKET(i)=fKET(i)+0.285; fONITQ3b(i)=fONITQ3b(i)+1; 
...
%O3 Tracer
i=i+1; %<BAPI_201a>
Rnames{i} = 'ONITQa=wONITQ';
k(:,i) =  8.8E-6;
Gstr{i,1} = 'ONITQa'; 
fONITQa(i)=fONITQa(i)-1;
 fwONITQ(i)=fwONITQ(i)+1; 

%O3 Tracer
i=i+1; %<BAPI_201b>
Rnames{i} = 'ONITQ2a=wONITQ2';
k(:,i) =  8.8E-6;
Gstr{i,1} = 'ONITQ2a'; 
fONITQ2a(i)=fONITQ2a(i)-1;
 fwONITQ2(i)=fwONITQ2(i)+1; 

%O3 Tracer
i=i+1; %<BAPI_201c>
Rnames{i} = 'ONITQ3a=wONITQ3';
k(:,i) =  8.8E-6;
Gstr{i,1} = 'ONITQ3a'; 
fONITQ3a(i)=fONITQ3a(i)-1;
 fwONITQ3(i)=fwONITQ3(i)+1; 
...
%O3 Tracer
i=i+1; %<BAPI_201e>
Rnames{i} = 'ONITQb=wONITQ';
k(:,i) =  8.8E-6;
Gstr{i,1} = 'ONITQb'; 
fONITQb(i)=fONITQb(i)-1;
 fwONITQ(i)=fwONITQ(i)+1; 

%O3 Tracer
i=i+1; %<BAPI_201f>
Rnames{i} = 'ONITQ2b=wONITQ2';
k(:,i) =  8.8E-6;
Gstr{i,1} = 'ONITQ2b'; 
fONITQ2b(i)=fONITQ2b(i)-1;
 fwONITQ2(i)=fwONITQ2(i)+1; 

%O3 Tracer
i=i+1; %<BAPI_201g>
Rnames{i} = 'ONITQ3b=wONITQ3';
k(:,i) =  8.8E-6;
Gstr{i,1} = 'ONITQ3b'; 
fONITQ3b(i)=fONITQ3b(i)-1;
 fwONITQ3(i)=fwONITQ3(i)+1; 
