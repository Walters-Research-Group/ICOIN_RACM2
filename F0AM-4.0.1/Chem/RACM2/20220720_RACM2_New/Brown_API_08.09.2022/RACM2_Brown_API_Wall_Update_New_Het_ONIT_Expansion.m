...
'APIO2a'; 'APIO2b'; 'APINO2a'; 'APINO2b'; 'MONITSa'; 'MONITUa'; 'MONITSb'; 'HONITa'; 'HONITb'; ...
'A'; 'wO3'; 'wNO'; 'wNO2'; 'wHNO3'; 'wMONITS'; 'wMONITU'; 'wHONIT';...
};
...
fAPINO2a(i)=fAPINO2a(i)-1; fNO(i)=fNO(i)-1;  fMONITSa(i)=fMONITSa(i)+0.5; fNO2(i)=fNO2(i)+1.5; fHO2(i)=fHO2(i)+0.5; 
fHCHO(i)=fHCHO(i)+0.1435; fALD(i)=fALD(i)+0.62; fKET(i)=fKET(i)+0.232; 
