...
fAPI(i)=fAPI(i)-1; fNO3(i)=fNO3(i)-1; fAPINO2a(i)=fAPINO2a(i)+0.10;  fAPINO2b(i)=fAPINO2b(i)+0.90; 

%O3 Tracer
i=i+1; %<RACM2_146a>; <BAPI_087a>
Rnames{i} = 'API+NO2Q=0.10 APINO2Qa+0.90 APINO2Qb';
k(:,i) = 1.19E-12.*exp(490./T);
...
Rnames{i} = 'API+NOQ2=0.10 APINO2Q2a+0.90 APINO2Q2b';
k(:,i) = 1.19E-12.*exp(490./T);
...
Rnames{i} = 'API+NQ3=0.10 APINO2Q2a+0.90 APINO2Q3b';
k(:,i) = 1.19E-12.*exp(490./T);
