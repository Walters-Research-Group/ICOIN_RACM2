...
'NO3'; 'O3'; 'O3P'; 'OH'; 'OLI'; 'OLIP'; 'OLND'; 'OLNN'; 'OLT'; 'ONIT';...
'OLTP'; 'OP1'; 'OP2'; 'ORA1'; 'ORA2'; 'ORAP'; 'O1D'; 'PAA'; 'PAN'; ...
...
'NQ2'; 'NQ3'; 'PANQ'; 'PANQ2'; 'Q1D'; 'Q3P'; 'QH'; ...
'OQ'; 'Q2'; 'H2Q2'; 'N2O4Q'; 'N2O3Q2'; 'N2O2Q3'; 'N2OQ4'; 'N2Q5'; 'OLNDQ'; 
'OLNDQ2'; 'OLNDQ3'; 'OLNNQ'; 'OLNNQ2'; 'OLNNQ3'; 'PPNQ'; 'PPNQ2';...
'wO3'; 'wNO'; 'wNQ'; 'wHNO3'; 'wHNO2Q'; 'wHNOQ2'; 'wHNQ3';  ...
'ONITT'; 'ONITTQ'; 'ONITTQ2'; 'ONITTQ3'; 'ONITS'; 'ONITSQ'; 'ONITSQ2'; 'ONITSQ3';...
'OLNNT'; 'OLNNTQ'; 'OLNNTQ2'; 'OLNNTQ3'; 'OLNNS'; 'OLNNSQ'; 'OLNNSQ2'; 'OLNNSQ3'; 'OLNDT'; 'OLNDTQ'; 'OLNDTQ2';...
'OLNDTQ3'; 'OLNDS'; 'OLNDSQ'; 'OLNDSQ2'; 'OLNDSQ3'; 'pONITT'; 'pONITTQ'; 'pONITTQ2'; 'pONITTQ3'; 'pONITS'; 'pONITSQ'; ...
'pONITSQ2'; 'pONITSQ3'; 'wONITT'; 'wONITTQ'; 'wONITTQ2'; 'wONITTQ3'; 'wONITS'; 'wONITSQ'; 'wONITSQ2'; 'wONITSQ3';...
'wpONITT'; 'wpONITTQ'; 'wpONITTQ2'; 'wpONITTQ3'; 'wpONITS'; 'wpONITSQ'; 'wpONITSQ2'; 'wpONITSQ3'; 'SHNO3';
};
...
i=i+1; %R031
Rnames{i} = 'ONITT=HO2+0.2ALD+NO2+0.8KET';
k(:,i) = JONIT;
Gstr{i,1} = 'ONIT'; 
fONITT(i)=fONITT(i)-1; fHO2(i)=fHO2(i)+1; fALD(i)=fALD(i)+0.2; fNO2(i)=fNO2(i)+1; fKET(i)=fKET(i)+0.8; 

%O3 Tracer
i=i+1; %R031a
Rnames{i} = 'ONITTQ=HO2+0.2ALD+NOQ+0.8KET+NO2';
k(:,i) = JONIT;
Gstr{i,1} = 'ONITTQ'; 
fONITTQ(i)=fONITTQ(i)-1; fHO2(i)=fHO2(i)+1; fALD(i)=fALD(i)+0.2; fNOQ(i)=fNOQ(i)+(2/3); fNO2(i)=fNO2(i)+(1/3); fKET(i)=fKET(i)+0.8;

%O3 Tracer
i=i+1; %R031b
Rnames{i} = 'ONITTQ2=HO2+0.2ALD+NQ2+0.8KET+NOQ';
k(:,i) = JONIT;
Gstr{i,1} = 'ONITTQ2'; 
fONITTQ2(i)=fONITTQ2(i)-1; fHO2(i)=fHO2(i)+1; fALD(i)=fALD(i)+0.2; fNQ2(i)=fNQ2(i)+(1/3); fNOQ(i)=fNOQ(i)+(2/3); fKET(i)=fKET(i)+0.8;

%O3 Tracer
i=i+1; %R031c
Rnames{i} = 'ONITTQ3=HOQ+0.2ALD+NQ2+0.8KET';
k(:,i) = JONIT;
Gstr{i,1} = 'ONITTQ3'; 
fONITTQ3(i)=fONITTQ3(i)-1; fHOQ(i)=fHOQ(i)+1; fALD(i)=fALD(i)+0.2; fNQ2(i)=fNQ2(i)+1; fKET(i)=fKET(i)+0.8;


i=i+1; %R031_other
Rnames{i} = 'ONITS=HO2+0.2ALD+NO2+0.8KET';
k(:,i) = JONIT;
Gstr{i,1} = 'ONITS'; 
fONITS(i)=fONITS(i)-1; fHO2(i)=fHO2(i)+1; fALD(i)=fALD(i)+0.2; fNO2(i)=fNO2(i)+1; fKET(i)=fKET(i)+0.8; 

%O3 Tracer
i=i+1; %R031_other_a
Rnames{i} = 'ONITSQ=HO2+0.2ALD+NOQ+0.8KET+NO2';
k(:,i) = JONIT;
Gstr{i,1} = 'ONITSQ'; 
fONITSQ(i)=fONITSQ(i)-1; fHO2(i)=fHO2(i)+1; fALD(i)=fALD(i)+0.2; fNOQ(i)=fNOQ(i)+(2/3); fNO2(i)=fNO2(i)+(1/3); fKET(i)=fKET(i)+0.8;

%O3 Tracer
i=i+1; %R031_other_b
Rnames{i} = 'ONITSQ2=HO2+0.2ALD+NQ2+0.8KET+NOQ';
k(:,i) = JONIT;
Gstr{i,1} = 'ONITSQ2'; 
fONITSQ2(i)=fONITSQ2(i)-1; fHO2(i)=fHO2(i)+1; fALD(i)=fALD(i)+0.2; fNQ2(i)=fNQ2(i)+(1/3); fNOQ(i)=fNOQ(i)+(2/3); fKET(i)=fKET(i)+0.8;

%O3 Tracer
i=i+1; %R031_other_c
Rnames{i} = 'ONITSQ3=HOQ+0.2ALD+NQ2+0.8KET';
k(:,i) = JONIT;
Gstr{i,1} = 'ONITSQ3'; 
fONITSQ3(i)=fONITSQ3(i)-1; fHOQ(i)=fHOQ(i)+1; fALD(i)=fALD(i)+0.2; fNQ2(i)=fNQ2(i)+1; fKET(i)=fKET(i)+0.8;
...
i=i+1; %R123
Rnames{i} = 'ONITT+OH=HC3P+NO2+H2O';
k(:,i) = 5.31E-12.*exp(-260./T);
Gstr{i,1} = 'ONITT'; Gstr{i,2} = 'OH'; 
fONITT(i)=fONITT(i)-1; fOH(i)=fOH(i)-1; fHC3P(i)=fHC3P(i)+1; fNO2(i)=fNO2(i)+1; 

%O3 Tracer
i=i+1; %R123a
Rnames{i} = 'ONITT+QH=HC3P+NO2+H2Q';
k(:,i) = 5.31E-12.*exp(-260./T);
Gstr{i,1} = 'ONITT'; Gstr{i,2} = 'QH'; 
fONITT(i)=fONITT(i)-1; fQH(i)=fQH(i)-1; fHC3P(i)=fHC3P(i)+1; fNO2(i)=fNO2(i)+1; 

%O3 Tracer
i=i+1; %R123b
Rnames{i} = 'ONITTQ+OH=HC3P+NOQ+H2O+NO2';
k(:,i) = 5.31E-12.*exp(-260./T);
Gstr{i,1} = 'ONITTQ'; Gstr{i,2} = 'OH'; 
fONITTQ(i)=fONITTQ(i)-1; fOH(i)=fOH(i)-1; fHC3P(i)=fHC3P(i)+1; fNOQ(i)=fNOQ(i)+(2/3); fNO2(i)=fNO2(i)+(1/3);

%O3 Tracer
i=i+1; %R123c
Rnames{i} = 'ONITTQ+QH=HC3P+NOQ+H2Q+NO2';
k(:,i) = 5.31E-12.*exp(-260./T);
Gstr{i,1} = 'ONITTQ'; Gstr{i,2} = 'QH'; fNOQ(i)=fNOQ(i)+(2/3); fNO2(i)=fNO2(i)+(1/3);fNOQ(i)=fNOQ(i)+1;

%O3 Tracer
i=i+1; %R123d
Rnames{i} = 'ONITTQ2+OH=HC3P+NQ2+H2O+NOQ';
k(:,i) = 5.31E-12.*exp(-260./T);
Gstr{i,1} = 'ONITTQ2'; Gstr{i,2} = 'OH'; 
fONITTQ2(i)=fONITTQ2(i)-1; fOH(i)=fOH(i)-1; fHC3P(i)=fHC3P(i)+1; fNQ2(i)=fNQ2(i)+(1/3); fNOQ(i)=fNOQ(i)+(2/3);

%O3 Tracer
i=i+1; %R123e
Rnames{i} = 'ONITTQ2+QH=HC3P+NQ2+H2Q+NOQ';
k(:,i) = 5.31E-12.*exp(-260./T);
Gstr{i,1} = 'ONITTQ2'; Gstr{i,2} = 'QH'; 
fONITTQ2(i)=fONITTQ2(i)-1; fQH(i)=fQH(i)-1; fHC3P(i)=fHC3P(i)+1; fNQ2(i)=fNQ2(i)+(1/3); fNOQ(i)=fNOQ(i)+(2/3);

%O3 Tracer
i=i+1; %R123f
Rnames{i} = 'ONITTQ3+OH=HC3P+NQ2+H2O';
k(:,i) = 5.31E-12.*exp(-260./T);
Gstr{i,1} = 'ONITTQ3'; Gstr{i,2} = 'OH'; 
fONITTQ3(i)=fONITTQ3(i)-1; fOH(i)=fOH(i)-1; fHC3P(i)=fHC3P(i)+1; fNQ2(i)=fNQ2(i)+1;

%O3 Tracer
i=i+1; %R123g
Rnames{i} = 'ONITTQ3+QH=HC3P+NQ2+H2Q';
k(:,i) = 5.31E-12.*exp(-260./T);
Gstr{i,1} = 'ONITTQ3'; Gstr{i,2} = 'QH'; 
fONITTQ3(i)=fONITTQ3(i)-1; fQH(i)=fQH(i)-1; fHC3P(i)=fHC3P(i)+1; fNQ2(i)=fNQ2(i)+1;


i=i+1; %R123_other
Rnames{i} = 'ONITS+OH=HC3P+NO2+H2O';
k(:,i) = 5.31E-12.*exp(-260./T);
Gstr{i,1} = 'ONITS'; Gstr{i,2} = 'OH'; 
fONITS(i)=fONITS(i)-1; fOH(i)=fOH(i)-1; fHC3P(i)=fHC3P(i)+1; fNO2(i)=fNO2(i)+1; 

%O3 Tracer
i=i+1; %R123_other_a
Rnames{i} = 'ONITS+QH=HC3P+NO2+H2Q';
k(:,i) = 5.31E-12.*exp(-260./T);
Gstr{i,1} = 'ONITS'; Gstr{i,2} = 'QH'; 
fONITS(i)=fONITS(i)-1; fQH(i)=fQH(i)-1; fHC3P(i)=fHC3P(i)+1; fNO2(i)=fNO2(i)+1; 

%O3 Tracer
i=i+1; %R123_other_b
Rnames{i} = 'ONITSQ+OH=HC3P+NOQ+H2O+NO2';
k(:,i) = 5.31E-12.*exp(-260./T);
Gstr{i,1} = 'ONITSQ'; Gstr{i,2} = 'OH'; 
fONITSQ(i)=fONITSQ(i)-1; fOH(i)=fOH(i)-1; fHC3P(i)=fHC3P(i)+1; fNOQ(i)=fNOQ(i)+(2/3); fNO2(i)=fNO2(i)+(1/3);

%O3 Tracer
i=i+1; %R123_other_c
Rnames{i} = 'ONITSQ+QH=HC3P+NOQ+H2Q+NO2';
k(:,i) = 5.31E-12.*exp(-260./T);
Gstr{i,1} = 'ONITSQ'; Gstr{i,2} = 'QH'; 
fONITSQ(i)=fONITSQ(i)-1; fQH(i)=fQH(i)-1; fHC3P(i)=fHC3P(i)+1; fNOQ(i)=fNOQ(i)+(2/3); fNO2(i)=fNO2(i)+(1/3);

%O3 Tracer
i=i+1; %R123_other_d
Rnames{i} = 'ONITSQ2+OH=HC3P+NQ2+H2O+NOQ';
k(:,i) = 5.31E-12.*exp(-260./T);
Gstr{i,1} = 'ONITSQ2'; Gstr{i,2} = 'OH'; 
fONITSQ2(i)=fONITSQ2(i)-1; fOH(i)=fOH(i)-1; fHC3P(i)=fHC3P(i)+1; fNQ2(i)=fNQ2(i)+(1/3); fNOQ(i)=fNOQ(i)+(2/3);

%O3 Tracer
i=i+1; %R123_other_e
Rnames{i} = 'ONITSQ2+QH=HC3P+NQ2+H2Q+NOQ';
k(:,i) = 5.31E-12.*exp(-260./T);
Gstr{i,1} = 'ONITSQ2'; Gstr{i,2} = 'QH'; 
fONITSQ2(i)=fONITSQ2(i)-1; fQH(i)=fQH(i)-1; fHC3P(i)=fHC3P(i)+1; fNQ2(i)=fNQ2(i)+(1/3); fNOQ(i)=fNOQ(i)+(2/3);

%O3 Tracer
i=i+1; %R123_other_f
Rnames{i} = 'ONITSQ3+OH=HC3P+NQ2+H2O';
k(:,i) = 5.31E-12.*exp(-260./T);
Gstr{i,1} = 'ONITSQ3'; Gstr{i,2} = 'OH'; 
fONITSQ3(i)=fONITSQ3(i)-1; fOH(i)=fOH(i)-1; fHC3P(i)=fHC3P(i)+1; fNQ2(i)=fNQ2(i)+1;

%O3 Tracer
i=i+1; %R123_other_g
Rnames{i} = 'ONITSQ3+QH=HC3P+NQ2+H2Q';
k(:,i) = 5.31E-12.*exp(-260./T);
Gstr{i,1} = 'ONITSQ3'; Gstr{i,2} = 'QH'; 
fONITSQ3(i)=fONITSQ3(i)-1; fQH(i)=fQH(i)-1; fHC3P(i)=fHC3P(i)+1; fNQ2(i)=fNQ2(i)+1;
...
i=i+1; %R146
Rnames{i} = 'API+NO3=0.035 OLNNT+ 0.065OLNNS+0.315OLNDT+0.585OLNDS';
k(:,i) = 1.19E-12.*exp(490./T);
Gstr{i,1} = 'API'; Gstr{i,2} = 'NO3'; 
fAPI(i)=fAPI(i)-1; fNO3(i)=fNO3(i)-1; fOLNNT(i)=fOLNNT(i)+0.035; fOLNNS(i)=fOLNNS(i)+0.065; fOLNDT(i)=fOLNDT(i)+0.315; fOLNDS(i)=fOLNDS(i)+0.585; 

%O3 Tracer
i=i+1; %R146a
Rnames{i} = 'API+NO2Q=0.035 OLNNTQ+ 0.065OLNNSQ+0.315OLNDTQ+0.585OLNDSQ';
k(:,i) = 1.19E-12.*exp(490./T);
Gstr{i,1} = 'API'; Gstr{i,2} = 'NO2Q'; 
fAPI(i)=fAPI(i)-1; fNO2Q(i)=fNO2Q(i)-1; fOLNNTQ(i)=fOLNNTQ(i)+0.035; fOLNNSQ(i)=fOLNNSQ(i)+0.065; fOLNDTQ(i)=fOLNDTQ(i)+0.315; fOLNDSQ(i)=fOLNDSQ(i)+0.585;

%O3 Tracer
i=i+1; %R146b
Rnames{i} = 'API+NOQ2=0.035 OLNNTQ2+ 0.065OLNNSQ2+0.315OLNDTQ2+0.585OLNDSQ2';
k(:,i) = 1.19E-12.*exp(490./T);
Gstr{i,1} = 'API'; Gstr{i,2} = 'NOQ2'; 
fAPI(i)=fAPI(i)-1; fNOQ2(i)=fNOQ2(i)-1; fOLNNTQ2(i)=fOLNNTQ2(i)+0.035; fOLNNSQ2(i)=fOLNNSQ2(i)+0.065; fOLNDTQ2(i)=fOLNDTQ2(i)+0.315; fOLNDSQ2(i)=fOLNDSQ2(i)+0.585;

%O3 Tracer
i=i+1; %R146c
Rnames{i} = 'API+NQ3=0.035 OLNNTQ3+ 0.065OLNNSQ3+0.315OLNDTQ3+0.585OLNDSQ3';
k(:,i) = 1.19E-12.*exp(490./T);
Gstr{i,1} = 'API'; Gstr{i,2} = 'NQ3'; 
fAPI(i)=fAPI(i)-1; fNQ3(i)=fNQ3(i)-1; fOLNNTQ3(i)=fOLNNTQ3(i)+0.035; fOLNNSQ3(i)=fOLNNSQ3(i)+0.065; fOLNDTQ3(i)=fOLNDTQ3(i)+0.315; fOLNDSQ3(i)=fOLNDSQ3(i)+0.585;
...
i=i+1; %R174
Rnames{i} = 'HC3P+NO=HO2+MO2+ETHP+XO2+NO2+ACD+ALD+ACT+MEK+ONITT';
k(:,i) = 4.00E-12;
...
fALD(i)=fALD(i)+0.132; fACT(i)=fACT(i)+0.165; fMEK(i)=fMEK(i)+0.042; fONITT(i)=fONITT(i)+0.065; %mmarvin 20151020

%O3 Tracer
i=i+1; %R174a
Rnames{i} = 'HC3P+NQ=HO2+MO2+ETHP+XO2+NOQ+ACD+ALD+ACT+MEK+ONITTQ';
k(:,i) = 4.00E-12;
...
fALD(i)=fALD(i)+0.132; fACT(i)=fACT(i)+0.165; fMEK(i)=fMEK(i)+0.042; fONITTQ(i)=fONITTQ(i)+0.065; %mmarvin 20151020
...
i=i+1; %R189
Rnames{i} = 'APIP+NO= HO2+NO2+HCHO+ALD+ACT+KET+ORA1+ONITT+ONITS';
k(:,i) = 4.00E-12;
...
fORA1(i)=fORA1(i)+0.07; fONITT(i)=fONITT(i)+0.12; fONITS(i)=fONITS(i)+0.06;

%O3 Tracer
i=i+1; %R189a
Rnames{i} = 'APIP+NQ= HO2+NOQ+HCHO+ALD+ACT+KET+ORA1+ONITTQ + ONITSQ';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'APIP'; Gstr{i,2} = 'NQ'; 
fAPIP(i)=fAPIP(i)-1; fNQ(i)=fNQ(i)-1; fHO2(i)=fHO2(i)+0.82; fNOQ(i)=fNOQ(i)+0.82; 
fHCHO(i)=fHCHO(i)+0.23; fALD(i)=fALD(i)+0.43; fACT(i)=fACT(i)+0.11; fKET(i)=fKET(i)+0.44; 
fORA1(i)=fORA1(i)+0.07; fONITTQ(i)=fONITTQ(i)+0.12; fONITSQ(i)=fONITSQ(i)+0.06; 
...
i=i+1;  %R205
Rnames{i} = 'OLNNT+NO=ONITT+NO2+HO2';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'OLNNT'; Gstr{i,2} = 'NO'; 
fOLNNT(i)=fOLNNT(i)-1; fNO(i)=fNO(i)-1; fONITT(i)=fONITT(i)+1; fNO2(i)=fNO2(i)+1; fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1;  %R205a
Rnames{i} = 'OLNNT+NQ=ONITT+NOQ+HO2';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'OLNNT'; Gstr{i,2} = 'NQ'; 
fOLNNT(i)=fOLNNT(i)-1; fNQ(i)=fNQ(i)-1; fONITT(i)=fONITT(i)+1; fNOQ(i)=fNOQ(i)+1; fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1;  %R205b
Rnames{i} = 'OLNNTQ+NO=ONITTQ+NO2+HO2';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'OLNNTQ'; Gstr{i,2} = 'NO'; 
fOLNNTQ(i)=fOLNNTQ(i)-1; fNO(i)=fNO(i)-1; fONITTQ(i)=fONITTQ(i)+1; fNO2(i)=fNO2(i)+1; fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1;  %R205c
Rnames{i} = 'OLNNTQ+NQ=ONITTQ+NOQ+HO2';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'OLNNTQ'; Gstr{i,2} = 'NQ'; 
fOLNNTQ(i)=fOLNNTQ(i)-1; fNQ(i)=fNQ(i)-1; fONITTQ(i)=fONITTQ(i)+1; fNOQ(i)=fNOQ(i)+1; fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1;  %R205d
Rnames{i} = 'OLNNTQ2+NO=ONITTQ2+NO2+HO2';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'OLNNTQ2'; Gstr{i,2} = 'NO'; 
fOLNNTQ2(i)=fOLNNTQ2(i)-1; fNO(i)=fNO(i)-1; fONITTQ2(i)=fONITTQ2(i)+1; fNO2(i)=fNO2(i)+1; fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1;  %R205e
Rnames{i} = 'OLNNTQ2+NQ=ONITTQ2+NOQ+HO2';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'OLNNTQ2'; Gstr{i,2} = 'NQ'; 
fOLNNTQ2(i)=fOLNNTQ2(i)-1; fNQ(i)=fNQ(i)-1; fONITTQ2(i)=fONITTQ2(i)+1; fNOQ(i)=fNOQ(i)+1; fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1;  %R205f
Rnames{i} = 'OLNNTQ3+NO=ONITTQ3+NO2+HO2';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'OLNNTQ3'; Gstr{i,2} = 'NO'; 
fOLNNTQ3(i)=fOLNNTQ3(i)-1; fNO(i)=fNO(i)-1; fONITTQ3(i)=fONITTQ3(i)+1; fNO2(i)=fNO2(i)+1; fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1;  %R205g
Rnames{i} = 'OLNNTQ3+NQ=ONITTQ3+NOQ+HO2';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'OLNNTQ3'; Gstr{i,2} = 'NQ'; 
fOLNNTQ3(i)=fOLNNTQ3(i)-1; fNQ(i)=fNQ(i)-1; fONITTQ3(i)=fONITTQ3(i)+1; fNOQ(i)=fNOQ(i)+1; fHO2(i)=fHO2(i)+1; 

i=i+1;  %R205_other
Rnames{i} = 'OLNNS+NO=ONITS+NO2+HO2';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'OLNNS'; Gstr{i,2} = 'NO'; 
fOLNNS(i)=fOLNNS(i)-1; fNO(i)=fNO(i)-1; fONITS(i)=fONITS(i)+1; fNO2(i)=fNO2(i)+1; fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1;  %R205_other_a
Rnames{i} = 'OLNNS+NQ=ONITS+NOQ+HO2';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'OLNNS'; Gstr{i,2} = 'NQ'; 
fOLNNS(i)=fOLNNS(i)-1; fNQ(i)=fNQ(i)-1; fONITS(i)=fONITS(i)+1; fNOQ(i)=fNOQ(i)+1; fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1;  %R205_other_b
Rnames{i} = 'OLNNSQ+NO=ONITSQ+NO2+HO2';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'OLNNSQ'; Gstr{i,2} = 'NO'; 
fOLNNSQ(i)=fOLNNSQ(i)-1; fNO(i)=fNO(i)-1; fONITSQ(i)=fONITSQ(i)+1; fNO2(i)=fNO2(i)+1; fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1;  %R205_other_c
Rnames{i} = 'OLNNSQ+NQ=ONITSQ+NOQ+HO2';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'OLNNSQ'; Gstr{i,2} = 'NQ'; 
fOLNNSQ(i)=fOLNNSQ(i)-1; fNQ(i)=fNQ(i)-1; fONITSQ(i)=fONITSQ(i)+1; fNOQ(i)=fNOQ(i)+1; fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1;  %R205_other_d
Rnames{i} = 'OLNNSQ2+NO=ONITSQ2+NO2+HO2';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'OLNNSQ2'; Gstr{i,2} = 'NO'; 
fOLNNSQ2(i)=fOLNNSQ2(i)-1; fNO(i)=fNO(i)-1; fONITSQ2(i)=fONITSQ2(i)+1; fNO2(i)=fNO2(i)+1; fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1;  %R205_other_e
Rnames{i} = 'OLNNSQ2+NQ=ONITSQ2+NOQ+HO2';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'OLNNSQ2'; Gstr{i,2} = 'NQ'; 
fOLNNSQ2(i)=fOLNNSQ2(i)-1; fNQ(i)=fNQ(i)-1; fONITSQ2(i)=fONITSQ2(i)+1; fNOQ(i)=fNOQ(i)+1; fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1;  %R205_other_f
Rnames{i} = 'OLNNSQ3+NO=ONITSQ3+NO2+HO2';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'OLNNSQ3'; Gstr{i,2} = 'NO'; 
fOLNNSQ3(i)=fOLNNSQ3(i)-1; fNO(i)=fNO(i)-1; fONITSQ3(i)=fONITSQ3(i)+1; fNO2(i)=fNO2(i)+1; fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1;  %R205_other_g
Rnames{i} = 'OLNNSQ3+NQ=ONITSQ3+NOQ+HO2';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'OLNNSQ3'; Gstr{i,2} = 'NQ'; 
fOLNNSQ3(i)=fOLNNSQ3(i)-1; fNQ(i)=fNQ(i)-1; fONITSQ3(i)=fONITSQ3(i)+1; fNOQ(i)=fNOQ(i)+1; fHO2(i)=fHO2(i)+1;


i=i+1;  %R206
Rnames{i} = 'OLNDT+NO=NO2+HCHO+ALD+KET';
k(:,i) = 4.00E-12;
...
%O3 Tracer
i=i+1;  %R206a
Rnames{i} = 'OLNDT+NQ=NOQ+HCHO+ALD+KET';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'OLNDT'; Gstr{i,2} = 'NQ'; 
fOLNDT(i)=fOLNDT(i)-1; fNQ(i)=fNQ(i)-1; fNOQ(i)=fNOQ(i)+2; fHCHO(i)=fHCHO(i)+0.287; fALD(i)=fALD(i)+1.24; fKET(i)=fKET(i)+0.464; 

%O3 Tracer
i=i+1;  %R206b
Rnames{i} = 'OLNDTQ+NO=NO2+HCHO+ALD+KET';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'OLNDTQ'; Gstr{i,2} = 'NO'; 
fOLNDTQ(i)=fOLNDTQ(i)-1; fNO(i)=fNO(i)-1; fNO2(i)=fNO2(i)+2; fHCHO(i)=fHCHO(i)+0.287; fALD(i)=fALD(i)+1.24; fKET(i)=fKET(i)+0.464; 

%O3 Tracer
i=i+1;  %R206c
Rnames{i} = 'OLNDTQ+NQ=NOQ+HCHO+ALD+KET';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'OLNDTQ'; Gstr{i,2} = 'NQ'; 
fOLNDTQ(i)=fOLNDTQ(i)-1; fNQ(i)=fNQ(i)-1; fNOQ(i)=fNOQ(i)+2; fHCHO(i)=fHCHO(i)+0.287; fALD(i)=fALD(i)+1.24; fKET(i)=fKET(i)+0.464; 

%O3 Tracer
i=i+1;  %R206d
Rnames{i} = 'OLNDTQ2+NO=NO2+HCHO+ALD+KET';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'OLNDTQ2'; Gstr{i,2} = 'NO'; 
fOLNDTQ2(i)=fOLNDTQ2(i)-1; fNO(i)=fNO(i)-1; fNO2(i)=fNO2(i)+2; fHCHO(i)=fHCHO(i)+0.287; fALD(i)=fALD(i)+1.24; fKET(i)=fKET(i)+0.464; 

%O3 Tracer
i=i+1;  %R206e
Rnames{i} = 'OLNDTQ2+NQ=NOQ+HCHO+ALD+KET';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'OLNDTQ2'; Gstr{i,2} = 'NQ'; 
fOLNDTQ2(i)=fOLNDTQ2(i)-1; fNQ(i)=fNQ(i)-1; fNOQ(i)=fNOQ(i)+2; fHCHO(i)=fHCHO(i)+0.287; fALD(i)=fALD(i)+1.24; fKET(i)=fKET(i)+0.464; 

%O3 Tracer
i=i+1;  %R206f
Rnames{i} = 'OLNDTQ3+NO=NO2+HCHO+ALD+KET';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'OLNDTQ3'; Gstr{i,2} = 'NO'; 
fOLNDTQ3(i)=fOLNDTQ3(i)-1; fNO(i)=fNO(i)-1; fNO2(i)=fNO2(i)+2; fHCHO(i)=fHCHO(i)+0.287; fALD(i)=fALD(i)+1.24; fKET(i)=fKET(i)+0.464;

i=i+1;  %R206_other
Rnames{i} = 'OLNDS+NO=NO2+HCHO+ALD+KET';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'OLND'; Gstr{i,2} = 'NO'; 
fOLND(i)=fOLND(i)-1; fNO(i)=fNO(i)-1; fNO2(i)=fNO2(i)+2; fHCHO(i)=fHCHO(i)+0.287; fALD(i)=fALD(i)+1.24; fKET(i)=fKET(i)+0.464; 
...
%O3 Tracer
i=i+1;  %R206_other_a
Rnames{i} = 'OLNDS+NQ=NOQ+HCHO+ALD+KET';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'OLNDS'; Gstr{i,2} = 'NQ'; 
fOLNDS(i)=fOLNDS(i)-1; fNQ(i)=fNQ(i)-1; fNOQ(i)=fNOQ(i)+2; fHCHO(i)=fHCHO(i)+0.287; fALD(i)=fALD(i)+1.24; fKET(i)=fKET(i)+0.464; 

%O3 Tracer
i=i+1;  %R206_other_b
Rnames{i} = 'OLNDSQ+NO=NO2+HCHO+ALD+KET';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'OLNDSQ'; Gstr{i,2} = 'NO'; 
fOLNDSQ(i)=fOLNDSQ(i)-1; fNO(i)=fNO(i)-1; fNO2(i)=fNO2(i)+2; fHCHO(i)=fHCHO(i)+0.287; fALD(i)=fALD(i)+1.24; fKET(i)=fKET(i)+0.464; 

%O3 Tracer
i=i+1;  %R206_other_c
Rnames{i} = 'OLNDSQ+NQ=NOQ+HCHO+ALD+KET';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'OLNDSQ'; Gstr{i,2} = 'NQ'; 
fOLNDSQ(i)=fOLNDSQ(i)-1; fNQ(i)=fNQ(i)-1; fNOQ(i)=fNOQ(i)+2; fHCHO(i)=fHCHO(i)+0.287; fALD(i)=fALD(i)+1.24; fKET(i)=fKET(i)+0.464; 

%O3 Tracer
i=i+1;  %R206_other_d
Rnames{i} = 'OLNDSQ2+NO=NO2+HCHO+ALD+KET';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'OLNDSQ2'; Gstr{i,2} = 'NO'; 
fOLNDSQ2(i)=fOLNDSQ2(i)-1; fNO(i)=fNO(i)-1; fNO2(i)=fNO2(i)+2; fHCHO(i)=fHCHO(i)+0.287; fALD(i)=fALD(i)+1.24; fKET(i)=fKET(i)+0.464; 

%O3 Tracer
i=i+1;  %R206_other_e
Rnames{i} = 'OLNDSQ2+NQ=NOQ+HCHO+ALD+KET';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'OLNDSQ2'; Gstr{i,2} = 'NQ'; 
fOLNDSQ2(i)=fOLNDSQ2(i)-1; fNQ(i)=fNQ(i)-1; fNOQ(i)=fNOQ(i)+2; fHCHO(i)=fHCHO(i)+0.287; fALD(i)=fALD(i)+1.24; fKET(i)=fKET(i)+0.464; 

%O3 Tracer
i=i+1;  %R206_other_f
Rnames{i} = 'OLNDSQ3+NO=NO2+HCHO+ALD+KET';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'OLNDSQ3'; Gstr{i,2} = 'NO'; 
fOLNDSQ3(i)=fOLNDSQ3(i)-1; fNO(i)=fNO(i)-1; fNO2(i)=fNO2(i)+2; fHCHO(i)=fHCHO(i)+0.287; fALD(i)=fALD(i)+1.24; fKET(i)=fKET(i)+0.464;
...
i=i+1; %R244
Rnames{i} = 'OLNNT+HO2=ONITT';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'OLNNT'; Gstr{i,2} = 'HO2'; 
fOLNNT(i)=fOLNNT(i)-1; fHO2(i)=fHO2(i)-1; fONITT(i)=fONITT(i)+1; 

%O3 Tracer
i=i+1; %R244a
Rnames{i} = 'OLNNT+HOQ=ONITT';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'OLNNT'; Gstr{i,2} = 'HOQ'; 
fOLNNT(i)=fOLNNT(i)-1; fHOQ(i)=fHOQ(i)-1; fONITT(i)=fONITT(i)+1; 

%O3 Tracer
i=i+1; %R244b
Rnames{i} = 'OLNNT+HQ2=ONITT';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'OLNNT'; Gstr{i,2} = 'HQ2'; 
fOLNNT(i)=fOLNNT(i)-1; fHQ2(i)=fHQ2(i)-1; fONITT(i)=fONITT(i)+1; 

%O3 Tracer
i=i+1; %R244c
Rnames{i} = 'OLNNTQ+HO2=ONITTQ';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'OLNNTQ'; Gstr{i,2} = 'HO2'; 
fOLNNTQ(i)=fOLNNTQ(i)-1; fHO2(i)=fHO2(i)-1; fONITTQ(i)=fONITTQ(i)+1; 

%O3 Tracer
i=i+1; %R244d
Rnames{i} = 'OLNNTQ+HOQ=ONITTQ';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'OLNNTQ'; Gstr{i,2} = 'HOQ'; 
fOLNNTQ(i)=fOLNNTQ(i)-1; fHOQ(i)=fHOQ(i)-1; fONITTQ(i)=fONITTQ(i)+1; 

%O3 Tracer
i=i+1; %R244e
Rnames{i} = 'OLNNTQ+HQ2=ONITTQ';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'OLNNTQ'; Gstr{i,2} = 'HQ2'; 
fOLNNTQ(i)=fOLNNTQ(i)-1; fHQ2(i)=fHQ2(i)-1; fONITTQ(i)=fONITTQ(i)+1;

%O3 Tracer
i=i+1; %R244f
Rnames{i} = 'OLNNTQ2+HO2=ONITTQ2';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'OLNNTQ2'; Gstr{i,2} = 'HO2'; 
fOLNNTQ2(i)=fOLNNTQ2(i)-1; fHO2(i)=fHO2(i)-1; fONITTQ2(i)=fONITTQ2(i)+1;

%O3 Tracer
i=i+1; %R244g
Rnames{i} = 'OLNNTQ2+HOQ=ONITTQ2';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'OLNNTQ2'; Gstr{i,2} = 'HOQ'; 
fOLNNTQ2(i)=fOLNNTQ2(i)-1; fHOQ(i)=fHOQ(i)-1; fONITTQ2(i)=fONITTQ2(i)+1;

%O3 Tracer
i=i+1; %R244h
Rnames{i} = 'OLNNTQ2+HQ2=ONITTQ2';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'OLNNTQ2'; Gstr{i,2} = 'HQ2'; 
fOLNNTQ2(i)=fOLNNTQ2(i)-1; fHQ2(i)=fHQ2(i)-1; fONITTQ2(i)=fONITTQ2(i)+1;

%O3 Tracer
i=i+1; %R244i
Rnames{i} = 'OLNNTQ3+HO2=ONITTQ3';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'OLNNTQ3'; Gstr{i,2} = 'HO2'; 
fOLNNTQ3(i)=fOLNNTQ3(i)-1; fHO2(i)=fHO2(i)-1; fONITTQ3(i)=fONITTQ3(i)+1;

%O3 Tracer
i=i+1; %R244j
Rnames{i} = 'OLNNTQ3+HOQ=ONITTQ3';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'OLNNTQ3'; Gstr{i,2} = 'HOQ'; 
fOLNNTQ3(i)=fOLNNTQ3(i)-1; fHOQ(i)=fHOQ(i)-1; fONITTQ3(i)=fONITTQ3(i)+1;

%O3 Tracer
i=i+1; %R244k
Rnames{i} = 'OLNNTQ3+HQ2=ONITTQ3';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'OLNNTQ3'; Gstr{i,2} = 'HQ2'; 
fOLNNTQ3(i)=fOLNNTQ3(i)-1; fHQ2(i)=fHQ2(i)-1; fONITTQ3(i)=fONITTQ3(i)+1;

i=i+1; %R244_other
Rnames{i} = 'OLNNS+HO2=ONITS';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'OLNNS'; Gstr{i,2} = 'HO2'; 
fOLNNS(i)=fOLNNS(i)-1; fHO2(i)=fHO2(i)-1; fONITS(i)=fONITS(i)+1; 

%O3 Tracer
i=i+1; %R244_other_a
Rnames{i} = 'OLNNS+HOQ=ONITS';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'OLNNS'; Gstr{i,2} = 'HOQ'; 
fOLNNS(i)=fOLNNS(i)-1; fHOQ(i)=fHOQ(i)-1; fONITS(i)=fONITS(i)+1; 

%O3 Tracer
i=i+1; %R244_other_b
Rnames{i} = 'OLNNS+HQ2=ONITS';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'OLNNS'; Gstr{i,2} = 'HQ2'; 
fOLNNS(i)=fOLNNS(i)-1; fHQ2(i)=fHQ2(i)-1; fONITS(i)=fONITS(i)+1; 

%O3 Tracer
i=i+1; %R244_other_c
Rnames{i} = 'OLNNSQ+HO2=ONITSQ';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'OLNNSQ'; Gstr{i,2} = 'HO2'; 
fOLNNSQ(i)=fOLNNSQ(i)-1; fHO2(i)=fHO2(i)-1; fONITSQ(i)=fONITSQ(i)+1; 

%O3 Tracer
i=i+1; %R244_other_d
Rnames{i} = 'OLNNSQ+HOQ=ONITSQ';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'OLNNSQ'; Gstr{i,2} = 'HOQ'; 
fOLNNSQ(i)=fOLNNSQ(i)-1; fHOQ(i)=fHOQ(i)-1; fONITSQ(i)=fONITSQ(i)+1; 

%O3 Tracer
i=i+1; %R244_other_e
Rnames{i} = 'OLNNSQ+HQ2=ONITSQ';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'OLNNSQ'; Gstr{i,2} = 'HQ2'; 
fOLNNSQ(i)=fOLNNSQ(i)-1; fHQ2(i)=fHQ2(i)-1; fONITSQ(i)=fONITSQ(i)+1;

%O3 Tracer
i=i+1; %R244_other_f
Rnames{i} = 'OLNNSQ2+HO2=ONITSQ2';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'OLNNSQ2'; Gstr{i,2} = 'HO2'; 
fOLNNSQ2(i)=fOLNNSQ2(i)-1; fHO2(i)=fHO2(i)-1; fONITSQ2(i)=fONITSQ2(i)+1;

%O3 Tracer
i=i+1; %R244_other_g
Rnames{i} = 'OLNNSQ2+HOQ=ONITSQ2';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'OLNNSQ2'; Gstr{i,2} = 'HOQ'; 
fOLNNSQ2(i)=fOLNNSQ2(i)-1; fHOQ(i)=fHOQ(i)-1; fONITSQ2(i)=fONITSQ2(i)+1;

%O3 Tracer
i=i+1; %R244_other_h
Rnames{i} = 'OLNNSQ2+HQ2=ONITSQ2';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'OLNNSQ2'; Gstr{i,2} = 'HQ2'; 
fOLNNSQ2(i)=fOLNNSQ2(i)-1; fHQ2(i)=fHQ2(i)-1; fONITSQ2(i)=fONITSQ2(i)+1;

%O3 Tracer
i=i+1; %R244_other_i
Rnames{i} = 'OLNNSQ3+HO2=ONITSQ3';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'OLNNSQ3'; Gstr{i,2} = 'HO2'; 
fOLNNSQ3(i)=fOLNNSQ3(i)-1; fHO2(i)=fHO2(i)-1; fONITSQ3(i)=fONITSQ3(i)+1;

%O3 Tracer
i=i+1; %R244_other_j
Rnames{i} = 'OLNNSQ3+HOQ=ONITSQ3';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'OLNNSQ3'; Gstr{i,2} = 'HOQ'; 
fOLNNSQ3(i)=fOLNNSQ3(i)-1; fHOQ(i)=fHOQ(i)-1; fONITSQ3(i)=fONITSQ3(i)+1;

%O3 Tracer
i=i+1; %R244_other_k
Rnames{i} = 'OLNNSQ3+HQ2=ONITSQ3';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'OLNNSQ3'; Gstr{i,2} = 'HQ2'; 
fOLNNSQ3(i)=fOLNNSQ3(i)-1; fHQ2(i)=fHQ2(i)-1; fONITSQ3(i)=fONITSQ3(i)+1;


i=i+1; %R245
Rnames{i} = 'OLNDT+HO2=ONITT';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'OLNDT'; Gstr{i,2} = 'HO2'; 
fOLNDT(i)=fOLNDT(i)-1; fHO2(i)=fHO2(i)-1; fONITT(i)=fONITT(i)+1; 

%O3 Tracer
i=i+1; %R245a
Rnames{i} = 'OLNDT+HOQ=ONITT';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'OLNDT'; Gstr{i,2} = 'HOQ'; 
fOLNDT(i)=fOLNDT(i)-1; fHOQ(i)=fHOQ(i)-1; fONITT(i)=fONITT(i)+1; 

%O3 Tracer
i=i+1; %R245b
Rnames{i} = 'OLNDT+HQ2=ONITT';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'OLNDT'; Gstr{i,2} = 'HQ2'; 
fOLNDT(i)=fOLNDT(i)-1; fHQ2(i)=fHQ2(i)-1; fONITT(i)=fONITT(i)+1; 

%O3 Tracer
i=i+1; %R245b
Rnames{i} = 'OLNDTQ+HO2=ONITTQ';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'OLNDTQ'; Gstr{i,2} = 'HO2'; 
fOLNDTQ(i)=fOLNDTQ(i)-1; fHO2(i)=fHO2(i)-1; fONITTQ(i)=fONITTQ(i)+1; 

%O3 Tracer
i=i+1; %R245c
Rnames{i} = 'OLNDTQ+HOQ=ONITTQ';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'OLNDTQ'; Gstr{i,2} = 'HOQ'; 
fOLNDTQ(i)=fOLNDTQ(i)-1; fHOQ(i)=fHOQ(i)-1; fONITTQ(i)=fONITTQ(i)+1;

%O3 Tracer
i=i+1; %R245d
Rnames{i} = 'OLNDTQ+HQ2=ONITTQ';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'OLNDTQ'; Gstr{i,2} = 'HQ2'; 
fOLNDTQ(i)=fOLNDTQ(i)-1; fHQ2(i)=fHQ2(i)-1; fONITTQ(i)=fONITTQ(i)+1;

%O3 Tracer
i=i+1; %R245e
Rnames{i} = 'OLNDTQ2+HO2=ONITTQ2';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'OLNDTQ2'; Gstr{i,2} = 'HO2'; 
fOLNDTQ2(i)=fOLNDTQ2(i)-1; fHO2(i)=fHO2(i)-1; fONITTQ2(i)=fONITTQ2(i)+1;

%O3 Tracer
i=i+1; %R245f
Rnames{i} = 'OLNDTQ2+HOQ=ONITTQ2';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'OLNDTQ2'; Gstr{i,2} = 'HOQ'; 
fOLNDTQ2(i)=fOLNDTQ2(i)-1; fHOQ(i)=fHOQ(i)-1; fONITTQ2(i)=fONITTQ2(i)+1;

%O3 Tracer
i=i+1; %R245g
Rnames{i} = 'OLNDTQ2+HQ2=ONITTQ2';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'OLNDTQ2'; Gstr{i,2} = 'HQ2'; 
fOLNDTQ2(i)=fOLNDTQ2(i)-1; fHQ2(i)=fHQ2(i)-1; fONITTQ2(i)=fONITTQ2(i)+1;

%O3 Tracer
i=i+1; %R245h
Rnames{i} = 'OLNDTQ3+HO2=ONITTQ3';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'OLNDTQ3'; Gstr{i,2} = 'HO2'; 
fOLNDTQ3(i)=fOLNDTQ3(i)-1; fHO2(i)=fHO2(i)-1; fONITTQ3(i)=fONITTQ3(i)+1;

%O3 Tracer
i=i+1; %R245i
Rnames{i} = 'OLNDTQ3+HOQ=ONITTQ3';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'OLNDTQ3'; Gstr{i,2} = 'HOQ'; 
fOLNDTQ3(i)=fOLNDTQ3(i)-1; fHOQ(i)=fHOQ(i)-1; fONITTQ3(i)=fONITTQ3(i)+1;

%O3 Tracer
i=i+1; %R245j
Rnames{i} = 'OLNDTQ3+HQ2=ONITTQ3';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'OLNDTQ3'; Gstr{i,2} = 'HQ2'; 
fOLNDTQ3(i)=fOLNDTQ3(i)-1; fHQ2(i)=fHQ2(i)-1; fONITTQ3(i)=fONITTQ3(i)+1;


i=i+1; %R245_other
Rnames{i} = 'OLNDS+HO2=ONITS';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'OLNDS'; Gstr{i,2} = 'HO2'; 
fOLNDS(i)=fOLNDS(i)-1; fHO2(i)=fHO2(i)-1; fONITS(i)=fONITS(i)+1; 

%O3 Tracer
i=i+1; %R245_other_a
Rnames{i} = 'OLNDS+HOQ=ONITS';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'OLNDS'; Gstr{i,2} = 'HOQ'; 
fOLNDS(i)=fOLNDS(i)-1; fHOQ(i)=fHOQ(i)-1; fONITS(i)=fONITS(i)+1; 

%O3 Tracer
i=i+1; %R245_other_b
Rnames{i} = 'OLNDS+HQ2=ONITS';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'OLNDS'; Gstr{i,2} = 'HQ2'; 
fOLNDS(i)=fOLNDS(i)-1; fHQ2(i)=fHQ2(i)-1; fONITS(i)=fONITS(i)+1; 

%O3 Tracer
i=i+1; %R245_other_b
Rnames{i} = 'OLNDSQ+HO2=ONITSQ';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'OLNDSQ'; Gstr{i,2} = 'HO2'; 
fOLNDSQ(i)=fOLNDSQ(i)-1; fHO2(i)=fHO2(i)-1; fONITSQ(i)=fONITSQ(i)+1; 

%O3 Tracer
i=i+1; %R245_other_c
Rnames{i} = 'OLNDSQ+HOQ=ONITSQ';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'OLNDSQ'; Gstr{i,2} = 'HOQ'; 
fOLNDSQ(i)=fOLNDSQ(i)-1; fHOQ(i)=fHOQ(i)-1; fONITSQ(i)=fONITSQ(i)+1;

%O3 Tracer
i=i+1; %R245_other_d
Rnames{i} = 'OLNDSQ+HQ2=ONITSQ';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'OLNDSQ'; Gstr{i,2} = 'HQ2'; 
fOLNDSQ(i)=fOLNDSQ(i)-1; fHQ2(i)=fHQ2(i)-1; fONITSQ(i)=fONITSQ(i)+1;

%O3 Tracer
i=i+1; %R245_other_e
Rnames{i} = 'OLNDSQ2+HO2=ONITSQ2';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'OLNDSQ2'; Gstr{i,2} = 'HO2'; 
fOLNDSQ2(i)=fOLNDSQ2(i)-1; fHO2(i)=fHO2(i)-1; fONITSQ2(i)=fONITSQ2(i)+1;

%O3 Tracer
i=i+1; %R245_other_f
Rnames{i} = 'OLNDSQ2+HOQ=ONITSQ2';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'OLNDSQ2'; Gstr{i,2} = 'HOQ'; 
fOLNDSQ2(i)=fOLNDSQ2(i)-1; fHOQ(i)=fHOQ(i)-1; fONITSQ2(i)=fONITSQ2(i)+1;

%O3 Tracer
i=i+1; %R245_other_g
Rnames{i} = 'OLNDSQ2+HQ2=ONITSQ2';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'OLNDSQ2'; Gstr{i,2} = 'HQ2'; 
fOLNDSQ2(i)=fOLNDSQ2(i)-1; fHQ2(i)=fHQ2(i)-1; fONITSQ2(i)=fONITSQ2(i)+1;

%O3 Tracer
i=i+1; %R245_other_h
Rnames{i} = 'OLNDSQ3+HO2=ONITSQ3';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'OLNDSQ3'; Gstr{i,2} = 'HO2'; 
fOLNDSQ3(i)=fOLNDSQ3(i)-1; fHO2(i)=fHO2(i)-1; fONITSQ3(i)=fONITSQ3(i)+1;

%O3 Tracer
i=i+1; %R245_other_i
Rnames{i} = 'OLNDSQ3+HOQ=ONITSQ3';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'OLNDSQ3'; Gstr{i,2} = 'HOQ'; 
fOLNDSQ3(i)=fOLNDSQ3(i)-1; fHOQ(i)=fHOQ(i)-1; fONITSQ3(i)=fONITSQ3(i)+1;

%O3 Tracer
i=i+1; %R245_other_j
Rnames{i} = 'OLNDSQ3+HQ2=ONITSQ3';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'OLNDSQ3'; Gstr{i,2} = 'HQ2'; 
fOLNDSQ3(i)=fOLNDSQ3(i)-1; fHQ2(i)=fHQ2(i)-1; fONITSQ3(i)=fONITSQ3(i)+1;
...
i=i+1; %R281
Rnames{i} = 'OLNNT+MO2=HCHO+HO2+HO2+ONITT';
k(:,i) = 1.60E-13.*exp(708./T);
Gstr{i,1} = 'OLNNT'; Gstr{i,2} = 'MO2'; 
fOLNNT(i)=fOLNNT(i)-1; fMO2(i)=fMO2(i)-1; fHCHO(i)=fHCHO(i)+1; fHO2(i)=fHO2(i)+1; fHO2(i)=fHO2(i)+1; fONITT(i)=fONITT(i)+1; 

%O3 Tracer
i=i+1; %R281a
Rnames{i} = 'OLNNTQ+MO2=HCHO+HO2+HO2+ONITTQ';
k(:,i) = 1.60E-13.*exp(708./T);
Gstr{i,1} = 'OLNNTQ'; Gstr{i,2} = 'MO2'; 
fOLNNTQ(i)=fOLNNTQ(i)-1; fMO2(i)=fMO2(i)-1; fHCHO(i)=fHCHO(i)+1; fHO2(i)=fHO2(i)+1; fHO2(i)=fHO2(i)+1; fONITTQ(i)=fONITTQ(i)+1;

%O3 Tracer
i=i+1; %R281b
Rnames{i} = 'OLNNTQ2+MO2=HCHO+HO2+HO2+ONITTQ2';
k(:,i) = 1.60E-13.*exp(708./T);
Gstr{i,1} = 'OLNNTQ2'; Gstr{i,2} = 'MO2'; 
fOLNNTQ2(i)=fOLNNTQ2(i)-1; fMO2(i)=fMO2(i)-1; fHCHO(i)=fHCHO(i)+1; fHO2(i)=fHO2(i)+1; fHO2(i)=fHO2(i)+1; fONITTQ2(i)=fONITTQ2(i)+1;

%O3 Tracer
i=i+1; %R281c
Rnames{i} = 'OLNNTQ3+MO2=HCHO+HO2+HO2+ONITTQ3';
k(:,i) = 1.60E-13.*exp(708./T);
Gstr{i,1} = 'OLNNTQ3'; Gstr{i,2} = 'MO2'; 
fOLNNTQ3(i)=fOLNNTQ3(i)-1; fMO2(i)=fMO2(i)-1; fHCHO(i)=fHCHO(i)+1; fHO2(i)=fHO2(i)+1; fHO2(i)=fHO2(i)+1; fONITTQ3(i)=fONITTQ3(i)+1;

i=i+1; %R281_other
Rnames{i} = 'OLNNS+MO2=HCHO+HO2+HO2+ONITS';
k(:,i) = 1.60E-13.*exp(708./T);
Gstr{i,1} = 'OLNNS'; Gstr{i,2} = 'MO2'; 
fOLNNS(i)=fOLNNS(i)-1; fMO2(i)=fMO2(i)-1; fHCHO(i)=fHCHO(i)+1; fHO2(i)=fHO2(i)+1; fHO2(i)=fHO2(i)+1; fONITS(i)=fONITS(i)+1; 

%O3 Tracer
i=i+1; %R281_other_a
Rnames{i} = 'OLNNSQ+MO2=HCHO+HO2+HO2+ONITSQ';
k(:,i) = 1.60E-13.*exp(708./T);
Gstr{i,1} = 'OLNNSQ'; Gstr{i,2} = 'MO2'; 
fOLNNSQ(i)=fOLNNSQ(i)-1; fMO2(i)=fMO2(i)-1; fHCHO(i)=fHCHO(i)+1; fHO2(i)=fHO2(i)+1; fHO2(i)=fHO2(i)+1; fONITSQ(i)=fONITSQ(i)+1;

%O3 Tracer
i=i+1; %R281_other_b
Rnames{i} = 'OLNNSQ2+MO2=HCHO+HO2+HO2+ONITSQ2';
k(:,i) = 1.60E-13.*exp(708./T);
Gstr{i,1} = 'OLNNSQ2'; Gstr{i,2} = 'MO2'; 
fOLNNSQ2(i)=fOLNNSQ2(i)-1; fMO2(i)=fMO2(i)-1; fHCHO(i)=fHCHO(i)+1; fHO2(i)=fHO2(i)+1; fHO2(i)=fHO2(i)+1; fONITSQ2(i)=fONITSQ2(i)+1;

%O3 Tracer
i=i+1; %R281_other_c
Rnames{i} = 'OLNNSQ3+MO2=HCHO+HO2+HO2+ONITSQ3';
k(:,i) = 1.60E-13.*exp(708./T);
Gstr{i,1} = 'OLNNSQ3'; Gstr{i,2} = 'MO2'; 
fOLNNSQ3(i)=fOLNNSQ3(i)-1; fMO2(i)=fMO2(i)-1; fHCHO(i)=fHCHO(i)+1; fHO2(i)=fHO2(i)+1; fHO2(i)=fHO2(i)+1; fONITSQ3(i)=fONITSQ3(i)+1;


i=i+1; %R282
Rnames{i} = 'OLNDT+MO2= HO2+NO2+HCHO+ALD+KET+MOH+ROH+ONITT';
k(:,i) = 9.68E-14.*exp(708./T);
Gstr{i,1} = 'OLNDT'; Gstr{i,2} = 'MO2'; 
fOLNDT(i)=fOLNDT(i)-1; fMO2(i)=fMO2(i)-1; fHO2(i)=fHO2(i)+0.50; fNO2(i)=fNO2(i)+0.50; 
fHCHO(i)=fHCHO(i)+0.965; fALD(i)=fALD(i)+0.93; fKET(i)=fKET(i)+0.348; fMOH(i)=fMOH(i)+0.25; 
fROH(i)=fROH(i)+0.25; fONITT(i)=fONITT(i)+0.5; 

%O3 Tracer
i=i+1; %R282a
Rnames{i} = 'OLNDTQ+MO2= HO2+NOQ+NO2+HCHO+ALD+KET+MOH+ROH+ONITTQ';
k(:,i) = 9.68E-14.*exp(708./T);
Gstr{i,1} = 'OLNDTQ'; Gstr{i,2} = 'MO2'; 
fOLNDT(i)=fOLNDT(i)-1; fMO2(i)=fMO2(i)-1; fHO2(i)=fHO2(i)+0.50; fNO2(i)=fNO2(i)+(1/6); fNOQ(i)=fNOQ(i)+(1/3); 
fHCHO(i)=fHCHO(i)+0.965; fALD(i)=fALD(i)+0.93; fKET(i)=fKET(i)+0.348; fMOH(i)=fMOH(i)+0.25; 
fROH(i)=fROH(i)+0.25; fONITTQ(i)=fONITTQ(i)+0.5; 

%O3 Tracer
i=i+1; %R282b
Rnames{i} = 'OLNDTQ2+MO2= HO2+NOQ+NQ2+HCHO+ALD+KET+MOH+ROH+ONITTQ2';
k(:,i) = 9.68E-14.*exp(708./T);
Gstr{i,1} = 'OLNDTQ'; Gstr{i,2} = 'MO2'; 
fOLNDT(i)=fOLNDT(i)-1; fMO2(i)=fMO2(i)-1; fHO2(i)=fHO2(i)+0.50; fNQ2(i)=fNQ2(i)+(1/6); fNOQ(i)=fNOQ(i)+(1/3); 
fHCHO(i)=fHCHO(i)+0.965; fALD(i)=fALD(i)+0.93; fKET(i)=fKET(i)+0.348; fMOH(i)=fMOH(i)+0.25; 
fROH(i)=fROH(i)+0.25; fONITTQ2(i)=fONITTQ2(i)+0.5; 


%O3 Tracer
i=i+1; %R282c
Rnames{i} = 'OLNDTQ3+MO2= HO2+NQ2+HCHO+ALD+KET+MOH+ROH+ONITTQ3';
k(:,i) = 9.68E-14.*exp(708./T);
Gstr{i,1} = 'OLNDTQ'; Gstr{i,2} = 'MO2'; 
fOLNDT(i)=fOLNDT(i)-1; fMO2(i)=fMO2(i)-1; fHO2(i)=fHO2(i)+0.50; fNQ2(i)=fNQ2(i)+0.5; 
fHCHO(i)=fHCHO(i)+0.965; fALD(i)=fALD(i)+0.93; fKET(i)=fKET(i)+0.348; fMOH(i)=fMOH(i)+0.25; 
fROH(i)=fROH(i)+0.25; fONITTQ3(i)=fONITTQ3(i)+0.5;


i=i+1; %R282_other
Rnames{i} = 'OLNDS+MO2= HO2+NO2+HCHO+ALD+KET+MOH+ROH+ONITS';
k(:,i) = 9.68E-14.*exp(708./T);
Gstr{i,1} = 'OLNDS'; Gstr{i,2} = 'MO2'; 
fOLNDS(i)=fOLNDS(i)-1; fMO2(i)=fMO2(i)-1; fHO2(i)=fHO2(i)+0.50; fNO2(i)=fNO2(i)+0.50; 
fHCHO(i)=fHCHO(i)+0.965; fALD(i)=fALD(i)+0.93; fKET(i)=fKET(i)+0.348; fMOH(i)=fMOH(i)+0.25; 
fROH(i)=fROH(i)+0.25; fONITS(i)=fONITS(i)+0.5; 

%O3 Tracer
i=i+1; %R282_other_a
Rnames{i} = 'OLNDSQ+MO2= HO2+NOQ+NO2+HCHO+ALD+KET+MOH+ROH+ONITSQ';
k(:,i) = 9.68E-14.*exp(708./T);
Gstr{i,1} = 'OLNDSQ'; Gstr{i,2} = 'MO2'; 
fOLNDS(i)=fOLNDS(i)-1; fMO2(i)=fMO2(i)-1; fHO2(i)=fHO2(i)+0.50; fNO2(i)=fNO2(i)+(1/6); fNOQ(i)=fNOQ(i)+(1/3); 
fHCHO(i)=fHCHO(i)+0.965; fALD(i)=fALD(i)+0.93; fKET(i)=fKET(i)+0.348; fMOH(i)=fMOH(i)+0.25; 
fROH(i)=fROH(i)+0.25; fONITSQ(i)=fONITSQ(i)+0.5; 

%O3 Tracer
i=i+1; %R282_other_b
Rnames{i} = 'OLNDSQ2+MO2= HO2+NOQ+NQ2+HCHO+ALD+KET+MOH+ROH+ONITSQ2';
k(:,i) = 9.68E-14.*exp(708./T);
Gstr{i,1} = 'OLNDSQ'; Gstr{i,2} = 'MO2'; 
fOLNDS(i)=fOLNDS(i)-1; fMO2(i)=fMO2(i)-1; fHO2(i)=fHO2(i)+0.50; fNQ2(i)=fNQ2(i)+(1/6); fNOQ(i)=fNOQ(i)+(1/3); 
fHCHO(i)=fHCHO(i)+0.965; fALD(i)=fALD(i)+0.93; fKET(i)=fKET(i)+0.348; fMOH(i)=fMOH(i)+0.25; 
fROH(i)=fROH(i)+0.25; fONITSQ2(i)=fONITSQ2(i)+0.5; 


%O3 Tracer
i=i+1; %R282_other_c
Rnames{i} = 'OLNDSQ3+MO2= HO2+NQ2+HCHO+ALD+KET+MOH+ROH+ONITSQ3';
k(:,i) = 9.68E-14.*exp(708./T);
Gstr{i,1} = 'OLNDSQ'; Gstr{i,2} = 'MO2'; 
fOLNDS(i)=fOLNDS(i)-1; fMO2(i)=fMO2(i)-1; fHO2(i)=fHO2(i)+0.50; fNQ2(i)=fNQ2(i)+0.5; 
fHCHO(i)=fHCHO(i)+0.965; fALD(i)=fALD(i)+0.93; fKET(i)=fKET(i)+0.348; fMOH(i)=fMOH(i)+0.25; 
fROH(i)=fROH(i)+0.25; fONITSQ3(i)=fONITSQ3(i)+0.5;
...
i=i+1; %R317
Rnames{i} = 'OLNNT+ACO3=ONITT+MO2+HO2';
k(:,i) = 8.85E-13.*exp(765./T);
Gstr{i,1} = 'OLNNT'; Gstr{i,2} = 'ACO3'; 
fOLNNT(i)=fOLNNT(i)-1; fACO3(i)=fACO3(i)-1; fONITT(i)=fONITT(i)+1; fMO2(i)=fMO2(i)+1; fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1; %R317a
Rnames{i} = 'OLNNTQ+ACO3=ONITTQ+MO2+HO2';
k(:,i) = 8.85E-13.*exp(765./T);
Gstr{i,1} = 'OLNNTQ'; Gstr{i,2} = 'ACO3'; 
fOLNNTQ(i)=fOLNNTQ(i)-1; fACO3(i)=fACO3(i)-1; fONITTQ(i)=fONITTQ(i)+1; fMO2(i)=fMO2(i)+1; fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1; %R317b
Rnames{i} = 'OLNNTQ2+ACO3=ONITTQ2+MO2+HO2';
k(:,i) = 8.85E-13.*exp(765./T);
Gstr{i,1} = 'OLNNTQ2'; Gstr{i,2} = 'ACO3'; 
fOLNNTQ2(i)=fOLNNTQ2(i)-1; fACO3(i)=fACO3(i)-1; fONITTQ2(i)=fONITTQ2(i)+1; fMO2(i)=fMO2(i)+1; fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1; %R317c
Rnames{i} = 'OLNNTQ3+ACO3=ONITTQ3+MO2+HO2';
k(:,i) = 8.85E-13.*exp(765./T);
Gstr{i,1} = 'OLNNTQ3'; Gstr{i,2} = 'ACO3'; 
fOLNNTQ3(i)=fOLNNTQ3(i)-1; fACO3(i)=fACO3(i)-1; fONITTQ3(i)=fONITTQ3(i)+1; fMO2(i)=fMO2(i)+1; fHO2(i)=fHO2(i)+1;


i=i+1; %R317_other
Rnames{i} = 'OLNNS+ACO3=ONITS+MO2+HO2';
k(:,i) = 8.85E-13.*exp(765./T);
Gstr{i,1} = 'OLNNS'; Gstr{i,2} = 'ACO3'; 
fOLNNS(i)=fOLNNS(i)-1; fACO3(i)=fACO3(i)-1; fONITS(i)=fONITS(i)+1; fMO2(i)=fMO2(i)+1; fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1; %R317_other_a
Rnames{i} = 'OLNNSQ+ACO3=ONITSQ+MO2+HO2';
k(:,i) = 8.85E-13.*exp(765./T);
Gstr{i,1} = 'OLNNSQ'; Gstr{i,2} = 'ACO3'; 
fOLNNSQ(i)=fOLNNSQ(i)-1; fACO3(i)=fACO3(i)-1; fONITSQ(i)=fONITSQ(i)+1; fMO2(i)=fMO2(i)+1; fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1; %R317_other_b
Rnames{i} = 'OLNNSQ2+ACO3=ONITSQ2+MO2+HO2';
k(:,i) = 8.85E-13.*exp(765./T);
Gstr{i,1} = 'OLNNSQ2'; Gstr{i,2} = 'ACO3'; 
fOLNNSQ2(i)=fOLNNSQ2(i)-1; fACO3(i)=fACO3(i)-1; fONITSQ2(i)=fONITSQ2(i)+1; fMO2(i)=fMO2(i)+1; fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1; %R317_other_c
Rnames{i} = 'OLNNSQ3+ACO3=ONITSQ3+MO2+HO2';
k(:,i) = 8.85E-13.*exp(765./T);
Gstr{i,1} = 'OLNNSQ3'; Gstr{i,2} = 'ACO3'; 
fOLNNSQ3(i)=fOLNNSQ3(i)-1; fACO3(i)=fACO3(i)-1; fONITSQ3(i)=fONITSQ3(i)+1; fMO2(i)=fMO2(i)+1; fHO2(i)=fHO2(i)+1;


i=i+1; %R318
Rnames{i} = 'OLNDT+ACO3= MO2+NO2+HCHO+ALD+KET+ORA2';
k(:,i) = 5.37E-13.*exp(765./T) ;
Gstr{i,1} = 'OLNDT'; Gstr{i,2} = 'ACO3'; 
fOLNDT(i)=fOLNDT(i)-1; fACO3(i)=fACO3(i)-1; fMO2(i)=fMO2(i)+0.50; fNO2(i)=fNO2(i)+1; 
fHCHO(i)=fHCHO(i)+0.287; fALD(i)=fALD(i)+1.24; fKET(i)=fKET(i)+0.464; fORA2(i)=fORA2(i)+0.50; 

%O3 Tracer
i=i+1; %R318a
Rnames{i} = 'OLNDTQ+ACO3= MO2+NO2+NOQ+HCHO+ALD+KET+ORA2';
k(:,i) = 5.37E-13.*exp(765./T) ;
Gstr{i,1} = 'OLNDTQ'; Gstr{i,2} = 'ACO3'; 
fOLNDTQ(i)=fOLNDTQ(i)-1; fACO3(i)=fACO3(i)-1; fMO2(i)=fMO2(i)+0.50; fNO2(i)=fNO2(i)+(1/3); fNOQ(i)=fNOQ(i)+(2/3); 
fHCHO(i)=fHCHO(i)+0.287; fALD(i)=fALD(i)+1.24; fKET(i)=fKET(i)+0.464; fORA2(i)=fORA2(i)+0.50; 

%O3 Tracer
i=i+1; %R318b
Rnames{i} = 'OLNDTQ2+ACO3= MO2+NQ2+NOQ+HCHO+ALD+KET+ORA2';
k(:,i) = 5.37E-13.*exp(765./T) ;
Gstr{i,1} = 'OLNDTQ2'; Gstr{i,2} = 'ACO3'; 
fOLNDTQ2(i)=fOLNDTQ2(i)-1; fACO3(i)=fACO3(i)-1; fMO2(i)=fMO2(i)+0.50; fNQ2(i)=fNQ2(i)+(1/3); fNOQ(i)=fNOQ(i)+(2/3); 
fHCHO(i)=fHCHO(i)+0.287; fALD(i)=fALD(i)+1.24; fKET(i)=fKET(i)+0.464; fORA2(i)=fORA2(i)+0.50; 

%O3 Tracer
i=i+1; %R318c
Rnames{i} = 'OLNDTQ3+ACO3= MO2+NQ2+HCHO+ALD+KET+ORA2';
k(:,i) = 5.37E-13.*exp(765./T) ;
Gstr{i,1} = 'OLNDTQ3'; Gstr{i,2} = 'ACO3'; 
fOLNDTQ3(i)=fOLNDTQ3(i)-1; fACO3(i)=fACO3(i)-1; fMO2(i)=fMO2(i)+0.50; fNQ2(i)=fNQ2(i)+1;  
fHCHO(i)=fHCHO(i)+0.287; fALD(i)=fALD(i)+1.24; fKET(i)=fKET(i)+0.464; fORA2(i)=fORA2(i)+0.50;


i=i+1; %R318_other
Rnames{i} = 'OLNDS+ACO3= MO2+NO2+HCHO+ALD+KET+ORA2';
k(:,i) = 5.37E-13.*exp(765./T) ;
Gstr{i,1} = 'OLNDT'; Gstr{i,2} = 'ACO3'; 
fOLNDS(i)=fOLNDS(i)-1; fACO3(i)=fACO3(i)-1; fMO2(i)=fMO2(i)+0.50; fNO2(i)=fNO2(i)+1; 
fHCHO(i)=fHCHO(i)+0.287; fALD(i)=fALD(i)+1.24; fKET(i)=fKET(i)+0.464; fORA2(i)=fORA2(i)+0.50; 

%O3 Tracer
i=i+1; %R318_other_a
Rnames{i} = 'OLNDSQ+ACO3= MO2+NO2+NOQ+HCHO+ALD+KET+ORA2';
k(:,i) = 5.37E-13.*exp(765./T) ;
Gstr{i,1} = 'OLNDSQ'; Gstr{i,2} = 'ACO3'; 
fOLNDSQ(i)=fOLNDSQ(i)-1; fACO3(i)=fACO3(i)-1; fMO2(i)=fMO2(i)+0.50; fNO2(i)=fNO2(i)+(1/3); fNOQ(i)=fNOQ(i)+(2/3); 
fHCHO(i)=fHCHO(i)+0.287; fALD(i)=fALD(i)+1.24; fKET(i)=fKET(i)+0.464; fORA2(i)=fORA2(i)+0.50; 

%O3 Tracer
i=i+1; %R318_other_b
Rnames{i} = 'OLNDSQ2+ACO3= MO2+NQ2+NOQ+HCHO+ALD+KET+ORA2';
k(:,i) = 5.37E-13.*exp(765./T) ;
Gstr{i,1} = 'OLNDSQ2'; Gstr{i,2} = 'ACO3'; 
fOLNDSQ2(i)=fOLNDSQ2(i)-1; fACO3(i)=fACO3(i)-1; fMO2(i)=fMO2(i)+0.50; fNQ2(i)=fNQ2(i)+(1/3); fNOQ(i)=fNOQ(i)+(2/3); 
fHCHO(i)=fHCHO(i)+0.287; fALD(i)=fALD(i)+1.24; fKET(i)=fKET(i)+0.464; fORA2(i)=fORA2(i)+0.50; 

%O3 Tracer
i=i+1; %R318_other_c
Rnames{i} = 'OLNDSQ3+ACO3= MO2+NQ2+HCHO+ALD+KET+ORA2';
k(:,i) = 5.37E-13.*exp(765./T) ;
Gstr{i,1} = 'OLNDSQ3'; Gstr{i,2} = 'ACO3'; 
fOLNDSQ3(i)=fOLNDSQ3(i)-1; fACO3(i)=fACO3(i)-1; fMO2(i)=fMO2(i)+0.50; fNQ2(i)=fNQ2(i)+1;  
fHCHO(i)=fHCHO(i)+0.287; fALD(i)=fALD(i)+1.24; fKET(i)=fKET(i)+0.464; fORA2(i)=fORA2(i)+0.50;
...
i=i+1; %R354
Rnames{i} = 'OLNNT+NO3=ONITT+NO2+HO2';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'OLNNT'; Gstr{i,2} = 'NO3'; 
fOLNNT(i)=fOLNNT(i)-1; fNO3(i)=fNO3(i)-1; fONITT(i)=fONITT(i)+1; fNO2(i)=fNO2(i)+1; fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1; %R354a
Rnames{i} = 'OLNNT+NO2Q=ONITT+NO2+NOQ+HO2';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'OLNNT'; Gstr{i,2} = 'NO2Q'; 
fOLNNT(i)=fOLNNT(i)-1; fNO2Q(i)=fNO2Q(i)-1; fONITT(i)=fONITT(i)+1; fNO2(i)=fNO2(i)+(1/3); fNOQ(i)=fNOQ(i)+(2/3); fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1; %R354b
Rnames{i} = 'OLNNT+NOQ2=ONITT+NQ2+NOQ+HO2';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'OLNNT'; Gstr{i,2} = 'NOQ2'; 
fOLNNT(i)=fOLNNT(i)-1; fNOQ2(i)=fNOQ2(i)-1; fONITT(i)=fONITT(i)+1; fNQ2(i)=fNQ2(i)+(1/3); fNOQ(i)=fNOQ(i)+(2/3); fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1; %R354c
Rnames{i} = 'OLNNT+NQ3=ONITT+NQ2+HO2';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'OLNNT'; Gstr{i,2} = 'NQ3'; 
fOLNNT(i)=fOLNNT(i)-1; fNQ3(i)=fNQ3(i)-1; fONITT(i)=fONITT(i)+1; fNQ2(i)=fNQ2(i)+1; fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1; %R354d
Rnames{i} = 'OLNNTQ+NO3=ONITTQ+NO2+HO2';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'OLNNTQ'; Gstr{i,2} = 'NO3'; 
fOLNNTQ(i)=fOLNNTQ(i)-1; fNO3(i)=fNO3(i)-1; fONITTQ(i)=fONITTQ(i)+1; fNO2(i)=fNO2(i)+1; fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1; %R354e
Rnames{i} = 'OLNNTQ+NO2Q=ONITTQ+NO2+NOQ+HO2';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'OLNNTQ'; Gstr{i,2} = 'NO2Q'; 
fOLNNTQ(i)=fOLNNTQ(i)-1; fNO2Q(i)=fNO2Q(i)-1; fONITTQ(i)=fONITTQ(i)+1; fNO2(i)=fNO2(i)+(1/3); fNOQ(i)=fNOQ(i)+(2/3); fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1; %R354f
Rnames{i} = 'OLNNTQ+NOQ2=ONITTQ+NQ2+NOQ+HO2';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'OLNNTQ'; Gstr{i,2} = 'NOQ2'; 
fOLNNTQ(i)=fOLNNTQ(i)-1; fNOQ2(i)=fNOQ2(i)-1; fONITTQ(i)=fONITTQ(i)+1; fNQ2(i)=fNQ2(i)+(1/3); fNOQ(i)=fNOQ(i)+(2/3); fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1; %R354g
Rnames{i} = 'OLNNTQ+NQ3=ONITTQ+NQ2+HO2';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'OLNNTQ'; Gstr{i,2} = 'NQ3'; 
fOLNNTQ(i)=fOLNNTQ(i)-1; fNQ3(i)=fNQ3(i)-1; fONITTQ(i)=fONITTQ(i)+1; fNQ2(i)=fNQ2(i)+1; fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1; %R354h
Rnames{i} = 'OLNNTQ2+NO3=ONITTQ2+NO2+HO2';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'OLNNTQ2'; Gstr{i,2} = 'NO3'; 
fOLNNTQ2(i)=fOLNNTQ2(i)-1; fNO3(i)=fNO3(i)-1; fONITTQ2(i)=fONITTQ2(i)+1; fNO2(i)=fNO2(i)+1; fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1; %R354i
Rnames{i} = 'OLNNTQ2+NO2Q=ONITTQ2+NO2+NOQ+HO2';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'OLNNTQ2'; Gstr{i,2} = 'NO2Q'; 
fOLNNTQ2(i)=fOLNNTQ2(i)-1; fNO2Q(i)=fNO2Q(i)-1; fONITTQ2(i)=fONITTQ2(i)+1; fNO2(i)=fNO2(i)+(1/3); fNOQ(i)=fNOQ(i)+(2/3); fHO2(i)=fHO2(i)+1;

%O3 Tracer
i=i+1; %R354j
Rnames{i} = 'OLNNTQ2+NOQ2=ONITTQ2+NQ2+NOQ+HO2';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'OLNNTQ2'; Gstr{i,2} = 'NOQ2'; 
fOLNNTQ2(i)=fOLNNTQ2(i)-1; fNOQ2(i)=fNOQ2(i)-1; fONITTQ2(i)=fONITTQ2(i)+1; fNQ2(i)=fNQ2(i)+(1/3); fNOQ(i)=fNOQ(i)+(2/3); fHO2(i)=fHO2(i)+1;

%O3 Tracer
i=i+1; %R354k
Rnames{i} = 'OLNNTQ2+NQ3=ONITTQ2+NQ2+HO2';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'OLNNTQ2'; Gstr{i,2} = 'NQ3'; 
fOLNNTQ2(i)=fOLNNTQ2(i)-1; fNQ3(i)=fNQ3(i)-1; fONITTQ2(i)=fONITTQ2(i)+1; fNQ2(i)=fNQ2(i)+1; fHO2(i)=fHO2(i)+1;

%O3 Tracer
i=i+1; %R354l
Rnames{i} = 'OLNNTQ3+NO3=ONITTQ3+NO2+HO2';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'OLNNTQ3'; Gstr{i,2} = 'NO3'; 
fOLNNTQ3(i)=fOLNNTQ3(i)-1; fNO3(i)=fNO3(i)-1; fONITTQ3(i)=fONITTQ3(i)+1; fNO2(i)=fNO2(i)+1; fHO2(i)=fHO2(i)+1;

%O3 Tracer
i=i+1; %R354m
Rnames{i} = 'OLNNTQ3+NO2Q=ONITTQ3+NO2+NOQ+HO2';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'OLNNTQ3'; Gstr{i,2} = 'NO2Q'; 
fOLNNTQ3(i)=fOLNNTQ3(i)-1; fNO2Q(i)=fNO2Q(i)-1; fONITTQ3(i)=fONITTQ3(i)+1; fNO2(i)=fNO2(i)+(1/3); fNOQ(i)=fNOQ(i)+(2/3); fHO2(i)=fHO2(i)+1;

%O3 Tracer
i=i+1; %R354n
Rnames{i} = 'OLNNTQ3+NOQ2=ONITTQ3+NQ2+NOQ+HO2';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'OLNNTQ3'; Gstr{i,2} = 'NOQ2'; 
fOLNNTQ3(i)=fOLNNTQ3(i)-1; fNOQ2(i)=fNOQ2(i)-1; fONITTQ3(i)=fONITTQ3(i)+1; fNQ2(i)=fNQ2(i)+(1/3); fNOQ(i)=fNOQ(i)+(2/3); fHO2(i)=fHO2(i)+1;

%O3 Tracer
i=i+1; %R354o
Rnames{i} = 'OLNNTQ3+NQ3=ONITTQ3+NQ2+HO2';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'OLNNTQ3'; Gstr{i,2} = 'NQ3'; 
fOLNNTQ3(i)=fOLNNTQ3(i)-1; fNQ3(i)=fNQ3(i)-1; fONITTQ3(i)=fONITTQ3(i)+1; fNQ2(i)=fNQ2(i)+1; fHO2(i)=fHO2(i)+1;

i=i+1; %R354_other
Rnames{i} = 'OLNNS+NO3=ONITS+NO2+HO2';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'OLNNS'; Gstr{i,2} = 'NO3'; 
fOLNNS(i)=fOLNNS(i)-1; fNO3(i)=fNO3(i)-1; fONITS(i)=fONITS(i)+1; fNO2(i)=fNO2(i)+1; fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1; %R354_other_a
Rnames{i} = 'OLNNS+NO2Q=ONITS+NO2+NOQ+HO2';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'OLNNS'; Gstr{i,2} = 'NO2Q'; 
fOLNNS(i)=fOLNNS(i)-1; fNO2Q(i)=fNO2Q(i)-1; fONITS(i)=fONITS(i)+1; fNO2(i)=fNO2(i)+(1/3); fNOQ(i)=fNOQ(i)+(2/3); fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1; %R354_other_b
Rnames{i} = 'OLNNS+NOQ2=ONITS+NQ2+NOQ+HO2';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'OLNNS'; Gstr{i,2} = 'NOQ2'; 
fOLNNS(i)=fOLNNS(i)-1; fNOQ2(i)=fNOQ2(i)-1; fONITS(i)=fONITS(i)+1; fNQ2(i)=fNQ2(i)+(1/3); fNOQ(i)=fNOQ(i)+(2/3); fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1; %R354_other_c
Rnames{i} = 'OLNNS+NQ3=ONITS+NQ2+HO2';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'OLNNS'; Gstr{i,2} = 'NQ3'; 
fOLNNS(i)=fOLNNS(i)-1; fNQ3(i)=fNQ3(i)-1; fONITS(i)=fONITS(i)+1; fNQ2(i)=fNQ2(i)+1; fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1; %R354_other_d
Rnames{i} = 'OLNNSQ+NO3=ONITSQ+NO2+HO2';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'OLNNSQ'; Gstr{i,2} = 'NO3'; 
fOLNNSQ(i)=fOLNNSQ(i)-1; fNO3(i)=fNO3(i)-1; fONITSQ(i)=fONITSQ(i)+1; fNO2(i)=fNO2(i)+1; fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1; %R354_other_e
Rnames{i} = 'OLNNSQ+NO2Q=ONITSQ+NO2+NOQ+HO2';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'OLNNSQ'; Gstr{i,2} = 'NO2Q'; 
fOLNNSQ(i)=fOLNNSQ(i)-1; fNO2Q(i)=fNO2Q(i)-1; fONITSQ(i)=fONITSQ(i)+1; fNO2(i)=fNO2(i)+(1/3); fNOQ(i)=fNOQ(i)+(2/3); fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1; %R354_other_f
Rnames{i} = 'OLNNSQ+NOQ2=ONITSQ+NQ2+NOQ+HO2';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'OLNNSQ'; Gstr{i,2} = 'NOQ2'; 
fOLNNSQ(i)=fOLNNSQ(i)-1; fNOQ2(i)=fNOQ2(i)-1; fONITSQ(i)=fONITSQ(i)+1; fNQ2(i)=fNQ2(i)+(1/3); fNOQ(i)=fNOQ(i)+(2/3); fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1; %R354_other_g
Rnames{i} = 'OLNNSQ+NQ3=ONITSQ+NQ2+HO2';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'OLNNSQ'; Gstr{i,2} = 'NQ3'; 
fOLNNSQ(i)=fOLNNSQ(i)-1; fNQ3(i)=fNQ3(i)-1; fONITSQ(i)=fONITSQ(i)+1; fNQ2(i)=fNQ2(i)+1; fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1; %R354_other_h
Rnames{i} = 'OLNNSQ2+NO3=ONITSQ2+NO2+HO2';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'OLNNSQ2'; Gstr{i,2} = 'NO3'; 
fOLNNSQ2(i)=fOLNNSQ2(i)-1; fNO3(i)=fNO3(i)-1; fONITSQ2(i)=fONITSQ2(i)+1; fNO2(i)=fNO2(i)+1; fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1; %R354_other_i
Rnames{i} = 'OLNNSQ2+NO2Q=ONITSQ2+NO2+NOQ+HO2';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'OLNNSQ2'; Gstr{i,2} = 'NO2Q'; 
fOLNNSQ2(i)=fOLNNSQ2(i)-1; fNO2Q(i)=fNO2Q(i)-1; fONITSQ2(i)=fONITSQ2(i)+1; fNO2(i)=fNO2(i)+(1/3); fNOQ(i)=fNOQ(i)+(2/3); fHO2(i)=fHO2(i)+1;

%O3 Tracer
i=i+1; %R354_other_j
Rnames{i} = 'OLNNSQ2+NOQ2=ONITSQ2+NQ2+NOQ+HO2';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'OLNNSQ2'; Gstr{i,2} = 'NOQ2'; 
fOLNNSQ2(i)=fOLNNSQ2(i)-1; fNOQ2(i)=fNOQ2(i)-1; fONITSQ2(i)=fONITSQ2(i)+1; fNQ2(i)=fNQ2(i)+(1/3); fNOQ(i)=fNOQ(i)+(2/3); fHO2(i)=fHO2(i)+1;

%O3 Tracer
i=i+1; %R354_other_k
Rnames{i} = 'OLNNSQ2+NQ3=ONITSQ2+NQ2+HO2';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'OLNNSQ2'; Gstr{i,2} = 'NQ3'; 
fOLNNSQ2(i)=fOLNNSQ2(i)-1; fNQ3(i)=fNQ3(i)-1; fONITSQ2(i)=fONITSQ2(i)+1; fNQ2(i)=fNQ2(i)+1; fHO2(i)=fHO2(i)+1;

%O3 Tracer
i=i+1; %R354_other_l
Rnames{i} = 'OLNNSQ3+NO3=ONITSQ3+NO2+HO2';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'OLNNSQ3'; Gstr{i,2} = 'NO3'; 
fOLNNSQ3(i)=fOLNNSQ3(i)-1; fNO3(i)=fNO3(i)-1; fONITSQ3(i)=fONITSQ3(i)+1; fNO2(i)=fNO2(i)+1; fHO2(i)=fHO2(i)+1;

%O3 Tracer
i=i+1; %R354_other_m
Rnames{i} = 'OLNNSQ3+NO2Q=ONITSQ3+NO2+NOQ+HO2';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'OLNNSQ3'; Gstr{i,2} = 'NO2Q'; 
fOLNNSQ3(i)=fOLNNSQ3(i)-1; fNO2Q(i)=fNO2Q(i)-1; fONITSQ3(i)=fONITSQ3(i)+1; fNO2(i)=fNO2(i)+(1/3); fNOQ(i)=fNOQ(i)+(2/3); fHO2(i)=fHO2(i)+1;

%O3 Tracer
i=i+1; %R354_other_n
Rnames{i} = 'OLNNSQ3+NOQ2=ONITSQ3+NQ2+NOQ+HO2';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'OLNNSQ3'; Gstr{i,2} = 'NOQ2'; 
fOLNNSQ3(i)=fOLNNSQ3(i)-1; fNOQ2(i)=fNOQ2(i)-1; fONITSQ3(i)=fONITSQ3(i)+1; fNQ2(i)=fNQ2(i)+(1/3); fNOQ(i)=fNOQ(i)+(2/3); fHO2(i)=fHO2(i)+1;

%O3 Tracer
i=i+1; %R354_other_o
Rnames{i} = 'OLNNSQ3+NQ3=ONITSQ3+NQ2+HO2';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'OLNNSQ3'; Gstr{i,2} = 'NQ3'; 
fOLNNSQ3(i)=fOLNNSQ3(i)-1; fNQ3(i)=fNQ3(i)-1; fONITSQ3(i)=fONITSQ3(i)+1; fNQ2(i)=fNQ2(i)+1; fHO2(i)=fHO2(i)+1;


i=i+1; %R355
Rnames{i} = 'OLNDT+NO3=2 NO2+0.287 HCHO+1.24 ALD+0.464 KET';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'OLNDT'; Gstr{i,2} = 'NO3'; 
fOLNDT(i)=fOLNDT(i)-1; fNO3(i)=fNO3(i)-1; fNO2(i)=fNO2(i)+2; fHCHO(i)=fHCHO(i)+0.287;
fALD(i)=fALD(i)+1.24; fKET(i)=fKET(i)+0.464;

%O3 Tracer
i=i+1; %R355a
Rnames{i} = 'OLNDT+NO2Q=2 NO2+NOQ+0.287 HCHO+1.24 ALD+0.464 KET';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'OLNDT'; Gstr{i,2} = 'NO2Q'; 
fOLNDT(i)=fOLNDT(i)-1; fNO2Q(i)=fNO2Q(i)-1; fNO2(i)=fNO2(i)+(1+1/3); fNOQ(i)=fNOQ(i)+(2/3); fHCHO(i)=fHCHO(i)+0.287;
fALD(i)=fALD(i)+1.24; fKET(i)=fKET(i)+0.464;

%O3 Tracer
i=i+1; %R355b
Rnames{i} = 'OLNDT+NOQ2=NO2+NOQ+0.287 HCHO+1.24 ALD+0.464 KET';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'OLNDT'; Gstr{i,2} = 'NOQ2'; 
fOLNDT(i)=fOLNDT(i)-1; fNOQ2(i)=fNOQ2(i)-1; fNO2(i)=fNO2(i)+(1); fNOQ(i)=fNOQ(i)+(1/3); fNOQ(i)=fNOQ(i)+(2/3); fHCHO(i)=fHCHO(i)+0.287;
fALD(i)=fALD(i)+1.24; fKET(i)=fKET(i)+0.464;

%O3 Tracer
i=i+1; %R355c
Rnames{i} = 'OLNDT+NQ3=NO2+NOQ+0.287 HCHO+1.24 ALD+0.464 KET';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'OLNDT'; Gstr{i,2} = 'NQ3'; 
fOLNDT(i)=fOLNDT(i)-1; fNQ3(i)=fNQ3(i)-1; fNO2(i)=fNO2(i)+(1); fNOQ(i)=fNOQ(i)+1; fHCHO(i)=fHCHO(i)+0.287;
fALD(i)=fALD(i)+1.24; fKET(i)=fKET(i)+0.464;

%O3 Tracer
i=i+1; %R355d
Rnames{i} = 'OLNDTQ+NO3=NO2+NOQ+0.287 HCHO+1.24 ALD+0.464 KET';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'OLNDTQ'; Gstr{i,2} = 'NO3'; 
fOLNDTQ(i)=fOLNDTQ(i)-1; fNO3(i)=fNO3(i)-1; fNO2(i)=fNO2(i)+(4/3); fNOQ(i)=fNOQ(i)+(2/3); fHCHO(i)=fHCHO(i)+0.287;
fALD(i)=fALD(i)+1.24; fKET(i)=fKET(i)+0.464;


%O3 Tracer
i=i+1; %R355e
Rnames{i} = 'OLNDTQ+NO2Q=NO2+NOQ+0.287 HCHO+1.24 ALD+0.464 KET';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'OLNDTQ'; Gstr{i,2} = 'NO2Q'; 
fOLNDTQ(i)=fOLNDTQ(i)-1; fNO2Q(i)=fNO2Q(i)-1; fNO2(i)=fNO2(i)+(2/3); fNOQ(i)=fNOQ(i)+(4/3); fHCHO(i)=fHCHO(i)+0.287;
fALD(i)=fALD(i)+1.24; fKET(i)=fKET(i)+0.464;

%O3 Tracer
i=i+1; %R355f
Rnames{i} = 'OLNDTQ+NOQ2=NO2+NOQ+NQ2+0.287 HCHO+1.24 ALD+0.464 KET';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'OLNDTQ'; Gstr{i,2} = 'NOQ2'; 
fOLNDTQ(i)=fOLNDTQ(i)-1; fNOQ2(i)=fNOQ2(i)-1; fNO2(i)=fNO2(i)+(1/3); fNOQ(i)=fNOQ(i)+(4/3); fNQ2(i)=fNQ2(i)+(1/3); fHCHO(i)=fHCHO(i)+0.287;
fALD(i)=fALD(i)+1.24; fKET(i)=fKET(i)+0.464;

%O3 Tracer
i=i+1; %R355g
Rnames{i} = 'OLNDTQ+NQ3=NO2+NOQ+NQ2+0.287 HCHO+1.24 ALD+0.464 KET';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'OLNDTQ'; Gstr{i,2} = 'NQ3'; 
fOLNDTQ(i)=fOLNDTQ(i)-1; fNQ3(i)=fNQ3(i)-1; fNO2(i)=fNO2(i)+(1/3); fNOQ(i)=fNOQ(i)+(2/3); fNQ2(i)=fNQ2(i)+1; fHCHO(i)=fHCHO(i)+0.287;
fALD(i)=fALD(i)+1.24; fKET(i)=fKET(i)+0.464;

%O3 Tracer
i=i+1; %R355h
Rnames{i} = 'OLNDTQ2+NO3=NO2+NOQ+NQ2+0.287 HCHO+1.24 ALD+0.464 KET';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'OLNDTQ2'; Gstr{i,2} = 'NO3'; 
fOLNDTQ2(i)=fOLNDTQ2(i)-1; fNO3(i)=fNO3(i)-1; fNO2(i)=fNO2(i)+1; fNOQ(i)=fNOQ(i)+(2/3); fNQ2(i)=fNQ2(i)+(1/3); fHCHO(i)=fHCHO(i)+0.287;
fALD(i)=fALD(i)+1.24; fKET(i)=fKET(i)+0.464;

%O3 Tracer
i=i+1; %R355i
Rnames{i} = 'OLNDTQ2+NO2Q=NO2+NOQ+NQ2+0.287 HCHO+1.24 ALD+0.464 KET';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'OLNDTQ2'; Gstr{i,2} = 'NO2Q'; 
fOLNDTQ2(i)=fOLNDTQ2(i)-1; fNO2Q(i)=fNO2Q(i)-1; fNO2(i)=fNO2(i)+(1/3); fNOQ(i)=fNOQ(i)+(4/3); fNQ2(i)=fNQ2(i)+(1/3); fHCHO(i)=fHCHO(i)+0.287;
fALD(i)=fALD(i)+1.24; fKET(i)=fKET(i)+0.464;

%O3 Tracer
i=i+1; %R355j
Rnames{i} = 'OLNDTQ2+NOQ2=NOQ+NQ2+0.287 HCHO+1.24 ALD+0.464 KET';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'OLNDTQ2'; Gstr{i,2} = 'NOQ2'; 
fOLNDTQ2(i)=fOLNDTQ2(i)-1; fNOQ2(i)=fNOQ2(i)-1; fNOQ(i)=fNOQ(i)+(4/3); fNQ2(i)=fNQ2(i)+(2/3); fHCHO(i)=fHCHO(i)+0.287;
fALD(i)=fALD(i)+1.24; fKET(i)=fKET(i)+0.464;

%O3 Tracer
i=i+1; %R355k
Rnames{i} = 'OLNDTQ2+NQ3=NOQ+NQ2+0.287 HCHO+1.24 ALD+0.464 KET';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'OLNDTQ2'; Gstr{i,2} = 'NQ3'; 
fOLNDTQ2(i)=fOLNDTQ2(i)-1; fNQ3(i)=fNQ3(i)-1; fNOQ(i)=fNOQ(i)+(2/3); fNQ2(i)=fNQ2(i)+(4/3); fHCHO(i)=fHCHO(i)+0.287;
fALD(i)=fALD(i)+1.24; fKET(i)=fKET(i)+0.464;

%O3 Tracer
i=i+1; %R355l
Rnames{i} = 'OLNDTQ3+NO3=NO2+NQ2+0.287 HCHO+1.24 ALD+0.464 KET';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'OLNDTQ3'; Gstr{i,2} = 'NO3'; 
fOLNDTQ3(i)=fOLNDTQ3(i)-1; fNO3(i)=fNO3(i)-1; fNO2(i)=fNO2(i)+1; fNQ2(i)=fNQ2(i)+1; fHCHO(i)=fHCHO(i)+0.287;
fALD(i)=fALD(i)+1.24; fKET(i)=fKET(i)+0.464;

%O3 Tracer
i=i+1; %R355m
Rnames{i} = 'OLNDTQ3+NO2Q=NO2+NOQ+NQ2+0.287 HCHO+1.24 ALD+0.464 KET';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'OLNDTQ3'; Gstr{i,2} = 'NO2Q'; 
fOLNDTQ3(i)=fOLNDTQ3(i)-1; fNO2Q(i)=fNO2Q(i)-1; fNO2(i)=fNO2(i)+(1/3); fNOQ(i)=fNOQ(i)+(2/3); fNQ2(i)=fNQ2(i)+1; fHCHO(i)=fHCHO(i)+0.287;
fALD(i)=fALD(i)+1.24; fKET(i)=fKET(i)+0.464;

%O3 Tracer
i=i+1; %R355ln
Rnames{i} = 'OLNDTQ3+NOQ2=NOQ+NQ2+0.287 HCHO+1.24 ALD+0.464 KET';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'OLNDTQ3'; Gstr{i,2} = 'NOQ2'; 
fOLNDTQ3(i)=fOLNDTQ3(i)-1; fNOQ2(i)=fNOQ2(i)-1; fNOQ(i)=fNOQ(i)+(2/3); fNQ2(i)=fNQ2(i)+(4/3); fHCHO(i)=fHCHO(i)+0.287;
fALD(i)=fALD(i)+1.24; fKET(i)=fKET(i)+0.464;

%O3 Tracer
i=i+1; %R355lo
Rnames{i} = 'OLNDTQ3+NQ3=NQ2+0.287 HCHO+1.24 ALD+0.464 KET';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'OLNDTQ3'; Gstr{i,2} = 'NQ3'; 
fOLNDTQ3(i)=fOLNDTQ3(i)-1; fNQ3(i)=fNQ3(i)-1; fNQ2(i)=fNQ2(i)+2; fHCHO(i)=fHCHO(i)+0.287;
fALD(i)=fALD(i)+1.24; fKET(i)=fKET(i)+0.464;


i=i+1; %R355_other
Rnames{i} = 'OLNDS+NO3=2 NO2+0.287 HCHO+1.24 ALD+0.464 KET';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'OLNDT'; Gstr{i,2} = 'NO3'; 
fOLNDS(i)=fOLNDS(i)-1; fNO3(i)=fNO3(i)-1; fNO2(i)=fNO2(i)+2; fHCHO(i)=fHCHO(i)+0.287;
fALD(i)=fALD(i)+1.24; fKET(i)=fKET(i)+0.464;

%O3 Tracer
i=i+1; %R355_other_a
Rnames{i} = 'OLNDS+NO2Q=2 NO2+NOQ+0.287 HCHO+1.24 ALD+0.464 KET';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'OLNDS'; Gstr{i,2} = 'NO2Q'; 
fOLNDS(i)=fOLNDS(i)-1; fNO2Q(i)=fNO2Q(i)-1; fNO2(i)=fNO2(i)+(1+1/3); fNOQ(i)=fNOQ(i)+(2/3); fHCHO(i)=fHCHO(i)+0.287;
fALD(i)=fALD(i)+1.24; fKET(i)=fKET(i)+0.464;

%O3 Tracer
i=i+1; %R355_other_b
Rnames{i} = 'OLNDS+NOQ2=NO2+NOQ+0.287 HCHO+1.24 ALD+0.464 KET';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'OLNDS'; Gstr{i,2} = 'NOQ2'; 
fOLNDS(i)=fOLNDS(i)-1; fNOQ2(i)=fNOQ2(i)-1; fNO2(i)=fNO2(i)+(1); fNOQ(i)=fNOQ(i)+(1/3); fNOQ(i)=fNOQ(i)+(2/3); fHCHO(i)=fHCHO(i)+0.287;
fALD(i)=fALD(i)+1.24; fKET(i)=fKET(i)+0.464;

%O3 Tracer
i=i+1; %R355_other_c
Rnames{i} = 'OLNDS+NQ3=NO2+NOQ+0.287 HCHO+1.24 ALD+0.464 KET';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'OLNDS'; Gstr{i,2} = 'NQ3'; 
fOLNDS(i)=fOLNDS(i)-1; fNQ3(i)=fNQ3(i)-1; fNO2(i)=fNO2(i)+(1); fNOQ(i)=fNOQ(i)+1; fHCHO(i)=fHCHO(i)+0.287;
fALD(i)=fALD(i)+1.24; fKET(i)=fKET(i)+0.464;

%O3 Tracer
i=i+1; %R355_other_d
Rnames{i} = 'OLNDSQ+NO3=NO2+NOQ+0.287 HCHO+1.24 ALD+0.464 KET';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'OLNDSQ'; Gstr{i,2} = 'NO3'; 
fOLNDSQ(i)=fOLNDSQ(i)-1; fNO3(i)=fNO3(i)-1; fNO2(i)=fNO2(i)+(4/3); fNOQ(i)=fNOQ(i)+(2/3); fHCHO(i)=fHCHO(i)+0.287;
fALD(i)=fALD(i)+1.24; fKET(i)=fKET(i)+0.464;


%O3 Tracer
i=i+1; %R355_other_e
Rnames{i} = 'OLNDSQ+NO2Q=NO2+NOQ+0.287 HCHO+1.24 ALD+0.464 KET';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'OLNDSQ'; Gstr{i,2} = 'NO2Q'; 
fOLNDSQ(i)=fOLNDSQ(i)-1; fNO2Q(i)=fNO2Q(i)-1; fNO2(i)=fNO2(i)+(2/3); fNOQ(i)=fNOQ(i)+(4/3); fHCHO(i)=fHCHO(i)+0.287;
fALD(i)=fALD(i)+1.24; fKET(i)=fKET(i)+0.464;

%O3 Tracer
i=i+1; %R355_other_f
Rnames{i} = 'OLNDSQ+NOQ2=NO2+NOQ+NQ2+0.287 HCHO+1.24 ALD+0.464 KET';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'OLNDSQ'; Gstr{i,2} = 'NOQ2'; 
fOLNDSQ(i)=fOLNDSQ(i)-1; fNOQ2(i)=fNOQ2(i)-1; fNO2(i)=fNO2(i)+(1/3); fNOQ(i)=fNOQ(i)+(4/3); fNQ2(i)=fNQ2(i)+(1/3); fHCHO(i)=fHCHO(i)+0.287;
fALD(i)=fALD(i)+1.24; fKET(i)=fKET(i)+0.464;

%O3 Tracer
i=i+1; %R355_other_g
Rnames{i} = 'OLNDSQ+NQ3=NO2+NOQ+NQ2+0.287 HCHO+1.24 ALD+0.464 KET';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'OLNDSQ'; Gstr{i,2} = 'NQ3'; 
fOLNDSQ(i)=fOLNDSQ(i)-1; fNQ3(i)=fNQ3(i)-1; fNO2(i)=fNO2(i)+(1/3); fNOQ(i)=fNOQ(i)+(2/3); fNQ2(i)=fNQ2(i)+1; fHCHO(i)=fHCHO(i)+0.287;
fALD(i)=fALD(i)+1.24; fKET(i)=fKET(i)+0.464;

%O3 Tracer
i=i+1; %R355_other_h
Rnames{i} = 'OLNDSQ2+NO3=NO2+NOQ+NQ2+0.287 HCHO+1.24 ALD+0.464 KET';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'OLNDSQ2'; Gstr{i,2} = 'NO3'; 
fOLNDSQ2(i)=fOLNDSQ2(i)-1; fNO3(i)=fNO3(i)-1; fNO2(i)=fNO2(i)+1; fNOQ(i)=fNOQ(i)+(2/3); fNQ2(i)=fNQ2(i)+(1/3); fHCHO(i)=fHCHO(i)+0.287;
fALD(i)=fALD(i)+1.24; fKET(i)=fKET(i)+0.464;

%O3 Tracer
i=i+1; %R355_other_i
Rnames{i} = 'OLNDSQ2+NO2Q=NO2+NOQ+NQ2+0.287 HCHO+1.24 ALD+0.464 KET';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'OLNDSQ2'; Gstr{i,2} = 'NO2Q'; 
fOLNDSQ2(i)=fOLNDSQ2(i)-1; fNO2Q(i)=fNO2Q(i)-1; fNO2(i)=fNO2(i)+(1/3); fNOQ(i)=fNOQ(i)+(4/3); fNQ2(i)=fNQ2(i)+(1/3); fHCHO(i)=fHCHO(i)+0.287;
fALD(i)=fALD(i)+1.24; fKET(i)=fKET(i)+0.464;

%O3 Tracer
i=i+1; %R355_other_j
Rnames{i} = 'OLNDSQ2+NOQ2=NOQ+NQ2+0.287 HCHO+1.24 ALD+0.464 KET';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'OLNDSQ2'; Gstr{i,2} = 'NOQ2'; 
fOLNDSQ2(i)=fOLNDSQ2(i)-1; fNOQ2(i)=fNOQ2(i)-1; fNOQ(i)=fNOQ(i)+(4/3); fNQ2(i)=fNQ2(i)+(2/3); fHCHO(i)=fHCHO(i)+0.287;
fALD(i)=fALD(i)+1.24; fKET(i)=fKET(i)+0.464;

%O3 Tracer
i=i+1; %R355_other_k
Rnames{i} = 'OLNDSQ2+NQ3=NOQ+NQ2+0.287 HCHO+1.24 ALD+0.464 KET';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'OLNDSQ2'; Gstr{i,2} = 'NQ3'; 
fOLNDSQ2(i)=fOLNDSQ2(i)-1; fNQ3(i)=fNQ3(i)-1; fNOQ(i)=fNOQ(i)+(2/3); fNQ2(i)=fNQ2(i)+(4/3); fHCHO(i)=fHCHO(i)+0.287;
fALD(i)=fALD(i)+1.24; fKET(i)=fKET(i)+0.464;

%O3 Tracer
i=i+1; %R355_other_l
Rnames{i} = 'OLNDSQ3+NO3=NO2+NQ2+0.287 HCHO+1.24 ALD+0.464 KET';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'OLNDSQ3'; Gstr{i,2} = 'NO3'; 
fOLNDSQ3(i)=fOLNDSQ3(i)-1; fNO3(i)=fNO3(i)-1; fNO2(i)=fNO2(i)+1; fNQ2(i)=fNQ2(i)+1; fHCHO(i)=fHCHO(i)+0.287;
fALD(i)=fALD(i)+1.24; fKET(i)=fKET(i)+0.464;

%O3 Tracer
i=i+1; %R355_other_m
Rnames{i} = 'OLNDSQ3+NO2Q=NO2+NOQ+NQ2+0.287 HCHO+1.24 ALD+0.464 KET';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'OLNDSQ3'; Gstr{i,2} = 'NO2Q'; 
fOLNDSQ3(i)=fOLNDSQ3(i)-1; fNO2Q(i)=fNO2Q(i)-1; fNO2(i)=fNO2(i)+(1/3); fNOQ(i)=fNOQ(i)+(2/3); fNQ2(i)=fNQ2(i)+1; fHCHO(i)=fHCHO(i)+0.287;
fALD(i)=fALD(i)+1.24; fKET(i)=fKET(i)+0.464;

%O3 Tracer
i=i+1; %R355_other_n
Rnames{i} = 'OLNDSQ3+NOQ2=NOQ+NQ2+0.287 HCHO+1.24 ALD+0.464 KET';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'OLNDSQ3'; Gstr{i,2} = 'NOQ2'; 
fOLNDSQ3(i)=fOLNDSQ3(i)-1; fNOQ2(i)=fNOQ2(i)-1; fNOQ(i)=fNOQ(i)+(2/3); fNQ2(i)=fNQ2(i)+(4/3); fHCHO(i)=fHCHO(i)+0.287;
fALD(i)=fALD(i)+1.24; fKET(i)=fKET(i)+0.464;

%O3 Tracer
i=i+1; %R355l_other_o
Rnames{i} = 'OLNDSQ3+NQ3=NQ2+0.287 HCHO+1.24 ALD+0.464 KET';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'OLNDSQ3'; Gstr{i,2} = 'NQ3'; 
fOLNDSQ3(i)=fOLNDSQ3(i)-1; fNQ3(i)=fNQ3(i)-1; fNQ2(i)=fNQ2(i)+2; fHCHO(i)=fHCHO(i)+0.287;
fALD(i)=fALD(i)+1.24; fKET(i)=fKET(i)+0.464;
...
i=i+1; %R359
Rnames{i} = 'OLNNT+OLNNT=ONITT+ONITT+HO2';
k(:,i) = 7.00E-14.*exp(1000./T);
Gstr{i,1} = 'OLNNT'; Gstr{i,2} = 'OLNNT'; 
fOLNNT(i)=fOLNNT(i)-1; fOLNNT(i)=fOLNNT(i)-1; fONITT(i)=fONITT(i)+1; fONITT(i)=fONITT(i)+1; fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1; %R359a
Rnames{i} = 'OLNNT+OLNNTQ=ONITT+ONITTQ+HO2';
k(:,i) = 7.00E-14.*exp(1000./T);
Gstr{i,1} = 'OLNNT'; Gstr{i,2} = 'OLNNTQ'; 
fOLNNT(i)=fOLNNT(i)-1; fOLNNTQ(i)=fOLNNTQ(i)-1; fONITT(i)=fONITT(i)+1; fONITTQ(i)=fONITTQ(i)+1; fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1; %R359b
Rnames{i} = 'OLNNT+OLNNTQ2=ONITT+ONITTQ2+HO2';
k(:,i) = 7.00E-14.*exp(1000./T);
Gstr{i,1} = 'OLNNT'; Gstr{i,2} = 'OLNNTQ2'; 
fOLNNT(i)=fOLNNT(i)-1; fOLNNTQ2(i)=fOLNNTQ2(i)-1; fONITT(i)=fONITT(i)+1; fONITTQ2(i)=fONITTQ2(i)+1; fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1; %R359c
Rnames{i} = 'OLNNT+OLNNTQ3=ONITT+ONITTQ3+HO2';
k(:,i) = 7.00E-14.*exp(1000./T);
Gstr{i,1} = 'OLNNT'; Gstr{i,2} = 'OLNNTQ3'; 
fOLNNT(i)=fOLNNT(i)-1; fOLNNTQ3(i)=fOLNNTQ3(i)-1; fONITT(i)=fONITT(i)+1; fONITTQ3(i)=fONITTQ3(i)+1; fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1; %R359d
Rnames{i} = 'OLNNTQ+OLNNTQ=ONITTQ+ONITTQ+HO2';
k(:,i) = 7.00E-14.*exp(1000./T);
Gstr{i,1} = 'OLNNTQ'; Gstr{i,2} = 'OLNNTQ'; 
fOLNNTQ(i)=fOLNNTQ(i)-1; fOLNNTQ(i)=fOLNNTQ(i)-1; fONITTQ(i)=fONITTQ(i)+1; fONITTQ(i)=fONITTQ(i)+1; fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1; %R359e
Rnames{i} = 'OLNNTQ+OLNNTQ2=ONITTQ+ONITTQ2+HO2';
k(:,i) = 7.00E-14.*exp(1000./T);
Gstr{i,1} = 'OLNNTQ'; Gstr{i,2} = 'OLNNTQ2'; 
fOLNNTQ(i)=fOLNNTQ(i)-1; fOLNNTQ2(i)=fOLNNTQ2(i)-1; fONITTQ(i)=fONITTQ(i)+1; fONITTQ2(i)=fONITTQ2(i)+1; fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1; %R359f
Rnames{i} = 'OLNNTQ+OLNNTQ3=ONITTQ+ONITTQ3+HO2';
k(:,i) = 7.00E-14.*exp(1000./T);
Gstr{i,1} = 'OLNNTQ'; Gstr{i,2} = 'OLNNTQ3'; 
fOLNNTQ(i)=fOLNNTQ(i)-1; fOLNNTQ3(i)=fOLNNTQ3(i)-1; fONITTQ(i)=fONITTQ(i)+1; fONITTQ3(i)=fONITTQ3(i)+1; fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1; %R359g
Rnames{i} = 'OLNNTQ2+OLNNTQ2=ONITTQ2+ONITTQ2+HO2';
k(:,i) = 7.00E-14.*exp(1000./T);
Gstr{i,1} = 'OLNNTQ2'; Gstr{i,2} = 'OLNNTQ2'; 
fOLNNTQ2(i)=fOLNNTQ2(i)-1; fOLNNTQ2(i)=fOLNNTQ2(i)-1; fONITTQ2(i)=fONITTQ2(i)+1; fONITTQ2(i)=fONITTQ2(i)+1; fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1; %R359h
Rnames{i} = 'OLNNTQ2+OLNNTQ3=ONITTQ2+ONITTQ3+HO2';
k(:,i) = 7.00E-14.*exp(1000./T);
Gstr{i,1} = 'OLNNTQ2'; Gstr{i,2} = 'OLNNTQ3'; 
fOLNNTQ2(i)=fOLNNTQ2(i)-1; fOLNNTQ3(i)=fOLNNTQ3(i)-1; fONITTQ2(i)=fONITTQ2(i)+1; fONITTQ3(i)=fONITTQ3(i)+1; fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1; %R359i
Rnames{i} = 'OLNNTQ3+OLNNTQ3=ONITTQ3+ONITTQ3+HO2';
k(:,i) = 7.00E-14.*exp(1000./T);
Gstr{i,1} = 'OLNNTQ3'; Gstr{i,2} = 'OLNNTQ3'; 
fOLNNTQ3(i)=fOLNNTQ3(i)-1; fOLNNTQ3(i)=fOLNNTQ3(i)-1; fONITTQ3(i)=fONITTQ3(i)+1; fONITTQ3(i)=fONITTQ3(i)+1; fHO2(i)=fHO2(i)+1;


i=i+1; %R359_other_1
Rnames{i} = 'OLNNT+OLNNS=ONITT+ONITS+HO2';
k(:,i) = 7.00E-14.*exp(1000./T);
Gstr{i,1} = 'OLNNT'; Gstr{i,2} = 'OLNNS'; 
fOLNNT(i)=fOLNNT(i)-1; fOLNNS(i)=fOLNNS(i)-1; fONITT(i)=fONITT(i)+1; fONITS(i)=fONITS(i)+1; fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1; %R359_other1_a
Rnames{i} = 'OLNNT+OLNNSQ=ONITT+ONITSQ+HO2';
k(:,i) = 7.00E-14.*exp(1000./T);
Gstr{i,1} = 'OLNNT'; Gstr{i,2} = 'OLNNSQ'; 
fOLNNT(i)=fOLNNT(i)-1; fOLNNSQ(i)=fOLNNSQ(i)-1; fONITT(i)=fONITT(i)+1; fONITSQ(i)=fONITSQ(i)+1; fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1; %R359_other1_b
Rnames{i} = 'OLNNT+OLNNSQ2=ONITT+ONITSQ2+HO2';
k(:,i) = 7.00E-14.*exp(1000./T);
Gstr{i,1} = 'OLNNT'; Gstr{i,2} = 'OLNNSQ2'; 
fOLNNT(i)=fOLNNT(i)-1; fOLNNSQ2(i)=fOLNNSQ2(i)-1; fONITT(i)=fONITT(i)+1; fONITSQ2(i)=fONITSQ2(i)+1; fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1; %R359_other1_c
Rnames{i} = 'OLNNT+OLNNSQ3=ONITT+ONITSQ3+HO2';
k(:,i) = 7.00E-14.*exp(1000./T);
Gstr{i,1} = 'OLNNT'; Gstr{i,2} = 'OLNNSQ3'; 
fOLNNT(i)=fOLNNT(i)-1; fOLNNSQ3(i)=fOLNNSQ3(i)-1; fONITT(i)=fONITT(i)+1; fONITSQ3(i)=fONITSQ3(i)+1; fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1; %R359_other1_d
Rnames{i} = 'OLNNTQ+OLNNSQ=ONITTQ+ONITSQ+HO2';
k(:,i) = 7.00E-14.*exp(1000./T);
Gstr{i,1} = 'OLNNTQ'; Gstr{i,2} = 'OLNNSQ'; 
fOLNNTQ(i)=fOLNNTQ(i)-1; fOLNNSQ(i)=fOLNNSQ(i)-1; fONITTQ(i)=fONITTQ(i)+1; fONITSQ(i)=fONITSQ(i)+1; fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1; %R359_other1_e
Rnames{i} = 'OLNNTQ+OLNNSQ2=ONITTQ+ONITSQ2+HO2';
k(:,i) = 7.00E-14.*exp(1000./T);
Gstr{i,1} = 'OLNNTQ'; Gstr{i,2} = 'OLNNSQ2'; 
fOLNNTQ(i)=fOLNNTQ(i)-1; fOLNNSQ2(i)=fOLNNSQ2(i)-1; fONITTQ(i)=fONITTQ(i)+1; fONITSQ2(i)=fONITSQ2(i)+1; fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1; %R359_other1_f
Rnames{i} = 'OLNNTQ+OLNNSQ3=ONITTQ+ONITSQ3+HO2';
k(:,i) = 7.00E-14.*exp(1000./T);
Gstr{i,1} = 'OLNNTQ'; Gstr{i,2} = 'OLNNSQ3'; 
fOLNNTQ(i)=fOLNNTQ(i)-1; fOLNNSQ3(i)=fOLNNSQ3(i)-1; fONITTQ(i)=fONITTQ(i)+1; fONITSQ3(i)=fONITSQ3(i)+1; fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1; %R359_other1_g
Rnames{i} = 'OLNNTQ2+OLNNSQ2=ONITTQ2+ONITSQ2+HO2';
k(:,i) = 7.00E-14.*exp(1000./T);
Gstr{i,1} = 'OLNNTQ2'; Gstr{i,2} = 'OLNNSQ2'; 
fOLNNTQ2(i)=fOLNNTQ2(i)-1; fOLNNSQ2(i)=fOLNNSQ2(i)-1; fONITTQ2(i)=fONITTQ2(i)+1; fONITSQ2(i)=fONITSQ2(i)+1; fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1; %R359_other1_h
Rnames{i} = 'OLNNTQ2+OLNNSQ3=ONITTQ2+ONITSQ3+HO2';
k(:,i) = 7.00E-14.*exp(1000./T);
Gstr{i,1} = 'OLNNTQ2'; Gstr{i,2} = 'OLNNSQ3'; 
fOLNNTQ2(i)=fOLNNTQ2(i)-1; fOLNNSQ3(i)=fOLNNSQ3(i)-1; fONITTQ2(i)=fONITTQ2(i)+1; fONITSQ3(i)=fONITSQ3(i)+1; fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1; %R359_other1_i
Rnames{i} = 'OLNNTQ3+OLNNSQ3=ONITTQ3+ONITSQ3+HO2';
k(:,i) = 7.00E-14.*exp(1000./T);
Gstr{i,1} = 'OLNNTQ3'; Gstr{i,2} = 'OLNNSQ3'; 
fOLNNTQ3(i)=fOLNNTQ3(i)-1; fOLNNSQ3(i)=fOLNNSQ3(i)-1; fONITTQ3(i)=fONITTQ3(i)+1; fONITSQ3(i)=fONITSQ3(i)+1; fHO2(i)=fHO2(i)+1;

i=i+1; %R359_other_2
Rnames{i} = 'OLNNS+OLNNS=ONITS+ONITS+HO2';
k(:,i) = 7.00E-14.*exp(1000./T);
Gstr{i,1} = 'OLNNS'; Gstr{i,2} = 'OLNNS'; 
fOLNNS(i)=fOLNNS(i)-1; fOLNNS(i)=fOLNNS(i)-1; fONITS(i)=fONITS(i)+1; fONITS(i)=fONITS(i)+1; fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1; %R359_other2_a
Rnames{i} = 'OLNNS+OLNNSQ=ONITS+ONITSQ+HO2';
k(:,i) = 7.00E-14.*exp(1000./T);
Gstr{i,1} = 'OLNNS'; Gstr{i,2} = 'OLNNSQ'; 
fOLNNS(i)=fOLNNS(i)-1; fOLNNSQ(i)=fOLNNSQ(i)-1; fONITS(i)=fONITS(i)+1; fONITSQ(i)=fONITSQ(i)+1; fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1; %R359_other2_b
Rnames{i} = 'OLNNS+OLNNSQ2=ONITS+ONITSQ2+HO2';
k(:,i) = 7.00E-14.*exp(1000./T);
Gstr{i,1} = 'OLNNS'; Gstr{i,2} = 'OLNNSQ2'; 
fOLNNS(i)=fOLNNS(i)-1; fOLNNSQ2(i)=fOLNNSQ2(i)-1; fONITS(i)=fONITS(i)+1; fONITSQ2(i)=fONITSQ2(i)+1; fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1; %R359_other2_c
Rnames{i} = 'OLNNS+OLNNSQ3=ONITS+ONITSQ3+HO2';
k(:,i) = 7.00E-14.*exp(1000./T);
Gstr{i,1} = 'OLNNS'; Gstr{i,2} = 'OLNNSQ3'; 
fOLNNS(i)=fOLNNS(i)-1; fOLNNSQ3(i)=fOLNNSQ3(i)-1; fONITS(i)=fONITS(i)+1; fONITSQ3(i)=fONITSQ3(i)+1; fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1; %R359_other2_d
Rnames{i} = 'OLNNSQ+OLNNSQ=ONITSQ+ONITSQ+HO2';
k(:,i) = 7.00E-14.*exp(1000./T);
Gstr{i,1} = 'OLNNSQ'; Gstr{i,2} = 'OLNNSQ'; 
fOLNNSQ(i)=fOLNNSQ(i)-1; fOLNNSQ(i)=fOLNNSQ(i)-1; fONITSQ(i)=fONITSQ(i)+1; fONITSQ(i)=fONITSQ(i)+1; fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1; %R359_other2_e
Rnames{i} = 'OLNNSQ+OLNNSQ2=ONITSQ+ONITSQ2+HO2';
k(:,i) = 7.00E-14.*exp(1000./T);
Gstr{i,1} = 'OLNNSQ'; Gstr{i,2} = 'OLNNSQ2'; 
fOLNNSQ(i)=fOLNNSQ(i)-1; fOLNNSQ2(i)=fOLNNSQ2(i)-1; fONITSQ(i)=fONITSQ(i)+1; fONITSQ2(i)=fONITSQ2(i)+1; fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1; %R359_other2_f
Rnames{i} = 'OLNNSQ+OLNNSQ3=ONITSQ+ONITSQ3+HO2';
k(:,i) = 7.00E-14.*exp(1000./T);
Gstr{i,1} = 'OLNNSQ'; Gstr{i,2} = 'OLNNSQ3'; 
fOLNNSQ(i)=fOLNNSQ(i)-1; fOLNNSQ3(i)=fOLNNSQ3(i)-1; fONITSQ(i)=fONITSQ(i)+1; fONITSQ3(i)=fONITSQ3(i)+1; fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1; %R359_other2_g
Rnames{i} = 'OLNNSQ2+OLNNSQ2=ONITSQ2+ONITSQ2+HO2';
k(:,i) = 7.00E-14.*exp(1000./T);
Gstr{i,1} = 'OLNNSQ2'; Gstr{i,2} = 'OLNNSQ2'; 
fOLNNSQ2(i)=fOLNNSQ2(i)-1; fOLNNSQ2(i)=fOLNNSQ2(i)-1; fONITSQ2(i)=fONITSQ2(i)+1; fONITSQ2(i)=fONITSQ2(i)+1; fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1; %R359_other2_h
Rnames{i} = 'OLNNSQ2+OLNNSQ3=ONITSQ2+ONITSQ3+HO2';
k(:,i) = 7.00E-14.*exp(1000./T);
Gstr{i,1} = 'OLNNSQ2'; Gstr{i,2} = 'OLNNSQ3'; 
fOLNNSQ2(i)=fOLNNSQ2(i)-1; fOLNNSQ3(i)=fOLNNSQ3(i)-1; fONITSQ2(i)=fONITSQ2(i)+1; fONITSQ3(i)=fONITSQ3(i)+1; fHO2(i)=fHO2(i)+1; 

%O3 Tracer
i=i+1; %R359_other2_i
Rnames{i} = 'OLNNSQ3+OLNNSQ3=ONITSQ3+ONITSQ3+HO2';
k(:,i) = 7.00E-14.*exp(1000./T);
Gstr{i,1} = 'OLNNSQ3'; Gstr{i,2} = 'OLNNSQ3'; 
fOLNNSQ3(i)=fOLNNSQ3(i)-1; fOLNNSQ3(i)=fOLNNSQ3(i)-1; fONITSQ3(i)=fONITSQ3(i)+1; fONITSQ3(i)=fONITSQ3(i)+1; fHO2(i)=fHO2(i)+1;


i=i+1; %R360
Rnames{i} = 'OLNNT+OLNDT=0.50 HO2+0.50 NO2+0.202 HCHO+0.640 ALD+0.149 KET+1.50 ONITT ';
k(:,i) = 4.25E-14.*exp(1000./T);
Gstr{i,1} = 'OLNNT'; Gstr{i,2} = 'OLNDT'; 
fOLNNT(i)=fOLNNT(i)-1; fOLNDT(i)=fOLNDT(i)-1; fHO2(i)=fHO2(i)+0.5; fNO2(i)=fNO2(i)+0.5;
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fONITT(i)=fONITT(i)+1.5; 

%O3 Tracer
i=i+1; %R360a
Rnames{i} = 'OLNNT+OLNDTQ=0.50 HO2+NO2+NOQ+0.202 HCHO+0.640 ALD+0.149 KET+ ONITT +ONITTQ ';
k(:,i) = 4.25E-14.*exp(1000./T);
Gstr{i,1} = 'OLNNT'; Gstr{i,2} = 'OLNDTQ'; 
fOLNNT(i)=fOLNNT(i)-1; fOLNDTQ(i)=fOLNDTQ(i)-1; fHO2(i)=fHO2(i)+0.5; fNO2(i)=fNO2(i)+(1/6); fNOQ(i)=fNOQ(i)+(2/6);
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fONITT(i)=fONITT(i)+1; fONITTQ(i)=fONITTQ(i)+0.5; 

%O3 Tracer
i=i+1; %R360b
Rnames{i} = 'OLNNT+OLNDTQ2=0.50 HO2+NQ2+NOQ+0.202 HCHO+0.640 ALD+0.149 KET+ ONITT +ONITTQ2';
k(:,i) = 4.25E-14.*exp(1000./T);
Gstr{i,1} = 'OLNNT'; Gstr{i,2} = 'OLNDTQ2'; 
fOLNNT(i)=fOLNNT(i)-1; fOLNDTQ2(i)=fOLNDTQ2(i)-1; fHO2(i)=fHO2(i)+0.5; fNQ2(i)=fNQ2(i)+(1/6); fNOQ(i)=fNOQ(i)+(2/6);
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fONITT(i)=fONITT(i)+1; fONITTQ2(i)=fONITTQ2(i)+0.5; 

%O3 Tracer
i=i+1; %R360c
Rnames{i} = 'OLNNT+OLNDTQ3=0.50 HO2+NQ2+0.202 HCHO+0.640 ALD+0.149 KET+ ONITT +ONITTQ3';
k(:,i) = 4.25E-14.*exp(1000./T);
Gstr{i,1} = 'OLNNT'; Gstr{i,2} = 'OLNDTQ3'; 
fOLNNT(i)=fOLNNT(i)-1; fOLNDTQ3(i)=fOLNDTQ3(i)-1; fHO2(i)=fHO2(i)+0.5; fNQ2(i)=fNQ2(i)+(1/2); 
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fONITT(i)=fONITT(i)+1; fONITTQ3(i)=fONITTQ3(i)+0.5; 

%O3 Tracer
i=i+1; %R360d
Rnames{i} = 'OLNNTQ+OLNDT=0.50 HO2+NO2+0.202 HCHO+0.640 ALD+0.149 KET+ ONITTQ +ONITT';
k(:,i) = 4.25E-14.*exp(1000./T);
Gstr{i,1} = 'OLNNTQ'; Gstr{i,2} = 'OLNDTQ'; 
fOLNNTQ(i)=fOLNNTQ(i)-1; fOLNDT(i)=fOLNDT(i)-1; fHO2(i)=fHO2(i)+0.5; fNO2(i)=fNO2(i)+(1/2); 
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fONITTQ(i)=fONITTQ(i)+1; fONITT(i)=fONITT(i)+0.5; 

%O3 Tracer
i=i+1; %R360e
Rnames{i} = 'OLNNTQ+OLNDTQ=0.50 HO2+NO2+NOQ+0.202 HCHO+0.640 ALD+0.149 KET+ ONITTQ';
k(:,i) = 4.25E-14.*exp(1000./T);
Gstr{i,1} = 'OLNNTQ'; Gstr{i,2} = 'OLNDTQ'; 
fOLNNTQ(i)=fOLNNTQ(i)-1; fOLNDTQ(i)=fOLNDTQ(i)-1; fHO2(i)=fHO2(i)+0.5; fNO2(i)=fNO2(i)+(1/6); fNOQ(i)=fNOQ(i)+(2/6); 
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fONITTQ(i)=fONITTQ(i)+1.5; 

%O3 Tracer
i=i+1; %R360f
Rnames{i} = 'OLNNTQ+OLNDTQ2=0.50 HO2+NQ2+NOQ+0.202 HCHO+0.640 ALD+0.149 KET+ ONITTQ+ONITTQ2';
k(:,i) = 4.25E-14.*exp(1000./T);
Gstr{i,1} = 'OLNNTQ'; Gstr{i,2} = 'OLNDTQ2'; 
fOLNNTQ(i)=fOLNNTQ(i)-1; fOLNDTQ2(i)=fOLNDTQ2(i)-1; fHO2(i)=fHO2(i)+0.5; fNQ2(i)=fNQ2(i)+(1/6); fNOQ(i)=fNOQ(i)+(2/6); 
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fONITTQ(i)=fONITTQ(i)+1; fONITTQ2(i)=fONITTQ2(i)+0.5; 

%O3 Tracer
i=i+1; %R360g
Rnames{i} = 'OLNNTQ+OLNDTQ3=0.50 HO2+NQ2+0.202 HCHO+0.640 ALD+0.149 KET+ ONITTQ+ONITTQ3';
k(:,i) = 4.25E-14.*exp(1000./T);
Gstr{i,1} = 'OLNNTQ'; Gstr{i,2} = 'OLNDTQ3'; 
fOLNNTQ(i)=fOLNNTQ(i)-1; fOLNDTQ3(i)=fOLNDTQ3(i)-1; fHO2(i)=fHO2(i)+0.5; fNQ2(i)=fNQ2(i)+(1/2);  
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fONITTQ(i)=fONITTQ(i)+1; fONITTQ3(i)=fONITTQ3(i)+0.5; 

%O3 Tracer
i=i+1; %R360h
Rnames{i} = 'OLNNTQ2+OLNDT=0.50 HO2+NO2+0.202 HCHO+0.640 ALD+0.149 KET+ ONITTQ2+ONITT';
k(:,i) = 4.25E-14.*exp(1000./T);
Gstr{i,1} = 'OLNNTQ2'; Gstr{i,2} = 'OLNDT'; 
fOLNNTQ2(i)=fOLNNTQ2(i)-1; fOLNDT(i)=fOLNDT(i)-1; fHO2(i)=fHO2(i)+0.5; fNO2(i)=fNO2(i)+(1/2);  
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fONITTQ2(i)=fONITTQ2(i)+1; fONITT(i)=fONITT(i)+0.5; 

%O3 Tracer
i=i+1; %R360i
Rnames{i} = 'OLNNTQ2+OLNDTQ=0.50 HO2+NO2+NOQ+0.202 HCHO+0.640 ALD+0.149 KET+ ONITTQ2+ONITTQ';
k(:,i) = 4.25E-14.*exp(1000./T);
Gstr{i,1} = 'OLNNTQ2'; Gstr{i,2} = 'OLNDTQ'; 
fOLNNTQ2(i)=fOLNNTQ2(i)-1; fOLNDTQ(i)=fOLNDTQ(i)-1; fHO2(i)=fHO2(i)+0.5; fNO2(i)=fNO2(i)+(1/6); fNOQ(i)=fNOQ(i)+(2/6);  
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fONITTQ2(i)=fONITTQ2(i)+1; fONITTQ(i)=fONITTQ(i)+0.5; 

%O3 Tracer
i=i+1; %R360j
Rnames{i} = 'OLNNTQ2+OLNDTQ2=0.50 HO2+NQ2+NOQ+0.202 HCHO+0.640 ALD+0.149 KET+ ONITTQ2+ONITTQ2';
k(:,i) = 4.25E-14.*exp(1000./T);
Gstr{i,1} = 'OLNNTQ2'; Gstr{i,2} = 'OLNDTQ2'; 
fOLNNTQ2(i)=fOLNNTQ2(i)-1; fOLNDTQ2(i)=fOLNDTQ2(i)-1; fHO2(i)=fHO2(i)+0.5; fNQ2(i)=fNQ2(i)+(1/6); fNOQ(i)=fNOQ(i)+(2/6);  
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fONITTQ2(i)=fONITTQ2(i)+1.5; 

%O3 Tracer
i=i+1; %R360k
Rnames{i} = 'OLNNTQ2+OLNDTQ3=0.50 HO2+NQ2+0.202 HCHO+0.640 ALD+0.149 KET+ ONITTQ2+ONITTQ3';
k(:,i) = 4.25E-14.*exp(1000./T);
Gstr{i,1} = 'OLNNTQ2'; Gstr{i,2} = 'OLNDTQ3'; 
fOLNNTQ2(i)=fOLNNTQ2(i)-1; fOLNDTQ3(i)=fOLNDTQ3(i)-1; fHO2(i)=fHO2(i)+0.5; fNQ2(i)=fNQ2(i)+(1/2);   
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fONITTQ2(i)=fONITTQ2(i)+1; fONITTQ3(i)=fONITTQ3(i)+0.5; 

%O3 Tracer
i=i+1; %R360l
Rnames{i} = 'OLNNTQ3+OLNDT=0.50 HO2+NO2+0.202 HCHO+0.640 ALD+0.149 KET+ ONITTQ3+ONITT';
k(:,i) = 4.25E-14.*exp(1000./T);
Gstr{i,1} = 'OLNNTQ3'; Gstr{i,2} = 'OLNDT'; 
fOLNNTQ3(i)=fOLNNTQ3(i)-1; fOLNDT(i)=fOLNDT(i)-1; fHO2(i)=fHO2(i)+0.5; fNO2(i)=fNO2(i)+(1/2);   
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fONITTQ3(i)=fONITTQ3(i)+1; fONITT(i)=fONITT(i)+0.5; 

%O3 Tracer
i=i+1; %R360m
Rnames{i} = 'OLNNTQ3+OLNDTQ=0.50 HO2+NO2+NOQ+0.202 HCHO+0.640 ALD+0.149 KET+ ONITTQ3+ONITTQ';
k(:,i) = 4.25E-14.*exp(1000./T);
Gstr{i,1} = 'OLNNTQ3'; Gstr{i,2} = 'OLNDTQ'; 
fOLNNTQ3(i)=fOLNNTQ3(i)-1; fOLNDTQ(i)=fOLNDTQ(i)-1; fHO2(i)=fHO2(i)+0.5; fNO2(i)=fNO2(i)+(1/6); fNOQ(i)=fNOQ(i)+(2/6);   
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fONITTQ3(i)=fONITTQ3(i)+1; fONITTQ(i)=fONITTQ(i)+0.5; 

%O3 Tracer
i=i+1; %R360n
Rnames{i} = 'OLNNTQ3+OLNDTQ2=0.50 HO2+NQ2+NOQ+0.202 HCHO+0.640 ALD+0.149 KET+ ONITTQ3+ONITTQ2';
k(:,i) = 4.25E-14.*exp(1000./T);
Gstr{i,1} = 'OLNNTQ3'; Gstr{i,2} = 'OLNDTQ2'; 
fOLNNTQ3(i)=fOLNNTQ3(i)-1; fOLNDTQ2(i)=fOLNDTQ2(i)-1; fHO2(i)=fHO2(i)+0.5; fNQ2(i)=fNQ2(i)+(1/6); fNOQ(i)=fNOQ(i)+(2/6);   
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fONITTQ3(i)=fONITTQ3(i)+1; fONITTQ2(i)=fONITTQ2(i)+0.5; 

%O3 Tracer
i=i+1; %R360o
Rnames{i} = 'OLNNTQ3+OLNDTQ3=0.50 HO2+NQ2+0.202 HCHO+0.640 ALD+0.149 KET+ ONITTQ3';
k(:,i) = 4.25E-14.*exp(1000./T);
Gstr{i,1} = 'OLNNTQ3'; Gstr{i,2} = 'OLNDTQ3'; 
fOLNNTQ3(i)=fOLNNTQ3(i)-1; fOLNDTQ3(i)=fOLNDTQ3(i)-1; fHO2(i)=fHO2(i)+0.5; fNQ2(i)=fNQ2(i)+(1/2);    
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fONITTQ3(i)=fONITTQ3(i)+1.5;

i=i+1; %R360_other
Rnames{i} = 'OLNNT+OLNDS=0.50 HO2+0.50 NO2+0.202 HCHO+0.640 ALD+0.149 KET+1.0 ONITT+0.5ONITS ';
k(:,i) = 4.25E-14.*exp(1000./T);
Gstr{i,1} = 'OLNNT'; Gstr{i,2} = 'OLNDT'; 
fOLNNT(i)=fOLNNT(i)-1; fOLNDT(i)=fOLNDT(i)-1; fHO2(i)=fHO2(i)+0.5; fNO2(i)=fNO2(i)+0.5;
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fONITT(i)=fONITT(i)+1; fONITS(i)=fONITS(i)+0.5;

%O3 Tracer
i=i+1; %R360_other_a
Rnames{i} = 'OLNNT+OLNDQ=0.50 HO2+NO2+NOQ+0.202 HCHO+0.640 ALD+0.149 KET+ ONITT +ONITSQ ';
k(:,i) = 4.25E-14.*exp(1000./T);
Gstr{i,1} = 'OLNNT'; Gstr{i,2} = 'OLNDSQ'; 
fOLNNT(i)=fOLNNT(i)-1; fOLNDSQ(i)=fOLNDSQ(i)-1; fHO2(i)=fHO2(i)+0.5; fNO2(i)=fNO2(i)+(1/6); fNOQ(i)=fNOQ(i)+(2/6);
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fONITT(i)=fONITT(i)+1; fONITSQ(i)=fONITSQ(i)+0.5; 

%O3 Tracer
i=i+1; %R360_other_b
Rnames{i} = 'OLNNT+OLNDSQ2=0.50 HO2+NQ2+NOQ+0.202 HCHO+0.640 ALD+0.149 KET+ ONITT +ONITSQ2';
k(:,i) = 4.25E-14.*exp(1000./T);
Gstr{i,1} = 'OLNNT'; Gstr{i,2} = 'OLNDSQ2'; 
fOLNNT(i)=fOLNNT(i)-1; fOLNDSQ2(i)=fOLNDSQ2(i)-1; fHO2(i)=fHO2(i)+0.5; fNQ2(i)=fNQ2(i)+(1/6); fNOQ(i)=fNOQ(i)+(2/6);
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fONITT(i)=fONITT(i)+1; fONITSQ2(i)=fONITSQ2(i)+0.5; 

%O3 Tracer
i=i+1; %R360_other_c
Rnames{i} = 'OLNNT+OLNDSQ3=0.50 HO2+NQ2+0.202 HCHO+0.640 ALD+0.149 KET+ ONITT +ONITSQ3';
k(:,i) = 4.25E-14.*exp(1000./T);
Gstr{i,1} = 'OLNNT'; Gstr{i,2} = 'OLNDSQ3'; 
fOLNNT(i)=fOLNNT(i)-1; fOLNDSQ3(i)=fOLNDSQ3(i)-1; fHO2(i)=fHO2(i)+0.5; fNQ2(i)=fNQ2(i)+(1/2); 
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fONITT(i)=fONITT(i)+1; fONITSQ3(i)=fONITSQ3(i)+0.5; 

%O3 Tracer
i=i+1; %R360_other_d
Rnames{i} = 'OLNNTQ+OLNDS=0.50 HO2+NO2+0.202 HCHO+0.640 ALD+0.149 KET+ ONITTQ +ONITS';
k(:,i) = 4.25E-14.*exp(1000./T);
Gstr{i,1} = 'OLNNTQ'; Gstr{i,2} = 'OLNDSQ'; 
fOLNNTQ(i)=fOLNNTQ(i)-1; fOLNDS(i)=fOLNDS(i)-1; fHO2(i)=fHO2(i)+0.5; fNO2(i)=fNO2(i)+(1/2); 
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fONITTQ(i)=fONITTQ(i)+1; fONITS(i)=fONITS(i)+0.5; 

%O3 Tracer
i=i+1; %R360_other_e
Rnames{i} = 'OLNNTQ+OLNDSQ=0.50 HO2+NO2+NOQ+0.202 HCHO+0.640 ALD+0.149 KET+ ONITTQ+OLNDSQ';
k(:,i) = 4.25E-14.*exp(1000./T);
Gstr{i,1} = 'OLNNTQ'; Gstr{i,2} = 'OLNDSQ'; 
fOLNNTQ(i)=fOLNNTQ(i)-1; fOLNDSQ(i)=fOLNDSQ(i)-1; fHO2(i)=fHO2(i)+0.5; fNO2(i)=fNO2(i)+(1/6); fNOQ(i)=fNOQ(i)+(2/6); 
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fONITTQ(i)=fONITTQ(i)+1; fONITSQ(i)=fONITSQ(i)+1; 

%O3 Tracer
i=i+1; %R360_other_f
Rnames{i} = 'OLNNTQ+OLNDSQ2=0.50 HO2+NQ2+NOQ+0.202 HCHO+0.640 ALD+0.149 KET+ ONITTQ+ONITSQ2';
k(:,i) = 4.25E-14.*exp(1000./T);
Gstr{i,1} = 'OLNNTQ'; Gstr{i,2} = 'OLNDSQ2'; 
fOLNNTQ(i)=fOLNNTQ(i)-1; fOLNDSQ2(i)=fOLNDSQ2(i)-1; fHO2(i)=fHO2(i)+0.5; fNQ2(i)=fNQ2(i)+(1/6); fNOQ(i)=fNOQ(i)+(2/6); 
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fONITTQ(i)=fONITTQ(i)+1; fONITSQ2(i)=fONITSQ2(i)+0.5; 

%O3 Tracer
i=i+1; %R360_other_g
Rnames{i} = 'OLNNTQ+OLNDSQ3=0.50 HO2+NQ2+0.202 HCHO+0.640 ALD+0.149 KET+ ONITTQ+ONITSQ3';
k(:,i) = 4.25E-14.*exp(1000./T);
Gstr{i,1} = 'OLNNTQ'; Gstr{i,2} = 'OLNDSQ3'; 
fOLNNTQ(i)=fOLNNTQ(i)-1; fOLNDSQ3(i)=fOLNDSQ3(i)-1; fHO2(i)=fHO2(i)+0.5; fNQ2(i)=fNQ2(i)+(1/2);  
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fONITTQ(i)=fONITTQ(i)+1; fONITSQ3(i)=fONITSQ3(i)+0.5; 

%O3 Tracer
i=i+1; %R360_other_h
Rnames{i} = 'OLNNTQ2+OLNDS=0.50 HO2+NO2+0.202 HCHO+0.640 ALD+0.149 KET+ ONITTQ2+ONITS';
k(:,i) = 4.25E-14.*exp(1000./T);
Gstr{i,1} = 'OLNNTQ2'; Gstr{i,2} = 'OLNDS'; 
fOLNNTQ2(i)=fOLNNTQ2(i)-1; fOLNDS(i)=fOLNDS(i)-1; fHO2(i)=fHO2(i)+0.5; fNO2(i)=fNO2(i)+(1/2);  
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fONITTQ2(i)=fONITTQ2(i)+1; fONITS(i)=fONITS(i)+0.5; 

%O3 Tracer
i=i+1; %R360_other_i
Rnames{i} = 'OLNNTQ2+OLNDSQ=0.50 HO2+NO2+NOQ+0.202 HCHO+0.640 ALD+0.149 KET+ ONITTQ2+ONITSQ';
k(:,i) = 4.25E-14.*exp(1000./T);
Gstr{i,1} = 'OLNNTQ2'; Gstr{i,2} = 'OLNDSQ'; 
fOLNNTQ2(i)=fOLNNTQ2(i)-1; fOLNDSQ(i)=fOLNDSQ(i)-1; fHO2(i)=fHO2(i)+0.5; fNO2(i)=fNO2(i)+(1/6); fNOQ(i)=fNOQ(i)+(2/6);  
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fONITTQ2(i)=fONITTQ2(i)+1; fONITSQ(i)=fONITSQ(i)+0.5; 

%O3 Tracer
i=i+1; %R360_other_j
Rnames{i} = 'OLNNTQ2+OLNDSQ2=0.50 HO2+NQ2+NOQ+0.202 HCHO+0.640 ALD+0.149 KET+ ONITTQ2+ONITSQ2';
k(:,i) = 4.25E-14.*exp(1000./T);
Gstr{i,1} = 'OLNNTQ2'; Gstr{i,2} = 'OLNDSQ2'; 
fOLNNTQ2(i)=fOLNNTQ2(i)-1; fOLNDSQ2(i)=fOLNDSQ2(i)-1; fHO2(i)=fHO2(i)+0.5; fNQ2(i)=fNQ2(i)+(1/6); fNOQ(i)=fNOQ(i)+(2/6);  
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fONITTQ2(i)=fONITTQ2(i)+1; fONITSQ2(i)=fONITSQ2(i)+0.5; 

%O3 Tracer
i=i+1; %R360_other_k
Rnames{i} = 'OLNNTQ2+OLNDSQ3=0.50 HO2+NQ2+0.202 HCHO+0.640 ALD+0.149 KET+ ONITTQ2+ONITSQ3';
k(:,i) = 4.25E-14.*exp(1000./T);
Gstr{i,1} = 'OLNNTQ2'; Gstr{i,2} = 'OLNDSQ3'; 
fOLNNTQ2(i)=fOLNNTQ2(i)-1; fOLNDSQ3(i)=fOLNDSQ3(i)-1; fHO2(i)=fHO2(i)+0.5; fNQ2(i)=fNQ2(i)+(1/2);   
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fONITTQ2(i)=fONITTQ2(i)+1; fONITSQ3(i)=fONITSQ3(i)+0.5; 

%O3 Tracer
i=i+1; %R360_other_l
Rnames{i} = 'OLNNTQ3+OLNDS=0.50 HO2+NO2+0.202 HCHO+0.640 ALD+0.149 KET+ ONITTQ3+ONITS';
k(:,i) = 4.25E-14.*exp(1000./T);
Gstr{i,1} = 'OLNNTQ3'; Gstr{i,2} = 'OLNDS'; 
fOLNNTQ3(i)=fOLNNTQ3(i)-1; fOLNDS(i)=fOLNDS(i)-1; fHO2(i)=fHO2(i)+0.5; fNO2(i)=fNO2(i)+(1/2);   
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fONITTQ3(i)=fONITTQ3(i)+1; fONITS(i)=fONITS(i)+0.5; 

%O3 Tracer
i=i+1; %R360_other_m
Rnames{i} = 'OLNNTQ3+OLNDSQ=0.50 HO2+NO2+NOQ+0.202 HCHO+0.640 ALD+0.149 KET+ ONITTQ3+ONITSQ';
k(:,i) = 4.25E-14.*exp(1000./T);
Gstr{i,1} = 'OLNNTQ3'; Gstr{i,2} = 'OLNDSQ'; 
fOLNNTQ3(i)=fOLNNTQ3(i)-1; fOLNDSQ(i)=fOLNDSQ(i)-1; fHO2(i)=fHO2(i)+0.5; fNO2(i)=fNO2(i)+(1/6); fNOQ(i)=fNOQ(i)+(2/6);   
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fONITTQ3(i)=fONITTQ3(i)+1; fONITSQ(i)=fONITSQ(i)+0.5; 

%O3 Tracer
i=i+1; %R360_other_n
Rnames{i} = 'OLNNTQ3+OLNDSQ2=0.50 HO2+NQ2+NOQ+0.202 HCHO+0.640 ALD+0.149 KET+ ONITTQ3+ONITSQ2';
k(:,i) = 4.25E-14.*exp(1000./T);
Gstr{i,1} = 'OLNNTQ3'; Gstr{i,2} = 'OLNDSQ2'; 
fOLNNTQ3(i)=fOLNNTQ3(i)-1; fOLNDSQ2(i)=fOLNDSQ2(i)-1; fHO2(i)=fHO2(i)+0.5; fNQ2(i)=fNQ2(i)+(1/6); fNOQ(i)=fNOQ(i)+(2/6);   
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fONITTQ3(i)=fONITTQ3(i)+1; fONITSQ2(i)=fONITSQ2(i)+0.5; 

%O3 Tracer
i=i+1; %R360_other_o
Rnames{i} = 'OLNNTQ3+OLNDSQ3=0.50 HO2+NQ2+0.202 HCHO+0.640 ALD+0.149 KET+ ONITTQ3 + ONITSQ3';
k(:,i) = 4.25E-14.*exp(1000./T);
Gstr{i,1} = 'OLNNTQ3'; Gstr{i,2} = 'OLNDSQ3'; 
fOLNNTQ3(i)=fOLNNTQ3(i)-1; fOLNDSQ3(i)=fOLNDSQ3(i)-1; fHO2(i)=fHO2(i)+0.5; fNQ2(i)=fNQ2(i)+(1/2);    
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fONITTQ3(i)=fONITTQ3(i)+1; fONITSQ3(i)=fONITSQ3(i)+1;


i=i+1; %R360_other_2
Rnames{i} = 'OLNNS+OLNDT=0.50 HO2+0.50 NO2+0.202 HCHO+0.640 ALD+0.149 KET+1.0 ONITS+0.5ONITT ';
k(:,i) = 4.25E-14.*exp(1000./T);
Gstr{i,1} = 'OLNNT'; Gstr{i,2} = 'OLNDT'; 
fOLNNT(i)=fOLNNT(i)-1; fOLNDT(i)=fOLNDT(i)-1; fHO2(i)=fHO2(i)+0.5; fNO2(i)=fNO2(i)+0.5;
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fONITS(i)=fONITS(i)+1; fONITT(i)=fONITT(i)+0.5;

%O3 Tracer
i=i+1; %R360_other2_a
Rnames{i} = 'OLNNS+OLNDTQ=0.50 HO2+NO2+NOQ+0.202 HCHO+0.640 ALD+0.149 KET+ ONITS +ONITTQ ';
k(:,i) = 4.25E-14.*exp(1000./T);
Gstr{i,1} = 'OLNNS'; Gstr{i,2} = 'OLNDTQ'; 
fOLNNS(i)=fOLNNS(i)-1; fOLNDTQ(i)=fOLNDTQ(i)-1; fHO2(i)=fHO2(i)+0.5; fNO2(i)=fNO2(i)+(1/6); fNOQ(i)=fNOQ(i)+(2/6);
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fONITS(i)=fONITS(i)+1; fONITTQ(i)=fONITTQ(i)+0.5; 

%O3 Tracer
i=i+1; %R360_other2_b
Rnames{i} = 'OLNNS+OLNDTQ2=0.50 HO2+NQ2+NOQ+0.202 HCHO+0.640 ALD+0.149 KET+ ONITS +ONITTQ2';
k(:,i) = 4.25E-14.*exp(1000./T);
Gstr{i,1} = 'OLNNS'; Gstr{i,2} = 'OLNDTQ2'; 
fOLNNS(i)=fOLNNS(i)-1; fOLNDTQ2(i)=fOLNDTQ2(i)-1; fHO2(i)=fHO2(i)+0.5; fNQ2(i)=fNQ2(i)+(1/6); fNOQ(i)=fNOQ(i)+(2/6);
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fONITS(i)=fONITS(i)+1; fONITTQ2(i)=fONITTQ2(i)+0.5; 

%O3 Tracer
i=i+1; %R360_other2_c
Rnames{i} = 'OLNNS+OLNDTQ3=0.50 HO2+NQ2+0.202 HCHO+0.640 ALD+0.149 KET+ ONITS +ONITTQ3';
k(:,i) = 4.25E-14.*exp(1000./T);
Gstr{i,1} = 'OLNNS'; Gstr{i,2} = 'OLNDTQ3'; 
fOLNNS(i)=fOLNNS(i)-1; fOLNDTQ3(i)=fOLNDTQ3(i)-1; fHO2(i)=fHO2(i)+0.5; fNQ2(i)=fNQ2(i)+(1/2); 
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fONITS(i)=fONITS(i)+1; fONITTQ3(i)=fONITTQ3(i)+0.5; 

%O3 Tracer
i=i+1; %R360_other2_d
Rnames{i} = 'OLNNSQ+OLNDT=0.50 HO2+NO2+0.202 HCHO+0.640 ALD+0.149 KET+ ONITSQ +ONITT';
k(:,i) = 4.25E-14.*exp(1000./T);
Gstr{i,1} = 'OLNNSQ'; Gstr{i,2} = 'OLNDTQ'; 
fOLNNSQ(i)=fOLNNSQ(i)-1; fOLNDT(i)=fOLNDT(i)-1; fHO2(i)=fHO2(i)+0.5; fNO2(i)=fNO2(i)+(1/2); 
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fONITSQ(i)=fONITSQ(i)+1; fONITT(i)=fONITT(i)+0.5; 

%O3 Tracer
i=i+1; %R360_other2_e
Rnames{i} = 'OLNNSQ+OLNDTQ=0.50 HO2+NO2+NOQ+0.202 HCHO+0.640 ALD+0.149 KET + ONITSQ+ ONITTQ';
k(:,i) = 4.25E-14.*exp(1000./T);
Gstr{i,1} = 'OLNNSQ'; Gstr{i,2} = 'OLNDTQ'; 
fOLNNSQ(i)=fOLNNSQ(i)-1; fOLNDTQ(i)=fOLNDTQ(i)-1; fHO2(i)=fHO2(i)+0.5; fNO2(i)=fNO2(i)+(1/6); fNOQ(i)=fNOQ(i)+(2/6); 
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fONITTQ(i)=fONITTQ(i)+0.5; fONITSQ(i)=fONITSQ(i)+1.0; 

%O3 Tracer
i=i+1; %R360_other2_f
Rnames{i} = 'OLNNSQ+OLNDTQ2=0.50 HO2+NQ2+NOQ+0.202 HCHO+0.640 ALD+0.149 KET+ ONITSQ+ONITTQ2';
k(:,i) = 4.25E-14.*exp(1000./T);
Gstr{i,1} = 'OLNNSQ'; Gstr{i,2} = 'OLNDTQ2'; 
fOLNNSQ(i)=fOLNNSQ(i)-1; fOLNDTQ2(i)=fOLNDTQ2(i)-1; fHO2(i)=fHO2(i)+0.5; fNQ2(i)=fNQ2(i)+(1/6); fNOQ(i)=fNOQ(i)+(2/6); 
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fONITSQ(i)=fONITSQ(i)+1; fONITTQ2(i)=fONITTQ2(i)+0.5; 

%O3 Tracer
i=i+1; %R360_other2_g
Rnames{i} = 'OLNNSQ+OLNDTQ3=0.50 HO2+NQ2+0.202 HCHO+0.640 ALD+0.149 KET+ ONITSQ+ONITTQ3';
k(:,i) = 4.25E-14.*exp(1000./T);
Gstr{i,1} = 'OLNNSQ'; Gstr{i,2} = 'OLNDTQ3'; 
fOLNNSQ(i)=fOLNNSQ(i)-1; fOLNDTQ3(i)=fOLNDTQ3(i)-1; fHO2(i)=fHO2(i)+0.5; fNQ2(i)=fNQ2(i)+(1/2);  
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fONITSQ(i)=fONITSQ(i)+1; fONITTQ3(i)=fONITTQ3(i)+0.5; 

%O3 Tracer
i=i+1; %R360_other2_h
Rnames{i} = 'OLNNSQ2+OLNDT=0.50 HO2+NO2+0.202 HCHO+0.640 ALD+0.149 KET+ ONITSQ2+ONITT';
k(:,i) = 4.25E-14.*exp(1000./T);
Gstr{i,1} = 'OLNNSQ2'; Gstr{i,2} = 'OLNDT'; 
fOLNNSQ2(i)=fOLNNSQ2(i)-1; fOLNDT(i)=fOLNDT(i)-1; fHO2(i)=fHO2(i)+0.5; fNO2(i)=fNO2(i)+(1/2);  
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fONITSQ2(i)=fONITSQ2(i)+1; fONITT(i)=fONITT(i)+0.5; 

%O3 Tracer
i=i+1; %R360_other2_i
Rnames{i} = 'OLNNSQ2+OLNDTQ=0.50 HO2+NO2+NOQ+0.202 HCHO+0.640 ALD+0.149 KET+ ONITSQ2+ONITTQ';
k(:,i) = 4.25E-14.*exp(1000./T);
Gstr{i,1} = 'OLNNSQ2'; Gstr{i,2} = 'OLNDTQ'; 
fOLNNSQ2(i)=fOLNNSQ2(i)-1; fOLNDTQ(i)=fOLNDTQ(i)-1; fHO2(i)=fHO2(i)+0.5; fNO2(i)=fNO2(i)+(1/6); fNOQ(i)=fNOQ(i)+(2/6);  
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fONITSQ2(i)=fONITSQ2(i)+1; fONITTQ(i)=fONITTQ(i)+0.5; 

%O3 Tracer
i=i+1; %R360_other2_j
Rnames{i} = 'OLNNSQ2+OLNDTQ2=0.50 HO2+NQ2+NOQ+0.202 HCHO+0.640 ALD+0.149 KET+ ONITSQ2+ONITTQ2';
k(:,i) = 4.25E-14.*exp(1000./T);
Gstr{i,1} = 'OLNNSQ2'; Gstr{i,2} = 'OLNDTQ2'; 
fOLNNSQ2(i)=fOLNNSQ2(i)-1; fOLNDTQ2(i)=fOLNDTQ2(i)-1; fHO2(i)=fHO2(i)+0.5; fNQ2(i)=fNQ2(i)+(1/6); fNOQ(i)=fNOQ(i)+(2/6);  
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fONITTQ2(i)=fONITTQ2(i)+0.5; fONITSQ2(i)=fONITSQ2(i)+1.0; 

%O3 Tracer
i=i+1; %R360_other2_k
Rnames{i} = 'OLNNSQ2+OLNDTQ3=0.50 HO2+NQ2+0.202 HCHO+0.640 ALD+0.149 KET+ ONITSQ2+ONITTQ3';
k(:,i) = 4.25E-14.*exp(1000./T);
Gstr{i,1} = 'OLNNSQ2'; Gstr{i,2} = 'OLNDTQ3'; 
fOLNNSQ2(i)=fOLNNSQ2(i)-1; fOLNDTQ3(i)=fOLNDTQ3(i)-1; fHO2(i)=fHO2(i)+0.5; fNQ2(i)=fNQ2(i)+(1/2);   
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fONITSQ2(i)=fONITSQ2(i)+1; fONITTQ3(i)=fONITTQ3(i)+0.5; 

%O3 Tracer
i=i+1; %R360_other2_l
Rnames{i} = 'OLNNSQ3+OLNDT=0.50 HO2+NO2+0.202 HCHO+0.640 ALD+0.149 KET+ ONITSQ3+ONITT';
k(:,i) = 4.25E-14.*exp(1000./T);
Gstr{i,1} = 'OLNNSQ3'; Gstr{i,2} = 'OLNDT'; 
fOLNNSQ3(i)=fOLNNSQ3(i)-1; fOLNDT(i)=fOLNDT(i)-1; fHO2(i)=fHO2(i)+0.5; fNO2(i)=fNO2(i)+(1/2);   
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fONITSQ3(i)=fONITSQ3(i)+1; fONITT(i)=fONITT(i)+0.5; 

%O3 Tracer
i=i+1; %R360_other2_m
Rnames{i} = 'OLNNSQ3+OLNDTQ=0.50 HO2+NO2+NOQ+0.202 HCHO+0.640 ALD+0.149 KET+ ONITSQ3+ONITTQ';
k(:,i) = 4.25E-14.*exp(1000./T);
Gstr{i,1} = 'OLNNSQ3'; Gstr{i,2} = 'OLNDTQ'; 
fOLNNSQ3(i)=fOLNNSQ3(i)-1; fOLNDTQ(i)=fOLNDTQ(i)-1; fHO2(i)=fHO2(i)+0.5; fNO2(i)=fNO2(i)+(1/6); fNOQ(i)=fNOQ(i)+(2/6);   
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fONITSQ3(i)=fONITSQ3(i)+1; fONITTQ(i)=fONITTQ(i)+0.5; 

%O3 Tracer
i=i+1; %R360_other2_n
Rnames{i} = 'OLNNSQ3+OLNDTQ2=0.50 HO2+NQ2+NOQ+0.202 HCHO+0.640 ALD+0.149 KET+ ONITSQ3+ONITTQ2';
k(:,i) = 4.25E-14.*exp(1000./T);
Gstr{i,1} = 'OLNNSQ3'; Gstr{i,2} = 'OLNDTQ2'; 
fOLNNSQ3(i)=fOLNNSQ3(i)-1; fOLNDTQ2(i)=fOLNDTQ2(i)-1; fHO2(i)=fHO2(i)+0.5; fNQ2(i)=fNQ2(i)+(1/6); fNOQ(i)=fNOQ(i)+(2/6);   
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fONITSQ3(i)=fONITSQ3(i)+1; fONITTQ2(i)=fONITTQ2(i)+0.5; 

%O3 Tracer
i=i+1; %R360_other2_o
Rnames{i} = 'OLNNSQ3+OLNDTQ3=0.50 HO2+NQ2+0.202 HCHO+0.640 ALD+0.149 KET + ONITSQ3+ ONITTQ3';
k(:,i) = 4.25E-14.*exp(1000./T);
Gstr{i,1} = 'OLNNSQ3'; Gstr{i,2} = 'OLNDTQ3'; 
fOLNNSQ3(i)=fOLNNSQ3(i)-1; fOLNDTQ3(i)=fOLNDTQ3(i)-1; fHO2(i)=fHO2(i)+0.5; fNQ2(i)=fNQ2(i)+(1/2);    
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fONITTQ3(i)=fONITTQ3(i)+0.5; fONITSQ3(i)=fONITSQ3(i)+1.0;

i=i+1; %R360_other_3
Rnames{i} = 'OLNNS+OLNDS=0.50 HO2+0.50 NO2+0.202 HCHO+0.640 ALD+0.149 KET+1.5 ONITS ';
k(:,i) = 4.25E-14.*exp(1000./T);
Gstr{i,1} = 'OLNNT'; Gstr{i,2} = 'OLNDT'; 
fOLNNT(i)=fOLNNT(i)-1; fOLNDT(i)=fOLNDT(i)-1; fHO2(i)=fHO2(i)+0.5; fNO2(i)=fNO2(i)+0.5;
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fONITS(i)=fONITS(i)+1.5;

%O3 Tracer
i=i+1; %R360_other3_a
Rnames{i} = 'OLNNS+OLNDSQ=0.50 HO2+NO2+NOQ+0.202 HCHO+0.640 ALD+0.149 KET+ ONITS +ONITSQ ';
k(:,i) = 4.25E-14.*exp(1000./T);
Gstr{i,1} = 'OLNNS'; Gstr{i,2} = 'OLNDSQ'; 
fOLNNS(i)=fOLNNS(i)-1; fOLNDSQ(i)=fOLNDSQ(i)-1; fHO2(i)=fHO2(i)+0.5; fNO2(i)=fNO2(i)+(1/6); fNOQ(i)=fNOQ(i)+(2/6);
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fONITS(i)=fONITS(i)+1; fONITSQ(i)=fONITSQ(i)+0.5; 

%O3 Tracer
i=i+1; %R360_other3_b
Rnames{i} = 'OLNNS+OLNDSQ2=0.50 HO2+NQ2+NOQ+0.202 HCHO+0.640 ALD+0.149 KET+ ONITS +ONITSQ2';
k(:,i) = 4.25E-14.*exp(1000./T);
Gstr{i,1} = 'OLNNS'; Gstr{i,2} = 'OLNDSQ2'; 
fOLNNS(i)=fOLNNS(i)-1; fOLNDSQ2(i)=fOLNDSQ2(i)-1; fHO2(i)=fHO2(i)+0.5; fNQ2(i)=fNQ2(i)+(1/6); fNOQ(i)=fNOQ(i)+(2/6);
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fONITS(i)=fONITS(i)+1; fONITSQ2(i)=fONITSQ2(i)+0.5; 

%O3 Tracer
i=i+1; %R360_other3_c
Rnames{i} = 'OLNNS+OLNDSQ3=0.50 HO2+NQ2+0.202 HCHO+0.640 ALD+0.149 KET+ ONITS +ONITSQ3';
k(:,i) = 4.25E-14.*exp(1000./T);
Gstr{i,1} = 'OLNNS'; Gstr{i,2} = 'OLNDSQ3'; 
fOLNNS(i)=fOLNNS(i)-1; fOLNDSQ3(i)=fOLNDSQ3(i)-1; fHO2(i)=fHO2(i)+0.5; fNQ2(i)=fNQ2(i)+(1/2); 
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fONITS(i)=fONITS(i)+1; fONITSQ3(i)=fONITSQ3(i)+0.5; 

%O3 Tracer
i=i+1; %R360_other3_d
Rnames{i} = 'OLNNSQ+OLNDS=0.50 HO2+NO2+0.202 HCHO+0.640 ALD+0.149 KET+ ONITSQ +ONITS';
k(:,i) = 4.25E-14.*exp(1000./T);
Gstr{i,1} = 'OLNNSQ'; Gstr{i,2} = 'OLNDSQ'; 
fOLNNSQ(i)=fOLNNSQ(i)-1; fOLNDS(i)=fOLNDS(i)-1; fHO2(i)=fHO2(i)+0.5; fNO2(i)=fNO2(i)+(1/2); 
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fONITSQ(i)=fONITSQ(i)+1; fONITS(i)=fONITS(i)+0.5; 

%O3 Tracer
i=i+1; %R360_other3_e
Rnames{i} = 'OLNNSQ+OLNDSQ=0.50 HO2+NO2+NOQ+0.202 HCHO+0.640 ALD+0.149 KET+ ONITSQ';
k(:,i) = 4.25E-14.*exp(1000./T);
Gstr{i,1} = 'OLNNSQ'; Gstr{i,2} = 'OLNDSQ'; 
fOLNNSQ(i)=fOLNNSQ(i)-1; fOLNDSQ(i)=fOLNDSQ(i)-1; fHO2(i)=fHO2(i)+0.5; fNO2(i)=fNO2(i)+(1/6); fNOQ(i)=fNOQ(i)+(2/6); 
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fONITSQ(i)=fONITSQ(i)+1.5; 

%O3 Tracer
i=i+1; %R360_other3_f
Rnames{i} = 'OLNNSQ+OLNDSQ2=0.50 HO2+NQ2+NOQ+0.202 HCHO+0.640 ALD+0.149 KET+ ONITSQ+ONITSQ2';
k(:,i) = 4.25E-14.*exp(1000./T);
Gstr{i,1} = 'OLNNSQ'; Gstr{i,2} = 'OLNDSQ2'; 
fOLNNSQ(i)=fOLNNSQ(i)-1; fOLNDSQ2(i)=fOLNDSQ2(i)-1; fHO2(i)=fHO2(i)+0.5; fNQ2(i)=fNQ2(i)+(1/6); fNOQ(i)=fNOQ(i)+(2/6); 
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fONITSQ(i)=fONITSQ(i)+1; fONITSQ2(i)=fONITSQ2(i)+0.5; 

%O3 Tracer
i=i+1; %R360_other3_g
Rnames{i} = 'OLNNSQ+OLNDSQ3=0.50 HO2+NQ2+0.202 HCHO+0.640 ALD+0.149 KET+ ONITSQ+ONITSQ3';
k(:,i) = 4.25E-14.*exp(1000./T);
Gstr{i,1} = 'OLNNSQ'; Gstr{i,2} = 'OLNDSQ3'; 
fOLNNSQ(i)=fOLNNSQ(i)-1; fOLNDSQ3(i)=fOLNDSQ3(i)-1; fHO2(i)=fHO2(i)+0.5; fNQ2(i)=fNQ2(i)+(1/2);  
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fONITSQ(i)=fONITSQ(i)+1; fONITSQ3(i)=fONITSQ3(i)+0.5; 

%O3 Tracer
i=i+1; %R360_other3_h
Rnames{i} = 'OLNNSQ2+OLNDS=0.50 HO2+NO2+0.202 HCHO+0.640 ALD+0.149 KET+ ONITSQ2+ONITS';
k(:,i) = 4.25E-14.*exp(1000./T);
Gstr{i,1} = 'OLNNSQ2'; Gstr{i,2} = 'OLNDS'; 
fOLNNSQ2(i)=fOLNNSQ2(i)-1; fOLNDS(i)=fOLNDS(i)-1; fHO2(i)=fHO2(i)+0.5; fNO2(i)=fNO2(i)+(1/2);  
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fONITSQ2(i)=fONITSQ2(i)+1; fONITS(i)=fONITS(i)+0.5; 

%O3 Tracer
i=i+1; %R360_other3_i
Rnames{i} = 'OLNNSQ2+OLNDSQ=0.50 HO2+NO2+NOQ+0.202 HCHO+0.640 ALD+0.149 KET+ ONITSQ2+ONITSQ';
k(:,i) = 4.25E-14.*exp(1000./T);
Gstr{i,1} = 'OLNNSQ2'; Gstr{i,2} = 'OLNDSQ'; 
fOLNNSQ2(i)=fOLNNSQ2(i)-1; fOLNDSQ(i)=fOLNDSQ(i)-1; fHO2(i)=fHO2(i)+0.5; fNO2(i)=fNO2(i)+(1/6); fNOQ(i)=fNOQ(i)+(2/6);  
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fONITSQ2(i)=fONITSQ2(i)+1; fONITSQ(i)=fONITSQ(i)+0.5; 

%O3 Tracer
i=i+1; %R360_other3_j
Rnames{i} = 'OLNNSQ2+OLNDSQ2=0.50 HO2+NQ2+NOQ+0.202 HCHO+0.640 ALD+0.149 KET+ ONITSQ2+ONITSQ2';
k(:,i) = 4.25E-14.*exp(1000./T);
Gstr{i,1} = 'OLNNSQ2'; Gstr{i,2} = 'OLNDSQ2'; 
fOLNNSQ2(i)=fOLNNSQ2(i)-1; fOLNDSQ2(i)=fOLNDSQ2(i)-1; fHO2(i)=fHO2(i)+0.5; fNQ2(i)=fNQ2(i)+(1/6); fNOQ(i)=fNOQ(i)+(2/6);  
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fONITSQ2(i)=fONITSQ2(i)+1.5; 

%O3 Tracer
i=i+1; %R360_other3_k
Rnames{i} = 'OLNNSQ2+OLNDSQ3=0.50 HO2+NQ2+0.202 HCHO+0.640 ALD+0.149 KET+ ONITSQ2+ONITSQ3';
k(:,i) = 4.25E-14.*exp(1000./T);
Gstr{i,1} = 'OLNNSQ2'; Gstr{i,2} = 'OLNDSQ3'; 
fOLNNSQ2(i)=fOLNNSQ2(i)-1; fOLNDSQ3(i)=fOLNDSQ3(i)-1; fHO2(i)=fHO2(i)+0.5; fNQ2(i)=fNQ2(i)+(1/2);   
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fONITSQ2(i)=fONITSQ2(i)+1; fONITSQ3(i)=fONITSQ3(i)+0.5; 

%O3 Tracer
i=i+1; %R360_other3_l
Rnames{i} = 'OLNNSQ3+OLNDS=0.50 HO2+NO2+0.202 HCHO+0.640 ALD+0.149 KET+ ONITSQ3+ONITS';
k(:,i) = 4.25E-14.*exp(1000./T);
Gstr{i,1} = 'OLNNSQ3'; Gstr{i,2} = 'OLNDS'; 
fOLNNSQ3(i)=fOLNNSQ3(i)-1; fOLNDS(i)=fOLNDS(i)-1; fHO2(i)=fHO2(i)+0.5; fNO2(i)=fNO2(i)+(1/2);   
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fONITSQ3(i)=fONITSQ3(i)+1; fONITS(i)=fONITS(i)+0.5; 

%O3 Tracer
i=i+1; %R360_other3_m
Rnames{i} = 'OLNNSQ3+OLNDSQ=0.50 HO2+NO2+NOQ+0.202 HCHO+0.640 ALD+0.149 KET+ ONITSQ3+ONITSQ';
k(:,i) = 4.25E-14.*exp(1000./T);
Gstr{i,1} = 'OLNNSQ3'; Gstr{i,2} = 'OLNDSQ'; 
fOLNNSQ3(i)=fOLNNSQ3(i)-1; fOLNDSQ(i)=fOLNDSQ(i)-1; fHO2(i)=fHO2(i)+0.5; fNO2(i)=fNO2(i)+(1/6); fNOQ(i)=fNOQ(i)+(2/6);   
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fONITSQ3(i)=fONITSQ3(i)+1; fONITSQ(i)=fONITSQ(i)+0.5; 

%O3 Tracer
i=i+1; %R360_other3_n
Rnames{i} = 'OLNNSQ3+OLNDSQ2=0.50 HO2+NQ2+NOQ+0.202 HCHO+0.640 ALD+0.149 KET+ ONITSQ3+ONITSQ2';
k(:,i) = 4.25E-14.*exp(1000./T);
Gstr{i,1} = 'OLNNSQ3'; Gstr{i,2} = 'OLNDSQ2'; 
fOLNNSQ3(i)=fOLNNSQ3(i)-1; fOLNDSQ2(i)=fOLNDSQ2(i)-1; fHO2(i)=fHO2(i)+0.5; fNQ2(i)=fNQ2(i)+(1/6); fNOQ(i)=fNOQ(i)+(2/6);   
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fONITSQ3(i)=fONITSQ3(i)+1; fONITSQ2(i)=fONITSQ2(i)+0.5; 

%O3 Tracer
i=i+1; %R360_other3_o
Rnames{i} = 'OLNNSQ3+OLNDSQ3=0.50 HO2+NQ2+0.202 HCHO+0.640 ALD+0.149 KET+ ONITSQ3';
k(:,i) = 4.25E-14.*exp(1000./T);
Gstr{i,1} = 'OLNNSQ3'; Gstr{i,2} = 'OLNDSQ3'; 
fOLNNSQ3(i)=fOLNNSQ3(i)-1; fOLNDSQ3(i)=fOLNDSQ3(i)-1; fHO2(i)=fHO2(i)+0.5; fNQ2(i)=fNQ2(i)+(1/2);    
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fONITSQ3(i)=fONITSQ3(i)+1.5;


i=i+1; %R361
Rnames{i} = 'OLNDT+OLNDT=NO2+0.504 HCHO+1.21 ALD+0.285 KET+ONITT ';
...
%O3 Tracer
i=i+1; %R361a
Rnames{i} = 'OLNDT+OLNDTQ=NO2+NOQ+0.504 HCHO+1.21 ALD+0.285 KET+ONITT+ONITTQ ';
k(:,i) = 2.96E-14.*exp(1000./T);
Gstr{i,1} = 'OLNDT'; Gstr{i,2} = 'OLNDTQ'; 
fOLNDT(i)=fOLNDT(i)-1; fOLNDTQ(i)=fOLNDTQ(i)-1; fNO2(i)=fNO2(i)+(4/6); fNOQ(i)=fNOQ(i)+(1/3); fHCHO(i)=fHCHO(i)+0.504;
fALD(i)=fALD(i)+1.21; fKET(i)=fKET(i)+0.285; fONITT(i)=fONITT(i)+0.5; fONITTQ(i)=fONITTQ(i)+0.5;

%O3 Tracer
i=i+1; %R361b
Rnames{i} = 'OLNDT+OLNDTQ2=NO2+NOQ+NQ2+0.504 HCHO+1.21 ALD+0.285 KET+ONITT+ONITTQ2';
k(:,i) = 2.96E-14.*exp(1000./T);
Gstr{i,1} = 'OLNDT'; Gstr{i,2} = 'OLNDTQ2'; 
fOLNDT(i)=fOLNDT(i)-1; fOLNDTQ2(i)=fOLNDTQ2(i)-1; fNO2(i)=fNO2(i)+(1/2); fNQ2(i)=fNQ2(i)+(1/6); fNOQ(i)=fNOQ(i)+(2/6); fHCHO(i)=fHCHO(i)+0.504;
fALD(i)=fALD(i)+1.21; fKET(i)=fKET(i)+0.285; fONITT(i)=fONITT(i)+0.5; fONITTQ2(i)=fONITTQ2(i)+0.5;

%O3 Tracer
i=i+1; %R361c
Rnames{i} = 'OLNDT+OLNDTQ3=NO2+NQ2+0.504 HCHO+1.21 ALD+0.285 KET+ONITT+ONITTQ3';
k(:,i) = 2.96E-14.*exp(1000./T);
Gstr{i,1} = 'OLNDT'; Gstr{i,2} = 'OLNDTQ3'; 
fOLNDT(i)=fOLNDT(i)-1; fOLNDTQ3(i)=fOLNDTQ3(i)-1; fNO2(i)=fNO2(i)+(1/2); fNQ2(i)=fNQ2(i)+(1/2); fHCHO(i)=fHCHO(i)+0.504;
fALD(i)=fALD(i)+1.21; fKET(i)=fKET(i)+0.285; fONITT(i)=fONITT(i)+0.5; fONITTQ3(i)=fONITTQ3(i)+0.5;

%O3 Tracer
i=i+1; %R361d
Rnames{i} = 'OLNDTQ+OLNDTQ=NO2+NQ2+0.504 HCHO+1.21 ALD+0.285 KET+ONITTQ';
k(:,i) = 2.96E-14.*exp(1000./T);
Gstr{i,1} = 'OLNDTQ'; Gstr{i,2} = 'OLNDTQ'; 
fOLNDTQ(i)=fOLNDTQ(i)-1; fOLNDTQ(i)=fOLNDTQ(i)-1; fNO2(i)=fNO2(i)+(1/3); fNOQ(i)=fNOQ(i)+(2/3); fHCHO(i)=fHCHO(i)+0.504;
fALD(i)=fALD(i)+1.21; fKET(i)=fKET(i)+0.285; fONITTQ(i)=fONITTQ(i)+1;

%O3 Tracer
i=i+1; %R361e
Rnames{i} = 'OLNDTQ+OLNDTQ2=NO2+NQ2+NQ2+0.504 HCHO+1.21 ALD+0.285 KET+ONITTQ+ONITTQ2';
k(:,i) = 2.96E-14.*exp(1000./T);
Gstr{i,1} = 'OLNDTQ'; Gstr{i,2} = 'OLNDTQ2'; 
fOLNDTQ(i)=fOLNDTQ(i)-1; fOLNDTQ2(i)=fOLNDTQ2(i)-1; fNO2(i)=fNO2(i)+(1/6); fNOQ(i)=fNOQ(i)+(4/6); fNQ2(i)=fNQ2(i)+(1/6); fHCHO(i)=fHCHO(i)+0.504;
fALD(i)=fALD(i)+1.21; fKET(i)=fKET(i)+0.285; fONITTQ(i)=fONITTQ(i)+0.5; fONITTQ2(i)=fONITTQ2(i)+0.5;

%O3 Tracer
i=i+1; %R361f
Rnames{i} = 'OLNDTQ+OLNDTQ3=NO2+NQ2+NQ2+0.504 HCHO+1.21 ALD+0.285 KET+ONITTQ+ONITTQ3';
k(:,i) = 2.96E-14.*exp(1000./T);
Gstr{i,1} = 'OLNDTQ'; Gstr{i,2} = 'OLNDTQ3'; 
fOLNDTQ(i)=fOLNDTQ(i)-1; fOLNDTQ3(i)=fOLNDTQ3(i)-1; fNO2(i)=fNO2(i)+(1/6); fNOQ(i)=fNOQ(i)+(2/6); fNQ2(i)=fNQ2(i)+(1/2); fHCHO(i)=fHCHO(i)+0.504;
fALD(i)=fALD(i)+1.21; fKET(i)=fKET(i)+0.285; fONITTQ(i)=fONITTQ(i)+0.5; fONITTQ3(i)=fONITTQ3(i)+0.5;

%O3 Tracer
i=i+1; %R361g
Rnames{i} = 'OLNDTQ2+OLNDTQ2=NQ2+NQ2+0.504 HCHO+1.21 ALD+0.285 KET+ONITTQ2';
k(:,i) = 2.96E-14.*exp(1000./T);
Gstr{i,1} = 'OLNDTQ2'; Gstr{i,2} = 'OLNDTQ2'; 
fOLNDTQ2(i)=fOLNDTQ2(i)-1; fOLNDTQ2(i)=fOLNDTQ2(i)-1; fNOQ(i)=fNOQ(i)+(2/3); fNQ2(i)=fNQ2(i)+(1/3); fHCHO(i)=fHCHO(i)+0.504;
fALD(i)=fALD(i)+1.21; fKET(i)=fKET(i)+0.285; fONITTQ2(i)=fONITTQ2(i)+1; 

%O3 Tracer
i=i+1; %R361h
Rnames{i} = 'OLNDTQ2+OLNDTQ3=NQ2+NQ2+0.504 HCHO+1.21 ALD+0.285 KET+ONITTQ2+ONITTQ3';
k(:,i) = 2.96E-14.*exp(1000./T);
Gstr{i,1} = 'OLNDTQ2'; Gstr{i,2} = 'OLNDTQ3'; 
fOLNDTQ2(i)=fOLNDTQ2(i)-1; fOLNDTQ3(i)=fOLNDTQ3(i)-1; fNOQ(i)=fNOQ(i)+(2/6); fNQ2(i)=fNQ2(i)+(4/6); fHCHO(i)=fHCHO(i)+0.504;
fALD(i)=fALD(i)+1.21; fKET(i)=fKET(i)+0.285; fONITTQ2(i)=fONITTQ2(i)+0.5; fONITTQ3(i)=fONITTQ3(i)+0.5; 

%O3 Tracer
i=i+1; %R361i
Rnames{i} = 'OLNDTQ3+OLNDTQ3=NQ2+0.504 HCHO+1.21 ALD+0.285 KET+ONITTQ3';
k(:,i) = 2.96E-14.*exp(1000./T);
Gstr{i,1} = 'OLNDTQ3'; Gstr{i,2} = 'OLNDTQ3'; 
fOLNDTQ3(i)=fOLNDTQ3(i)-1; fOLNDTQ3(i)=fOLNDTQ3(i)-1; fNQ2(i)=fNQ2(i)+1; fHCHO(i)=fHCHO(i)+0.504;
fALD(i)=fALD(i)+1.21; fKET(i)=fKET(i)+0.285; fONITTQ3(i)=fONITTQ3(i)+1;


i=i+1; %R361_other1
Rnames{i} = 'OLNDS+OLNDT=NO2+0.504 HCHO+1.21 ALD+0.285 KET+ONITS+ONITT ';
k(:,i) = 2.96E-14.*exp(1000./T);
Gstr{i,1} = 'OLND'; Gstr{i,2} = 'OLND'; 
fOLND(i)=fOLND(i)-1; fOLND(i)=fOLND(i)-1; fNO2(i)=fNO2(i)+1; fHCHO(i)=fHCHO(i)+0.504;
fALD(i)=fALD(i)+1.21; fKET(i)=fKET(i)+0.285; fONITS(i)=fONITS(i)+0.5; fONITT(i)=fONITT(i)+0.5;

%O3 Tracer
i=i+1; %R361_other1_a
Rnames{i} = 'OLNDS+OLNDTQ=NO2+NOQ+0.504 HCHO+1.21 ALD+0.285 KET+ONITS+ONITTQ ';
k(:,i) = 2.96E-14.*exp(1000./T);
Gstr{i,1} = 'OLNDS'; Gstr{i,2} = 'OLNDTQ'; 
fOLNDS(i)=fOLNDS(i)-1; fOLNDTQ(i)=fOLNDTQ(i)-1; fNO2(i)=fNO2(i)+(4/6); fNOQ(i)=fNOQ(i)+(1/3); fHCHO(i)=fHCHO(i)+0.504;
fALD(i)=fALD(i)+1.21; fKET(i)=fKET(i)+0.285; fONITS(i)=fONITS(i)+0.5; fONITTQ(i)=fONITTQ(i)+0.5;

%O3 Tracer
i=i+1; %R361_other1_b
Rnames{i} = 'OLNDS+OLNDTQ2=NO2+NOQ+NQ2+0.504 HCHO+1.21 ALD+0.285 KET+ONITS+ONITTQ2';
k(:,i) = 2.96E-14.*exp(1000./T);
Gstr{i,1} = 'OLNDS'; Gstr{i,2} = 'OLNDTQ2'; 
fOLNDS(i)=fOLNDS(i)-1; fOLNDTQ2(i)=fOLNDTQ2(i)-1; fNO2(i)=fNO2(i)+(1/2); fNQ2(i)=fNQ2(i)+(1/6); fNOQ(i)=fNOQ(i)+(2/6); fHCHO(i)=fHCHO(i)+0.504;
fALD(i)=fALD(i)+1.21; fKET(i)=fKET(i)+0.285; fONITS(i)=fONITS(i)+0.5; fONITTQ2(i)=fONITTQ2(i)+0.5;

%O3 Tracer
i=i+1; %R361_other1_c
Rnames{i} = 'OLNDS+OLNDTQ3=NO2+NQ2+0.504 HCHO+1.21 ALD+0.285 KET+ONITS+ONITTQ3';
k(:,i) = 2.96E-14.*exp(1000./T);
Gstr{i,1} = 'OLNDS'; Gstr{i,2} = 'OLNDTQ3'; 
fOLNDS(i)=fOLNDS(i)-1; fOLNDTQ3(i)=fOLNDTQ3(i)-1; fNO2(i)=fNO2(i)+(1/2); fNQ2(i)=fNQ2(i)+(1/2); fHCHO(i)=fHCHO(i)+0.504;
fALD(i)=fALD(i)+1.21; fKET(i)=fKET(i)+0.285; fONITS(i)=fONITS(i)+0.5; fONITTQ3(i)=fONITTQ3(i)+0.5;

%O3 Tracer
i=i+1; %R361_other1_d
Rnames{i} = 'OLNDSQ+OLNDTQ=NO2+NQ2+0.504 HCHO+1.21 ALD+0.285 KET+ONITSQ+ONITTQ';
k(:,i) = 2.96E-14.*exp(1000./T);
Gstr{i,1} = 'OLNDSQ'; Gstr{i,2} = 'OLNDTQ'; 
fOLNDSQ(i)=fOLNDSQ(i)-1; fOLNDTQ(i)=fOLNDTQ(i)-1; fNO2(i)=fNO2(i)+(1/3); fNOQ(i)=fNOQ(i)+(2/3); fHCHO(i)=fHCHO(i)+0.504;
fALD(i)=fALD(i)+1.21; fKET(i)=fKET(i)+0.285; fONITSQ(i)=fONITSQ(i)+0.5; fONITTQ(i)=fONITTQ(i)+0.5;

%O3 Tracer
i=i+1; %R361_other1_e
Rnames{i} = 'OLNDSQ+OLNDTQ2=NO2+NQ2+NQ2+0.504 HCHO+1.21 ALD+0.285 KET+ONITSQ+ONITTQ2';
k(:,i) = 2.96E-14.*exp(1000./T);
Gstr{i,1} = 'OLNDSQ'; Gstr{i,2} = 'OLNDTQ2'; 
fOLNDSQ(i)=fOLNDSQ(i)-1; fOLNDTQ2(i)=fOLNDTQ2(i)-1; fNO2(i)=fNO2(i)+(1/6); fNOQ(i)=fNOQ(i)+(4/6); fNQ2(i)=fNQ2(i)+(1/6); fHCHO(i)=fHCHO(i)+0.504;
fALD(i)=fALD(i)+1.21; fKET(i)=fKET(i)+0.285; fONITSQ(i)=fONITSQ(i)+0.5; fONITTQ2(i)=fONITTQ2(i)+0.5;

%O3 Tracer
i=i+1; %R361_other1_f
Rnames{i} = 'OLNDSQ+OLNDTQ3=NO2+NQ2+NQ2+0.504 HCHO+1.21 ALD+0.285 KET+ONITSQ+ONITTQ3';
k(:,i) = 2.96E-14.*exp(1000./T);
Gstr{i,1} = 'OLNDSQ'; Gstr{i,2} = 'OLNDTQ3'; 
fOLNDSQ(i)=fOLNDSQ(i)-1; fOLNDTQ3(i)=fOLNDTQ3(i)-1; fNO2(i)=fNO2(i)+(1/6); fNOQ(i)=fNOQ(i)+(2/6); fNQ2(i)=fNQ2(i)+(1/2); fHCHO(i)=fHCHO(i)+0.504;
fALD(i)=fALD(i)+1.21; fKET(i)=fKET(i)+0.285; fONITSQ(i)=fONITSQ(i)+0.5; fONITTQ3(i)=fONITTQ3(i)+0.5;

%O3 Tracer
i=i+1; %R361_other1_g
Rnames{i} = 'OLNDSQ2+OLNDTQ2=NQ2+NQ2+0.504 HCHO+1.21 ALD+0.285 KET+ONITSQ2+ONITTQ2';
k(:,i) = 2.96E-14.*exp(1000./T);
Gstr{i,1} = 'OLNDSQ2'; Gstr{i,2} = 'OLNDTQ2'; 
fOLNDSQ2(i)=fOLNDSQ2(i)-1; fOLNDTQ2(i)=fOLNDTQ2(i)-1; fNOQ(i)=fNOQ(i)+(2/3); fNQ2(i)=fNQ2(i)+(1/3); fHCHO(i)=fHCHO(i)+0.504;
fALD(i)=fALD(i)+1.21; fKET(i)=fKET(i)+0.285; fONITSQ2(i)=fONITSQ2(i)+0.5; fONITTQ2(i)=fONITTQ2(i)+0.5; 

%O3 Tracer
i=i+1; %R361_other1_h
Rnames{i} = 'OLNDSQ2+OLNDTQ3=NQ2+NQ2+0.504 HCHO+1.21 ALD+0.285 KET+ONITSQ2+ONITTQ3';
k(:,i) = 2.96E-14.*exp(1000./T);
Gstr{i,1} = 'OLNDSQ2'; Gstr{i,2} = 'OLNDTQ3'; 
fOLNDSQ2(i)=fOLNDSQ2(i)-1; fOLNDTQ3(i)=fOLNDTQ3(i)-1; fNOQ(i)=fNOQ(i)+(2/6); fNQ2(i)=fNQ2(i)+(4/6); fHCHO(i)=fHCHO(i)+0.504;
fALD(i)=fALD(i)+1.21; fKET(i)=fKET(i)+0.285; fONITSQ2(i)=fONITSQ2(i)+0.5; fONITTQ3(i)=fONITTQ3(i)+0.5; 

%O3 Tracer
i=i+1; %R361_other1_i
Rnames{i} = 'OLNDSQ3+OLNDTQ3=NQ2+0.504 HCHO+1.21 ALD+0.285 KET+ONITTQ3';
k(:,i) = 2.96E-14.*exp(1000./T);
Gstr{i,1} = 'OLNDSQ3'; Gstr{i,2} = 'OLNDTQ3'; 
fOLNDSQ3(i)=fOLNDSQ3(i)-1; fOLNDSQ3(i)=fOLNDTQ3(i)-1; fNQ2(i)=fNQ2(i)+1; fHCHO(i)=fHCHO(i)+0.504;
fALD(i)=fALD(i)+1.21; fKET(i)=fKET(i)+0.285; fONITSQ3(i)=fONITSQ3(i)+0.5; fONITTQ3(i)=fONITTQ3(i)+0.5;

i=i+1; %R361_other2
Rnames{i} = 'OLNDS+OLNDS=NO2+0.504 HCHO+1.21 ALD+0.285 KET+ONITS';
k(:,i) = 2.96E-14.*exp(1000./T);
Gstr{i,1} = 'OLND'; Gstr{i,2} = 'OLND'; 
fOLND(i)=fOLND(i)-1; fOLND(i)=fOLND(i)-1; fNO2(i)=fNO2(i)+1; fHCHO(i)=fHCHO(i)+0.504;
fALD(i)=fALD(i)+1.21; fKET(i)=fKET(i)+0.285; fONITS(i)=fONITS(i)+1;

%O3 Tracer
i=i+1; %R361_other2_a
Rnames{i} = 'OLNDS+OLNDSQ=NO2+NOQ+0.504 HCHO+1.21 ALD+0.285 KET+ONITS+ONITSQ ';
k(:,i) = 2.96E-14.*exp(1000./T);
Gstr{i,1} = 'OLNDS'; Gstr{i,2} = 'OLNDSQ'; 
fOLNDS(i)=fOLNDS(i)-1; fOLNDSQ(i)=fOLNDSQ(i)-1; fNO2(i)=fNO2(i)+(4/6); fNOQ(i)=fNOQ(i)+(1/3); fHCHO(i)=fHCHO(i)+0.504;
fALD(i)=fALD(i)+1.21; fKET(i)=fKET(i)+0.285; fONITS(i)=fONITS(i)+0.5; fONITSQ(i)=fONITSQ(i)+0.5;

%O3 Tracer
i=i+1; %R361_other2_b
Rnames{i} = 'OLNDS+OLNDSQ2=NO2+NOQ+NQ2+0.504 HCHO+1.21 ALD+0.285 KET+ONITS+ONITSQ2';
k(:,i) = 2.96E-14.*exp(1000./T);
Gstr{i,1} = 'OLNDS'; Gstr{i,2} = 'OLNDSQ2'; 
fOLNDS(i)=fOLNDS(i)-1; fOLNDSQ2(i)=fOLNDSQ2(i)-1; fNO2(i)=fNO2(i)+(1/2); fNQ2(i)=fNQ2(i)+(1/6); fNOQ(i)=fNOQ(i)+(2/6); fHCHO(i)=fHCHO(i)+0.504;
fALD(i)=fALD(i)+1.21; fKET(i)=fKET(i)+0.285; fONITS(i)=fONITS(i)+0.5; fONITSQ2(i)=fONITSQ2(i)+0.5;

%O3 Tracer
i=i+1; %R361_other2_c
Rnames{i} = 'OLNDS+OLNDSQ3=NO2+NQ2+0.504 HCHO+1.21 ALD+0.285 KET+ONITS+ONITSQ3';
k(:,i) = 2.96E-14.*exp(1000./T);
Gstr{i,1} = 'OLNDS'; Gstr{i,2} = 'OLNDSQ3'; 
fOLNDS(i)=fOLNDS(i)-1; fOLNDSQ3(i)=fOLNDSQ3(i)-1; fNO2(i)=fNO2(i)+(1/2); fNQ2(i)=fNQ2(i)+(1/2); fHCHO(i)=fHCHO(i)+0.504;
fALD(i)=fALD(i)+1.21; fKET(i)=fKET(i)+0.285; fONITS(i)=fONITS(i)+0.5; fONITSQ3(i)=fONITSQ3(i)+0.5;

%O3 Tracer
i=i+1; %R361_other2_d
Rnames{i} = 'OLNDSQ+OLNDSQ=NO2+NQ2+0.504 HCHO+1.21 ALD+0.285 KET+ONITSQ';
k(:,i) = 2.96E-14.*exp(1000./T);
Gstr{i,1} = 'OLNDSQ'; Gstr{i,2} = 'OLNDSQ'; 
fOLNDSQ(i)=fOLNDSQ(i)-1; fOLNDSQ(i)=fOLNDSQ(i)-1; fNO2(i)=fNO2(i)+(1/3); fNOQ(i)=fNOQ(i)+(2/3); fHCHO(i)=fHCHO(i)+0.504;
fALD(i)=fALD(i)+1.21; fKET(i)=fKET(i)+0.285; fONITSQ(i)=fONITSQ(i)+1;

%O3 Tracer
i=i+1; %R361_other2_e
Rnames{i} = 'OLNDSQ+OLNDSQ2=NO2+NQ2+NQ2+0.504 HCHO+1.21 ALD+0.285 KET+ONITSQ+ONITSQ2';
k(:,i) = 2.96E-14.*exp(1000./T);
Gstr{i,1} = 'OLNDSQ'; Gstr{i,2} = 'OLNDSQ2'; 
fOLNDSQ(i)=fOLNDSQ(i)-1; fOLNDSQ2(i)=fOLNDSQ2(i)-1; fNO2(i)=fNO2(i)+(1/6); fNOQ(i)=fNOQ(i)+(4/6); fNQ2(i)=fNQ2(i)+(1/6); fHCHO(i)=fHCHO(i)+0.504;
fALD(i)=fALD(i)+1.21; fKET(i)=fKET(i)+0.285; fONITSQ(i)=fONITSQ(i)+0.5; fONITSQ2(i)=fONITSQ2(i)+0.5;

%O3 Tracer
i=i+1; %R361_other2_f
Rnames{i} = 'OLNDSQ+OLNDSQ3=NO2+NQ2+NQ2+0.504 HCHO+1.21 ALD+0.285 KET+ONITSQ+ONITSQ3';
k(:,i) = 2.96E-14.*exp(1000./T);
Gstr{i,1} = 'OLNDSQ'; Gstr{i,2} = 'OLNDSQ3'; 
fOLNDSQ(i)=fOLNDSQ(i)-1; fOLNDSQ3(i)=fOLNDSQ3(i)-1; fNO2(i)=fNO2(i)+(1/6); fNOQ(i)=fNOQ(i)+(2/6); fNQ2(i)=fNQ2(i)+(1/2); fHCHO(i)=fHCHO(i)+0.504;
fALD(i)=fALD(i)+1.21; fKET(i)=fKET(i)+0.285; fONITSQ(i)=fONITSQ(i)+0.5; fONITSQ3(i)=fONITSQ3(i)+0.5;

%O3 Tracer
i=i+1; %R361_other2_g
Rnames{i} = 'OLNDSQ2+OLNDSQ2=NQ2+NQ2+0.504 HCHO+1.21 ALD+0.285 KET+ONITSQ2';
k(:,i) = 2.96E-14.*exp(1000./T);
Gstr{i,1} = 'OLNDSQ2'; Gstr{i,2} = 'OLNDSQ2'; 
fOLNDSQ2(i)=fOLNDSQ2(i)-1; fOLNDSQ2(i)=fOLNDSQ2(i)-1; fNOQ(i)=fNOQ(i)+(2/3); fNQ2(i)=fNQ2(i)+(1/3); fHCHO(i)=fHCHO(i)+0.504;
fALD(i)=fALD(i)+1.21; fKET(i)=fKET(i)+0.285; fONITSQ2(i)=fONITSQ2(i)+1; 

%O3 Tracer
i=i+1; %R361_other2_h
Rnames{i} = 'OLNDSQ2+OLNDSQ3=NQ2+NQ2+0.504 HCHO+1.21 ALD+0.285 KET+ONITSQ2+ONITSQ3';
k(:,i) = 2.96E-14.*exp(1000./T);
Gstr{i,1} = 'OLNDSQ2'; Gstr{i,2} = 'OLNDSQ3'; 
fOLNDSQ2(i)=fOLNDSQ2(i)-1; fOLNDSQ3(i)=fOLNDSQ3(i)-1; fNOQ(i)=fNOQ(i)+(2/6); fNQ2(i)=fNQ2(i)+(4/6); fHCHO(i)=fHCHO(i)+0.504;
fALD(i)=fALD(i)+1.21; fKET(i)=fKET(i)+0.285; fONITSQ2(i)=fONITSQ2(i)+0.5; fONITSQ3(i)=fONITSQ3(i)+0.5; 

%O3 Tracer
i=i+1; %R361_other2_i
Rnames{i} = 'OLNDSQ3+OLNDSQ3=NQ2+0.504 HCHO+1.21 ALD+0.285 KET+ONITSQ3';
k(:,i) = 2.96E-14.*exp(1000./T);
Gstr{i,1} = 'OLNDSQ3'; Gstr{i,2} = 'OLNDSQ3'; 
fOLNDSQ3(i)=fOLNDSQ3(i)-1; fOLNDSQ3(i)=fOLNDSQ3(i)-1; fNQ2(i)=fNQ2(i)+1; fHCHO(i)=fHCHO(i)+0.504;
fALD(i)=fALD(i)+1.21; fKET(i)=fKET(i)+0.285; fONITSQ3(i)=fONITSQ3(i)+1;
...
%i=i+1; %R385
%Rnames{i} = 'ONITT=wONITT';
%k(:,i) = 1.69E-5; %mmarvin 20151020
%Gstr{i,1} = 'ONITT'; 
%fONITT(i)=fONITT(i)-1; fwONITT(i)=fwONITT(i)+1;

%i=i+1; %R385a
%Rnames{i} = 'ONITTQ=wONITTQ';
%k(:,i) = 1.69E-5; %mmarvin 20151020
%Gstr{i,1} = 'ONITTQ'; 
%fONITTQ(i)=fONITTQ(i)-1; fwONITTQ(i)=fwONITTQ(i)+1;

%O3 Tracer
%i=i+1; %R385b
%Rnames{i} = 'ONITTQ2=wONITTQ2';
%k(:,i) = 1.69E-5; %mmarvin 20151020
%Gstr{i,1} = 'ONITTQ2'; 
%fONITTQ2(i)=fONITTQ2(i)-1; fwONITTQ2(i)=fwONITTQ2(i)+1;

%O3 Tracer
%i=i+1; %R385c
%Rnames{i} = 'ONITTQ3=wONITTQ3';
%k(:,i) = 1.69E-5; %mmarvin 20151020
%Gstr{i,1} = 'ONITTQ3'; 
%fONITTQ3(i)=fONITTQ3(i)-1; fwONITTQ3(i)=fwONITTQ3(i)+1;


%i=i+1; %R385_d
%Rnames{i} = 'ONITS=wONITS';
%k(:,i) = 1.69E-5; %mmarvin 20151020
%Gstr{i,1} = 'ONITS'; 
%fONITS(i)=fONITS(i)-1; fwONITS(i)=fwONITS(i)+1;

%O3 Tracer
%i=i+1; %R385_e
%Rnames{i} = 'ONITSQ=wONITSQ';
%k(:,i) = 1.69E-5; %mmarvin 20151020
%Gstr{i,1} = 'ONITSQ'; 
%fONITSQ(i)=fONITSQ(i)-1; fwONITSQ(i)=fwONITSQ(i)+1;

%O3 Tracer
%i=i+1; %R385_f
%Rnames{i} = 'ONITSQ2=wONITSQ2';
%k(:,i) = 1.69E-5; %mmarvin 20151020
%Gstr{i,1} = 'ONITSQ2'; 
%fONITSQ2(i)=fONITSQ2(i)-1; fwONITSQ2(i)=fwONITSQ2(i)+1;

%O3 Tracer
%i=i+1; %R385_g
%%Rnames{i} = 'ONITSQ3=wONITSQ3';
%k(:,i) = 1.69E-5; %mmarvin 20151020
%Gstr{i,1} = 'ONITSQ3'; 
%fONITSQ3(i)=fONITSQ3(i)-1; fwONITSQ3(i)=fwONITSQ3(i)+1;

%i=i+1; %R385_h
%Rnames{i} = 'pONITT=wpONITT';
%k(:,i) = 3.75E-5; %mmarvin 20151020
%Gstr{i,1} = 'pONITT'; 
%fpONITT(i)=fpONITT(i)-1; fwpONITT(i)=fwpONITT(i)+1;

%O3 Tracer
%i=i+1; %R385_i
%Rnames{i} = 'pONITTQ=wpONITTQ';
%k(:,i) = 3.75E-5; %mmarvin 20151020
%Gstr{i,1} = 'pONITTQ'; 
%fpONITTQ(i)=fpONITTQ(i)-1; fwpONITTQ(i)=fwpONITTQ(i)+1;

%O3 Tracer
%i=i+1; %R385_j
%Rnames{i} = 'pONITTQ2=wpONITTQ2';
%k(:,i) = 3.75E-5; %mmarvin 20151020
%Gstr{i,1} = 'pONITTQ2'; 
%fpONITTQ2(i)=fpONITTQ2(i)-1; fwpONITTQ2(i)=fwpONITTQ2(i)+1;

%O3 Tracer
%i=i+1; %R385_k
%Rnames{i} = 'pONITTQ3=wpONITTQ3';
%k(:,i) = 3.75E-5; %mmarvin 20151020
%Gstr{i,1} = 'pONITTQ3'; 
%fpONITTQ3(i)=fpONITTQ3(i)-1; fwpONITTQ3(i)=fwpONITTQ3(i)+1;


%i=i+1; %R385__l
%Rnames{i} = 'pONITS=wpONITS';
%k(:,i) = 3.75E-5; %mmarvin 20151020
%Gstr{i,1} = 'pONITS'; 
%fpONITS(i)=fpONITS(i)-1; fwpONITS(i)=fwpONITS(i)+1;

%O3 Tracer
%i=i+1; %R385_m
%%Rnames{i} = 'pONITSQ=wpONITSQ';
%k(:,i) = 3.75E-5; %mmarvin 20151020
%Gstr{i,1} = 'pONITSQ'; 
%fpONITSQ(i)=fpONITSQ(i)-1; fwpONITSQ(i)=fwpONITSQ(i)+1;

%O3 Tracer
%i=i+1; %R385_n
%Rnames{i} = 'pONITSQ2=wpONITSQ2';
%k(:,i) = 3.75E-5; %mmarvin 20151020
%Gstr{i,1} = 'pONITSQ2'; 
%fpONITSQ2(i)=fpONITSQ2(i)-1; fwpONITSQ2(i)=fwpONITSQ2(i)+1;

%O3 Tracer
%i=i+1; %R385_o
%Rnames{i} = 'pONITSQ3=wpONITSQ3';
%k(:,i) = 3.75E-5; %mmarvin 20151020
%Gstr{i,1} = 'pONITSQ3'; 
%fpONITSQ3(i)=fpONITSQ3(i)-1; fwpONITSQ3(i)=fwpONITSQ3(i)+1;
...
%i=i+1; %R387
%Rnames{i} = 'wONITT=HO2+0.2ALD+NO2+0.8KET';
%k(:,i) = JONIT;
%Gstr{i,1} = 'wONITT'; 
%fwONITT(i)=fwONITT(i)-1; fHO2(i)=fHO2(i)+1; fALD(i)=fALD(i)+0.2; fNO2(i)=fNO2(i)+1; fKET(i)=fKET(i)+0.8; 

%O3 Tracer
%i=i+1; %R387a
%%Rnames{i} = 'wONITTQ=HO2+0.2ALD+NOQ+0.8KET+NO2';%
%k(:,i) = JONIT;
%Gstr{i,1} = 'wONITTQ'; 
%fwONITTQ(i)=fwONITTQ(i)-1; fHO2(i)=fHO2(i)+1; fALD(i)=fALD(i)+0.2; fNOQ(i)=fNOQ(i)+(2/3); fNO2(i)=fNO2(i)+(1/3); fKET(i)=fKET(i)+0.8;

%O3 Tracer
%i=i+1; %R387b
%%Rnames{i} = 'wONITTQ2=HO2+0.2ALD+NQ2+0.8KET+NOQ';
%k(:,i) = JONIT;
%Gstr{i,1} = 'wONITTQ2'; 
%fwONITTQ2(i)=fwONITTQ2(i)-1; fHO2(i)=fHO2(i)+1; fALD(i)=fALD(i)+0.2; fNQ2(i)=fNQ2(i)+(1/3); fNOQ(i)=fNOQ(i)+(2/3); fKET(i)=fKET(i)+0.8;

%O3 Tracer
%i=i+1; %R387c
%Rnames{i} = 'wONITTQ3=HOQ+0.2ALD+NQ2+0.8KET';
%k(:,i) = JONIT;
%Gstr{i,1} = 'wONITTQ3'; 
%fwONITTQ3(i)=fwONITTQ3(i)-1; fHOQ(i)=fHOQ(i)+1; fALD(i)=fALD(i)+0.2; fNQ2(i)=fNQ2(i)+1; fKET(i)=fKET(i)+0.8;


%i=i+1; %R387_other
%Rnames{i} = 'wONITS=HO2+0.2ALD+NO2+0.8KET';
%%k(:,i) = JONIT;
%Gstr{i,1} = 'wONITS'; 
%fwONITS(i)=fwONITS(i)-1; fHO2(i)=fHO2(i)+1; fALD(i)=fALD(i)+0.2; fNO2(i)=fNO2(i)+1; fKET(i)=fKET(i)+0.8; 

%O3 Tracer
%i=i+1; %R387_other_a
%Rnames{i} = 'wONITSQ=HO2+0.2ALD+NOQ+0.8KET+NO2';
%%k(:,i) = JONIT;
%Gstr{i,1} = 'wONITSQ'; 
%fwONITSQ(i)=fwONITSQ(i)-1; fHO2(i)=fHO2(i)+1; fALD(i)=fALD(i)+0.2; fNOQ(i)=fNOQ(i)+(2/3); fNO2(i)=fNO2(i)+(1/3); fKET(i)=fKET(i)+0.8;

%O3 Tracer
%i=i+1; %R387_other_b
%%Rnames{i} = 'wONITSQ2=HO2+0.2ALD+NQ2+0.8KET+NOQ';
%k(:,i) = JONIT;
%Gstr{i,1} = 'wONITSQ2'; 
%fwONITSQ2(i)=fwONITSQ2(i)-1; fHO2(i)=fHO2(i)+1; fALD(i)=fALD(i)+0.2; fNQ2(i)=fNQ2(i)+(1/3); fNOQ(i)=fNOQ(i)+(2/3); fKET(i)=fKET(i)+0.8;

%O3 Tracer
%i=i+1; %R387_other_c
%Rnames{i} = 'wONITSQ3=HOQ+0.2ALD+NQ2+0.8KET';
%k(:,i) = JONIT;
%Gstr{i,1} = 'wONITSQ3'; 
%fwONITSQ3(i)=fwONITSQ3(i)-1; fHOQ(i)=fHOQ(i)+1; fALD(i)=fALD(i)+0.2; fNQ2(i)=fNQ2(i)+1; fKET(i)=fKET(i)+0.8;
...
%Phase Partitioning
i=i+1; %R388
Rnames{i} = 'ONITT=pONITT';
k(:,i) = 1.868E-2;
Gstr{i,1} = 'ONITT'; 
fONITT(i)=fONITT(i)-1; fpONITT(i)=fpONITT(i)+1; 

i=i+1; %R388_a
Rnames{i} = 'ONITTQ=pONITTQ';
k(:,i) = 1.868E-2;
Gstr{i,1} = 'ONITTQ'; 
fONITTQ(i)=fONITTQ(i)-1; fpONITTQ(i)=fpONITTQ(i)+1; 

i=i+1; %R388_b
Rnames{i} = 'ONITTQ2=pONITTQ2';
k(:,i) = 1.868E-2;
Gstr{i,1} = 'ONITTQ2'; 
fONITTQ2(i)=fONITTQ2(i)-1; fpONITTQ2(i)=fpONITTQ2(i)+1; 

i=i+1; %R388_c
Rnames{i} = 'ONITTQ3=pONITTQ3';
k(:,i) = 1.868E-2;
Gstr{i,1} = 'ONITTQ3'; 
fONITTQ3(i)=fONITTQ3(i)-1; fpONITTQ3(i)=fpONITTQ3(i)+1;

i=i+1; %R389
Rnames{i} = 'ONITS=pONITS';
k(:,i) = 1.868E-2;
Gstr{i,1} = 'ONITS'; 
fONITS(i)=fONITS(i)-1; fpONITS(i)=fpONITS(i)+1; 

i=i+1; %R389_a
Rnames{i} = 'ONITSQ=pONITSQ';
k(:,i) = 1.868E-2;
Gstr{i,1} = 'ONITSQ'; 
fONITSQ(i)=fONITSQ(i)-1; fpONITSQ(i)=fpONITSQ(i)+1; 

i=i+1; %R389_b
Rnames{i} = 'ONITSQ2=pONITSQ2';
k(:,i) = 1.868E-2;
Gstr{i,1} = 'ONITSQ2'; 
fONITSQ2(i)=fONITSQ2(i)-1; fpONITSQ2(i)=fpONITSQ2(i)+1; 

i=i+1; %R389_c
Rnames{i} = 'ONITSQ3=pONITSQ3';
k(:,i) = 1.868E-2;
Gstr{i,1} = 'ONITSQ3'; 
fONITSQ3(i)=fONITSQ3(i)-1; fpONITSQ3(i)=fpONITSQ3(i)+1; 

%Repartition
i=i+1; %R390
Rnames{i} = 'pONITT=ONITT';
k(:,i) = 1.868E-2;
Gstr{i,1} = 'pONITT'; 
fpONITT(i)=fpONITT(i)-1; fONITT(i)=fONITT(i)+1; 

i=i+1; %R390_a
Rnames{i} = 'pONITTQ=ONITTQ';
k(:,i) = 1.868E-2;
Gstr{i,1} = 'pONITTQ'; 
fpONITTQ(i)=fpONITTQ(i)-1; fONITTQ(i)=fONITTQ(i)+1; 

i=i+1; %R390_b
Rnames{i} = 'pONITTQ2=ONITTQ2';
k(:,i) = 1.868E-2;
Gstr{i,1} = 'pONITTQ2'; 
fpONITTQ2(i)=fpONITTQ2(i)-1; fONITTQ2(i)=fONITTQ2(i)+1; 

i=i+1; %R390_c
Rnames{i} = 'pONITTQ3=ONITTQ3';
k(:,i) = 1.868E-2;
Gstr{i,1} = 'pONITTQ3'; 
fpONITTQ3(i)=fpONITTQ3(i)-1; fONITTQ3(i)=fONITTQ3(i)+1;

i=i+1; %R391
Rnames{i} = 'pONITS=ONITS';
k(:,i) = 1.868E-2;
Gstr{i,1} = 'pONITS'; 
fpONITS(i)=fpONITS(i)-1; fONITS(i)=fONITS(i)+1; 

i=i+1; %R391_a
Rnames{i} = 'pONITSQ=ONITSQ';
k(:,i) = 1.868E-2;
Gstr{i,1} = 'pONITSQ'; 
fpONITSQ(i)=fpONITSQ(i)-1; fONITSQ(i)=fONITSQ(i)+1; 

i=i+1; %R391_b
Rnames{i} = 'pONITSQ2=ONITSQ2';
k(:,i) = 1.868E-2;
Gstr{i,1} = 'pONITSQ2'; 
fpONITSQ2(i)=fpONITSQ2(i)-1; fONITSQ2(i)=fONITSQ2(i)+1; 

i=i+1; %R391_c
Rnames{i} = 'pONITSQ3=ONITSQ3';
k(:,i) = 1.868E-2;
Gstr{i,1} = 'pONITSQ3'; 
fpONITSQ3(i)=fpONITSQ3(i)-1; fONITSQ3(i)=fONITSQ3(i)+1; 





%HNO3 Heterogeneous Rxns
i=i+1; %R392a
Rnames{i} = 'NO2=HNO3+HONO';
k(:,i) = 4.04E-06;
Gstr{i,1} = 'NO2'; 
...
k(:,i) = 1.58E-04; %mmarvin 20151020
Gstr{i,1} = 'N2O4Q'; 
fN2O4Q(i)=fN2O4Q(i)-1; fHNO2Q(i)=fHNO2Q(i)+1; fHNO3(i)=fHNO3(i)+1;

%O3 Tracer
i=i+1; %R394b
Rnames{i} = 'N2O3Q2=HNOQ2+HNO3';
k(:,i) = 0.5*1.58E-04; 
Gstr{i,1} = 'N2O3Q2'; 
fN2O3Q2(i)=fN2O3Q2(i)-1; fHNOQ2(i)=fHNOQ2(i)+1; fHNO3(i)=fHNO3(i)+1; 

%O3 Tracer
i=i+1; %R394c
Rnames{i} = 'N2O3Q2=HNO2Q+HNO2Q';
k(:,i) = 0.5*1.58E-04; 
Gstr{i,1} = 'N2O3Q2'; 
fN2O3Q2(i)=fN2O3Q2(i)-1; fHNO2Q(i)=fHNO2Q(i)+2; 


%O3 Tracer
i=i+1; %R394d
Rnames{i} = 'N2O2Q3=HNQ3+HNO3';
k(:,i) = 0.33*1.58E-04;
Gstr{i,1} = 'N2O2Q3'; 
fN2O2Q3(i)=fN2O2Q3(i)-1; fHNQ3(i)=fHNQ3(i)+1;  fHNO3(i)=fHNO3(i)+1; 


%O3 Tracer
i=i+1; %R394e
Rnames{i} = 'N2O2Q3=HNOQ2+HNO2Q';
k(:,i) = 0.66*1.58E-04; 
Gstr{i,1} = 'N2O2Q3'; 
fN2O2Q3(i)=fN2O2Q3(i)-1; fHNOQ2(i)=fHNOQ2(i)+1;  fHNO2Q(i)=fHNO2Q(i)+1; 

%O3 Tracer
i=i+1; %R394f
Rnames{i} = 'N2OQ4=HNQ3+HNO2Q';
k(:,i) = 0.5*1.58E-04; 
Gstr{i,1} = 'N2OQ4'; 
fN2OQ4(i)=fN2OQ4(i)-1; fHNQ3(i)=fHNQ3(i)+1;  fHNO2Q(i)=fHNO2Q(i)+1; 

%O3 Tracer
i=i+1; %R394g
Rnames{i} = 'N2OQ4=HNOQ2+HNOQ2';
k(:,i) = 0.5*1.58E-04; 
Gstr{i,1} = 'N2OQ4';  
fN2OQ4(i)=fN2OQ4(i)-1; fHNOQ2(i)=fHNOQ2(i)+2;
...
%ON Hydrolysis
%i=i+1; %R389
%Rnames{i} = 'pONITT=HNO3';
%k(:,i) = 2.78E-4;
%Gstr{i,1} = 'ONITT'; 
%fONITT(i)=fONITT(i)-1; fHNO3(i)=fHNO3(i)+1; 

%i=i+1; %R389_a
%Rnames{i} = 'pONITTQ=HNO2Q';
%k(:,i) = 2.78E-4;
%Gstr{i,1} = 'ONITTQ'; 
%fONITTQ(i)=fONITTQ(i)-1; fHNO2Q(i)=fHNO2Q(i)+1; 


%i=i+1; %R389_b
%Rnames{i} = 'pONITTQ2=HNOQ2';
%k(:,i) = 2.78E-4;
%Gstr{i,1} = 'ONITTQ2'; 
%fONITTQ2(i)=fONITTQ2(i)-1; fHNOQ2(i)=fHNOQ2(i)+1; 


%i=i+1; %R389_c
%Rnames{i} = 'pONITTQ3=HNQ3';
%k(:,i) = 2.78E-4;
%Gstr{i,1} = 'ONITTQ3'; 
%fONITTQ3(i)=fONITTQ3(i)-1; fHNQ3(i)=fHNQ3(i)+1;



%%New HNO3 Wall Loss
i=i+1; %R390
Rnames{i} = 'HNO3 + SHNO3 =wHNO3';
k(:,i) = 1E-12;
Gstr{i,1} = 'HNO3'; Gstr{i,2} = 'SHNO3'; 
fHNO3(i)=fHNO3(i)-1; fSHNO3(i)=fSHNO3(i)-1; fwHNO3(i)=fwHNO3(i)+1;

%O3 Tracer
i=i+1; %R390a
Rnames{i} = 'HNO2Q + SHNO3 =wHNO2Q';
k(:,i) = 1E-12;
Gstr{i,1} = 'HNO2Q'; Gstr{i,2} = 'SHNO3'; 
fHNO2Q(i)=fHNO2Q(i)-1; fSHNO3(i)=fSHNO3(i)-1; fwHNO2Q(i)=fwHNO2Q(i)+1;


%O3 Tracer
i=i+1; %R390b
Rnames{i} = 'HNOQ2 + SHNO3 =wHNOQ2';
k(:,i) = 1E-12;
Gstr{i,1} = 'HNOQ2'; Gstr{i,2} = 'SHNO3'; 
fHNOQ2(i)=fHNOQ2(i)-1; fSHNO3(i)=fSHNO3(i)-1; fwHNOQ2(i)=fwHNOQ2(i)+1;

%O3 Tracer
i=i+1; %R390c
Rnames{i} = 'HNQ3 + SHNO3 =wHNQ3';
k(:,i) = 1E-12;
Gstr{i,1} = 'HNQ3'; Gstr{i,2} = 'SHNO3'; 
fHNQ3(i)=fHNQ3(i)-1; fSHNO3(i)=fSHNO3(i)-1; fwHNQ3(i)=fwHNQ3(i)+1;


i=i+1; %R390
Rnames{i} = 'wHNO3=HNO3 + SHNO3';
k(:,i) = 3E-4;
Gstr{i,1} = 'wHNO3';  
fHNO3(i)=fHNO3(i)+1; fSHNO3(i)=fSHNO3(i)+1; fwHNO3(i)=fwHNO3(i)-1;
...
%O3 Tracer
i=i+1; %R390c
Rnames{i} = 'wHNQ3=HNQ3 + SHNO3';
k(:,i) = 3E-4;
Gstr{i,1} = 'wHNQ3';  
fHNQ3(i)=fHNQ3(i)+1; fSHNO3(i)=fSHNO3(i)+1; fwHNQ3(i)=fwHNQ3(i)-1;

i=i+1; %R391
Rnames{i} = 'wHNO3=OH+NO2+SHNO3';
k(:,i) = JHNO3;
Gstr{i,1} = 'HNO3'; 
fwHNO3(i)=fwHNO3(i)-1; fOH(i)=fOH(i)+1; fNO2(i)=fNO2(i)+1; fSHNO3(i)=fSHNO3(i)+1; 

%O3 Tracer
i=i+1; %R008a
Rnames{i} = 'wHNO2Q=OH+NOQ+ SHNO3';
k(:,i) = 0.66*JHNO3;
Gstr{i,1} = 'wHNO2Q'; 
fwHNO2Q(i)=fwHNO2Q(i)-1; fOH(i)=fOH(i)+1; fNOQ(i)=fNOQ(i)+1;fSHNO3(i)=fSHNO3(i)+1; 

%O3 Tracer
i=i+1; %R008b
Rnames{i} = 'wHNO2Q=QH+NO2+ SHNO3';
k(:,i) = 0.33*JHNO3;
Gstr{i,1} = 'wHNO2Q'; 
fwHNO2Q(i)=fwHNO2Q(i)-1; fQH(i)=fQH(i)+1; fNO2(i)=fNO2(i)+1;fSHNO3(i)=fSHNO3(i)+1; 

%O3 Tracer
i=i+1; %R008c
Rnames{i} = 'wHNOQ2=QH+NOQ+ SHNO3';
k(:,i) = 0.66*JHNO3;
Gstr{i,1} = 'wHNOQ2'; 
fwHNOQ2(i)=fwHNOQ2(i)-1; fQH(i)=fQH(i)+1; fNOQ(i)=fNOQ(i)+1;fSHNO3(i)=fSHNO3(i)+1; 

%O3 Tracer
i=i+1; %R008d
Rnames{i} = 'wHNOQ2=OH+NQ2+ SHNO3';
k(:,i) = 0.33*JHNO3;
Gstr{i,1} = 'wHNOQ2'; 
fwHNOQ2(i)=fwHNOQ2(i)-1; fOH(i)=fOH(i)+1; fNQ2(i)=fNQ2(i)+1;fSHNO3(i)=fSHNO3(i)+1; 

 %O3 Tracer
i=i+1; %R008e
Rnames{i} = 'wHNQ3=QH+NQ2+ SHNO3';
k(:,i) = JHNO3;
Gstr{i,1} = 'wHNQ3'; 
fwHNQ3(i)=fwHNQ3(i)-1; fQH(i)=fQH(i)+1; fNQ2(i)=fNQ2(i)+1;fSHNO3(i)=fSHNO3(i)+1; 
