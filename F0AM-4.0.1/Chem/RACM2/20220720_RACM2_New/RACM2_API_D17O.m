...
Rnames{i} = 'N2O3Q2= NO2+NOQ+NQ2+NO3+NO2Q+NOQ2+NQ3';
k(:,i) = K_N2O5;
Gstr{i,1} = 'N2O3Q2'; 
fN2O3Q2(i)=fN2O3Q2(i)-1; fNO2(i)=fNO2(i)+0.15; fNOQ(i)=fNOQ(i)+0.3; fNQ2(i)=fNQ2(i)+0.05; fNO3(i)=fNO3(i)+0.05; fNO2Q(i)=fNO2Q(i)+0.3; fNOQ2(i)=fNOQ2(i)+0.15; 
...
k(:,i) = K_N2O5;
Gstr{i,1} = 'N2O2Q3'; 
fN2O2Q3(i)=fN2O2Q3(i)-1; fNO2(i)=fNO2(i)+(0.05); fNOQ(i)=fNOQ(i)+(0.3); fNQ2(i)=fNQ2(i)+(0.15); fNO2Q(i)=fNO2Q(i)+(0.15); fNOQ2(i)=fNOQ2(i)+(0.3); fNQ3(i)=fNQ3(i)+(0.05);
...
k(:,i) = K_N2O5;
Gstr{i,1} = 'N2OQ4'; 
fN2OQ4(i)=fN2OQ4(i)-1; fNOQ(i)=fNOQ(i)+0.2; fNQ2(i)=fNQ2(i)+0.3; fNOQ2(i)=fNOQ2(i)+0.3; fNQ3(i)=fNQ3(i)+0.2;
