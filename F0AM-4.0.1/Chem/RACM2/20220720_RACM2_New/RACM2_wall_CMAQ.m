...
'XYO'; 'XYP'; 'XYO2'; 'XYOP'; 'wO3'; 'wNO'; 'wHNO3'; 'wPAN'; 'wPPN'; 'wONIT' };
...
i=i+1; %R087
Rnames{i} = 'API+OH=APIP + TRPRXN';  %walters 20220705
k(:,i) = 1.21E-11.*exp(440./T);
Gstr{i,1} = 'API'; Gstr{i,2} = 'OH'; 
fAPI(i)=fAPI(i)-1; fOH(i)=fOH(i)-1; fAPIP(i)=fAPIP(i)+1, fTRPRXN(i)=fTRPRXN(i)+1; 
...
i=i+1; %R131
Rnames{i} = 'API+O3= OH+HO2+ETHP+KETP+CO+H2O2+ALD+KET+TRPRXN'; %walters 20220705
...
fALD(i)=fALD(i)+0.65; fKET(i)=fKET(i)+0.53; fTRPRXN(i)=fTRPRXN(i)+1;
...
i=i+1; %R146
Rnames{i} = 'API+NO3=0.10 OLNN+0.90 OLND + TRPRXN'; %walters 20220705
k(:,i) = 1.19E-12.*exp(490./T);
Gstr{i,1} = 'API'; Gstr{i,2} = 'NO3'; 
fAPI(i)=fAPI(i)-1; fNO3(i)=fNO3(i)-1; fOLNN(i)=fOLNN(i)+0.1;  fOLND(i)=fOLND(i)+0.9; fTRPRXN(i)=fTRPRXN(i)+1; 
