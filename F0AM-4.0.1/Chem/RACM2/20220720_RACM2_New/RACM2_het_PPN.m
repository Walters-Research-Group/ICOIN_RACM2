...
%Walters04.30.2021
i=i+1; %R121
Rnames{i} = 'PPN+OH=ALD+CO+NO2';
k(:,i) = 1.27E-12;
Gstr{i,1} = 'PPN'; Gstr{i,2} = 'OH'; 
fPPN(i)=fPPN(i)-1; fOH(i)=fOH(i)-1; fALD(i)=fALD(i)+1; fCO(i)=fCO(i)+1; fNO2(i)=fNO2(i)+1; 
...
%%Walters04.30.21 N2O5heterogeneous
i=i+1;
Rnames{i} = 'N2O5 = HNO3';
k(:,i) = 0.0004;
Gstr{i,1} = 'N2O5';  
...
%%Walters04.30.21 PPN Photolysis
i=i+1;
Rnames{i} = 'PPN = RCO3+NO2';
k(:,i) = 3E-8;
Gstr{i,1} = 'PPN';  
...
%%Walters 04.30.21 ON Photolysis?
i=i+1;
Rnames{i} = 'ONIT = NO2 + APIP';
k(:,i) = 1E-4;
Gstr{i,1} = 'ONIT';  
fONIT(i)=fONIT(i)-1; fHONO(i)=fHONO(i)+1;
