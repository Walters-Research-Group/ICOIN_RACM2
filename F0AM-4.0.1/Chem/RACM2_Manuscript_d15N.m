...
SpeciesToAdd = {...
'NO'; 'ZO'; 'NO2'; 'ZO2'; 'PAN'; 'PAZ'; 'HNO3'; 'HZO3'; ...
 'MONITSh'; 'MOZITSh'; 'MONITUh'; 'MOZITUh';  'HONITh'; 'HOZITh'; ...
...
'HONO'; 'O3'; 'PAN'; 'PPN'; 'MONITS'; 'MOZITS'; ...
'MONITU'; 'MOZITU'; 'HONIT'; 'HOZIT'; ...
'OLNN'; 'ONIT'; 'OP1'; 'OP2'; 'ORA1'; 'ORA2'; 'ORAP'; 'PAA';  'RCO3'; 'ROH'; 'XO2'; ...
'wHNO3'; 'wHZO3'; 'wHO2'; 'wH2O2';...
'HOZO'; 'HO2ZO2'; 'ZNO5';  'Z2O5'; 'ZO3'; 'OLZD'; 'OLZN'; 'OZIT'; ...
'PAZ'; 'PPZ'; 'A'; ...
'A'; ...
};
...
k(:,i) = JNO2*1.0042;
Gstr{i,1} = 'ZO2'; 
fZO2(i)=fZO2(i)-1; fO3P(i)=fO3P(i)+1; fZO(i)=fZO(i)+1; 
...
Rnames{i} = 'ZO3=O3P+ZO2';
k(:,i) = JNO3_NO2;
Gstr{i,1} = 'ZO3'; 
fZO3(i)=fZO3(i)-1; fO3P(i)=fO3P(i)+1; fZO2(i)=fZO2(i)+1; 
...
k(:,i) = JHONO;
Gstr{i,1} = 'HOZO'; 
fHOZO(i)=fHOZO(i)-1; fOH(i)=fOH(i)+1; fZO(i)=fZO(i)+1; 
...
Rnames{i} = 'HZO3=OH+ZO2';
k(:,i) = JHNO3;
Gstr{i,1} = 'HZO3'; 
fHZO3(i)=fHZO3(i)-1; fOH(i)=fOH(i)+1; fZO2(i)=fZO2(i)+1; 
...
Rnames{i} = 'HO2ZO2 = 0.2OH+0.2ZO3+0.8HO2+0.8ZO2';
k(:,i) = JHO2NO2;
Gstr{i,1} = 'HO2ZO2'; 
fHO2ZO2(i)=fHO2ZO2(i)-1; fOH(i)=fOH(i)+0.2; fZO3(i)=fZO3(i)+0.2; fHO2(i)=fHO2(i)+0.8; fZO2(i)=fZO2(i)+0.8; 
...
%d15N Tracer
i=i+1; %<RACM2_031a>; <BAPI_026a>
Rnames{i} = 'OZIT=HO2+0.2ALD+ZO2+0.8KET';
k(:,i) = JONIT;
Gstr{i,1} = 'OZIT'; 
fOZIT(i)=fOZIT(i)-1; fHO2(i)=fHO2(i)+1; fALD(i)=fALD(i)+0.2; fZO2(i)=fZO2(i)+1; fKET(i)=fKET(i)+0.8; 
...
Rnames{i} = 'PAZ=ACO3+ZO2';
k(:,i) = JPAN1;
Gstr{i,1} = 'PAZ'; 
fPAZ(i)=fPAZ(i)-1; fACO3(i)=fACO3(i)+1; fZO2(i)=fZO2(i)+1;
...
%d15N Tracer
%mmarvin 20151020
i=i+1; %<RACM2_033a>; <BAPI_028a>
Rnames{i} = 'PAZ=MO2+ZO3+CO2';
k(:,i) = JPAN2;
Gstr{i,1} = 'PAZ'; 
fPAZ(i)=fPAZ(i)-1; fMO2(i)=fMO2(i)+1; fZO3(i)=fZO3(i)+1; fCO2(i)=fCO2(i)+1;
...
Rnames{i} = 'O3+ZO=ZO2 +O2';
k(:,i) = 1.40e-12.*exp(-1310./T)*0.9933;
Gstr{i,1} = 'O3'; Gstr{i,2} = 'ZO'; 
fO3(i)=fO3(i)-1; fZO(i)=fZO(i)-1; fZO2(i)=fZO2(i)+1;
...
Rnames{i} = 'ZO2+O3=ZO3 +O2';
k(:,i) = 1.40e-13.*exp(-2470./T);
Gstr{i,1} = 'ZO2'; Gstr{i,2} = 'O3'; 
fZO2(i)=fZO2(i)-1; fO3(i)=fO3(i)-1; fZO3(i)=fZO3(i)+1;
...
Rnames{i} = 'ZO+O3P=ZO2';
k(:,i) = K_O3P_NO;
Gstr{i,1} = 'ZO'; Gstr{i,2} = 'O3P'; 
fZO(i)=fZO(i)-1; fO3P(i)=fO3P(i)-1; fZO2(i)=fZO2(i)+1; 
...
Rnames{i} = 'ZO+OH=HOZO';
k(:,i) = K_OH_NO;
Gstr{i,1} = 'ZO'; Gstr{i,2} = 'OH'; 
fZO(i)=fZO(i)-1; fOH(i)=fOH(i)-1; fHOZO(i)=fHOZO(i)+1; 
...
Rnames{i} = 'HO2+ZO=OH+ZO2';
k(:,i) = 3.45E-12.*exp(270./T);
Gstr{i,1} = 'HO2'; Gstr{i,2} = 'ZO'; 
fHO2(i)=fHO2(i)-1; fZO(i)=fZO(i)-1; fOH(i)=fOH(i)+1; fZO2(i)=fZO2(i)+1; 
...
Rnames{i} = 'HO2+ZO=HZO3';
k(:,i) = K_HO2_NO_HNO3;
Gstr{i,1} = 'HO2'; Gstr{i,2} = 'ZO'; 
fHO2(i)=fHO2(i)-1; fZO(i)=fZO(i)-1; fHZO3(i)=fHZO3(i)+1;
...
Rnames{i} = 'NO+ZO=NO2+ZO2';
k(:,i) = 3.30e-39.*exp(530./T).*.21.*M;
Gstr{i,1} = 'NO'; Gstr{i,2} = 'ZO'; 
fNO(i)=fNO(i)-1; fZO(i)=fZO(i)-1; fNO2(i)=fNO2(i)+1; ; fZO2(i)=fZO2(i)+1; 

%d15N Tracer
i=i+1; %<RACM2_052b>; <BAPI_047b>
Rnames{i} = 'ZO+ZO=ZO2+ZO2';
k(:,i) = 3.30e-39.*exp(530./T).*.21.*M;
Gstr{i,1} = 'ZO'; Gstr{i,2} = 'ZO'; 
fZO(i)=fZO(i)-1; fZO(i)=fZO(i)-1; fZO2(i)=fZO2(i)+1; ; fZO2(i)=fZO2(i)+1; 
...
Rnames{i} = 'HOZO+OH=ZO2+H2O';
k(:,i) = 2.50e-12.*exp(260./T);
Gstr{i,1} = 'HOZO'; Gstr{i,2} = 'OH'; 
fHOZO(i)=fHOZO(i)-1; fOH(i)=fOH(i)-1; fZO2(i)=fZO2(i)+1; 
...
Rnames{i} = 'O3P+ZO2=ZO+O2';
k(:,i) = 5.50e-12.*exp(188./T);
Gstr{i,1} = 'O3P'; Gstr{i,2} = 'ZO2'; 
fO3P(i)=fO3P(i)-1; fZO2(i)=fZO2(i)-1; fZO(i)=fZO(i)+1;
...
Rnames{i} = 'O3P+ZO2=ZO3';
k(:,i) = K_O3P_NO2;
Gstr{i,1} = 'O3P'; Gstr{i,2} = 'ZO2'; 
fO3P(i)=fO3P(i)-1; fZO2(i)=fZO2(i)-1; fZO3(i)=fZO3(i)+1; 
...
Rnames{i} = 'OH+ZO2=HZO3';
k(:,i) = K_OH_NO2_HONO2*1.040;
Gstr{i,1} = 'OH'; Gstr{i,2} = 'ZO2'; 
fOH(i)=fOH(i)-1; fZO2(i)=fZO2(i)-1; fHZO3(i)=fHZO3(i)+1; 
...
Rnames{i} = 'OH+HZO3=ZO3+H2O';
k(:,i) = K_OH_HNO3;
Gstr{i,1} = 'OH'; Gstr{i,2} = 'HZO3'; 
fOH(i)=fOH(i)-1; fHZO3(i)=fHZO3(i)-1; fZO3(i)=fZO3(i)+1;
...
Rnames{i} = 'OH+ZO3=HO2+ZO2';
k(:,i) = 2.00e-11;
Gstr{i,1} = 'OH'; Gstr{i,2} = 'ZO3'; 
fOH(i)=fOH(i)-1; fZO3(i)=fZO3(i)-1; fHO2(i)=fHO2(i)+1; fZO2(i)=fZO2(i)+1; 
...
Rnames{i} = 'HO2+ZO3=0.7OH+0.7ZO2+0.3HZO3';
k(:,i) = 4.00e-12;
Gstr{i,1} = 'HO2'; Gstr{i,2} = 'ZO3'; 
fHO2(i)=fHO2(i)-1; fZO3(i)=fZO3(i)-1; fOH(i)=fOH(i)+0.7; fZO2(i)=fZO2(i)+0.7; fHZO3(i)=fHZO3(i)+0.3; 
...
Rnames{i} = 'ZO+NO3=ZO2+NO2';
k(:,i) = 1.80E-11.*exp(110./T);
Gstr{i,1} = 'ZO'; Gstr{i,2} = 'NO3'; 
fZO(i)=fZO(i)-1; fNO3(i)=fNO3(i)-1; fZO2(i)=fZO2(i)+1; fNO2(i)=fNO2(i)+1; %SR 20160406

%d15N Tracer
i=i+1; %<RACM2_060b>; <BAPI_055b>
Rnames{i} = 'NO+ZO3=ZO2+NO2';
k(:,i) = 1.80E-11.*exp(110./T);
Gstr{i,1} = 'NO'; Gstr{i,2} = 'ZO3'; 
fNO(i)=fNO(i)-1; fZO3(i)=fZO3(i)-1; fZO2(i)=fZO2(i)+1; fNO2(i)=fNO2(i)+1; %SR 20160406

%d15N Tracer
i=i+1; %<RACM2_060c>; <BAPI_055c>
Rnames{i} = 'ZO+ZO3=ZO2+ZO2';
k(:,i) = 1.80E-11.*exp(110./T);
Gstr{i,1} = 'ZO'; Gstr{i,2} = 'ZO3'; 
fZO(i)=fZO(i)-1; fZO3(i)=fZO3(i)-1; fZO2(i)=fZO2(i)+1; fZO2(i)=fZO2(i)+1; %SR 20160406
...
Rnames{i} = 'ZO2+NO3=ZO+NO2+O2';
k(:,i) = 4.50e-14.*exp(-1260./T)*0.5;
Gstr{i,1} = 'ZO2'; Gstr{i,2} = 'NO3'; 
fZO2(i)=fZO2(i)-1; fNO3(i)=fNO3(i)-1; fZO(i)=fZO(i)+1; fNO2(i)=fNO2(i)+1;

%d15N Tracer
i=i+1; %<RACM2_061b>; <BAPI_056b>
Rnames{i} = 'ZO2+NO3=NO+ZO2+O2';
k(:,i) = 4.50e-14.*exp(-1260./T)*0.5;
Gstr{i,1} = 'ZO2'; Gstr{i,2} = 'NO3'; 
fZO2(i)=fZO2(i)-1; fNO3(i)=fNO3(i)-1; fNO(i)=fNO(i)+1; fZO2(i)=fZO2(i)+1;

%d15N Tracer
i=i+1; %<RACM2_061c>; <BAPI_056c>
Rnames{i} = 'NO2+ZO3=NO+ZO2+O2';
k(:,i) = 4.50e-14.*exp(-1260./T)*0.5;
Gstr{i,1} = 'NO2'; Gstr{i,2} = 'ZO3'; 
fNO2(i)=fNO2(i)-1; fZO3(i)=fZO3(i)-1; fNO(i)=fNO(i)+1; fZO2(i)=fZO2(i)+1;

%d15N Tracer
i=i+1; %<RACM2_061d>; <BAPI_056d>
Rnames{i} = 'NO2+ZO3=ZO+NO2+O2';
k(:,i) = 4.50e-14.*exp(-1260./T)*0.5;
Gstr{i,1} = 'NO2'; Gstr{i,2} = 'ZO3'; 
fNO2(i)=fNO2(i)-1; fZO3(i)=fZO3(i)-1; fZO(i)=fZO(i)+1; fNO2(i)=fNO2(i)+1;

%d15N Tracer
i=i+1; %<RACM2_061e>; <BAPI_056e>
Rnames{i} = 'ZO2+ZO3=ZO+ZO2+O2';
k(:,i) = 4.50e-14.*exp(-1260./T);
Gstr{i,1} = 'ZO2'; Gstr{i,2} = 'ZO3'; 
fZO2(i)=fZO2(i)-1; fZO3(i)=fZO3(i)-1; fZO(i)=fZO(i)+1; fZO2(i)=fZO2(i)+1;
...
Rnames{i} = 'ZO3+NO3=ZO2+NO2+O2';
k(:,i) = 8.50E-13.*exp(-2450./T);
Gstr{i,1} = 'ZO3'; Gstr{i,2} = 'NO3'; 
fZO3(i)=fZO3(i)-1; fNO3(i)=fNO3(i)-1; fZO2(i)=fZO2(i)+1; fNO2(i)=fNO2(i)+1; %SR 20160406

%d15N Tracer
i=i+1; %<RACM2_062b>; <BAPI_057b>
Rnames{i} = 'ZO3+ZO3=ZO2+ZO2+O2';
k(:,i) = 8.50E-13.*exp(-2450./T);
Gstr{i,1} = 'ZO3'; Gstr{i,2} = 'ZO3'; 
fZO3(i)=fZO3(i)-1; fZO3(i)=fZO3(i)-1; fZO2(i)=fZO2(i)+1; fZO2(i)=fZO2(i)+1; %SR 20160406
...
Rnames{i} = 'ZO2+NO3=ZNO5';
k(:,i) = K_NO2_NO3*1.0266;
Gstr{i,1} = 'ZO2'; Gstr{i,2} = 'NO3'; 
fZO2(i)=fZO2(i)-1; fNO3(i)=fNO3(i)-1; fZNO5(i)=fZNO5(i)+1;

%d15N Tracer
i=i+1; %<RACM2_063b>; <BAPI_058b>
Rnames{i} = 'NO2+ZO3=ZNO5';
k(:,i) = K_NO2_NO3*1.0309;
Gstr{i,1} = 'NO2'; Gstr{i,2} = 'ZO3'; 
fNO2(i)=fNO2(i)-1; fZO3(i)=fZO3(i)-1; fZNO5(i)=fZNO5(i)+1;

%d15N Tracer
i=i+1; %<RACM2_063c>; <BAPI_058c>
Rnames{i} = 'ZO2+ZO3=Z2O5';
k(:,i) = K_NO2_NO3*1.057;
Gstr{i,1} = 'ZO2'; Gstr{i,2} = 'ZO3'; 
fZO2(i)=fZO2(i)-1; fZO3(i)=fZO3(i)-1; fZ2O5(i)=fZ2O5(i)+1;
...
Rnames{i} = 'ZNO5= ZO2+NO3';
k(:,i) = K_N2O5*0.5;
Gstr{i,1} = 'ZNO5'; 
fZNO5(i)=fZNO5(i)-1; fZO2(i)=fZO2(i)+1; fNO3(i)=fNO3(i)+1; 

%d15N Tracer
i=i+1; %<RACM2_064b>; <BAPI_059b>
Rnames{i} = 'ZNO5= NO2+ZO3';
k(:,i) = K_N2O5*0.5;
Gstr{i,1} = 'ZNO5'; 
fZNO5(i)=fZNO5(i)-1; fNO2(i)=fNO2(i)+1; fZO3(i)=fZO3(i)+1; 

%d15N Tracer
i=i+1; %<RACM2_064c>; <BAPI_059c>
Rnames{i} = 'Z2O5= ZO2+ZO3';
k(:,i) = K_N2O5;
Gstr{i,1} = 'Z2O5'; 
fZ2O5(i)=fZ2O5(i)-1; fZO2(i)=fZO2(i)+1; fZO3(i)=fZO3(i)+1; 
...
Rnames{i} = 'ZNO5+H2O=HZO3+HNO3';
k(:,i) = 2.50E-22.*H2O; %mmarvin 20151020
Gstr{i,1} = 'ZNO5'; 
fZNO5(i)=fZNO5(i)-1; fHNO3(i)=fHNO3(i)+1; fHZO3(i)=fHZO3(i)+1; %SR 20160406

%d15N Tracer
i=i+1; %<RACM2_065b>; <BAPI_060b>
Rnames{i} = 'Z2O5+H2O=HZO3+HZO3';
k(:,i) = 2.50E-22.*H2O; %mmarvin 20151020
Gstr{i,1} = 'Z2O5'; 
fZ2O5(i)=fZ2O5(i)-1; fHZNO3(i)=fHZO3(i)+1; fHZO3(i)=fHZO3(i)+1; %SR 20160406
...
Rnames{i} = 'HO2+ZO2=HO2ZO2';
k(:,i) = K_HO2_NO2;
Gstr{i,1} = 'HO2'; Gstr{i,2} = 'ZO2'; 
fHO2(i)=fHO2(i)-1; fZO2(i)=fZO2(i)-1; fHO2ZO2(i)=fHO2ZO2(i)+1;
...
Rnames{i} = 'HO2ZO2=HO2+ZO2';
k(:,i) = K_HO2NO2;
Gstr{i,1} = 'HO2ZO2'; 
fHO2ZO2(i)=fHO2ZO2(i)-1; fHO2(i)=fHO2(i)+1; fZO2(i)=fZO2(i)+1; 
...
Rnames{i} = 'OH+HO2ZO2=ZO2+H2O+O2';
k(:,i) = 1.30e-12.*exp(380./T);
Gstr{i,1} = 'OH'; Gstr{i,2} = 'HO2ZO2'; 
fOH(i)=fOH(i)-1; fHO2ZO2(i)=fHO2ZO2(i)-1; fZO2(i)=fZO2(i)+1;
...
Rnames{i} = 'PAZ+OH=XO2+ZO3+HCHO+H2O';
k(:,i) = 4.00E-14;
Gstr{i,1} = 'PAZ'; Gstr{i,2} = 'OH'; 
fPAZ(i)=fPAZ(i)-1; fOH(i)=fOH(i)-1; fXO2(i)=fXO2(i)+1; fZO3(i)=fZO3(i)+1; fHCHO(i)=fHCHO(i)+1; 
...
%d15N Tracer
i=i+1; %<RACM2_121a>; <BAPI_086a>
Rnames{i} = 'PPZ+OH=XO2+ZO3+HCHO+H2O';
k(:,i) = 4.00E-14;
Gstr{i,1} = 'PPZ'; Gstr{i,2} = 'OH'; 
fPPZ(i)=fPPZ(i)-1; fOH(i)=fOH(i)-1; fXO2(i)=fXO2(i)+1; fZO3(i)=fZO3(i)+1; fHCHO(i)=fHCHO(i)+1; 
...
Rnames{i} = 'OZIT+OH=HC3P+ZO2+H2O';
k(:,i) = 5.31E-12.*exp(-260./T);
Gstr{i,1} = 'OZIT'; Gstr{i,2} = 'OH'; 
fOZIT(i)=fOZIT(i)-1; fOH(i)=fOH(i)-1; fHC3P(i)=fHC3P(i)+1; fZO2(i)=fZO2(i)+1; 
...
Rnames{i} = 'API+ZO3=0.10 OLZN+0.90 OLZD';
k(:,i) = 1.19E-12.*exp(490./T);
Gstr{i,1} = 'API'; Gstr{i,2} = 'ZO3'; 
fAPI(i)=fAPI(i)-1; fZO3(i)=fZO3(i)-1; fOLZN(i)=fOLZN(i)+0.1;  fOLZD(i)=fOLZD(i)+0.9; 
...
Rnames{i} = 'HCHO+ZO3=HO2+HZO3+CO';
k(:,i) = 2.00E-12.*exp(-2440./T)*0.9974;
Gstr{i,1} = 'HCHO'; Gstr{i,2} = 'ZO3'; 
fHCHO(i)=fHCHO(i)-1; fZO3(i)=fZO3(i)-1; fHO2(i)=fHO2(i)+1; fHZO3(i)=fHZO3(i)+1; fCO(i)=fCO(i)+1; 
...
Rnames{i} = 'ACD+ZO3=ACO3+HZO3';
k(:,i) = 1.40E-12.*exp(-1900./T);
Gstr{i,1} = 'ACD'; Gstr{i,2} = 'ZO3'; 
fACD(i)=fACD(i)-1; fZO3(i)=fZO3(i)-1; fACO3(i)=fACO3(i)+1; fHZO3(i)=fHZO3(i)+1; 
...
Rnames{i} = 'ALD+ZO3=RCO3+HZO3';
k(:,i) = 3.76E-12.*exp(-1900./T)*0.9962;
Gstr{i,1} = 'ALD'; Gstr{i,2} = 'ZO3'; 
fALD(i)=fALD(i)-1; fZO3(i)=fZO3(i)-1; fRCO3(i)=fRCO3(i)+1; fHZO3(i)=fHZO3(i)+1; 
...
Rnames{i} = 'GLY+ZO3=HZO3+HO2+CO+CO';
k(:,i) = 2.90E-12.*exp(-1900./T)*0.9962;
Gstr{i,1} = 'GLY'; Gstr{i,2} = 'ZO3'; 
fGLY(i)=fGLY(i)-1; fZO3(i)=fZO3(i)-1; fHZO3(i)=fHZO3(i)+1; fHO2(i)=fHO2(i)+1; fCO(i)=fCO(i)+1; fCO(i)=fCO(i)+1; 
...
Rnames{i} = 'MGLY+ZO3=HZO3+ACO3+CO';
k(:,i) = 3.76E-12.*exp(-1900./T)*0.9957;
Gstr{i,1} = 'MGLY'; Gstr{i,2} = 'ZO3'; 
fMGLY(i)=fMGLY(i)-1; fZO3(i)=fZO3(i)-1; fHZO3(i)=fHZO3(i)+1; fACO3(i)=fACO3(i)+1; fCO(i)=fCO(i)+1; 
...
Rnames{i} = 'ACO3+ZO2=PAZ';
k(:,i) = K_ACO3_NO2;
Gstr{i,1} = 'ACO3'; Gstr{i,2} = 'ZO2'; 
fACO3(i)=fACO3(i)-1; fZO2(i)=fZO2(i)-1; fPAZ(i)=fPAZ(i)+1; 
...
Rnames{i} = 'RCO3+ZO2=PPZ';
k(:,i) = K_ACO3_NO2;
Gstr{i,1} = 'RCO3'; Gstr{i,2} = 'ZO2'; 
fRCO3(i)=fRCO3(i)-1; fZO2(i)=fZO2(i)-1; fPPZ(i)=fPPZ(i)+1; 
...
Rnames{i} = 'PPZ=RCO3+ZO2';
k(:,i) = K_PAN;
Gstr{i,1} = 'PPZ'; 
fPPZ(i)=fPPZ(i)-1; fRCO3(i)=fRCO3(i)+1; fZO2(i)=fZO2(i)+1; 
...
Rnames{i} = 'MO2+ZO=HCHO+HO2+ZO2';
k(:,i) = 2.80E-12.*exp(300./T);
Gstr{i,1} = 'MO2'; Gstr{i,2} = 'ZO'; 
fMO2(i)=fMO2(i)-1; fZO(i)=fZO(i)-1; fHCHO(i)=fHCHO(i)+1; fHO2(i)=fHO2(i)+1; fZO2(i)=fZO2(i)+1; 
...
Rnames{i} = 'ETHP+ZO=HO2+ACD+ZO2';
k(:,i) = 2.60E-12.*exp(365./T);
Gstr{i,1} = 'ETHP'; Gstr{i,2} = 'ZO'; 
fETHP(i)=fETHP(i)-1; fZO(i)=fZO(i)-1; fHO2(i)=fHO2(i)+1; fACD(i)=fACD(i)+1; fZO2(i)=fZO2(i)+1; 
...
Rnames{i} = 'HC3P+ZO=HO2+MO2+ETHP+XO2+ZO2+ACD+ALD+ACT+MEK+OZIT';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'HC3P'; Gstr{i,2} = 'ZO'; 
fHC3P(i)=fHC3P(i)-1; fZO(i)=fZO(i)-1; fHO2(i)=fHO2(i)+0.66; fMO2(i)=fMO2(i)+0.131; 
fETHP(i)=fETHP(i)+0.048; fXO2(i)=fXO2(i)+0.089; fZO2(i)=fZO2(i)+0.935; fACD(i)=fACD(i)+0.504; 
fALD(i)=fALD(i)+0.132; fACT(i)=fACT(i)+0.165; fMEK(i)=fMEK(i)+0.042; fOZIT(i)=fOZIT(i)+0.065; %mmarvin 20151020
...
fORA1(i)=fORA1(i)+0.07; fMONITS(i)=fMONITS(i)+0.084; fMONITSh(i)=fMONITSh(i)+0.036; fMONITU(i)=fMONITU(i)+0.042; fMONITUh(i)=fMONITUh(i)+0.018;

%d15N Tracer
i=i+1; %<RACM2_189a>; <BAPI_102a>
Rnames{i} = 'APIP+ZO= HO2+ZO2+HCHO+ALD+ACT+KET+ORA1+MOZITS+MOZITSh+MOZITU+MOZITUh';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'APIP'; Gstr{i,2} = 'ZO'; 
fAPIP(i)=fAPIP(i)-1; fZO(i)=fZO(i)-1; fHO2(i)=fHO2(i)+0.82; fZO2(i)=fZO2(i)+0.82; 
fHCHO(i)=fHCHO(i)+0.23; fALD(i)=fALD(i)+0.43; fACT(i)=fACT(i)+0.11; fKET(i)=fKET(i)+0.44; 
fORA1(i)=fORA1(i)+0.07; fMOZITS(i)=fMOZITS(i)+0.084; fMOZITSh(i)=fMOZITSh(i)+0.036; fMOZITU(i)=fMOZITU(i)+0.042; fMOZITUh(i)=fMOZITUh(i)+0.018;
...
Rnames{i} = 'ACO3+ZO=MO2+ZO2';
k(:,i) = 8.10E-12.*exp(270./T);
Gstr{i,1} = 'ACO3'; Gstr{i,2} = 'ZO'; 
fACO3(i)=fACO3(i)-1; fZO(i)=fZO(i)-1; fMO2(i)=fMO2(i)+1; fZO2(i)=fZO2(i)+1; 
...
Rnames{i} = 'RCO3+ZO=ETHP+ZO2';
k(:,i) = 8.10E-12.*exp(270./T);
Gstr{i,1} = 'RCO3'; Gstr{i,2} = 'ZO'; 
fRCO3(i)=fRCO3(i)-1; fZO(i)=fZO(i)-1; fETHP(i)=fETHP(i)+1; fZO2(i)=fZO2(i)+1; 
...
Rnames{i} = 'ACTP+ZO=ACO3+ZO2+HCHO';
k(:,i) = 2.90E-12.*exp(300./T);
Gstr{i,1} = 'ACTP'; Gstr{i,2} = 'ZO'; 
fACTP(i)=fACTP(i)-1; fZO(i)=fZO(i)-1; fACO3(i)=fACO3(i)+1; fZO2(i)=fZO2(i)+1; fHCHO(i)=fHCHO(i)+1; 
...
Rnames{i} = 'MEKP+ZO=0.67 HO2+ZO2+0.33 HCHO+0.67 DCB1';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'MEKP'; Gstr{i,2} = 'ZO'; 
fMEKP(i)=fMEKP(i)-1; fZO(i)=fZO(i)-1; fHO2(i)=fHO2(i)+0.67; fZO2(i)=fZO2(i)+1; 
fHCHO(i)=fHCHO(i)+0.33; fDCB1(i)=fDCB1(i)+0.67;
...
Rnames{i} = 'KETP+ZO= HO2+ACO3+XO2+ZO2+MGLY+ALD';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'KETP'; Gstr{i,2} = 'ZO'; 
fKETP(i)=fKETP(i)-1; fZO(i)=fZO(i)-1; fHO2(i)=fHO2(i)+0.77; fACO3(i)=fACO3(i)+0.23; 
fXO2(i)=fXO2(i)+0.16; fZO2(i)=fZO2(i)+1; fMGLY(i)=fMGLY(i)+0.54; fALD(i)=fALD(i)+0.46; 
...
Rnames{i} = 'ORAP+ZO=HO2+ZO2+GLY';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'ORAP'; Gstr{i,2} = 'ZO'; 
fORAP(i)=fORAP(i)-1; fZO(i)=fZO(i)-1; fHO2(i)=fHO2(i)+1; fZO2(i)=fZO2(i)+1; fGLY(i)=fGLY(i)+1; 
...
Rnames{i} = 'OLNN+ZO=MONITS+MONITSh+ZO2+HO2';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'OLNN'; Gstr{i,2} = 'ZO'; 
fOLNN(i)=fOLNN(i)-1; fZO(i)=fZO(i)-1; fMONITS(i)=fMONITS(i)+0.85; 
fMONITSh(i)=fMONITSh(i)+0.15; fZO2(i)=fZO2(i)+1; fHO2(i)=fHO2(i)+1;

%d15N Tracer
i=i+1;  %<RACM2_205b>; <BAPI_109b>
Rnames{i} = 'OLZN+NO=MOZITS+MOZITSh+NO2+HO2';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'OLZN'; Gstr{i,2} = 'NO'; 
fOLZN(i)=fOLZN(i)-1; fNO(i)=fNO(i)-1; fMOZITS(i)=fMOZITS(i)+0.85; 
fMOZITSh(i)=fMOZITSh(i)+0.15; fNO2(i)=fNO2(i)+1; fHO2(i)=fHO2(i)+1; 

%d15N Tracer
i=i+1;  %<RACM2_205c>; <BAPI_109c>
Rnames{i} = 'OLZN+ZO=MOZITS+MOZITSh+ZO2+HO2';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'OLZN'; Gstr{i,2} = 'ZO'; 
fOLZN(i)=fOLZN(i)-1; fZO(i)=fZO(i)-1; fMOZITS(i)=fMOZITS(i)+0.85; 
fMOZITSh(i)=fMOZITSh(i)+0.15; fZO2(i)=fZO2(i)+1; fHO2(i)=fHO2(i)+1; 
...
Rnames{i} = 'OLND+ZO=ZO2+NO2+HCHO+ALD+KET';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'OLND'; Gstr{i,2} = 'ZO'; 
fOLND(i)=fOLND(i)-1; fZO(i)=fZO(i)-1; fZO2(i)=fZO2(i)+1; fNO2(i)=fNO2(i)+1; fHCHO(i)=fHCHO(i)+0.287; fALD(i)=fALD(i)+1.24; fKET(i)=fKET(i)+0.464; 

%d15N Tracer
i=i+1;  %<RACM2_206b>; <BAPI_110b>
Rnames{i} = 'OLZD+ZO=ZO2+ZO2+HCHO+ALD+KET';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'OLZD'; Gstr{i,2} = 'ZO'; 
fOLZD(i)=fOLZD(i)-1; fZO(i)=fZO(i)-1; fZO2(i)=fZO2(i)+1; fZO2(i)=fZO2(i)+1; fHCHO(i)=fHCHO(i)+0.287; fALD(i)=fALD(i)+1.24; fKET(i)=fKET(i)+0.464; 

%d15N Tracer
i=i+1;  %<RACM2_206c>; <BAPI_110c>
Rnames{i} = 'OLZD+NO=NO2+ZO2+HCHO+ALD+KET';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'OLZD'; Gstr{i,2} = 'NO'; 
fOLZD(i)=fOLZD(i)-1; fNO(i)=fNO(i)-1; fNO2(i)=fNO2(i)+1; fZO2(i)=fZO2(i)+1; fHCHO(i)=fHCHO(i)+0.287; fALD(i)=fALD(i)+1.24; fKET(i)=fKET(i)+0.464; 
...
Rnames{i} = 'XO2+ZO=ZO2';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'XO2'; Gstr{i,2} = 'ZO'; 
fXO2(i)=fXO2(i)-1; fZO(i)=fZO(i)-1; fZO2(i)=fZO2(i)+1; 
...
Rnames{i} = 'OLZN+HO2=0.595MOZITS+0.105MOZITSh+0.255MOZITU+0.045MOZITUh';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'OLZN'; Gstr{i,2} = 'HO2'; 
fOLZN(i)=fOLZN(i)-1; fHO2(i)=fHO2(i)-1; fMOZITS(i)=fMOZITS(i)+0.595; 
fMOZITSh(i)=fMOZITSh(i)+0.105; fMOZITU(i)=fMOZITU(i)+0.255; fMOZITUh(i)=fMOZITUh(i)+0.045;
...
Rnames{i} = 'OLZD+HO2=0.595MOZITS+0.105MOZITSh+0.255MOZITU+0.045MOZITUh';
k(:,i) = 1.66E-13.*exp(1300./T);
Gstr{i,1} = 'OLZD'; Gstr{i,2} = 'HO2'; 
fOLZD(i)=fOLZD(i)-1; fHO2(i)=fHO2(i)-1; 
fMOZITS(i)=fMOZITS(i)+0.595; fMOZITSh(i)=fMOZITSh(i)+0.105; fMOZITU(i)=fMOZITU(i)+0.255; 
fMOZITUh(i)=fMOZITUh(i)+0.045;
...
Rnames{i} = 'OLZN+MO2=HCHO+HO2+HO2+0.595MOZITS+0.105MOZITSh+0.255MOZITU+0.045MOZITUh';
k(:,i) = 1.60E-13.*exp(708./T);
Gstr{i,1} = 'OLZN'; Gstr{i,2} = 'MO2'; 
fOLZN(i)=fOLZN(i)-1; fMO2(i)=fMO2(i)-1; fHCHO(i)=fHCHO(i)+1; fHO2(i)=fHO2(i)+1; fHO2(i)=fHO2(i)+1; 
fMOZITS(i)=fMOZITS(i)+0.595; fMOZITSh(i)=fMOZITSh(i)+0.105; 
fMOZITU(i)=fMOZITU(i)+0.255; fMOZITUh(i)=fMOZITUh(i)+0.045;
...
Rnames{i} = 'OLZD+MO2= HO2+ZO2+HCHO+ALD+KET+MOH+ROH+.2975MOZITS+.0525MOZITSh+0.1275MOZITU+0.0225MOZITUh';
k(:,i) = 9.68E-14.*exp(708./T);
Gstr{i,1} = 'OLZD'; Gstr{i,2} = 'MO2'; 
fOLZD(i)=fOLZD(i)-1; fMO2(i)=fMO2(i)-1; fHO2(i)=fHO2(i)+0.50; fZO2(i)=fZO2(i)+0.50; 
fHCHO(i)=fHCHO(i)+0.965; fALD(i)=fALD(i)+0.93; fKET(i)=fKET(i)+0.348; fMOH(i)=fMOH(i)+0.25; 
fROH(i)=fROH(i)+0.25; fMONITS(i)=fMONITS(i)+0.2975; 
fMOZITSh(i)=fMOZITSh(i)+0.0525; fMOZITU(i)=fMOZITU(i)+0.1275;  fMOZITUh(i)=fMOZITUh(i)+0.0225;
...
Rnames{i} = 'OLZN+ACO3=0.595MOZITS+0.105MOZITSh+0.255MOZITU+0.045MOZITUh+MO2+HO2';
k(:,i) = 8.85E-13.*exp(765./T);
Gstr{i,1} = 'OLZN'; Gstr{i,2} = 'ACO3'; 
fOLZN(i)=fOLZN(i)-1; fACO3(i)=fACO3(i)-1; fMO2(i)=fMO2(i)+1; fHO2(i)=fHO2(i)+1; 
fMOZITS(i)=fMOZITS(i)+0.595; fMOZITSh(i)=fMOZITSh(i)+0.105; 
fMOZITU(i)=fMOZITU(i)+0.255; fMOZITUh(i)=fMOZITUh(i)+0.045;
...
Rnames{i} = 'OLZD+ACO3= MO2+ZO2+HCHO+ALD+KET+ORA2';
k(:,i) = 5.37E-13.*exp(765./T);
Gstr{i,1} = 'OLZD'; Gstr{i,2} = 'ACO3'; 
fOLZD(i)=fOLZD(i)-1; fACO3(i)=fACO3(i)-1; fMO2(i)=fMO2(i)+0.50; fZO2(i)=fZO2(i)+1; 
fHCHO(i)=fHCHO(i)+0.287; fALD(i)=fALD(i)+1.24; fKET(i)=fKET(i)+0.464; fORA2(i)=fORA2(i)+0.50; 
...
Rnames{i} = 'MO2+ZO3=HCHO+HO2+ZO2';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'MO2'; Gstr{i,2} = 'ZO3'; 
fMO2(i)=fMO2(i)-1; fZO3(i)=fZO3(i)-1; fHCHO(i)=fHCHO(i)+1; fHO2(i)=fHO2(i)+1; fZO2(i)=fZO2(i)+1; 
...
Rnames{i} = 'ETHP+ZO3=ACD+HO2+ZO2';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'ETHP'; Gstr{i,2} = 'ZO3'; 
fETHP(i)=fETHP(i)-1; fZO3(i)=fZO3(i)-1; fACD(i)=fACD(i)+1; fHO2(i)=fHO2(i)+1; fZO2(i)=fZO2(i)+1; 
...
Rnames{i} = 'HC3P+ZO3=HO2+MO2+XO2+ETHP+ZO2+ACD+ALD+MEK+ACT';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'HC3P'; Gstr{i,2} = 'ZO3'; 
fHC3P(i)=fHC3P(i)-1; fZO3(i)=fZO3(i)-1; fHO2(i)=fHO2(i)+0.254; fMO2(i)=fMO2(i)+0.140; 
fXO2(i)=fXO2(i)+0.092; fETHP(i)=fETHP(i)+0.503; fZO2(i)=fZO2(i)+1; fACD(i)=fACD(i)+0.519; 
fALD(i)=fALD(i)+0.147; fMEK(i)=fMEK(i)+0.075; fACT(i)=fACT(i)+0.095; 
...
Rnames{i} = 'APIP+ZO3=HO2+ALD+ZO2+KET';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'APIP'; Gstr{i,2} = 'ZO3'; 
fAPIP(i)=fAPIP(i)-1; fZO3(i)=fZO3(i)-1; fHO2(i)=fHO2(i)+1; fALD(i)=fALD(i)+1; fZO2(i)=fZO2(i)+1; fKET(i)=fKET(i)+1; 
...
Rnames{i} = 'ACO3+ZO3=MO2+ZO2';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'ACO3'; Gstr{i,2} = 'ZO3'; 
fACO3(i)=fACO3(i)-1; fZO3(i)=fZO3(i)-1; fMO2(i)=fMO2(i)+1; fZO2(i)=fZO2(i)+1; 
...
Rnames{i} = 'RCO3+ZO3=ETHP+ZO2';
k(:,i) = 4.00E-12;
Gstr{i,1} = 'RCO3'; Gstr{i,2} = 'ZO3'; 
fRCO3(i)=fRCO3(i)-1; fZO3(i)=fZO3(i)-1; fETHP(i)=fETHP(i)+1; fZO2(i)=fZO2(i)+1; 
...
Rnames{i} = 'ACTP+ZO3=ACO3+ZO2+HCHO';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'ACTP'; Gstr{i,2} = 'ZO3'; 
fACTP(i)=fACTP(i)-1; fZO3(i)=fZO3(i)-1; fACO3(i)=fACO3(i)+1; fZO2(i)=fZO2(i)+1; fHCHO(i)=fHCHO(i)+1; 
...
Rnames{i} = 'MEKP+ZO3=0.67 HO2+ZO2+0.33 HCHO+0.67 DCB1';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'MEKP'; Gstr{i,2} = 'ZO3'; 
fMEKP(i)=fMEKP(i)-1; fZO3(i)=fZO3(i)-1; fHO2(i)=fHO2(i)+0.67; fZO2(i)=fZO2(i)+1; 
fHCHO(i)=fHCHO(i)+0.33; fDCB1(i)=fDCB1(i)+0.67;
...
Rnames{i} = 'KETP+ZO3=DCB1+HO2+ZO2';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'KETP'; Gstr{i,2} = 'ZO3'; 
fKETP(i)=fKETP(i)-1; fZO3(i)=fZO3(i)-1; fDCB1(i)=fDCB1(i)+1; fHO2(i)=fHO2(i)+1; fZO2(i)=fZO2(i)+1; 
...
Rnames{i} = 'ORAP+ZO3=HO2+ZO2+GLY';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'ORAP'; Gstr{i,2} = 'ZO3'; 
fORAP(i)=fORAP(i)-1; fZO3(i)=fZO3(i)-1; fHO2(i)=fHO2(i)+1; fZO2(i)=fZO2(i)+1; fGLY(i)=fGLY(i)+1; 
...
Rnames{i} = 'OLNN+ZO3=0.595MONITS+0.105MONITSh+0.255MONITU+0.045MONITUh+ZO2+HO2';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'OLNN'; Gstr{i,2} = 'ZO3'; 
fOLNN(i)=fOLNN(i)-1; fZO3(i)=fZO3(i)-1; fMONITS(i)=fMONITS(i)+0.595; fMONITSh(i)=fMONITSh(i)+0.105; fMONITU(i)=fMONITU(i)+0.255; 
fMONITUh(i)=fMONITUh(i)+0.045; fZO2(i)=fZO2(i)+1; fHO2(i)=fHO2(i)+1; 

%d15N Tracer
i=i+1; %<RACM2_354b>; <BAPI_160b>
Rnames{i} = 'OLZN+ZO3=0.595MOZITS+0.105MOZITSh+0.255MOZITU+0.045MOZITUh+ZO2+HO2';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'OLZN'; Gstr{i,2} = 'ZO3'; 
fOLZN(i)=fOLZN(i)-1; fZO3(i)=fZO3(i)-1; fMOZITS(i)=fMOZITS(i)+0.595; fMOZITSh(i)=fMOZITSh(i)+0.105; fMOZITU(i)=fMOZITU(i)+0.255; 
fMOZITUh(i)=fMOZITUh(i)+0.045; fZO2(i)=fZO2(i)+1; fHO2(i)=fHO2(i)+1; 

%d15N Tracer
i=i+1; %<RACM2_354c>; <BAPI_160c>
Rnames{i} = 'OLZN+NO3=0.595MOZITS+0.105MOZITSh+0.255MOZITU+0.045MOZITUh+NO2+HO2';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'OLZN'; Gstr{i,2} = 'NO3'; 
fOLZN(i)=fOLZN(i)-1; fNO3(i)=fNO3(i)-1; fMOZITS(i)=fMOZITS(i)+0.595; fMOZITSh(i)=fMOZITSh(i)+0.105; fMOZITU(i)=fMOZITU(i)+0.255; 
fMOZITUh(i)=fMOZITUh(i)+0.045; fNO2(i)=fNO2(i)+1; fHO2(i)=fHO2(i)+1; 
...
Rnames{i} = 'OLND+ZO3=NO2+ZO2+0.287 HCHO+1.24 ALD+0.464 KET';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'OLND'; Gstr{i,2} = 'ZO3'; 
fOLND(i)=fOLND(i)-1; fZO3(i)=fZO3(i)-1; fNO2(i)=fNO2(i)+1; fZO2(i)=fZO2(i)+1; fHCHO(i)=fHCHO(i)+0.287;
fALD(i)=fALD(i)+1.24; fKET(i)=fKET(i)+0.464;

i=i+1; %<RACM2_355b>; <BAPI_161b>
Rnames{i} = 'OLZD+ZO3=ZO2+ZO2+0.287 HCHO+1.24 ALD+0.464 KET';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'OLZD'; Gstr{i,2} = 'ZO3'; 
fOLZD(i)=fOLZD(i)-1; fZO3(i)=fZO3(i)-1; fZO2(i)=fZO2(i)+1; fZO2(i)=fZO2(i)+1; fHCHO(i)=fHCHO(i)+0.287;
fALD(i)=fALD(i)+1.24; fKET(i)=fKET(i)+0.464;

i=i+1; %<RACM2_355c>; <BAPI_161c>
Rnames{i} = 'OLZD+NO3=ZO2+NO2+0.287 HCHO+1.24 ALD+0.464 KET';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'OLZD'; Gstr{i,2} = 'NO3'; 
fOLZD(i)=fOLZD(i)-1; fNO3(i)=fNO3(i)-1; fZO2(i)=fZO2(i)+1; fNO2(i)=fNO2(i)+1; fHCHO(i)=fHCHO(i)+0.287;
fALD(i)=fALD(i)+1.24; fKET(i)=fKET(i)+0.464;
...
Rnames{i} = 'XO2+ZO3=ZO2';
k(:,i) = 1.20E-12;
Gstr{i,1} = 'XO2'; Gstr{i,2} = 'ZO3'; 
fXO2(i)=fXO2(i)-1; fZO3(i)=fZO3(i)-1; fZO2(i)=fZO2(i)+1; 
...
Rnames{i} = 'OLZN+OLNN=0.595MONITS+0.595MOZITS+0.105MONITSh+0.105MOZITSh+0.255MONITU+0.255MOZITU+0.045MONITUh+0.045MOZITUh+HO2';
k(:,i) = 7.00E-14.*exp(1000./T);
Gstr{i,1} = 'OLZN'; Gstr{i,2} = 'OLNN'; 
fOLZN(i)=fOLZN(i)-1; fOLNN(i)=fOLNN(i)-1; fHO2(i)=fHO2(i)+1; 
fMONITS(i)=fMONITS(i)+0.595; 
fMONITSh(i)=fMONITSh(i)+0.105; fMONITU(i)=fMONITU(i)+0.255; 
fMONITUh(i)=fMONITUh(i)+0.045; 
fMOZITS(i)=fMOZITS(i)+0.595; 
fMOZITSh(i)=fMOZITSh(i)+0.105; fMOZITU(i)=fMOZITU(i)+0.255; 
fMOZITUh(i)=fMOZITUh(i)+0.045;

%d15N Tracer
i=i+1; %<RACM2_359b>; <BAPI_164b>
Rnames{i} = 'OLZN+OLZN=1.19MONITS+0.21MONITSh+0.51MONITU+0.09MONITUh+HO2';
k(:,i) = 7.00E-14.*exp(1000./T);
Gstr{i,1} = 'OLZN'; Gstr{i,2} = 'OLZN'; 
fOLZN(i)=fOLZN(i)-1; fOLZN(i)=fOLZN(i)-1; fMOZITS(i)=fMOZITS(i)+1.19; 
fMOZITSh(i)=fMOZITSh(i)+0.21; fMOZITU(i)=fMOZITU(i)+0.51; 
fMOZITUh(i)=fMOZITUh(i)+0.09; fHO2(i)=fHO2(i)+1; 
...
Rnames{i} = 'OLZN+OLND=0.50 HO2+0.50 NO2+0.202 HCHO+0.640 ALD+0.149 KET+ 0.2975MONITS + 0.0525MONITSh + 0.1275MONITU + 0.225MONITUh + 0.595MOZITS + 0.105MOZITSh + 0.255 MOZITU + 0.045MOZITUh ';
k(:,i) = 4.25E-14.*exp(1000./T);
Gstr{i,1} = 'OLZN'; Gstr{i,2} = 'OLND'; 
fOLZN(i)=fOLZN(i)-1; fOLND(i)=fOLND(i)-1; fHO2(i)=fHO2(i)+0.5; fNO2(i)=fNO2(i)+0.5;
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fMONITSh(i)=fMONITSh(i)+0.0525; fMONITU(i)=fMONITU(i)+0.1275; fMONITUh(i)=fMONITUh(i)+0.0225;
fMOZITS(i)=fMOZITS(i)+0.2975; fMOZITS(i)=fMOZITS(i)+0.595; 
fMOZITSh(i)=fMOZITSh(i)+0.105; fMOZITU(i)=fMOZITU(i)+0.255; 
fMOZITUh(i)=fMOZITUh(i)+0.045;

%d15N Tracer
i=i+1; %<RACM2_360b>; <BAPI_165b>
Rnames{i} = 'OLZN+OLZD=0.50 HO2+0.50 ZO2+0.202 HCHO+0.640 ALD+0.149 KET++0.8925MOZITS+0.1575MOZITSh+0.3825MOZITU+0.0675MOZITUh ';
k(:,i) = 4.25E-14.*exp(1000./T);
Gstr{i,1} = 'OLZN'; Gstr{i,2} = 'OLZD'; 
fOLZN(i)=fOLZN(i)-1; fOLZD(i)=fOLZD(i)-1; fHO2(i)=fHO2(i)+0.5; fZO2(i)=fZO2(i)+0.5;
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fMOZITS(i)=fMOZITS(i)+0.8925; fMOZITSh(i)=fMOZITSh(i)+0.1575; fMOZITU(i)=fMOZITU(i)+0.3825; 
fMOZITUh(i)=fMOZITUh(i)+0.0675; 

%d15N Tracer
i=i+1; %<RACM2_360c>; <BAPI_165c>
Rnames{i} = 'OLNN+OLZD=0.50 HO2+0.50 ZO2+0.202 HCHO+0.640 ALD+0.149 KET + 0.595MONITS + 0.105MONITSh + 0.255MONITU + 0.045 MONITUh + 0.2975 MOZITS + 0.0525MOZITSh + 0.1275MOZITU + 0.0225 MOZITUh ';
k(:,i) = 4.25E-14.*exp(1000./T);
Gstr{i,1} = 'OLNN'; Gstr{i,2} = 'OLZD'; 
fOLNN(i)=fOLNN(i)-1; fOLZD(i)=fOLZD(i)-1; fHO2(i)=fHO2(i)+0.5; fZO2(i)=fZO2(i)+0.5;
fHCHO(i)=fHCHO(i)+0.202; fALD(i)=fALD(i)+0.640; fKET(i)=fKET(i)+0.149; 
fMOZITS(i)=fMOZITS(i)+0.2975;
fMOZITSh(i)=fMOZITSh(i)+0.0525; fMOZITU(i)=fMOZITU(i)+0.1275; fMOZITUh(i)=fMOZITUh(i)+0.0225;
fMONITS(i)=fMONITS(i)+0.595; 
fMONITSh(i)=fMONITSh(i)+0.105; fMONITU(i)=fMONITU(i)+0.255; 
fMONITUh(i)=fMONITUh(i)+0.045;
...
Rnames{i} = 'OLZD+OLND=0.5NO2 + 0.5ZO2+0.504 HCHO+1.21 ALD+0.285 KET+0.2975MONITS+0.2975MOZITS+0.0525MONITSh+0.0525MOZITSh+0.1275MONITU+0.1275MOZITU+0.0225MONITUh+0.0225MOZITUh ';
k(:,i) = 2.96E-14.*exp(1000./T);
Gstr{i,1} = 'OLZD'; Gstr{i,2} = 'OLND'; 
fOLZD(i)=fOLZD(i)-1; fOLND(i)=fOLND(i)-1; fNO2(i)=fNO2(i)+0.5; fZO2(i)=fZO2(i)+0.5; fHCHO(i)=fHCHO(i)+0.504; fALD(i)=fALD(i)+1.21; fKET(i)=fKET(i)+0.285; fMONITS(i)=fMONITS(i)+0.2975;
fMONITSh(i)=fMONITSh(i)+0.0525; fMONITU(i)=fMONITU(i)+0.1275; fMONITUh(i)=fMONITUh(i)+0.0225;
fMOZITS(i)=fMOZITS(i)+0.2975;
fMOZITSh(i)=fMOZITSh(i)+0.0525; fMOZITU(i)=fMOZITU(i)+0.1275; fMOZITUh(i)=fMOZITUh(i)+0.0225;
...
Rnames{i} = 'OLZD+OLZD=ZO2+0.504 HCHO+1.21 ALD+0.285 KET +0.595MONITS+0.105MONITSh+0.255MONITU+0.045MONITUh ';
k(:,i) = 2.96E-14.*exp(1000./T);
Gstr{i,1} = 'OLZD'; Gstr{i,2} = 'OLZD'; 
fOLZD(i)=fOLZD(i)-1; fOLZD(i)=fOLZD(i)-1; fZO2(i)=fZO2(i)+1; fHCHO(i)=fHCHO(i)+0.504; fALD(i)=fALD(i)+1.21; fKET(i)=fKET(i)+0.285; 
fMOZITS(i)=fMOZITS(i)+0.595;
fMOZITSh(i)=fMOZITSh(i)+0.105; fMOZITU(i)=fMOZITU(i)+0.255; fMOZITUh(i)=fMOZITUh(i)+0.045;
...
Rnames{i} = 'MOZITS+OH=HOZIT';
k(:,i) = 4.8E-12;
Gstr{i,1} = 'MOZITS';  Gstr{i,2} = 'OH'; 
fMOZITS(i)=fMOZITS(i)-1; fOH(i)=fOH(i)-1; fHOZIT(i)=fHOZIT(i)+1;
...
Rnames{i} = 'MOZITSh+OH=HOZITh';
k(:,i) = 4.8E-12;
Gstr{i,1} = 'MOZITSh';  Gstr{i,2} = 'OH'; 
fMOZITSh(i)=fMOZITSh(i)-1; fOH(i)=fOH(i)-1; fHOZITh(i)=fHOZITh(i)+1;
...
Rnames{i} = 'MOZITU+OH=HOZIT';
k(:,i) = 7.29E-11;
Gstr{i,1} = 'MOZITU';  Gstr{i,2} = 'OH'; 
fMOZITU(i)=fMOZITU(i)-1; fOH(i)=fOH(i)-1; fHOZIT(i)=fHOZIT(i)+1;
...
Rnames{i} = 'MOZITUh+OH=HOZITh';
k(:,i) = 7.29E-11;
Gstr{i,1} = 'MOZITUh';  Gstr{i,2} = 'OH'; 
fMOZITUh(i)=fMOZITUh(i)-1; fOH(i)=fOH(i)-1; fHOZITh(i)=fHOZITh(i)+1;
...
Rnames{i} = 'MOZITU+O3=HOZIT';
k(:,i) = 1.67E-16;
Gstr{i,1} = 'MOZITU';  Gstr{i,2} = 'O3'; 
fMOZITU(i)=fMOZITU(i)-1; fO3(i)=fO3(i)-1; fHOZIT(i)=fHOZIT(i)+1;
...
Rnames{i} = 'MOZITUh+O3=HOZITh';
k(:,i) = 1.67E-16;
Gstr{i,1} = 'MOZITUh';  Gstr{i,2} = 'O3'; 
fMOZITUh(i)=fMOZITUh(i)-1; fO3(i)=fO3(i)-1; fHOZITh(i)=fHOZITh(i)+1;
...
Rnames{i} = 'MOZITU+NO3=HOZIT';
k(:,i) = 3.15E-13*exp(-448/T);
Gstr{i,1} = 'MOZITU';  Gstr{i,2} = 'NO3'; 
fMOZITU(i)=fMOZITU(i)-1; fNO3(i)=fNO3(i)-1; fHOZIT(i)=fHOZIT(i)+1;


%d15N Tracer
i=i+1; %<BAPI_175b>; (rate from Fisher et al., 2015)
Rnames{i} = 'MOZITU+ZO3=HOZIT';
k(:,i) = 3.15E-13*exp(-448/T);
Gstr{i,1} = 'MOZITU';  Gstr{i,2} = 'ZO3'; 
fMOZITU(i)=fMOZITU(i)-1; fZO3(i)=fZO3(i)-1; fHOZIT(i)=fHOZIT(i)+1;

%d15N Tracer
i=i+1; %<BAPI_175c>; (rate from Fisher et al., 2015)
Rnames{i} = 'MONITU+ZO3=HONIT';
k(:,i) = 3.15E-13*exp(-448/T);
Gstr{i,1} = 'MONITU';  Gstr{i,2} = 'ZO3'; 
fMONITU(i)=fMONITU(i)-1; fZO3(i)=fZO3(i)-1; fHONIT(i)=fHONIT(i)+1;
...
Rnames{i} = 'MOZITUh+NO3=HOZITh';
k(:,i) = 3.15E-13*exp(-448/T);
Gstr{i,1} = 'MOZITUh';  Gstr{i,2} = 'NO3'; 
fMOZITUh(i)=fMOZITUh(i)-1; fNO3(i)=fNO3(i)-1; fHOZITh(i)=fHOZITh(i)+1;


%d15N Tracer
i=i+1; %<BAPI_176b>; (rate from Fisher et al., 2015)
Rnames{i} = 'MOZITUh+ZO3=HOZITh';
k(:,i) = 3.15E-13*exp(-448/T);
Gstr{i,1} = 'MOZITUh';  Gstr{i,2} = 'ZO3'; 
fMOZITUh(i)=fMOZITUh(i)-1; fZO3(i)=fZO3(i)-1; fHOZITh(i)=fHOZITh(i)+1;

%d15N Tracer
i=i+1; %<BAPI_176c>; (rate from Fisher et al., 2015)
Rnames{i} = 'MONITUh+ZO3=HONITh';
k(:,i) = 3.15E-13*exp(-448/T);
Gstr{i,1} = 'MONITUh';  Gstr{i,2} = 'ZO3'; 
fMOnITUh(i)=fMONITUh(i)-1; fZO3(i)=fZO3(i)-1; fHONITh(i)=fHONITh(i)+1;
...
Rnames{i} = 'MOZITS+NO3=HOZIT';
k(:,i) = 3.15E-13*exp(-448/T);
Gstr{i,1} = 'MOZITS';  Gstr{i,2} = 'NO3'; 
fMOZITS(i)=fMOZITS(i)-1; fNO3(i)=fNO3(i)-1; fHOZIT(i)=fHOZIT(i)+1;

%d15N Tracer
i=i+1; %<BAPI_177b>; (rate from Fisher et al., 2015)
Rnames{i} = 'MOZITS+ZO3=HOZIT';
k(:,i) = 3.15E-13*exp(-448/T);
Gstr{i,1} = 'MOZITS';  Gstr{i,2} = 'ZO3'; 
fMOZITS(i)=fMOZITS(i)-1; fZO3(i)=fZO3(i)-1; fHOZIT(i)=fHOZIT(i)+1;

%d15N Tracer
i=i+1; %<BAPI_177c>; (rate from Fisher et al., 2015)
Rnames{i} = 'MONITS+ZO3=HONIT';
k(:,i) = 3.15E-13*exp(-448/T);
Gstr{i,1} = 'MONITS';  Gstr{i,2} = 'ZO3'; 
fMONITS(i)=fMONITS(i)-1; fZO3(i)=fZO3(i)-1; fHONIT(i)=fHONIT(i)+1;
...
Rnames{i} = 'MOZITSh+NO3=HOZITh';
k(:,i) = 3.15E-13*exp(-448/T);
Gstr{i,1} = 'MOZITSh';  Gstr{i,2} = 'NO3'; 
fMOZITSh(i)=fMOZITSh(i)-1; fNO3(i)=fNO3(i)-1; fHOZITh(i)=fHOZITh(i)+1;

%d15N Tracer
i=i+1; %<BAPI_178b>; (rate from Fisher et al., 2015)
Rnames{i} = 'MOZITSh+ZO3=HOZITh';
k(:,i) = 3.15E-13*exp(-448/T);
Gstr{i,1} = 'MOZITSh';  Gstr{i,2} = 'ZO3'; 
fMOZITSh(i)=fMOZITSh(i)-1; fZO3(i)=fZO3(i)-1; fHOZITh(i)=fHOZITh(i)+1;

%d15N Tracer
i=i+1; %<BAPI_178c>; (rate from Fisher et al., 2015)
Rnames{i} = 'MONITSh+ZO3=HONITh';
k(:,i) = 3.15E-13*exp(-448/T);
Gstr{i,1} = 'MONITSh';  Gstr{i,2} = 'ZO3'; 
fMONITSh(i)=fMONITSh(i)-1; fZO3(i)=fZO3(i)-1; fHONITh(i)=fHONITh(i)+1;
...
Rnames{i} = 'HOZIT+OH=ZO3+HKET';
k(:,i) = K_OH_HNO3;
Gstr{i,1} = 'HOZIT';  Gstr{i,2} = 'OH'; 
fHOZIT(i)=fHOZIT(i)-1; fOH(i)=fOH(i)-1; fZO3(i)=fZO3(i)+1; fHKET(i)=fHKET(i)+1;
...
Rnames{i} = 'HOZITh+OH=ZO3+HKET';
k(:,i) = K_OH_HNO3;
Gstr{i,1} = 'HOZITh';  Gstr{i,2} = 'OH'; 
fHOZITh(i)=fHOZITh(i)-1; fOH(i)=fOH(i)-1; fZO3(i)=fZO3(i)+1; fHKET(i)=fHKET(i)+1;
...
%d15N Tracer
i=i+1; %<BAPI_181a>; 
Rnames{i} = 'MOZITS=ZO2+KET';
k(:,i) = JONIT;
Gstr{i,1} = 'MOZITS'; 
fMOZITS(i)=fMOZITS(i)-1; fZO2(i)=fZO2(i)+1; fKET(i)=fKET(i)+1;
...
%d15N Tracer
i=i+1; %<BAPI_182a>; 
Rnames{i} = 'MOZITSh=ZO2+KET';
k(:,i) = JONIT;
Gstr{i,1} = 'MOZITSh'; 
fMOZITSh(i)=fMOZITSh(i)-1; fZO2(i)=fZO2(i)+1; fKET(i)=fKET(i)+1;
...
%d15N Tracer
i=i+1; %<BAPI_183a>;
Rnames{i} = 'MOZITU=ZO2+ALD';
k(:,i) = JONIT;
Gstr{i,1} = 'MOZITU'; 
fMOZITU(i)=fMOZITU(i)-1; fZO2(i)=fZO2(i)+1; fALD(i)=fALD(i)+1;
...
%d15N Tracer
i=i+1; %<BAPI_184a>;
Rnames{i} = 'MOZITUh=ZO2+ALD';
k(:,i) = JONIT;
Gstr{i,1} = 'MOZITUh'; 
fMOZITUh(i)=fMOZITUh(i)-1; fZO2(i)=fZO2(i)+1; fALD(i)=fALD(i)+1;
...
%d15N Tracer
i=i+1; %<BAPI_185a>
Rnames{i} = 'HOZIT=ZO2+HKET';
k(:,i) = JONIT;
Gstr{i,1} = 'HOZIT'; 
fHOZIT(i)=fHOZIT(i)-1; fZO2(i)=fZO2(i)+1; fHKET(i)=fHKET(i)+1;
...
i=i+1; %<BAPI_186a>
Rnames{i} = 'HOZITh=ZO2+HKET';
k(:,i) = JONIT;
Gstr{i,1} = 'HOZITh'; 
fHOZITh(i)=fHOZITh(i)-1; fZO2(i)=fZO2(i)+1; fHKET(i)=fHKET(i)+1;
...
Rnames{i} = 'MOZITSh=HZO3+ROH';
k(:,i) = 9.26E-5;
Gstr{i,1} = 'MOZITSh'; 
fMOZITSh(i)=fMOZITSh(i)-1; fHZO3(i)=fHZO3(i)+1; fROH(i)=fROH(i)+1;
...
Rnames{i} = 'MOZITUh=HZO3+ROH';
k(:,i) =  9.26E-5;
Gstr{i,1} = 'MOZITUh'; 
fMOZITUh(i)=fMOZITUh(i)-1; fHZO3(i)=fHZO3(i)+1; fROH(i)=fROH(i)+1;
...
Rnames{i} = 'HOZITh=HZO3+ROH';
k(:,i) =  9.26E-5;
Gstr{i,1} = 'HOZITh'; 
fHOZITh(i)=fHOZITh(i)-1; fHZO3(i)=fHZO3(i)+1; fROH(i)=fROH(i)+1;
...
%d15N Tracer
i=i+1; %<Wall_03a>
Rnames{i} = 'ZO2=0.5HOZO + wHZO3';
k(:,i) = 2.31E-6;
Gstr{i,1} = 'ZO2'; 
fZO2(i)=fZO2(i)-1; fHOZO(i)=fHOZO(i)+0.5; fwHZO3(i)=fwHZO3(i)+0.5;
...
k(:,i) = 1E-5;
Gstr{i,1} = 'HZO3'; 
fHZO3(i)=fHZO3(i)-1; fwHZO3(i)=fwHZO3(i)+1;
...
%d15N Tracer
i=i+1; %<Wall_05a>
Rnames{i} = 'wHZO3=OH+ZO2';
k(:,i) = JHNO3
Gstr{i,1} = 'wHZO3'; 
fwHZO3(i)=fwHZO3(i)-1; fOH(i)=fOH(i)+1; fZO2(i)=fZO2(i)+1;
...
%d15N Tracer
i=i+1; %<Wall_06a>
Rnames{i} = 'ZNO5=wHNO3+wHZO3';
k(:,i) =  1.0E-20*H2O;
Gstr{i,1} = 'ZNO5'; 
fZNO5(i)=fZNO5(i)-1; fwHNO3(i)=fwHNO3(i)+1; fwHZO3(i)=fwHZO3(i)+1; 

%d15N Tracer
i=i+1; %<Wall_06b>
Rnames{i} = 'Z2O5=2wHZO3';
k(:,i) =  1.0E-20*H2O;
Gstr{i,1} = 'Z2O5'; 
fZ2O5(i)=fZ2O5(i)-1; fwHZO3(i)=fwHZO3(i)+2; 
...
k(:,i) =  8.8E-6;
Gstr{i,1} = 'HOZITh'; 
fHOZITh(i)=fHOZITh(i)-1; 

i=i+1; %<Wall_15>
Rnames{i} = 'H2O2=wH2O2';
k(:,i) =  2.19E-6;
Gstr{i,1} = 'H2O2'; 
fH2O2(i)=fH2O2(i)-1; fwH2O2(i)=fwH2O2(i)+1;

i=i+1; %<Wall_16>
Rnames{i} = 'HO2=wHO2';
k(:,i) =  2.19E-6;
Gstr{i,1} = 'HO2'; 
fHO2(i)=fHO2(i)-1; fwHO2(i)=fwHO2(i)+1;
...
%d15N Tracer
i=i+1; %<HET_01a>
Rnames{i} = 'ZO2=0.5HZO3+0.5HOZO';
k(:,i) = 9.31E-7;
Gstr{i,1} = 'ZO2'; 
fZO2(i)=fZO2(i)-1; fHZO3(i)=fHZO3(i)+0.5; fHOZO(i)=fHOZO(i)+0.5;
...
k(:,i) = 4.01E-3;
Gstr{i,1} = 'ZO3'; 
fZO3(i)=fZO3(i)-1; fHZO3(i)=fHZO3(i)+1; 
...
%d15N Tracer
i=i+1; %<HET_03a>
Rnames{i} = 'ZNO5=HNO3+HZO3';
k(:,i) = 9.11E-5;
Gstr{i,1} = 'ZNO5'; 
fZNO5(i)=fZNO5(i)-1; fHNO3(i)=fHNO3(i)+1; fHZO3(i)=fHZO3(i)+1;
...
k(:,i) = 9.11E-5;
Gstr{i,1} = 'Z2O5'; 
fZ2O5(i)=fZ2O5(i)-1; fHZO3(i)=fHZO3(i)+2;
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%Nitrogen Isotope Exhcange %%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
i=i+1; %<N_Exchange_01>
Rnames{i} = 'NO + ZO2 = ZO + NO2 ';
k(:,i) = 8.14E-14;
Gstr{i,1} = 'NO'; Gstr{i,2} = 'ZO2'; 
fNO(i)=fNO(i)-1; fZO2(i)=fZO2(i)-1; fZO(i)=fZO(i)+1; fNO2(i)=fNO2(i)+1; 

i=i+1; %<N_Exchange_02>
Rnames{i} = 'ZO + NO2 = NO + ZO2 ';
k(:,i) = 8.14E-14*1.0356;
Gstr{i,1} = 'ZO'; Gstr{i,2} = 'NO2'; 
fZO(i)=fZO(i)-1; fNO2(i)=fNO2(i)-1; fNO(i)=fNO(i)+1; fZO2(i)=fZO2(i)+1
